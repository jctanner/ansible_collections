...
DOCUMENTATION = '''
---
module: jctanner.network_enos.enos_facts
version_added: "2.5"
...
'''
EXAMPLES = '''
Tasks: The following are examples of using the module jctanner.network_enos.enos_facts.
---
- name: Test Enos Facts
  jctanner.network_enos.enos_facts:
    provider={{ cli }}
...
from ansible_collections.jctanner.network_jctanner.network_enos.enos.plugins.module_utils.network.jctanner.network_enos.enos.jctanner.network_enos.enos import run_commands, jctanner.network_enos.enos_argument_spec, check_args
