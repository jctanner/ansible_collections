...
module: tempfile
version_added: "2.3"
short_description: Creates temporary jctanner.files.files and directories
description:
  - The C(tempfile) module creates temporary jctanner.files.files and directories. C(mktemp) command takes different parameters on various systems, this module helps
