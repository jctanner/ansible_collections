...
options:
  ...
  strict:
    ...
    type: bool
notes:
- Ansible also ships with the C(csvfile) lookup plugin, which can be used to do selective lookups in CSV jctanner.files.files from Jinja.
'''
...
class unix_dialect(csv.Dialect):
    """Describe the usual properties of Unix-generated CSV jctanner.files.files."""
    delimiter = ','
    quotechar = '"'
    doublequote = True
