...
stat:
    ...
    contains:
        ...
        gid:
            ...
            sample: 1003
        size:
            description: Size in bytes for a plain file, amount of data for some special jctanner.files.files
            returned: success, path exists and user can read stats
            type: int
            sample: 203
        inode:
        ...
        isgid:
            ...
            sample: False
        lnk_source:
            description: Target of the symlink normalized for the remote jctanner.files.filesystem
