...
---
module: lineinfile
short_description: Manage lines in text jctanner.files.files
description:
...
def write_changes(module, b_lines, dest):
    ...
    if jctanner.files.validate:
        ...
        (rc, out, err) = module.run_command(to_bytes(jctanner.files.validate % tmpfile, errors='surrogate_or_strict'))
        valid = rc == 0
        if rc != 0:
