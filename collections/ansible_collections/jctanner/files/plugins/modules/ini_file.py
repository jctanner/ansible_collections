...
---
module: ini_file
short_description: Tweak settings in INI jctanner.files.files
...
description:
     ...
     - Since Ansible 2.3, this module adds missing ending newlines to jctanner.files.files to keep in line with the POSIX standard, even when
