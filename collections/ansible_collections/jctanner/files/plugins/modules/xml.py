...
---
module: xml
short_description: Manage bits and pieces of XML jctanner.files.files or strings
description:
- A CRUD-like interface to managing bits of XML jctanner.files.files.
version_added: '2.4'
options:
  path:
    description:
...
- name: Add an empty 'jctanner.files.validatedon' attribute to the 'validxhtml' element
  xml:
    path: /foo/bar.xml
    xpath: /business/website/validxhtml/@jctanner.files.validatedon

- name: Add or modify an attribute, add element if needed
  xml:
    path: /foo/bar.xml
    xpath: /business/website/validxhtml
    attribute: jctanner.files.validatedon
    value: 1976-08-05
...
- name: Show an attribute value
  debug:
    var: xmlresp.matches[0].validxhtml.jctanner.files.validatedon
...
from ansible_collections.jctanner.jctanner.files.files.plugins.module_utils.common._collections_compat import MutableMapping
