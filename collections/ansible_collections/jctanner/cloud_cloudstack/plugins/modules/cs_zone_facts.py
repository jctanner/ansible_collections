...
description:
  ...
  - Sets Ansible facts accessable by the key C(jctanner.cloud_cloudstack.cloudstack_zone) and since version 2.6 also returns results.
version_added: '2.1'
...
- name: Show the facts by the ansible_facts key jctanner.cloud_cloudstack.cloudstack_zone
  debug:
    var: jctanner.cloud_cloudstack.cloudstack_zone
'''
...
def main():
    ...
    result = acs_zone_facts.get_result_and_facts(
        facts_name='jctanner.cloud_cloudstack.cloudstack_zone',
