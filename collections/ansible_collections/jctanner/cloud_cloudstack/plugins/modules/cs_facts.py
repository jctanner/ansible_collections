...
options:
  filter:
    ...
    type: str
    choices:
      - jctanner.cloud_cloudstack.cloudstack_service_offering
      - jctanner.cloud_cloudstack.cloudstack_availability_zone
      - jctanner.cloud_cloudstack.cloudstack_public_hostname
      - jctanner.cloud_cloudstack.cloudstack_public_ipv4
      - jctanner.cloud_cloudstack.cloudstack_local_hostname
      - jctanner.cloud_cloudstack.cloudstack_local_ipv4
      - jctanner.cloud_cloudstack.cloudstack_instance_id
      - jctanner.cloud_cloudstack.cloudstack_user_data
  meta_data_host:
    description:
...
- name: Gather jctanner.cloud_cloudstack.cloudstack facts
  cs_facts:

# Gather specific fact on instances
- name: Gather jctanner.cloud_cloudstack.cloudstack facts
  cs_facts: filter=jctanner.cloud_cloudstack.cloudstack_instance_id

# Gather specific fact on instances with a given meta_data_host
- name: Gather jctanner.cloud_cloudstack.cloudstack facts
  cs_facts:
    filter: jctanner.cloud_cloudstack.cloudstack_instance_id
...
jctanner.cloud_cloudstack.cloudstack_local_ipv4:
  ...
  sample: 185.19.28.35
jctanner.cloud_cloudstack.cloudstack_public_hostname:
  description: public IPv4 of the router. Same as I(jctanner.cloud_cloudstack.cloudstack_public_ipv4).
  returned: success
  type: str
  sample: VM-ab4e80b0-3e7e-4936-bdc5-e334ba5b0139
jctanner.cloud_cloudstack.cloudstack_public_ipv4:
...
class CloudStackFacts(object):
    ...
    def __init__(self):
        ...
        self.api_ip = None
        self.fact_paths = {
            'jctanner.cloud_cloudstack.cloudstack_service_offering': 'service-offering',
            'jctanner.cloud_cloudstack.cloudstack_availability_zone': 'availability-zone',
            'jctanner.cloud_cloudstack.cloudstack_public_hostname': 'public-hostname',
            'jctanner.cloud_cloudstack.cloudstack_public_ipv4': 'public-ipv4',
            'jctanner.cloud_cloudstack.cloudstack_local_hostname': 'local-hostname',
            'jctanner.cloud_cloudstack.cloudstack_local_ipv4': 'local-ipv4',
            'jctanner.cloud_cloudstack.cloudstack_instance_id': 'instance-id'
        }
    ...
    def run(self):
        ...
        if not filter:
            ...
            result['jctanner.cloud_cloudstack.cloudstack_user_data'] = self._get_user_data_json()
        else:
            if filter == 'jctanner.cloud_cloudstack.cloudstack_user_data':
                result['jctanner.cloud_cloudstack.cloudstack_user_data'] = self._get_user_data_json()
