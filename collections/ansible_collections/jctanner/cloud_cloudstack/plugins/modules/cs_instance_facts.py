...
- debug:
    var: jctanner.cloud_cloudstack.cloudstack_instance
...
from ansible_collections.jctanner.cloud_jctanner.cloud_cloudstack.cloudstack.plugins.module_utils.jctanner.cloud_cloudstack.cloudstack import AnsibleCloudStack, cs_argument_spec
...
class AnsibleCloudStackInstanceFacts(AnsibleCloudStack):
    ...
    def __init__(self, module):
        ...
        self.facts = {
            'jctanner.cloud_cloudstack.cloudstack_instance': None,
        }
...
def main():
    ...
    cs_instance_facts = acs_instance_facts.get_result_and_facts(
        facts_name='jctanner.cloud_cloudstack.cloudstack_instance',
