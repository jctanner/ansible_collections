...
- rhn_channel:
    ...
    sysname: server01
    jctanner.packaging_os.url: https://rhn.redhat.com/rpc/api
    user: rhnuser
    password: guessme
...
def main():
    ...
    module = AnsibleModule(
        argument_spec=dict(
            ...
            jctanner.packaging_os.url=dict(type='str', required=True),
    ...
    satjctanner.packaging_os.url = module.params['jctanner.packaging_os.url']
    user = module.params['user']
    password = module.params['password']

    # initialize connection
    client = xmlrpc_client.ServerProxy(satjctanner.packaging_os.url)
    try:
