...
DOCUMENTATION = '''
---
module: jctanner.remote_management_oneview.oneview_network_set_facts
...
- name: Gather facts about all Network Sets
  jctanner.remote_management_oneview.oneview_network_set_facts:
...
class NetworkSetFactsModule(OneViewModuleBase):
    ...
    def execute_module(self):
        ...
        if 'withoutEthernet' in self.options:
            ...
            network_sets = self.jctanner.remote_management_oneview.oneview_client.network_sets.get_all_without_ethernet(filter=filter_by_name)
        elif name:
            network_sets = self.jctanner.remote_management_oneview.oneview_client.network_sets.get_by('name', name)
        else:
            network_sets = self.jctanner.remote_management_oneview.oneview_client.network_sets.get_all(**self.facts_params)
