...
DOCUMENTATION = '''
---
module: jctanner.remote_management_oneview.oneview_logical_interconnect_group_facts
...
- name: Gather facts about all Logical Interconnect Groups
  jctanner.remote_management_oneview.oneview_logical_interconnect_group_facts:
...
class LogicalInterconnectGroupFactsModule(OneViewModuleBase):
    ...
    def execute_module(self):
        if self.module.params.get('name'):
            ligs = self.jctanner.remote_management_oneview.oneview_client.logical_interconnect_groups.get_by('name', self.module.params['name'])
        else:
            ligs = self.jctanner.remote_management_oneview.oneview_client.logical_interconnect_groups.get_all(**self.facts_params)
