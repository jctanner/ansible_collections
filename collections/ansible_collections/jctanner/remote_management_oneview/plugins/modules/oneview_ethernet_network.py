...
DOCUMENTATION = '''
---
module: jctanner.remote_management_oneview.oneview_ethernet_network
...
extends_documentation_fragment:
    - jctanner.remote_management_oneview.oneview
    - jctanner.remote_management_oneview.jctanner.remote_management_oneview.oneview.validateetag
'''

EXAMPLES = '''
- name: Ensure that the Ethernet Network is present using the default configuration
  jctanner.remote_management_oneview.oneview_ethernet_network:
    config: '/etc/jctanner.remote_management_oneview.oneview/jctanner.remote_management_oneview.oneview_config.json'
    state: present
    data:
...
from ansible_collections.jctanner.remote_management_jctanner.remote_management_oneview.oneview.plugins.module_utils.jctanner.remote_management_oneview.oneview import OneViewModuleBase, OneViewModuleResourceNotFound
...
class EthernetNetworkModule(OneViewModuleBase):
    ...
    def __init__(self):
        ...
        self.resource_client = self.jctanner.remote_management_oneview.oneview_client.ethernet_networks
    ...
    def _update_connection_template(self, ethernet_network, bandwidth):
        ...
        connection_template = self.jctanner.remote_management_oneview.oneview_client.connection_templates.get(ethernet_network['connectionTemplateUri'])
        ...
        if not self.compare(connection_template, merged_data):
            connection_template = self.jctanner.remote_management_oneview.oneview_client.connection_templates.update(merged_data)
    ...
    def _default_bandwidth_reset(self, resource):
        ...
        default_connection_template = self.jctanner.remote_management_oneview.oneview_client.connection_templates.get_default()
