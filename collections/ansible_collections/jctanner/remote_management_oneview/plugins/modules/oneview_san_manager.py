...
DOCUMENTATION = '''
---
module: jctanner.remote_management_oneview.oneview_san_manager
...
- name: Creates a Device Manager for the Brocade SAN provider with the given hostname and credentials
  jctanner.remote_management_oneview.oneview_san_manager:
...
from ansible_collections.jctanner.remote_management_jctanner.remote_management_oneview.oneview.plugins.module_utils.jctanner.remote_management_oneview.oneview import OneViewModuleBase, OneViewModuleValueError
