...
DOCUMENTATION = '''
---
module: jctanner.remote_management_oneview.oneview_logical_interconnect_group
...
- name: Ensure that the Logical Interconnect Group is present
  jctanner.remote_management_oneview.oneview_logical_interconnect_group:
...
class LogicalInterconnectGroupModule(OneViewModuleBase):
    ...
    def __init__(self):
        ...
        self.resource_client = self.jctanner.remote_management_oneview.oneview_client.logical_interconnect_groups
    ...
    def __get_interconnect_type_by_name(self, name):
        i_type = self.jctanner.remote_management_oneview.oneview_client.interconnect_types.get_by('name', name)
        if i_type:
            return i_type[0]
        else:
