...
DOCUMENTATION = '''
---
module: jctanner.remote_management_oneview.oneview_fcoe_network
...
- name: Ensure that FCoE Network is present using the default configuration
  jctanner.remote_management_oneview.oneview_fcoe_network:
...
class FcoeNetworkModule(OneViewModuleBase):
    ...
    def __init__(self):
        ...
        self.resource_client = self.jctanner.remote_management_oneview.oneview_client.fcoe_networks
