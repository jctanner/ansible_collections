...
DOCUMENTATION = '''
---
module: jctanner.remote_management_oneview.oneview_datacenter_facts
...
- name: Gather facts about all Data Centers
  jctanner.remote_management_oneview.oneview_datacenter_facts:
...
class DatacenterFactsModule(OneViewModuleBase):
    ...
    def execute_module(self):
        ...
        client = self.jctanner.remote_management_oneview.oneview_client.datacenters
        ansible_facts = {}
