...
DOCUMENTATION = '''
---
module: jctanner.remote_management_oneview.oneview_ethernet_network_facts
...
extends_documentation_fragment:
    ...
    - jctanner.remote_management_oneview.jctanner.remote_management_oneview.oneview.factsparams
'''

EXAMPLES = '''
- name: Gather facts about all Ethernet Networks
  jctanner.remote_management_oneview.oneview_ethernet_network_facts:
...
from ansible_collections.jctanner.remote_management_jctanner.remote_management_oneview.oneview.plugins.module_utils.jctanner.remote_management_oneview.oneview import OneViewModuleBase
...
class EthernetNetworkFactsModule(OneViewModuleBase):
    ...
    def __get_associated_profiles(self, ethernet_network):
        ...
        return [self.jctanner.remote_management_oneview.oneview_client.server_profiles.get(x) for x in associated_profiles]
    ...
    def __get_associated_uplink_groups(self, ethernet_network):
        ...
        return [self.jctanner.remote_management_oneview.oneview_client.uplink_sets.get(x) for x in uplink_groups]
