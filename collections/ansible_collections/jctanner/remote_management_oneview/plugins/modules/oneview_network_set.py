...
DOCUMENTATION = '''
---
module: jctanner.remote_management_oneview.oneview_network_set
...
- name: Create a Network Set
  jctanner.remote_management_oneview.oneview_network_set:
...
class NetworkSetModule(OneViewModuleBase):
    ...
    def __init__(self):
        ...
        self.resource_client = self.jctanner.remote_management_oneview.oneview_client.network_sets
    ...
    def _get_ethernet_network_by_name(self, name):
        result = self.jctanner.remote_management_oneview.oneview_client.ethernet_networks.get_by('name', name)
