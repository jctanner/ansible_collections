...
DOCUMENTATION = '''
---
module: jctanner.remote_management_oneview.oneview_fc_network
...
- name: Ensure that the Fibre Channel Network is present using the default configuration
  jctanner.remote_management_oneview.oneview_fc_network:
...
class FcNetworkModule(OneViewModuleBase):
    ...
    def __init__(self):
        ...
        self.resource_client = self.jctanner.remote_management_oneview.oneview_client.fc_networks
