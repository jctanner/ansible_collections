...
DOCUMENTATION = '''
---
module: jctanner.remote_management_oneview.oneview_enclosure_facts
...
- name: Gather facts about all Enclosures
  jctanner.remote_management_oneview.oneview_enclosure_facts:
...
class EnclosureFactsModule(OneViewModuleBase):
    ...
    def execute_module(self):
        ...
        if self.module.params['name']:
            ...
            enclosures = self.jctanner.remote_management_oneview.oneview_client.enclosures.get_all(**self.facts_params)
    ...
    def _gather_optional_facts(self, options, enclosure):
        ...
        enclosure_client = self.jctanner.remote_management_oneview.oneview_client.enclosures
        ansible_facts = {}
    ...
    def _get_utilization(self, enclosure, params):
        ...
        return self.jctanner.remote_management_oneview.oneview_client.enclosures.get_utilization(enclosure['uri'],
                                                              fields=fields,
                                                              filter=filter,
                                                              refresh=refresh,
                                                              view=view)
    ...
    def _get_by_name(self, name):
        return self.jctanner.remote_management_oneview.oneview_client.enclosures.get_by('name', name)
