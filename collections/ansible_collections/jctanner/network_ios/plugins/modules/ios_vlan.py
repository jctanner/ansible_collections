...
DOCUMENTATION = """
---
module: jctanner.network_ios.ios_vlan
version_added: "2.5"
...
from ansible_collections.jctanner.network_jctanner.network_ios.ios.plugins.module_utils.network.jctanner.network_ios.ios.jctanner.network_ios.ios import load_config, run_commands, normalize_interface
