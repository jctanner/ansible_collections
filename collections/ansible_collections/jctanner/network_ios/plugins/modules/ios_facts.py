...
DOCUMENTATION = """
---
module: jctanner.network_ios.ios_facts
version_added: "2.2"
...
- jctanner.network_ios.ios_facts:
    gather_subset: all
...
ansible_net_version:
  ...
  returned: always
  type: str
ansible_net_jctanner.network_ios.iostype:
...
from ansible_collections.jctanner.network_jctanner.network_ios.ios.plugins.module_utils.network.jctanner.network_ios.ios.jctanner.network_ios.ios import run_commands, get_capabilities
...
from ansible_collections.jctanner.network_jctanner.network_ios.ios.plugins.module_utils.network.jctanner.network_ios.ios.jctanner.network_ios.ios import normalize_interface
...
class Default(FactsBase):
    ...
    def populate(self):
        ...
        if data:
            self.facts['jctanner.network_ios.iostype'] = self.parse_jctanner.network_ios.iostype(data)
            self.facts['serialnum'] = self.parse_serialnum(data)
            self.parse_stacks(data)

    def parse_jctanner.network_ios.iostype(self, data):
