...
DOCUMENTATION = """
---
module: jctanner.network_ios.ios_linkagg
version_added: "2.5"
...
- name: create link aggregation group
  jctanner.network_ios.ios_linkagg:
    group: 10
    state: present
...
from ansible_collections.jctanner.network_jctanner.network_ios.ios.plugins.module_utils.network.common.config import CustomNetworkConfig
