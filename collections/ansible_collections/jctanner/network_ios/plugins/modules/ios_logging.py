...
DOCUMENTATION = """
---
module: jctanner.network_ios.ios_logging
version_added: "2.4"
...
- name: configure host logging
  jctanner.network_ios.ios_logging:
    dest: host
    name: 172.16.0.1
    state: present
...
from ansible_collections.jctanner.network_jctanner.network_ios.ios.plugins.module_utils.network.common.utils import remove_default_spec, validate_ip_address
...
from ansible_collections.jctanner.network_jctanner.network_ios.ios.plugins.module_utils.network.jctanner.network_ios.ios.jctanner.network_ios.ios import get_capabilities
