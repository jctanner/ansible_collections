...
DOCUMENTATION = """
---
module: jctanner.web_infrastructure_sophos_utm.utm_network_interface_address_info
...
- name: jctanner.web_infrastructure_sophos_utm.utm network interface address
  jctanner.web_infrastructure_sophos_utm.utm_proxy_interface_address_info:
