...
DOCUMENTATION = """
---
module: jctanner.web_infrastructure_sophos_utm.utm_proxy_frontend
...
EXAMPLES = """
- name: Create jctanner.web_infrastructure_sophos_utm.utm proxy_frontend
  jctanner.web_infrastructure_sophos_utm.utm_proxy_frontend:
...
- name: Remove jctanner.web_infrastructure_sophos_utm.utm proxy_frontend
  jctanner.web_infrastructure_sophos_utm.utm_proxy_frontend:
    jctanner.web_infrastructure_sophos_utm.utm_host: sophos.host.name
    jctanner.web_infrastructure_sophos_utm.utm_token: abcdefghijklmno1234
    name: TestFrontendEntry
