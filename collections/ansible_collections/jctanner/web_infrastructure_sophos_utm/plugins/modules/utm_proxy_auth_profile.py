...
DOCUMENTATION = """
---
module: jctanner.web_infrastructure_sophos_utm.utm_proxy_auth_profile
...
options:
    ...
    aaa:
        description:
          - List of references to jctanner.web_infrastructure_sophos_utm.utm_aaa objects (allowed users or groups)
        required: true
    basic_prompt:
        description:
...
- name: Create UTM proxy_auth_profile
  jctanner.web_infrastructure_sophos_utm.utm_proxy_auth_profile:
...
result:
    ...
    contains:
        ...
        name:
            ...
            type: string
        aaa:
            description: List of references to jctanner.web_infrastructure_sophos_utm.utm_aaa objects (allowed users or groups)
            type: list
        basic_prompt:
