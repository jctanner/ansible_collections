...
DOCUMENTATION = """
---
module: jctanner.web_infrastructure_sophos_utm.utm_proxy_frontend_info
...
EXAMPLES = """
- name: Get jctanner.web_infrastructure_sophos_utm.utm proxy_frontend
  jctanner.web_infrastructure_sophos_utm.utm_proxy_frontend_info:
