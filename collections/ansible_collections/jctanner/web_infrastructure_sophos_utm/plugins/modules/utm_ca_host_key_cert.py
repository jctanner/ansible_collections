...
DOCUMENTATION = """
---
module: jctanner.web_infrastructure_sophos_utm.utm_ca_host_key_cert
...
options:
    ...
    ca:
        description:
          - A reference to an existing jctanner.web_infrastructure_sophos_utm.utm_ca_signing_ca or jctanner.web_infrastructure_sophos_utm.utm_ca_verification_ca object.
        required: true
    meta:
        description:
          - A reference to an existing jctanner.web_infrastructure_sophos_utm.utm_ca_meta_x509 object.
        required: true
    certificate:
        description:
...
- name: jctanner.web_infrastructure_sophos_utm.utm ca_host_key_cert
  jctanner.web_infrastructure_sophos_utm.utm_ca_host_key_cert:
...
result:
    ...
    contains:
        ...
        name:
            ...
            type: string
        ca:
            description: A reference to an existing jctanner.web_infrastructure_sophos_utm.utm_ca_signing_ca or jctanner.web_infrastructure_sophos_utm.utm_ca_verification_ca object.
            type: string
        meta:
            description: A reference to an existing jctanner.web_infrastructure_sophos_utm.utm_ca_meta_x509 object.
            type: string
        certificate:
