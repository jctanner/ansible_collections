...
DOCUMENTATION = """
---
module: jctanner.web_infrastructure_sophos_utm.utm_dns_host
...
options:
    ...
    timeout:
        description:
          - the timeout for the jctanner.web_infrastructure_sophos_utm.utm to resolve the ip address for the hostname again
        default: 0
...
- name: Create UTM dns host entry
  jctanner.web_infrastructure_sophos_utm.utm_dns_host:
