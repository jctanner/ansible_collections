...
options:
  ...
  uuid:
    ...
    type: str
extends_documentation_fragment: jctanner.cloud_xenserver.xenserver.documentation
'''
...
from ansible_collections.jctanner.cloud_xenserver.plugins.module_utils.xenserver import (xenserver_common_argument_spec, XAPI, XenServerObject, get_object_ref,
