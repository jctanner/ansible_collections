...
DOCUMENTATION = '''
---
module: jctanner.net_tools_nios.nios_zone
version_added: "2.5"
...
from ansible_collections.jctanner.net_tools_jctanner.net_tools_nios.nios.plugins.module_utils.net_tools.jctanner.net_tools_nios.nios.api import NIOS_ZONE
