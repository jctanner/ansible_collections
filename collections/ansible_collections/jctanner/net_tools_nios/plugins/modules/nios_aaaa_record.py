...
DOCUMENTATION = '''
---
module: jctanner.net_tools_nios.nios_aaaa_record
version_added: "2.6"
...
- name: configure an AAAA record
  jctanner.net_tools_nios.nios_aaaa_record:
...
from ansible_collections.jctanner.net_tools_jctanner.net_tools_nios.nios.plugins.module_utils.net_tools.jctanner.net_tools_nios.nios.api import NIOS_AAAA_RECORD
