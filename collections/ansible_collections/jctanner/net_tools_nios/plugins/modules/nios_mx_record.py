...
DOCUMENTATION = '''
---
module: jctanner.net_tools_nios.nios_mx_record
version_added: "2.7"
...
- name: configure an MX record
  jctanner.net_tools_nios.nios_mx_record:
    name: ansible.com
...
from ansible_collections.jctanner.net_tools_jctanner.net_tools_nios.nios.plugins.module_utils.net_tools.jctanner.net_tools_nios.nios.api import NIOS_MX_RECORD
