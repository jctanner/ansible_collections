...
DOCUMENTATION = '''
---
module: jctanner.net_tools_nios.nios_member
version_added: "2.8"
...
- name: add a member to the grid with IPv4 address
  jctanner.net_tools_nios.nios_member:
...
from ansible_collections.jctanner.net_tools_jctanner.net_tools_nios.nios.plugins.module_utils.net_tools.jctanner.net_tools_nios.nios.api import NIOS_MEMBER
