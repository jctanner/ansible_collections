...
DOCUMENTATION = '''
---
module: jctanner.net_tools_nios.nios_a_record
version_added: "2.7"
...
- name: configure an A record
  jctanner.net_tools_nios.nios_a_record:
    name: a.ansible.com
    ipv4: 192.168.10.1
    state: present
    provider:
...
- name: dynamically add a record to next available ip
  jctanner.net_tools_nios.nios_a_record:
    name: a.ansible.com
    ipv4: {jctanner.net_tools_nios.nios_next_ip: 192.168.10.0/24}
    state: present
    provider:
      host: "{{ inventory_hostname_short }}"
      username: admin
...
from ansible_collections.jctanner.net_tools_jctanner.net_tools_nios.nios.plugins.module_utils.net_tools.jctanner.net_tools_nios.nios.api import NIOS_A_RECORD
