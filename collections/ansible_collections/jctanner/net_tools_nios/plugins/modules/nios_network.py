...
DOCUMENTATION = '''
---
module: jctanner.net_tools_nios.nios_network
version_added: "2.5"
...
requirements:
  - infoblox-client
extends_documentation_fragment: jctanner.net_tools_nios.nios
options:
  network:
    description:
...
- name: configure a network ipv4
  jctanner.net_tools_nios.nios_network:
...
from ansible_collections.jctanner.net_tools_jctanner.net_tools_nios.nios.plugins.module_utils.net_tools.jctanner.net_tools_nios.nios.api import WapiModule
from ansible_collections.jctanner.net_tools_jctanner.net_tools_nios.nios.plugins.module_utils.network.common.utils import validate_ip_address, validate_ip_v6_address
from ansible_collections.jctanner.net_tools_jctanner.net_tools_nios.nios.plugins.module_utils.net_tools.jctanner.net_tools_nios.nios.api import NIOS_IPV4_NETWORK, NIOS_IPV6_NETWORK
from ansible_collections.jctanner.net_tools_jctanner.net_tools_nios.nios.plugins.module_utils.net_tools.jctanner.net_tools_nios.nios.api import NIOS_IPV4_NETWORK_CONTAINER, NIOS_IPV6_NETWORK_CONTAINER
