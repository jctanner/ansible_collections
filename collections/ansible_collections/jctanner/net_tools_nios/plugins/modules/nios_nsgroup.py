...
DOCUMENTATION = '''
---
module: jctanner.net_tools_nios.nios_nsgroup
...
- name: create simple infoblox nameserver group
  jctanner.net_tools_nios.nios_nsgroup:
...
from ansible_collections.jctanner.net_tools_jctanner.net_tools_nios.nios.plugins.module_utils.net_tools.jctanner.net_tools_nios.nios.api import NIOS_NSGROUP
