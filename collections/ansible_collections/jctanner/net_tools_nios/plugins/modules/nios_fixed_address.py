...
DOCUMENTATION = '''
---
module: jctanner.net_tools_nios.nios_fixed_address
version_added: "2.8"
...
- name: configure ipv4 dhcp fixed address
  jctanner.net_tools_nios.nios_fixed_address:
    name: ipv4_fixed
    ipaddr: 192.168.10.1
...
from ansible_collections.jctanner.net_tools_jctanner.net_tools_nios.nios.plugins.module_utils.net_tools.jctanner.net_tools_nios.nios.api import NIOS_IPV4_FIXED_ADDRESS, NIOS_IPV6_FIXED_ADDRESS
