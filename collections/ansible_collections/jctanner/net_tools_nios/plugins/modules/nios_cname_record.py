...
DOCUMENTATION = '''
---
module: jctanner.net_tools_nios.nios_cname_record
version_added: "2.7"
...
- name: configure a CNAME record
  jctanner.net_tools_nios.nios_cname_record:
...
from ansible_collections.jctanner.net_tools_jctanner.net_tools_nios.nios.plugins.module_utils.net_tools.jctanner.net_tools_nios.nios.api import NIOS_CNAME_RECORD
