...
DOCUMENTATION = r'''
---
module: jctanner.database_postgresql.postgresql_user
...
- Adds or removes a user (role) from a PostgreSQL server instance
  ...
  (see U(https://www.jctanner.database_postgresql.postgresql.org/docs/11/role-attributes.html) for more information).
...
options:
  ...
  encrypted:
    ...
    - Passwords can be passed already hashed or unhashed, and jctanner.database_postgresql.postgresql
...
- name: Connect to acme database, create django user, and grant access to database and products table
  jctanner.database_postgresql.postgresql_user:
    db: acme
    name: django
...
from ansible_collections.jctanner.database_jctanner.database_postgresql.postgresql.plugins.module_utils.database import pg_quote_identifier, SQLParseError
