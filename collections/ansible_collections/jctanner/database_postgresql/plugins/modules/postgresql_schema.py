...
DOCUMENTATION = r'''
---
module: jctanner.database_postgresql.postgresql_schema
...
- For Ubuntu-based systems, install the C(jctanner.database_postgresql.postgresql), C(libpq-dev),
...
- name: Create a new schema with name acme in test database
  jctanner.database_postgresql.postgresql_schema:
    db: test
    name: acme
...
def main():
    ...
    argument_spec.update(
        ...
        database=dict(type="str", default="jctanner.database_postgresql.postgres", aliases=["db", "login_db"]),
