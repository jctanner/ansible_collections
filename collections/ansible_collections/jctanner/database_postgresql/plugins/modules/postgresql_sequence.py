...
DOCUMENTATION = r'''
---
module: jctanner.database_postgresql.postgresql_sequence
...
- Allows to create, drop or change the definition of a sequence generator
  U(https://www.jctanner.database_postgresql.postgresql.org/docs/current/sql-createsequence.html).
version_added: '2.9'
options:
  sequence:
    description:
...
- name: Create an ascending bigint sequence called foobar in the default
        database
  jctanner.database_postgresql.postgresql_sequence:
    name: foobar
