...
DOCUMENTATION = r'''
---
module: jctanner.database_postgresql.postgresql_query
...
- name: Simple select query to acme db
  jctanner.database_postgresql.postgresql_query:
    db: acme
...
try:
    ...
    # ansible_collections.jctanner.database_jctanner.database_postgresql.postgresql.plugins.module_utils.jctanner.database_postgresql.postgres
    pass

import ansible_collections.jctanner.database_jctanner.database_postgresql.postgresql.plugins.module_utils.jctanner.database_postgresql.postgres as pgutils
