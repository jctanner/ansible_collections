...
DOCUMENTATION = r'''
---
module: jctanner.database_postgresql.postgresql_copy
short_description: Copy data between a file/program and a PostgreSQL table
description:
- Copy data between a file/program and a PostgreSQL table U(https://www.jctanner.database_postgresql.postgresql.org/docs/current/sql-copy.html).
version_added: '2.9'
...
options:
  ...
  program:
    ...
    - See block Examples and PROGRAM arg description U(https://www.jctanner.database_postgresql.postgresql.org/docs/current/sql-copy.html).
    type: bool
  options:
    description:
    - Options of COPY command.
    - See the full list of available options U(https://www.jctanner.database_postgresql.postgresql.org/docs/current/sql-copy.html).
    type: dict
  db:
    description:
...
- name: Copy text TAB-separated data from file /tmp/data.txt to acme table
  jctanner.database_postgresql.postgresql_copy:
