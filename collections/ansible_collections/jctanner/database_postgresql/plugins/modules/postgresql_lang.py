...
DOCUMENTATION = r'''
---
module: jctanner.database_postgresql.postgresql_lang
...
- For more information about PostgreSQL languages see the official documentation
  U(https://www.jctanner.database_postgresql.postgresql.org/docs/current/sql-createlanguage.html),
  U(https://www.jctanner.database_postgresql.postgresql.org/docs/current/sql-alterlanguage.html),
  U(https://www.jctanner.database_postgresql.postgresql.org/docs/current/sql-droplanguage.html).
version_added: '1.7'
options:
  lang:
    description:
...
- name: Add language pltclu to database testdb if it doesn't exist
  jctanner.database_postgresql.postgresql_lang: db=testdb lang=pltclu state=present
...
- name: Add language pltclu to database testdb if it doesn't exist and mark it as trusted
  jctanner.database_postgresql.postgresql_lang:
    db: testdb
    lang: pltclu
    state: present
    trust: yes
