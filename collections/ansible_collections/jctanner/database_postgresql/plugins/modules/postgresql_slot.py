...
DOCUMENTATION = '''
---
module: jctanner.database_postgresql.postgresql_slot
...
options:
  ...
  slot_type:
    ...
    - For more information see
      U(https://www.jctanner.database_postgresql.postgresql.org/docs/current/protocol-replication.html) and
      U(https://www.jctanner.database_postgresql.postgresql.org/docs/current/logicaldecoding-explanation.html).
    type: str
    default: physical
...
- name: Create physical_one physical slot if doesn't exist
  ...
  jctanner.database_postgresql.postgresql_slot:
