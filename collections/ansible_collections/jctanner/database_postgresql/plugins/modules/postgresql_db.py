...
DOCUMENTATION = r'''
---
module: jctanner.database_postgresql.postgresql_db
  ...
  tablespace:
    description:
      - The tablespace to set for the database
        U(https://www.jctanner.database_postgresql.postgresql.org/docs/current/sql-alterdatabase.html).
...
- name: Create a new database with name "acme"
  jctanner.database_postgresql.postgresql_db:
    name: acme
...
def main():
    ...
    argument_spec.update(
        ...
        maintenance_db=dict(type='str', default="jctanner.database_postgresql.postgres"),
