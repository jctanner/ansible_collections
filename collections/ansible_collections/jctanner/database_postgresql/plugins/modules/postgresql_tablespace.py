...
DOCUMENTATION = r'''
---
module: jctanner.database_postgresql.postgresql_tablespace
...
- Adds or removes PostgreSQL tablespaces from remote hosts
  U(https://www.jctanner.database_postgresql.postgresql.org/docs/current/sql-createtablespace.html),
  U(https://www.jctanner.database_postgresql.postgresql.org/docs/current/manage-ag-tablespaces.html).
version_added: '2.8'
options:
  tablespace:
    description:
  ...
  set:
    ...
    - For more information see U(https://www.jctanner.database_postgresql.postgresql.org/docs/current/sql-createtablespace.html).
    - When reset is passed as an option's value, if the option was set previously, it will be removed
      U(https://www.jctanner.database_postgresql.postgresql.org/docs/current/sql-altertablespace.html).
    type: dict
  rename_to:
    description:
...
- name: Create a new tablespace called acme and set bob as an its owner
  jctanner.database_postgresql.postgresql_tablespace:
    name: acme
    owner: bob
    location: /data/foo
