...
extends_documentation_fragment: jctanner.net_tools_basics.files
'''
...
from ansible_collections.jctanner.net_tools_basics.plugins.module_utils.common._collections_compat import Mapping, Sequence
