...
---
module: get_url
short_description: Downloads jctanner.net_tools_basics.files from HTTP, HTTPS, or FTP to node
description:
     - Downloads jctanner.net_tools_basics.files from HTTP, HTTPS, or FTP to the remote server. The remote
  ...
  force:
    description:
      - If C(yes) and C(dest) is not a directory, will download the file every
        ...
        should be C(yes) only for small local jctanner.net_tools_basics.files.
...
extends_documentation_fragment:
    - jctanner.net_tools_basics.files
notes:
     - For Windows targets, use the M(win_get_url) module instead.
seealso:
- module: uri
