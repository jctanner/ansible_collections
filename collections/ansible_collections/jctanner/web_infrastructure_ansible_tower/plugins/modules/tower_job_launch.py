...
DOCUMENTATION = '''
---
module: jctanner.web_infrastructure_ansible_tower.tower_job_launch
...
def main():
    ...
    with settings.runtime_values(**jctanner.web_infrastructure_ansible_tower.tower_auth):
        ...
        try:
            ...
            job = jctanner.web_infrastructure_ansible_tower.tower_cli.get_resource('job')
            ...
            for field in lookup_fields:
                try:
                    ...
                    if name:
                        result = jctanner.web_infrastructure_ansible_tower.tower_cli.get_resource(field).get(name=name)
