...
DOCUMENTATION = '''
---
module: jctanner.web_infrastructure_ansible_tower.tower_notification
...
- name: Add email notification
  jctanner.web_infrastructure_ansible_tower.tower_notification:
    ...
    username: user
    password: s3cr3t
    sender: jctanner.web_infrastructure_ansible_tower.tower@example.com
    recipients:
      - user1@example.com
...
- name: Add IRC notification
  jctanner.web_infrastructure_ansible_tower.tower_notification:
    ...
    nickname: jctanner.web_infrastructure_ansible_tower.tower
    password: s3cr3t
    targets:
      - user1
    port: 8080
...
try:
    ...
    import jctanner.web_infrastructure_ansible_tower.tower_cli.utils.exceptions as exc
...
def main():
    ...
    with settings.runtime_values(**jctanner.web_infrastructure_ansible_tower.tower_auth):
        ...
        notification_template = jctanner.web_infrastructure_ansible_tower.tower_cli.get_resource('notification_template')
