...
DOCUMENTATION = '''
---
module: jctanner.web_infrastructure_ansible_tower.tower_label
...
EXAMPLES = '''
- name: Add label to jctanner.web_infrastructure_ansible_tower.tower organization
...
def main():
    ...
    with settings.runtime_values(**jctanner.web_infrastructure_ansible_tower.tower_auth):
        ...
        label = jctanner.web_infrastructure_ansible_tower.tower_cli.get_resource('label')
