...
DOCUMENTATION = '''
---
module: jctanner.web_infrastructure_ansible_tower.tower_team
...
EXAMPLES = '''
- name: Create jctanner.web_infrastructure_ansible_tower.tower team
  jctanner.web_infrastructure_ansible_tower.tower_team:
    name: Team Name
...
def main():
    ...
    with settings.runtime_values(**jctanner.web_infrastructure_ansible_tower.tower_auth):
        ...
        team = jctanner.web_infrastructure_ansible_tower.tower_cli.get_resource('team')
