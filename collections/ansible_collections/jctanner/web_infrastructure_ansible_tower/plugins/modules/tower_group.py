...
DOCUMENTATION = '''
---
module: jctanner.web_infrastructure_ansible_tower.tower_group
...
EXAMPLES = '''
- name: Add jctanner.web_infrastructure_ansible_tower.tower group
  jctanner.web_infrastructure_ansible_tower.tower_group:
    name: localhost
...
def main():
    ...
    with settings.runtime_values(**jctanner.web_infrastructure_ansible_tower.tower_auth):
        ...
        group = jctanner.web_infrastructure_ansible_tower.tower_cli.get_resource('group')
        try:
