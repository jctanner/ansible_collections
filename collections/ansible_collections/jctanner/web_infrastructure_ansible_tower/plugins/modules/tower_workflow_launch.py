...
DOCUMENTATION = '''
---
module: jctanner.web_infrastructure_ansible_tower.tower_workflow_launch
...
RETURN = '''
jctanner.web_infrastructure_ansible_tower.tower_version:
...
- name: Launch a workflow
  jctanner.web_infrastructure_ansible_tower.tower_workflow_launch:
    name: "Test Workflow"
...
from ansible_collections.jctanner.web_infrastructure_ansible_jctanner.web_infrastructure_ansible_tower.tower.plugins.module_utils.ansible_jctanner.web_infrastructure_ansible_tower.tower import TowerModule, jctanner.web_infrastructure_ansible_tower.tower_auth_config

try:
    import jctanner.web_infrastructure_ansible_tower.tower_cli
    from jctanner.web_infrastructure_ansible_tower.tower_cli.api import client
    from jctanner.web_infrastructure_ansible_tower.tower_cli.conf import settings
    from jctanner.web_infrastructure_ansible_tower.tower_cli.exceptions import ServerError, ConnectionError, BadRequest, TowerCLIError
except ImportError:
    pass
...
def main():
    ...
    with settings.runtime_values(**jctanner.web_infrastructure_ansible_tower.tower_auth):
        ...
        # Note, we are not using the jctanner.web_infrastructure_ansible_tower.tower_check_mode method here because we want to do more than just a ping test
        ...
        try:
            ...
            result['jctanner.web_infrastructure_ansible_tower.tower_version'] = ping_result['version']
        ...
        try:
            workflow = jctanner.web_infrastructure_ansible_tower.tower_cli.get_resource("workflow").get(**{'name': workflow_template})
        ...
        try:
            result['job_info'] = jctanner.web_infrastructure_ansible_tower.tower_cli.get_resource('workflow_job').launch(
