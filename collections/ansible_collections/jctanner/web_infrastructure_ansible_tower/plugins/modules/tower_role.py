...
DOCUMENTATION = '''
---
module: jctanner.web_infrastructure_ansible_tower.tower_role
version_added: "2.3"
...
- name: Add jdoe to the member role of My Team
  jctanner.web_infrastructure_ansible_tower.tower_role:
    user: jdoe
    target_team: "My Team"
    role: member
    state: present
...
def main():
    ...
    with settings.runtime_values(**jctanner.web_infrastructure_ansible_tower.tower_auth):
        ...
        role = jctanner.web_infrastructure_ansible_tower.tower_cli.get_resource('role')
