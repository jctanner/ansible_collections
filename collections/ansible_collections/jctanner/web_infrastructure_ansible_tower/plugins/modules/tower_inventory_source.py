...
DOCUMENTATION = '''
---
module: jctanner.web_infrastructure_ansible_tower.tower_inventory_source
...
options:
    ...
    source:
      ...
      choices:
        ...
        - openstack
        - rhv
        - jctanner.web_infrastructure_ansible_tower.tower
        - custom
      required: True
    credential:
      description:
    ...
    validate_certs:
      ...
      type: bool
      aliases: [ jctanner.web_infrastructure_ansible_tower.tower_verify_ssl ]
extends_documentation_fragment: jctanner.web_infrastructure_ansible_tower.tower
'''


EXAMPLES = '''
- name: Add jctanner.web_infrastructure_ansible_tower.tower inventory source
...
def main():
    ...
    with settings.runtime_values(**jctanner.web_infrastructure_ansible_tower.tower_auth):
        ...
        inventory_source = jctanner.web_infrastructure_ansible_tower.tower_cli.get_resource('inventory_source')
        try:
            params = {}
            params['name'] = name
            ...
            if module.params.get('credential'):
                credential_res = jctanner.web_infrastructure_ansible_tower.tower_cli.get_resource('credential')
                try:
            ...
            if module.params.get('source_project'):
                source_project_res = jctanner.web_infrastructure_ansible_tower.tower_cli.get_resource('project')
                try:
            ...
            if module.params.get('source_script'):
                source_script_res = jctanner.web_infrastructure_ansible_tower.tower_cli.get_resource('inventory_script')
                try:
            ...
            try:
                inventory_res = jctanner.web_infrastructure_ansible_tower.tower_cli.get_resource('inventory')
