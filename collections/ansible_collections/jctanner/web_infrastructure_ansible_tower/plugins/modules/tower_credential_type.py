...
DOCUMENTATION = '''
---
module: jctanner.web_infrastructure_ansible_tower.tower_credential_type
...
- jctanner.web_infrastructure_ansible_tower.tower_credential_type:
    ...
    kind: cloud
    inputs: "{{ lookup('file', 'jctanner.web_infrastructure_ansible_tower.tower_credential_inputs_nexus.json') }}"
...
def main():
    ...
    with settings.runtime_values(**jctanner.web_infrastructure_ansible_tower.tower_auth):
        ...
        params['name'] = name
        params['kind'] = kind
        params['managed_by_jctanner.web_infrastructure_ansible_tower.tower'] = False
