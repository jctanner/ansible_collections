...
extends_documentation_fragment:
    - jctanner.storage_infinidat.infinibox
'''
...
from ansible_collections.jctanner.storage_infinidat.plugins.module_utils.jctanner.storage_infinidat.infinibox import HAS_INFINISDK, api_wrapper, get_system, jctanner.storage_infinidat.infinibox_argument_spec
...
def main():
    argument_spec = jctanner.storage_infinidat.infinibox_argument_spec()
