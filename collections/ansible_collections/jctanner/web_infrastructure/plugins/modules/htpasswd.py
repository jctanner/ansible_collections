...
module: htpasswd
version_added: "1.3"
short_description: manage user jctanner.web_infrastructure.files for basic authentication
description:
...
extends_documentation_fragment: jctanner.web_infrastructure.files
"""
