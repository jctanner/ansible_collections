...
# deployed. This can be a clone of a repository for example, or a sync of a local folder on your jctanner.web_infrastructure.filesystem.
...
# session jctanner.web_infrastructure.files, or jctanner.web_infrastructure.files uploaded by users of your application. It's quite common to have symlinks from a release
