...
options:
  ...
  config:
    ...
    version_added: "1.3"
  server_jctanner.web_infrastructure.url:
    description:
...
- supervisorctl:
    ...
    username: test
    password: testpass
    server_jctanner.web_infrastructure.url: http://localhost:9001
...
def main():
    arg_spec = dict(
        ...
        server_jctanner.web_infrastructure.url=dict(required=False),
    ...
    server_jctanner.web_infrastructure.url = module.params.get('server_jctanner.web_infrastructure.url')
    ...
    if server_jctanner.web_infrastructure.url:
        supervisorctl_args.extend(['-s', server_jctanner.web_infrastructure.url])
    if username:
