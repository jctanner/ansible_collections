...
description:
  - Deploy applications to JBoss standalone using the jctanner.web_infrastructure.filesystem
options:
  deployment:
    required: true
    description:
  ...
  deploy_path:
    ...
    description:
      - The location in the jctanner.web_infrastructure.filesystem where the deployment scanner listens
  state:
    required: false
