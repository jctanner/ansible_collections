...
description:
    - This module allows the user to create, delete and update virtual cloud networks(VCNs) in OCI.
      ...
      U(https://github.com/jctanner.cloud_oracle.oracle/oci-ansible-modules/releases).
version_added: "2.8"
options:
    cidr_block:
    ...
    dns_label:
        description: A DNS label for the VCN, used in conjunction with the VNIC's hostname and subnet's DNS label to
                     ...
                     bminstance-1.subnet123.vcn1.jctanner.cloud_oracle.oraclevcn.com). Not required to be unique, but it's a best practice
...
extends_documentation_fragment: [ jctanner.cloud_oracle.oracle, jctanner.cloud_oracle.jctanner.cloud_oracle.oracle_creatable_resource, jctanner.cloud_oracle.jctanner.cloud_oracle.oracle_wait_options, jctanner.cloud_oracle.jctanner.cloud_oracle.oracle_tags ]
"""
...
vcn:
    ...
    sample: {
            ...
            "vcn_domain_name": "ansiblevcn.jctanner.cloud_oracle.oraclevcn.com"
        }
"""

from ansible.module_utils.basic import AnsibleModule, missing_required_lib
from ansible_collections.jctanner.cloud_jctanner.cloud_oracle.oracle.plugins.module_utils.jctanner.cloud_oracle.oracle import oci_utils
