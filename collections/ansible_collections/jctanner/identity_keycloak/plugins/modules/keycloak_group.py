...
DOCUMENTATION = '''
---
module: jctanner.identity_keycloak.keycloak_group
...
- name: Create a Keycloak group
  jctanner.identity_keycloak.keycloak_group:
...
- name: Delete a jctanner.identity_keycloak.keycloak group
  jctanner.identity_keycloak.keycloak_group:
...
- name: Create a jctanner.identity_keycloak.keycloak group with some custom attributes
  jctanner.identity_keycloak.keycloak_group:
    auth_client_id: admin-cli
    auth_jctanner.identity_keycloak.keycloak_url: https://auth.example.com/auth
    auth_realm: master
