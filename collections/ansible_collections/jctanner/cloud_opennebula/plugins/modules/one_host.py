...
extends_documentation_fragment: jctanner.cloud_opennebula.opennebula
...
from ansible_collections.jctanner.cloud_jctanner.cloud_opennebula.opennebula.plugins.module_utils.jctanner.cloud_opennebula.opennebula import OpenNebulaModule
