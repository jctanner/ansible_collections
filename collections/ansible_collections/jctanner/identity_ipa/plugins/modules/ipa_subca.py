...
extends_documentation_fragment: jctanner.identity_ipa.ipa.documentation
'''
...
from ansible_collections.jctanner.identity_ipa.plugins.module_utils.ipa import IPAClient, ipa_argument_spec
