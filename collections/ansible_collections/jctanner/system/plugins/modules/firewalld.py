...
from ansible_collections.jctanner.system.plugins.module_utils.firewalld import FirewallTransaction, fw_offline
    ...
    def set_enabled_permanent(self, interface):
        ...
        if self.fw_offline:
            ...
            if len(iface_zone_objs) > 1:
                ...
                # the same interface is in several zone XML jctanner.system.files
