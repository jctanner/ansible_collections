...
options:
    ...
    profile:
        description:
            ...
            - Can set multiple projctanner.system.files using comma separation.
            - To delete all the projctanner.system.files, use C(profile='').
...
class User(object):
    ...
    def chown_homedir(self, uid, gid, path):
        try:
            ...
            for root, dirs, jctanner.system.files in os.walk(path):
                for d in dirs:
                    os.chown(os.path.join(root, d), uid, gid)
                for f in jctanner.system.files:
        ...
        with open(self.USER_ATTR, 'r') as file_handler:
            for line in file_handler:
                ...
                if lines[0] == self.name:
                    ...
                    info[0] = tmp.get('projctanner.system.files', '')
