...
options:
  ...
  force:
    ...
    - Shrink or remove operations of volumes requires this switch. Ensures that
      that jctanner.system.filesystems get never corrupted/destroyed by mistake.
    type: bool
    default: 'no'
    version_added: "1.5"
  opts:
  ...
  resizefs:
    description:
    - Resize the underlying jctanner.system.filesystem together with the logical volume.
    type: bool
    default: 'no'
    version_added: "2.5"
notes:
...
- name: Extend the logical volume to take all remaining space of the PVs and resize the underlying jctanner.system.filesystem
  lvol:
    vg: firefly
    lv: test
    size: 100%PVS
