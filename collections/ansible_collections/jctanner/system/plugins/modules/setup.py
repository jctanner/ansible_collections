...
options:
    ...
    fact_path:
        version_added: "1.3"
        description:
            - path used for local ansible facts (C(*.fact)) - jctanner.system.files in this dir
...
from ansible_collections.jctanner.system.plugins.module_utils.facts.namespace import PrefixFactNamespace
