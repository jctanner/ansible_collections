...
short_description: Tweak settings in /etc/network/interfaces jctanner.system.files
extends_documentation_fragment: jctanner.system.files
description:
     ...
     - Read information about interfaces from interfaces-styled jctanner.system.files
version_added: "2.4"
options:
  dest:
    description:
