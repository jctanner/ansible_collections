...
from ansible_collections.jctanner.system.plugins.module_utils.common.file import FileLock
...
def enforce_state(module, params):
    ...
    # Trailing newline in jctanner.system.files gets lost, so re-add if necessary
...
def normalize_known_hosts_key(key):
    ...
    absent in known_hosts jctanner.system.files)
    '''
