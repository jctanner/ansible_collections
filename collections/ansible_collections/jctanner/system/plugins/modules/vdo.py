    ...
    activated:
        description:
            - The "activate" status for a VDO volume.  If this is set
              ...
              (jctanner.system.filesystem, LVM headers, etc.) to the VDO volume prior
    ...
    emulate512:
        description:
            - Enables 512-byte emulation mode, allowing drivers or
              jctanner.system.filesystems to access the VDO volume at 512-byte
              granularity, instead of the default 4096-byte granularity.
              Default is 'disabled'; only recommended when a driver
              or jctanner.system.filesystem requires 512-byte sector level access to
