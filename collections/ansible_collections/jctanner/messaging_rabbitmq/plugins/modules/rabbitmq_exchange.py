...
DOCUMENTATION = '''
---
module: jctanner.messaging_rabbitmq.rabbitmq_exchange
...
extends_documentation_fragment:
    - jctanner.messaging_rabbitmq.rabbitmq
'''

EXAMPLES = '''
# Create direct exchange
- jctanner.messaging_rabbitmq.rabbitmq_exchange:
    name: directExchange
...
from ansible_collections.jctanner.messaging_jctanner.messaging_rabbitmq.rabbitmq.plugins.module_utils.jctanner.messaging_rabbitmq.rabbitmq import jctanner.messaging_rabbitmq.rabbitmq_argument_spec


def main():

    argument_spec = jctanner.messaging_rabbitmq.rabbitmq_argument_spec()
