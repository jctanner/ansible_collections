...
extends_documentation_fragment:
  ...
  - jctanner.cloud_kubevirt.kubevirt_vm_options
  - jctanner.cloud_kubevirt.kubevirt_common_options
...
from ansible_collections.jctanner.cloud_kubevirt.plugins.module_utils.kubevirt import (
    virtdict,
    KubeVirtRawModule,
    VM_COMMON_ARG_SPEC,
