...
extends_documentation_fragment:
  - jctanner.cloud_kubevirt.k8s_auth_options
...
from ansible_collections.jctanner.cloud_kubevirt.plugins.module_utils.k8s.common import AUTH_ARG_SPEC
from ansible_collections.jctanner.cloud_kubevirt.plugins.module_utils.k8s.raw import KubernetesRawModule
from ansible_collections.jctanner.cloud_kubevirt.plugins.module_utils.kubevirt import virtdict, KubeVirtRawModule
