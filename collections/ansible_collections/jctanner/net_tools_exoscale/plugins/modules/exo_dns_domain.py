...
extends_documentation_fragment: jctanner.net_tools_exoscale.exoscale
'''
...
from ansible_collections.jctanner.net_tools_jctanner.net_tools_exoscale.exoscale.plugins.module_utils.jctanner.net_tools_exoscale.exoscale import ExoDns, exo_dns_argument_spec, exo_dns_required_together
