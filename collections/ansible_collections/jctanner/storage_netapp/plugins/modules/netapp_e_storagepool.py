...
extends_documentation_fragment:
    - jctanner.storage_netapp.netapp.eseries
options:
  state:
    required: true
    description:
...
from ansible_collections.jctanner.storage_netapp.plugins.module_utils.netapp import request, eseries_host_argument_spec
