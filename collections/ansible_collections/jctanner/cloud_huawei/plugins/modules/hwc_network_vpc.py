...
DOCUMENTATION = '''
---
module: jctanner.cloud_huawei.hwc_network_vpc
description:
...
options:
    ...
    cidr:
        ...
        type: str
        required: true
extends_documentation_fragment: jctanner.cloud_huawei.hwc
'''

EXAMPLES = '''
- name: create a vpc
  jctanner.cloud_huawei.hwc_network_vpc:
...
from ansible_collections.jctanner.cloud_huawei.plugins.module_utils.jctanner.cloud_huawei.hwc_utils import (Config, HwcClientException,
...
def create(config, link):
    ...
    try:
        ...
        msg = ("module(jctanner.cloud_huawei.hwc_network_vpc): error creating "
...
def update(config, link):
    ...
    try:
        ...
        msg = ("module(jctanner.cloud_huawei.hwc_network_vpc): error updating "
               "resource, error: %s" % str(ex))
        module.fail_json(msg=msg)
...
def delete(config, link):
    ...
    try:
        ...
        msg = ("module(jctanner.cloud_huawei.hwc_network_vpc): error deleting "
               "resource, error: %s" % str(ex))
        module.fail_json(msg=msg)
...
def fetch_resource(module, client, link):
    try:
        ...
        msg = ("module(jctanner.cloud_huawei.hwc_network_vpc): error fetching "
               "resource, error: %s" % str(ex))
        module.fail_json(msg=msg)
