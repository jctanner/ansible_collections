...
DOCUMENTATION = '''
---
module: jctanner.cloud_huawei.hwc_smn_topic
description:
...
- name: create a smn topic
  jctanner.cloud_huawei.hwc_smn_topic:
...
def create(config):
    ...
    try:
        ...
        msg = ("module(jctanner.cloud_huawei.hwc_smn_topic): error creating "
...
def update(config):
    ...
    try:
        ...
        msg = ("module(jctanner.cloud_huawei.hwc_smn_topic): error updating "
               "resource, error: %s" % str(ex))
        module.fail_json(msg=msg)
...
def delete(config):
    ...
    try:
        ...
        msg = ("module(jctanner.cloud_huawei.hwc_smn_topic): error deleting "
               "resource, error: %s" % str(ex))
        module.fail_json(msg=msg)
...
def fetch_resource(module, client, link):
    try:
        ...
        msg = ("module(jctanner.cloud_huawei.hwc_smn_topic): error fetching "
               "resource, error: %s" % str(ex))
        module.fail_json(msg=msg)
