...
extends_documentation_fragment: jctanner.network_cli.network_agnostic
options:
  command:
    description:
...
from ansible_collections.jctanner.network_cli.plugins.module_utils.connection import Connection, ConnectionError
