...
DOCUMENTATION = '''
---
module: jctanner.network_nso.nso_config
...
def main():
    ...
    client = connect(p)
    jctanner.network_nso.nso_config = NsoConfig(module.check_mode, client, p['data'])
    try:
        verify_version(client, NsoConfig.REQUIRED_VERSIONS)

        changes, diffs = jctanner.network_nso.nso_config.main()
        client.logout()
