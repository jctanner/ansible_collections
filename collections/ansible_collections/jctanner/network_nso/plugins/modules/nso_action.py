...
DOCUMENTATION = '''
---
module: jctanner.network_nso.nso_action
...
- name: Sync NSO device
  jctanner.network_nso.nso_action:
...
def main():
    ...
    client = connect(p)
    jctanner.network_nso.nso_action = NsoAction(
    ...
    try:
        ...
        output = jctanner.network_nso.nso_action.main()
        client.logout()
