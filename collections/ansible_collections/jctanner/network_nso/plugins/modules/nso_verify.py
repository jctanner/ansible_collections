...
DOCUMENTATION = '''
---
module: jctanner.network_nso.nso_verify
extends_documentation_fragment: jctanner.network_nso.nso
...
- name: Verify interface is up
  jctanner.network_nso.nso_config:
...
from ansible_collections.jctanner.network_jctanner.network_nso.nso.plugins.module_utils.network.jctanner.network_nso.nso.jctanner.network_nso.nso import connect, verify_version, jctanner.network_nso.nso_argument_spec
from ansible_collections.jctanner.network_jctanner.network_nso.nso.plugins.module_utils.network.jctanner.network_nso.nso.jctanner.network_nso.nso import normalize_value
from ansible_collections.jctanner.network_jctanner.network_nso.nso.plugins.module_utils.network.jctanner.network_nso.nso.jctanner.network_nso.nso import State, ValueBuilder
from ansible_collections.jctanner.network_jctanner.network_nso.nso.plugins.module_utils.network.jctanner.network_nso.nso.jctanner.network_nso.nso import ModuleFailException, NsoException
...
def main():
    ...
    argument_spec.update(jctanner.network_nso.nso_argument_spec)
    ...
    client = connect(p)
    jctanner.network_nso.nso_verify = NsoVerify(client, p['data'])
    try:
        verify_version(client, NsoVerify.REQUIRED_VERSIONS)

        violations = jctanner.network_nso.nso_verify.main()
        client.logout()
