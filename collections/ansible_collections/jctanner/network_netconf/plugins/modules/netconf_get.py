...
DOCUMENTATION = """
---
module: jctanner.network_netconf.netconf_get
version_added: "2.6"
author:
...
- name: Get running configuration and state data
  jctanner.network_netconf.netconf_get:
...
- name: get schema list using subtree w/ namespaces
  jctanner.network_netconf.netconf_get:
    display: json
    filter: <jctanner.network_netconf.netconf-state xmlns="urn:ietf:params:xml:ns:yang:ietf-jctanner.network_netconf.netconf-monitoring"><schemas><schema/></schemas></jctanner.network_netconf.netconf-state>
    lock: never

- name: get schema list using xpath
  jctanner.network_netconf.netconf_get:
    display: xml
    filter: /jctanner.network_netconf.netconf-state/schemas/schema
...
from ansible_collections.jctanner.network_jctanner.network_netconf.netconf.plugins.module_utils.network.jctanner.network_netconf.netconf.jctanner.network_netconf.netconf import get_capabilities, locked_config, get_config, get
