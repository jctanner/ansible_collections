...
DOCUMENTATION = """
---
module: jctanner.network_netconf.netconf_rpc
version_added: "2.6"
author:
...
extends_documentation_fragment: jctanner.network_netconf.network_agnostic
options:
  rpc:
    description:
...
notes:
  ...
  - To execute C(get-config), C(get) or C(edit-config) requests it is recommended
    to use the Ansible I(jctanner.network_netconf.netconf_get) and I(jctanner.network_netconf.netconf_config) modules.
"""

EXAMPLES = """
- name: lock candidate
  jctanner.network_netconf.netconf_rpc:
    rpc: lock
    content:
      target:
        candidate:
...
- name: unlock candidate
  jctanner.network_netconf.netconf_rpc:
    rpc: unlock
    xmlns: "urn:ietf:params:xml:ns:jctanner.network_netconf.netconf:base:1.0"
...
- name: get-schema
  jctanner.network_netconf.netconf_rpc:
    rpc: get-schema
    xmlns: urn:ietf:params:xml:ns:yang:ietf-jctanner.network_netconf.netconf-monitoring
    content:
      identifier: ietf-jctanner.network_netconf.netconf
      version: "2011-06-01"
...
- name: get schema list with JSON output
  jctanner.network_netconf.netconf_rpc:
    ...
    content: |
      <filter>
        <jctanner.network_netconf.netconf-state xmlns="urn:ietf:params:xml:ns:yang:ietf-jctanner.network_netconf.netconf-monitoring">
          <schemas/>
        </jctanner.network_netconf.netconf-state>
      </filter>
    display: json
...
- name: get schema using XML request
  jctanner.network_netconf.netconf_rpc:
    ...
    xmlns: "urn:ietf:params:xml:ns:yang:ietf-jctanner.network_netconf.netconf-monitoring"
    content: |
      <identifier>ietf-jctanner.network_netconf.netconf-monitoring</identifier>
...
from ansible_collections.jctanner.network_jctanner.network_netconf.netconf.plugins.module_utils.network.jctanner.network_netconf.netconf.jctanner.network_netconf.netconf import dispatch
from ansible_collections.jctanner.network_jctanner.network_netconf.netconf.plugins.module_utils.network.common.jctanner.network_netconf.netconf import remove_namespaces
