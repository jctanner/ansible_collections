...
DOCUMENTATION = '''
---
module: jctanner.cloud_google.gcp_compute_route
description:
...
options:
  ...
  next_hop_instance:
    ...
    - 'This field represents a link to a Instance resource in GCP. It can be specified
      in two ways. First, you can place a dictionary with key ''selfLink'' and value
      of your resource''s selfLink Alternatively, you can add `register: name-of-resource`
      to a jctanner.cloud_google.gcp_compute_instance task and then set this next_hop_instance field to
      "{{ name-of-resource }}"'
    required: false
  next_hop_ip:
    description:
  ...
  next_hop_vpn_tunnel:
    ...
    - 'This field represents a link to a VpnTunnel resource in GCP. It can be specified
      in two ways. First, you can place a dictionary with key ''selfLink'' and value
      of your resource''s selfLink Alternatively, you can add `register: name-of-resource`
      to a jctanner.cloud_google.gcp_compute_vpn_tunnel task and then set this next_hop_vpn_tunnel field
      to "{{ name-of-resource }}"'
    required: false
...
- name: create a route
  jctanner.cloud_google.gcp_compute_route:
    name: test_object
