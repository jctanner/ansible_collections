...
DOCUMENTATION = '''
---
module: jctanner.cloud_google.gcp_spanner_database
description:
...
options:
  ...
  instance:
    ...
    - 'This field represents a link to a Instance resource in GCP. It can be specified
      ...
      to a jctanner.cloud_google.gcp_spanner_instance task and then set this instance field to "{{ name-of-resource
      }}"'
    required: true
...
- name: create a instance
  jctanner.cloud_google.gcp_spanner_instance:
...
- name: create a database
  jctanner.cloud_google.gcp_spanner_database:
    name: webstore
    instance: "{{ instance }}"
