...
DOCUMENTATION = '''
---
module: jctanner.cloud_google.gcp_compute_forwarding_rule
description:
...
options:
  ...
  backend_service:
    ...
    - 'This field represents a link to a BackendService resource in GCP. It can be
      ...
      name-of-resource` to a jctanner.cloud_google.gcp_compute_backend_service task and then set this backend_service
  ...
  network:
    ...
    - 'This field represents a link to a Network resource in GCP. It can be specified
      ...
      to a jctanner.cloud_google.gcp_compute_network task and then set this network field to "{{ name-of-resource
      }}"'
    required: false
  port_range:
    description:
  ...
  subnetwork:
    ...
    - 'This field represents a link to a Subnetwork resource in GCP. It can be specified
      in two ways. First, you can place a dictionary with key ''selfLink'' and value
      of your resource''s selfLink Alternatively, you can add `register: name-of-resource`
      to a jctanner.cloud_google.gcp_compute_subnetwork task and then set this subnetwork field to "{{ name-of-resource
      }}"'
    required: false
  target:
    description:
    ...
    - 'This field represents a link to a TargetPool resource in GCP. It can be specified
      in two ways. First, you can place a dictionary with key ''selfLink'' and value
      of your resource''s selfLink Alternatively, you can add `register: name-of-resource`
      to a jctanner.cloud_google.gcp_compute_target_pool task and then set this target field to "{{ name-of-resource
      }}"'
    required: false
    version_added: 2.7
  all_ports:
...
- name: create a address
  jctanner.cloud_google.gcp_compute_address:
...
- name: create a target pool
  jctanner.cloud_google.gcp_compute_target_pool:
...
- name: create a forwarding rule
  jctanner.cloud_google.gcp_compute_forwarding_rule:
    name: test_object
    region: us-west1
    target: "{{ targetpool }}"
    ip_protocol: TCP
