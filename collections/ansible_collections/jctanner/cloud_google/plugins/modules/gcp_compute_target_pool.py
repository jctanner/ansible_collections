...
DOCUMENTATION = '''
---
module: jctanner.cloud_google.gcp_compute_target_pool
description:
...
options:
  ...
  backup_pool:
    ...
    - 'This field represents a link to a TargetPool resource in GCP. It can be specified
      ...
      to a jctanner.cloud_google.gcp_compute_target_pool task and then set this backup_pool field to "{{
      name-of-resource }}"'
    required: false
  description:
    description:
  ...
  health_check:
    ...
    - 'This field represents a link to a HttpHealthCheck resource in GCP. It can be
      ...
      name-of-resource` to a jctanner.cloud_google.gcp_compute_http_health_check task and then set this
