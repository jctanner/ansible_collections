...
DOCUMENTATION = '''
---
module: jctanner.cloud_google.gcp_compute_global_forwarding_rule
description:
...
- name: create a global address
  jctanner.cloud_google.gcp_compute_global_address:
...
- name: create a target http proxy
  jctanner.cloud_google.gcp_compute_target_http_proxy:
...
- name: create a global forwarding rule
  jctanner.cloud_google.gcp_compute_global_forwarding_rule:
    name: test_object
