...
deprecated:
    ...
    alternative: Use M(jctanner.cloud_google.gcp_dns_resource_record_set) instead.
options:
    state:
        description:
...
from ansible_collections.jctanner.cloud_google.plugins.module_utils.gcdns import gcdns_connect
