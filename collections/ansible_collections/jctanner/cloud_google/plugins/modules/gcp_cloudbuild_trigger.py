...
DOCUMENTATION = '''
---
module: jctanner.cloud_google.gcp_cloudbuild_trigger
description:
...
- name: create a repository
  jctanner.cloud_google.gcp_sourcerepo_repository:
    name: projects/{{ jctanner.cloud_google.gcp_project }}/repos/{{ resource_name }}
...
- name: create a trigger
  jctanner.cloud_google.gcp_cloudbuild_trigger:
    trigger_template:
      branch_name: master
