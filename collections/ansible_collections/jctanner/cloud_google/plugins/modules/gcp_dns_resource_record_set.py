...
DOCUMENTATION = '''
---
module: jctanner.cloud_google.gcp_dns_resource_record_set
description:
...
options:
  ...
  managed_zone:
    ...
    - 'This field represents a link to a ManagedZone resource in GCP. It can be specified
      ...
      to a jctanner.cloud_google.gcp_dns_managed_zone task and then set this managed_zone field to "{{ name-of-resource
      }}"'
    required: true
...
- name: create a managed zone
  jctanner.cloud_google.gcp_dns_managed_zone:
...
- name: create a resource record set
  jctanner.cloud_google.gcp_dns_resource_record_set:
