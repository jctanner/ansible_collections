...
DOCUMENTATION = '''
---
module: jctanner.cloud_google.gcp_compute_vpn_tunnel
description:
- VPN tunnel resource.
...
options:
  ...
  target_vpn_gateway:
    ...
    - 'This field represents a link to a TargetVpnGateway resource in GCP. It can
      ...
      name-of-resource` to a jctanner.cloud_google.gcp_compute_target_vpn_gateway task and then set this
  ...
  router:
    ...
    - 'This field represents a link to a Router resource in GCP. It can be specified
      ...
      to a jctanner.cloud_google.gcp_compute_router task and then set this router field to "{{ name-of-resource
      }}"'
    required: false
  peer_ip:
    description:
...
- name: create a router
  jctanner.cloud_google.gcp_compute_router:
...
- name: create a target vpn gateway
  jctanner.cloud_google.gcp_compute_target_vpn_gateway:
...
- name: create a vpn tunnel
  jctanner.cloud_google.gcp_compute_vpn_tunnel:
    name: test_object
    region: us-west1
