...
DOCUMENTATION = '''
---
module: jctanner.cloud_google.gcpubsub_facts
version_added: "2.3"
short_description: List Topics/Subscriptions and Messages from Google PubSub.
description:
    - List Topics/Subscriptions from Google PubSub.  Use the jctanner.cloud_google.gcpubsub module for
...
- jctanner.cloud_google.gcpubsub_facts:
    view: topics
    state: list
...
from ansible_collections.jctanner.cloud_google.plugins.module_utils.jctanner.cloud_google.gcp import check_min_pkg_version, get_google_cloud_credentials
