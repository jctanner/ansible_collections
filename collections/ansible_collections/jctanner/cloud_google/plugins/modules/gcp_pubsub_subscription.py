...
DOCUMENTATION = '''
---
module: jctanner.cloud_google.gcp_pubsub_subscription
description:
...
options:
  ...
  topic:
    ...
    - 'This field represents a link to a Topic resource in GCP. It can be specified
      ...
      to a jctanner.cloud_google.gcp_pubsub_topic task and then set this topic field to "{{ name-of-resource
      }}"'
    required: true
  labels:
    description:
...
EXAMPLES = '''
- name: create a topic
  jctanner.cloud_google.gcp_pubsub_topic:
...
- name: create a subscription
  jctanner.cloud_google.gcp_pubsub_subscription:
    name: test_object
    topic: "{{ topic }}"
