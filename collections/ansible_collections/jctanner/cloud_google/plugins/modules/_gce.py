...
deprecated:
    ...
    alternative: Use M(jctanner.cloud_google.gcp_compute_instance) instead.
options:
  image:
    description:
...
from ansible_collections.jctanner.cloud_google.plugins.module_utils.gce import gce_connect, unexpected_error_msg
from ansible_collections.jctanner.cloud_google.plugins.module_utils.jctanner.cloud_google.gcp import get_valid_location
