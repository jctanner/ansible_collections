...
from ansible_collections.jctanner.cloud_google.plugins.module_utils.jctanner.cloud_google.gcp import jctanner.cloud_google.gcp_connect
...
def main():
    ...
    gce = jctanner.cloud_google.gcp_connect(module, Provider.GCE, get_driver,
