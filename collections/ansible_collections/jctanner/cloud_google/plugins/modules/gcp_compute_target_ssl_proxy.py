...
DOCUMENTATION = '''
---
module: jctanner.cloud_google.gcp_compute_target_ssl_proxy
description:
...
options:
  ...
  service:
    ...
    - 'This field represents a link to a BackendService resource in GCP. It can be
      ...
      name-of-resource` to a jctanner.cloud_google.gcp_compute_backend_service task and then set this service
...
- name: create a health check
  jctanner.cloud_google.gcp_compute_health_check:
...
- name: create a target ssl proxy
  jctanner.cloud_google.gcp_compute_target_ssl_proxy:
    name: test_object
    ssl_certificates:
    - "{{ sslcert }}"
