...
DOCUMENTATION = '''
---
module: jctanner.cloud_google.gcp_compute_image
description:
...
options:
  ...
  source_disk:
    ...
    - 'This field represents a link to a Disk resource in GCP. It can be specified
      ...
      to a jctanner.cloud_google.gcp_compute_disk task and then set this source_disk field to "{{ name-of-resource
      }}"'
    required: false
...
- name: create a image
  jctanner.cloud_google.gcp_compute_image:
    name: test_object
    source_disk: "{{ disk }}"
