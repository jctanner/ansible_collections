...
DOCUMENTATION = '''
---
module: jctanner.cloud_google.gcp_compute_instance_group_manager
description:
...
options:
  ...
  instance_template:
    ...
    - 'This field represents a link to a InstanceTemplate resource in GCP. It can
      ...
      name-of-resource` to a jctanner.cloud_google.gcp_compute_instance_template task and then set this
...
- name: create a instance group manager
  jctanner.cloud_google.gcp_compute_instance_group_manager:
    name: test_object
