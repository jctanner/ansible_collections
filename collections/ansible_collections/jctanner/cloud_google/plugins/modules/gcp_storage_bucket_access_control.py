...
DOCUMENTATION = '''
---
module: jctanner.cloud_google.gcp_storage_bucket_access_control
description:
...
options:
  ...
  bucket:
    ...
    - 'This field represents a link to a Bucket resource in GCP. It can be specified
      ...
      to a jctanner.cloud_google.gcp_storage_bucket task and then set this bucket field to "{{ name-of-resource
      }}"'
    required: true
  entity:
    description:
...
- name: create a bucket
  jctanner.cloud_google.gcp_storage_bucket:
    name: "{{ resource_name }}"
...
- name: create a bucket access control
  jctanner.cloud_google.gcp_storage_bucket_access_control:
    bucket: test_object
