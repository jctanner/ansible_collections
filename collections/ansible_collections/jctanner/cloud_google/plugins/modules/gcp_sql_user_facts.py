...
DOCUMENTATION = '''
---
module: jctanner.cloud_google.gcp_sql_user_facts
description:
...
options:
  instance:
    ...
    - 'This field represents a link to a Instance resource in GCP. It can be specified
      ...
      to a jctanner.cloud_google.gcp_sql_instance task and then set this instance field to "{{ name-of-resource
      }}"'
    required: true
...
EXAMPLES = '''
- name: " a user facts"
  jctanner.cloud_google.gcp_sql_user_facts:
    instance: "{{ instance }}"
