...
DOCUMENTATION = '''
---
module: jctanner.cloud_google.gcp_compute_region_disk
description:
...
options:
  ...
  source_snapshot:
    ...
    - 'This field represents a link to a Snapshot resource in GCP. It can be specified
      ...
      to a jctanner.cloud_google.gcp_compute_snapshot task and then set this source_snapshot field to "{{
      name-of-resource }}"'
    required: false
...
- name: create a region disk
  jctanner.cloud_google.gcp_compute_region_disk:
    name: test_object
    size_gb: 50
    disk_encryption_key:
