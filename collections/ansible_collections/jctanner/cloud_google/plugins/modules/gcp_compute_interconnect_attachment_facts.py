...
DOCUMENTATION = '''
---
module: jctanner.cloud_google.gcp_compute_interconnect_attachment_facts
description:
...
- name: " a interconnect attachment facts"
  jctanner.cloud_google.gcp_compute_interconnect_attachment_facts:
    region: us-central1
    filters:
    - name = test_object
...
# Imports
################################################################################
from ansible_collections.jctanner.cloud_google.plugins.module_utils.jctanner.cloud_google.gcp_utils import navigate_hash, GcpSession, GcpModule, GcpRequest
import json
