...
DOCUMENTATION = '''
module: jctanner.cloud_google.gcp_backend_service
version_added: "2.4"
...
deprecated:
    ...
    alternative: Use M(jctanner.cloud_google.gcp_compute_backend_service) instead.
author:
...
- name: Create Minimum Backend Service
  jctanner.cloud_google.gcp_backend_service:
...
from ansible_collections.jctanner.cloud_google.plugins.module_utils.gce import gce_connect
from ansible_collections.jctanner.cloud_google.plugins.module_utils.jctanner.cloud_google.gcp import check_params
