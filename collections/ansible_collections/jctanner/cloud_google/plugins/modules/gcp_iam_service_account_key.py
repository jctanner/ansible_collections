...
DOCUMENTATION = '''
---
module: jctanner.cloud_google.gcp_iam_service_account_key
description:
...
options:
  ...
  service_account:
    ...
    - 'This field represents a link to a ServiceAccount resource in GCP. It can be
      ...
      to a jctanner.cloud_google.gcp_iam_service_account task and then set this service_account field to
      "{{ name-of-resource }}"'
    required: false
  path:
    description:
...
- name: create a service account
  jctanner.cloud_google.gcp_iam_service_account:
...
- name: create a service account key
  jctanner.cloud_google.gcp_iam_service_account_key:
