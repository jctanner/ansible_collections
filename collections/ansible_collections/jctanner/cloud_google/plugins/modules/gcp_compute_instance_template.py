...
DOCUMENTATION = '''
---
module: jctanner.cloud_google.gcp_compute_instance_template
description:
        ...
        suboptions:
          ...
          source:
            ...
            - 'This field represents a link to a Disk resource in GCP. It can be specified
              ...
              name-of-resource` to a jctanner.cloud_google.gcp_compute_disk task and then set this source
        ...
        suboptions:
            ...
            suboptions:
              ...
              nat_ip:
                ...
                - 'This field represents a link to a Address resource in GCP. It can
                  ...
                  you can add `register: name-of-resource` to a jctanner.cloud_google.gcp_compute_address
          ...
          subnetwork:
            ...
            - 'This field represents a link to a Subnetwork resource in GCP. It can
              ...
              can add `register: name-of-resource` to a jctanner.cloud_google.gcp_compute_subnetwork task
...
- name: create a instance template
  jctanner.cloud_google.gcp_compute_instance_template:
    name: test_object
    properties:
      disks:
      - auto_delete: 'true'
