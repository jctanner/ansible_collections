...
DOCUMENTATION = '''
---
module: jctanner.cloud_google.gcp_compute_instance
description:
    ...
    suboptions:
      ...
      source:
        ...
        - 'This field represents a link to a Disk resource in GCP. It can be specified
          ...
          name-of-resource` to a jctanner.cloud_google.gcp_compute_disk task and then set this source field
          to "{{ name-of-resource }}"'
        required: false
      type:
        description:
    ...
    suboptions:
        ...
        suboptions:
          ...
          nat_ip:
            ...
            - 'This field represents a link to a Address resource in GCP. It can be
              ...
              name-of-resource` to a jctanner.cloud_google.gcp_compute_address task and then set this nat_ip
      ...
      network:
        ...
        - 'This field represents a link to a Network resource in GCP. It can be specified
          in two ways. First, you can place a dictionary with key ''selfLink'' and
          value of your resource''s selfLink Alternatively, you can add `register:
          name-of-resource` to a jctanner.cloud_google.gcp_compute_network task and then set this network
          field to "{{ name-of-resource }}"'
        required: false
      network_ip:
        description:
      ...
      subnetwork:
        ...
        - 'This field represents a link to a Subnetwork resource in GCP. It can be
          ...
          name-of-resource` to a jctanner.cloud_google.gcp_compute_subnetwork task and then set this subnetwork
          field to "{{ name-of-resource }}"'
        required: false
  scheduling:
    description:
...
EXAMPLES = '''
- name: create a disk
  jctanner.cloud_google.gcp_compute_disk:
    name: disk-instance
    size_gb: 50
...
- name: create a network
  jctanner.cloud_google.gcp_compute_network:
...
- name: create a instance
  jctanner.cloud_google.gcp_compute_instance:
    name: test_object
