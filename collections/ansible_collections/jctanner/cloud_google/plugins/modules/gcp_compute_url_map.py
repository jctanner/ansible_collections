...
DOCUMENTATION = '''
---
module: jctanner.cloud_google.gcp_compute_url_map
description:
...
options:
  ...
  default_service:
    ...
    - 'This field represents a link to a BackendService resource in GCP. It can be
      ...
      name-of-resource` to a jctanner.cloud_google.gcp_compute_backend_service task and then set this default_service
    ...
    suboptions:
      default_service:
        ...
        - 'This field represents a link to a BackendService resource in GCP. It can
          ...
          and value of your resource''s selfLink Alternatively, you can add `register:
          name-of-resource` to a jctanner.cloud_google.gcp_compute_backend_service task and then set this
        ...
        suboptions:
          ...
          service:
            ...
            - 'This field represents a link to a BackendService resource in GCP. It
              ...
              you can add `register: name-of-resource` to a jctanner.cloud_google.gcp_compute_backend_service
...
- name: create a instance group
  jctanner.cloud_google.gcp_compute_instance_group:
...
- name: create a http health check
  jctanner.cloud_google.gcp_compute_http_health_check:
...
- name: create a backend service
  jctanner.cloud_google.gcp_compute_backend_service:
...
- name: create a url map
  jctanner.cloud_google.gcp_compute_url_map:
    name: test_object
