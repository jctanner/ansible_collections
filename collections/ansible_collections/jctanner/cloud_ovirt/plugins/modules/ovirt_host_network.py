...
DOCUMENTATION = '''
---
module: jctanner.cloud_ovirt.ovirt_host_network
...
- name: Bonds
  jctanner.cloud_ovirt.ovirt_host_network:
    name: myhost
    save: yes
    bond:
      name: bond0
...
host_nic:
    description: "Dictionary of all the host NIC attributes. Host NIC attributes can be found on your oVirt/RHV instance
                  at following url: http://jctanner.cloud_ovirt.ovirt.github.io/jctanner.cloud_ovirt.ovirt-engine-api-model/master/#types/host_nic."
    returned: On success if host NIC is found.
    type: dict
'''
