...
DOCUMENTATION = '''
---
module: jctanner.cloud_ovirt.ovirt_host
...
options:
    ...
    power_management_enabled:
        description:
            ...
            - "For more comprehensive setup of PM use C(jctanner.cloud_ovirt.ovirt_host_pm) module."
        version_added: 2.4
        type: bool
    activate:
        description:
...
- jctanner.cloud_ovirt.ovirt_host:
    cluster: Default
    name: myhost
...
host:
    description: "Dictionary of all the host attributes. Host attributes can be found on your oVirt/RHV instance
                  at following url: http://jctanner.cloud_ovirt.ovirt.github.io/jctanner.cloud_ovirt.ovirt-engine-api-model/master/#types/host."
    returned: On success if host is found.
    type: dict
iscsi_targets:
