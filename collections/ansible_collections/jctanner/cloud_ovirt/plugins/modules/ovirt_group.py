...
DOCUMENTATION = '''
---
module: jctanner.cloud_ovirt.ovirt_group
...
- jctanner.cloud_ovirt.ovirt_group:
    name: group1
...
group:
    description: "Dictionary of all the group attributes. Group attributes can be found on your oVirt/RHV instance
                  at following url: http://jctanner.cloud_ovirt.ovirt.github.io/jctanner.cloud_ovirt.ovirt-engine-api-model/master/#types/group."
    returned: On success if group is found.
    type: dict
'''
