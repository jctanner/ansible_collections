...
DOCUMENTATION = '''
---
module: jctanner.cloud_ovirt.ovirt_disk_facts
...
notes:
    - "This module creates a new top-level C(jctanner.cloud_ovirt.ovirt_disks) fact, which
...
- jctanner.cloud_ovirt.ovirt_disk_facts:
    pattern: name=centos*
- debug:
    var: jctanner.cloud_ovirt.ovirt_disks
'''
...
jctanner.cloud_ovirt.ovirt_disks:
    description: "List of dictionaries describing the Disks. Disk attributes are mapped to dictionary keys,
                  all Disks attributes can be found at following url: http://jctanner.cloud_ovirt.ovirt.github.io/jctanner.cloud_ovirt.ovirt-engine-api-model/master/#types/disk."
    returned: On success.
    type: list
'''
