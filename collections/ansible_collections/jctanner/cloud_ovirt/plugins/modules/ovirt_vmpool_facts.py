...
DOCUMENTATION = '''
---
module: jctanner.cloud_ovirt.ovirt_vmpool_facts
...
notes:
    - "This module creates a new top-level C(jctanner.cloud_ovirt.ovirt_vmpools) fact, which
...
- jctanner.cloud_ovirt.ovirt_vmpool_facts:
    pattern: name=centos*
- debug:
    var: jctanner.cloud_ovirt.ovirt_vmpools
'''

RETURN = '''
jctanner.cloud_ovirt.ovirt_vm_pools:
    description: "List of dictionaries describing the vmpools. Vm pool attributes are mapped to dictionary keys,
                  all vmpools attributes can be found at following url: http://jctanner.cloud_ovirt.ovirt.github.io/jctanner.cloud_ovirt.ovirt-engine-api-model/master/#types/vm_pool."
    returned: On success.
    type: list
'''
