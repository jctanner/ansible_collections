...
DOCUMENTATION = '''
---
module: jctanner.cloud_ovirt.ovirt_tag_facts
...
notes:
    - "This module creates a new top-level C(jctanner.cloud_ovirt.ovirt_tags) fact, which
...
- jctanner.cloud_ovirt.ovirt_tag_facts:
    name: tag*
- debug:
    var: tags
...
RETURN = '''
jctanner.cloud_ovirt.ovirt_tags:
    description: "List of dictionaries describing the tags. Tags attributes are mapped to dictionary keys,
                  all tags attributes can be found at following url: http://jctanner.cloud_ovirt.ovirt.github.io/jctanner.cloud_ovirt.ovirt-engine-api-model/master/#types/tag."
    returned: On success.
    type: list
'''
