...
DOCUMENTATION = '''
---
module: jctanner.cloud_ovirt.ovirt_cluster
...
# Create cluster
- jctanner.cloud_ovirt.ovirt_cluster:
...
- jctanner.cloud_ovirt.ovirt_cluster:
    ...
    cpu_type: Intel SandyBridge Family
    external_network_providers:
      - name: jctanner.cloud_ovirt.ovirt-provider-ovn
...
cluster:
    description: "Dictionary of all the cluster attributes. Cluster attributes can be found on your oVirt/RHV instance
                  at following url: http://jctanner.cloud_ovirt.ovirt.github.io/jctanner.cloud_ovirt.ovirt-engine-api-model/master/#types/cluster."
    type: dict
    returned: On success if cluster is found.
'''
