...
DOCUMENTATION = '''
---
module: jctanner.cloud_ovirt.ovirt_permission_facts
...
notes:
    - "This module creates a new top-level C(jctanner.cloud_ovirt.ovirt_permissions) fact, which
...
- jctanner.cloud_ovirt.ovirt_permission_facts:
    user_name: john
    authz_name: example.com-authz
- debug:
    var: jctanner.cloud_ovirt.ovirt_permissions
'''

RETURN = '''
jctanner.cloud_ovirt.ovirt_permissions:
    description: "List of dictionaries describing the permissions. Permission attributes are mapped to dictionary keys,
                  all permissions attributes can be found at following url: http://jctanner.cloud_ovirt.ovirt.github.io/jctanner.cloud_ovirt.ovirt-engine-api-model/master/#types/permission."
    returned: On success.
    type: list
'''
...
def main():
    ...
    try:
        ...
        module.exit_json(
            changed=False,
            ansible_facts=dict(jctanner.cloud_ovirt.ovirt_permissions=permissions),
        )
