...
DOCUMENTATION = '''
---
module: jctanner.cloud_ovirt.ovirt_vm_facts
...
notes:
    - "This module creates a new top-level C(jctanner.cloud_ovirt.ovirt_vms) fact, which
...
- jctanner.cloud_ovirt.ovirt_vm_facts:
    pattern: name=centos* and cluster=west
- debug:
    var: jctanner.cloud_ovirt.ovirt_vms
...
- jctanner.cloud_ovirt.ovirt_vm_facts:
    ...
    next_run: true
- debug:
    var: jctanner.cloud_ovirt.ovirt_vms[0]
'''
...
jctanner.cloud_ovirt.ovirt_vms:
    description: "List of dictionaries describing the VMs. VM attributes are mapped to dictionary keys,
                  all VMs attributes can be found at following url: http://jctanner.cloud_ovirt.ovirt.github.io/jctanner.cloud_ovirt.ovirt-engine-api-model/master/#types/vm."
    returned: On success.
    type: list
'''
