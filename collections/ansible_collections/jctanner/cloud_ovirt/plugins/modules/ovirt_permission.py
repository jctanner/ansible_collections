...
DOCUMENTATION = '''
---
module: jctanner.cloud_ovirt.ovirt_permission
    ...
    user_name:
        description:
            ...
            - Note that if user does not exist in the system this module will fail,
              you should ensure the user exists by using M(jctanner.cloud_ovirt.ovirt_users) module.
    group_name:
        description:
            - Name of the group to manage.
            - Note that if group does not exist in the system this module will fail,
               you should ensure the group exists by using M(jctanner.cloud_ovirt.ovirt_groups) module.
    authz_name:
        description:
...
- name: Add user user1 from authorization provider example.com-authz
  jctanner.cloud_ovirt.ovirt_permission:
    user_name: user1
...
permission:
    description: "Dictionary of all the permission attributes. Permission attributes can be found on your oVirt/RHV instance
                  at following url: http://jctanner.cloud_ovirt.ovirt.github.io/jctanner.cloud_ovirt.ovirt-engine-api-model/master/#types/permission."
    returned: On success if permission is found.
    type: dict
'''
