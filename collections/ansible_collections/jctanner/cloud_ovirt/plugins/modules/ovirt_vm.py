...
DOCUMENTATION = '''
---
module: jctanner.cloud_ovirt.ovirt_vm
        ...
        suboptions:
            ...
            mac_address:
                description:
                    ...
                    To manage NICs of the VM in more depth please use M(jctanner.cloud_ovirt.ovirt_nics) module instead."
    disks:
        description:
        ...
        suboptions:
            ...
            activate:
                description:
                    ...
                    To manage disks of the VM in more depth please use M(jctanner.cloud_ovirt.ovirt_disks) module instead."
                type: bool
    sysprep:
        description:
...
# Since Ansible 2.5
- jctanner.cloud_ovirt.ovirt_quotas_facts:
    data_center: Default
    name: myquota
- jctanner.cloud_ovirt.ovirt_vm:
    name: myvm
    ...
    usb_support: True
    serial_console: True
    quota_id: "{{ jctanner.cloud_ovirt.ovirt_quotas[0]['id'] }}"
...
vm:
    description: "Dictionary of all the VM attributes. VM attributes can be found on your oVirt/RHV instance
                  at following url: http://jctanner.cloud_ovirt.ovirt.github.io/jctanner.cloud_ovirt.ovirt-engine-api-model/master/#types/vm.
