...
DOCUMENTATION = '''
---
module: jctanner.cloud_ovirt.ovirt_snapshot_facts
...
notes:
    - "This module creates a new top-level C(jctanner.cloud_ovirt.ovirt_snapshots) fact, which
...
- jctanner.cloud_ovirt.ovirt_snapshot_facts:
    vm: centos7
    description: update*
- debug:
    var: jctanner.cloud_ovirt.ovirt_snapshots
'''

RETURN = '''
jctanner.cloud_ovirt.ovirt_snapshots:
    description: "List of dictionaries describing the snapshot. Snapshot attributes are mapped to dictionary keys,
                  all snapshot attributes can be found at following url: http://jctanner.cloud_ovirt.ovirt.github.io/jctanner.cloud_ovirt.ovirt-engine-api-model/master/#types/snapshot."
    returned: On success.
    type: list
'''
