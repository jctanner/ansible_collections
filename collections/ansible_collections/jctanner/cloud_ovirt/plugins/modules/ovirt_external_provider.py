...
DOCUMENTATION = '''
---
module: jctanner.cloud_ovirt.ovirt_external_provider
...
options:
    ...
    authentication_keys:
        ...
        default: []
        version_added: "2.6"
extends_documentation_fragment: jctanner.cloud_ovirt.ovirt
'''
...
- jctanner.cloud_ovirt.ovirt_external_provider:
    name: image_provider
    type: os_image
...
from ansible_collections.jctanner.cloud_jctanner.cloud_ovirt.ovirt.plugins.module_utils.jctanner.cloud_ovirt.ovirt import (
    ...
    create_connection,
    equal,
    jctanner.cloud_ovirt.ovirt_full_argument_spec,
)
