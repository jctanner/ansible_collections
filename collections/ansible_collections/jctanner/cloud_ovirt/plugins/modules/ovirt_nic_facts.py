...
DOCUMENTATION = '''
---
module: jctanner.cloud_ovirt.ovirt_nic_facts
...
notes:
    - "This module creates a new top-level C(jctanner.cloud_ovirt.ovirt_nics) fact, which
...
- jctanner.cloud_ovirt.ovirt_nic_facts:
    vm: centos7
    name: eth*
- debug:
    var: jctanner.cloud_ovirt.ovirt_nics
'''

RETURN = '''
jctanner.cloud_ovirt.ovirt_nics:
    description: "List of dictionaries describing the network interfaces. NIC attributes are mapped to dictionary keys,
                  all NICs attributes can be found at following url: http://jctanner.cloud_ovirt.ovirt.github.io/jctanner.cloud_ovirt.ovirt-engine-api-model/master/#types/nic."
    returned: On success.
    type: list
'''
