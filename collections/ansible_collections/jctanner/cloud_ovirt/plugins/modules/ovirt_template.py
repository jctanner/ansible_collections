...
DOCUMENTATION = '''
---
module: jctanner.cloud_ovirt.ovirt_template
...
- jctanner.cloud_ovirt.ovirt_template:
    cluster: Default
    name: mytemplate
    vm: rhel7
    cpu_profile: Default
...
template:
    description: "Dictionary of all the template attributes. Template attributes can be found on your oVirt/RHV instance
                  at following url: http://jctanner.cloud_ovirt.ovirt.github.io/jctanner.cloud_ovirt.ovirt-engine-api-model/master/#types/template."
    returned: On success if template is found.
    type: dict
'''
