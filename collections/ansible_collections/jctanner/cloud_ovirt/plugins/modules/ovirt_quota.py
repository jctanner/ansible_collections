...
DOCUMENTATION = '''
---
module: jctanner.cloud_ovirt.ovirt_quota
...
- jctanner.cloud_ovirt.ovirt_quota:
    name: quota1
    data_center: dcX
    clusters:
        - name: cluster1
...
quota:
    description: "Dictionary of all the quota attributes. Quota attributes can be found on your oVirt/RHV instance
                  at following url: http://jctanner.cloud_ovirt.ovirt.github.io/jctanner.cloud_ovirt.ovirt-engine-api-model/master/#types/quota."
    returned: On success if quota is found.
    type: dict
'''
