...
DOCUMENTATION = '''
---
module: jctanner.cloud_ovirt.ovirt_role
...
- jctanner.cloud_ovirt.ovirt_role:
    name: role
    administrative: true
    permits:
...
jctanner.cloud_ovirt.ovirt_role:
    description: "List of dictionaries describing the Roles. Role attributes are mapped to dictionary keys,
                  all Roles attributes can be found at following url: http://jctanner.cloud_ovirt.ovirt.github.io/jctanner.cloud_ovirt.ovirt-engine-api-model/master/#types/role."
    returned: On success.
    type: list
'''
