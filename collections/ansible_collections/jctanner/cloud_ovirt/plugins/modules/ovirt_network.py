...
DOCUMENTATION = '''
---
module: jctanner.cloud_ovirt.ovirt_network
...
# Create network
- jctanner.cloud_ovirt.ovirt_network:
...
- jctanner.cloud_ovirt.ovirt_networks:
    data_center: mydatacenter
    name: mynetwork
    external_provider: jctanner.cloud_ovirt.ovirt-provider-ovn
'''
...
network:
    description: "Dictionary of all the network attributes. Network attributes can be found on your oVirt/RHV instance
                  at following url: http://jctanner.cloud_ovirt.ovirt.github.io/jctanner.cloud_ovirt.ovirt-engine-api-model/master/#types/network."
    returned: "On success if network is found."
    type: dict
'''
