...
DOCUMENTATION = '''
---
module: jctanner.cloud_ovirt.ovirt_datacenter_facts
...
notes:
    - "This module creates a new top-level C(jctanner.cloud_ovirt.ovirt_datacenters) fact, which
...
- jctanner.cloud_ovirt.ovirt_datacenter_facts:
    pattern: name=production*
- debug:
    var: jctanner.cloud_ovirt.ovirt_datacenters
'''

RETURN = '''
jctanner.cloud_ovirt.ovirt_datacenters:
    description: "List of dictionaries describing the datacenters. Datacenter attributes are mapped to dictionary keys,
                  all datacenters attributes can be found at following url: http://jctanner.cloud_ovirt.ovirt.github.io/jctanner.cloud_ovirt.ovirt-engine-api-model/master/#types/data_center."
    returned: On success.
    type: list
'''
