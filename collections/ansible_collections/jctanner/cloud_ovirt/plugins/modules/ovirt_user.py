...
DOCUMENTATION = '''
---
module: jctanner.cloud_ovirt.ovirt_user
...
- jctanner.cloud_ovirt.ovirt_user:
    name: user1
...
user:
    description: "Dictionary of all the user attributes. User attributes can be found on your oVirt/RHV instance
                  at following url: http://jctanner.cloud_ovirt.ovirt.github.io/jctanner.cloud_ovirt.ovirt-engine-api-model/master/#types/user."
    returned: On success if user is found.
    type: dict
'''
