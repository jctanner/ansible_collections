...
DOCUMENTATION = '''
---
module: jctanner.cloud_ovirt.ovirt_host_pm
...
- jctanner.cloud_ovirt.ovirt_host_pm:
    name: myhost
    address: 1.2.3.4
    options:
      myoption1: x
...
agent:
    description: "Dictionary of all the agent attributes. Agent attributes can be found on your oVirt/RHV instance
                  at following url: http://jctanner.cloud_ovirt.ovirt.github.io/jctanner.cloud_ovirt.ovirt-engine-api-model/master/#types/agent."
    returned: On success if agent is found.
    type: dict
'''
