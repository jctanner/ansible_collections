...
DOCUMENTATION = '''
---
module: jctanner.cloud_ovirt.ovirt_storage_vm_facts
...
notes:
    - "This module creates a new top-level C(jctanner.cloud_ovirt.ovirt_storage_vms) fact, which
...
# are unregistered:
- jctanner.cloud_ovirt.ovirt_vms_facts:
    unregistered=True
- debug:
    var: jctanner.cloud_ovirt.ovirt_storage_vms
'''

RETURN = '''
jctanner.cloud_ovirt.ovirt_storage_vms:
