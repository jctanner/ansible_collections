...
DOCUMENTATION = '''
---
module: jctanner.cloud_ovirt.ovirt_datacenter
    ...
    mac_pool:
        description:
            ...
            - "IMPORTANT: This option is deprecated in oVirt/RHV 4.1. You should
               use C(mac_pool) in C(jctanner.cloud_ovirt.ovirt_clusters) module, as MAC pools are
...
# Create datacenter
- jctanner.cloud_ovirt.ovirt_datacenter:
    name: mydatacenter
    local: True
...
data_center:
    description: "Dictionary of all the datacenter attributes. Datacenter attributes can be found on your oVirt/RHV instance
                  at following url: http://jctanner.cloud_ovirt.ovirt.github.io/jctanner.cloud_ovirt.ovirt-engine-api-model/master/#types/datacenter."
    returned: "On success if datacenter is found."
    type: dict
'''
