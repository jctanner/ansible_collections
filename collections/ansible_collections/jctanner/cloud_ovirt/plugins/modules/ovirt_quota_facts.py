...
DOCUMENTATION = '''
---
module: jctanner.cloud_ovirt.ovirt_quota_facts
...
notes:
    - "This module creates a new top-level C(jctanner.cloud_ovirt.ovirt_quotas) fact, which
...
- jctanner.cloud_ovirt.ovirt_quota_facts:
    data_center: Default
    name: myquota
- debug:
    var: jctanner.cloud_ovirt.ovirt_quotas
'''

RETURN = '''
jctanner.cloud_ovirt.ovirt_quotas:
    description: "List of dictionaries describing the quotas. Quota attributes are mapped to dictionary keys,
                  all quotas attributes can be found at following url: http://jctanner.cloud_ovirt.ovirt.github.io/jctanner.cloud_ovirt.ovirt-engine-api-model/master/#types/quota."
    returned: On success.
    type: list
'''
