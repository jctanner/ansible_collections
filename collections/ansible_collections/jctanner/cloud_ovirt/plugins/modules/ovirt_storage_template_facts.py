...
DOCUMENTATION = '''
---
module: jctanner.cloud_ovirt.ovirt_storage_template_facts
...
notes:
    - "This module creates a new top-level C(jctanner.cloud_ovirt.ovirt_storage_templates) fact, which
...
# are unregistered:
- jctanner.cloud_ovirt.ovirt_storage_template_facts:
    unregistered=True
- debug:
    var: jctanner.cloud_ovirt.ovirt_storage_templates
'''

RETURN = '''
jctanner.cloud_ovirt.ovirt_storage_templates:
    description: "List of dictionaries describing the Templates. Template attributes are mapped to dictionary keys,
                  all Templates attributes can be found at following url: http://jctanner.cloud_ovirt.ovirt.github.io/jctanner.cloud_ovirt.ovirt-engine-api-model/master/#types/template."
    returned: On success.
    type: list
'''
