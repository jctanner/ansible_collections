...
DOCUMENTATION = '''
---
module: jctanner.cloud_ovirt.ovirt_instance_type
    ...
    nics:
        description:
            ...
            - NOTE - This parameter is used only when C(state) is I(running) or I(present) and is able to only create NICs.
              To manage NICs of the instance type in more depth please use M(jctanner.cloud_ovirt.ovirt_nics) module instead.
    memory_max:
        description:
...
- name: Create instance type
  jctanner.cloud_ovirt.ovirt_instance_type:
    state: present
    name: myit
    rng_device: hwrng
    rng_bytes: 200
...
instancetype:
    description: "Dictionary of all the instance type attributes. instance type attributes can be found on your oVirt/RHV instance
                  at following url: http://jctanner.cloud_ovirt.ovirt.github.io/jctanner.cloud_ovirt.ovirt-engine-api-model/master/#types/instance_type."
    returned: On success if instance type is found.
    type: dict
'''
