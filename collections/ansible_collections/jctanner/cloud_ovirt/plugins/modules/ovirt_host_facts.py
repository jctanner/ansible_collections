...
DOCUMENTATION = '''
---
module: jctanner.cloud_ovirt.ovirt_host_facts
...
notes:
    - "This module creates a new top-level C(jctanner.cloud_ovirt.ovirt_hosts) fact, which
...
- jctanner.cloud_ovirt.ovirt_host_facts:
    pattern: name=host* and datacenter=west
- debug:
    var: jctanner.cloud_ovirt.ovirt_hosts
...
RETURN = '''
jctanner.cloud_ovirt.ovirt_hosts:
    description: "List of dictionaries describing the hosts. Host attributes are mapped to dictionary keys,
                  all hosts attributes can be found at following url: http://jctanner.cloud_ovirt.ovirt.github.io/jctanner.cloud_ovirt.ovirt-engine-api-model/master/#types/host."
    returned: On success.
    type: list
'''
