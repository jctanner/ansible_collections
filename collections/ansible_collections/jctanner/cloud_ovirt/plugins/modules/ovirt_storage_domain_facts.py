...
DOCUMENTATION = '''
---
module: jctanner.cloud_ovirt.ovirt_storage_domain_facts
...
notes:
    - "This module creates a new top-level C(jctanner.cloud_ovirt.ovirt_storage_domains) fact, which
...
- jctanner.cloud_ovirt.ovirt_storage_domain_facts:
    pattern: name=data* and datacenter=west
- debug:
    var: jctanner.cloud_ovirt.ovirt_storage_domains
'''

RETURN = '''
jctanner.cloud_ovirt.ovirt_storage_domains:
    description: "List of dictionaries describing the storage domains. Storage_domain attributes are mapped to dictionary keys,
                  all storage domains attributes can be found at following url: http://jctanner.cloud_ovirt.ovirt.github.io/jctanner.cloud_ovirt.ovirt-engine-api-model/master/#types/storage_domain."
    returned: On success.
    type: list
'''
