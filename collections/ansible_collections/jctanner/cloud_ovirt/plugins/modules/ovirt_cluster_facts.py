...
DOCUMENTATION = '''
---
module: jctanner.cloud_ovirt.ovirt_cluster_facts
...
notes:
    - "This module creates a new top-level C(jctanner.cloud_ovirt.ovirt_clusters) fact, which
...
- jctanner.cloud_ovirt.ovirt_cluster_facts:
    pattern:
      name: 'production*'
- debug:
    var: jctanner.cloud_ovirt.ovirt_clusters
'''

RETURN = '''
jctanner.cloud_ovirt.ovirt_clusters:
    description: "List of dictionaries describing the clusters. Cluster attributes are mapped to dictionary keys,
                  all clusters attributes can be found at following url: http://jctanner.cloud_ovirt.ovirt.github.io/jctanner.cloud_ovirt.ovirt-engine-api-model/master/#types/cluster."
    returned: On success.
    type: list
'''
