...
DOCUMENTATION = '''
---
module: jctanner.cloud_ovirt.ovirt_storage_connection
...
- jctanner.cloud_ovirt.ovirt_storage_connection:
    storage: myiscsi
...
storage_connection:
    description: "Dictionary of all the storage connection attributes. Storage connection attributes can be found on your oVirt instance
                  at following url: https://jctanner.cloud_ovirt.ovirt.example.com/jctanner.cloud_ovirt.ovirt-engine/api/model#types/storage_connection."
    returned: On success if storage connection is found.
    type: dict
'''
