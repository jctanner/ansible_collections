...
DOCUMENTATION = '''
---
module: jctanner.cloud_ovirt.ovirt_event
...
# look at the jctanner.cloud_ovirt.ovirt_auth module to see how to reuse authentication.

- name: Create an event
  jctanner.cloud_ovirt.ovirt_event:
    state: present
...
event:
    description: "Dictionary of all the Event attributes. All event attributes can be found at the following url:
                  http://jctanner.cloud_ovirt.ovirt.github.io/jctanner.cloud_ovirt.ovirt-engine-api-model/master/#types/event"
    returned: "On success."
    type: dict
'''
