...
DOCUMENTATION = '''
---
module: jctanner.cloud_ovirt.ovirt_snapshot
...
# Create snapshot:
- jctanner.cloud_ovirt.ovirt_snapshot:
    vm_name: rhel7
...
snapshot:
    description: "Dictionary of all the snapshot attributes. Snapshot attributes can be found on your oVirt/RHV instance
                  at following url: http://jctanner.cloud_ovirt.ovirt.github.io/jctanner.cloud_ovirt.ovirt-engine-api-model/master/#types/snapshot."
    returned: On success if snapshot is found.
    type: dict
snapshots:
