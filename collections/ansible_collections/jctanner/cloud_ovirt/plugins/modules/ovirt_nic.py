...
DOCUMENTATION = '''
---
module: jctanner.cloud_ovirt.ovirt_nic
...
- name: Add NIC to VM
  jctanner.cloud_ovirt.ovirt_nic:
    state: present
    vm: myvm
    name: mynic
    interface: e1000
    mac_address: 00:1a:4a:16:01:56
    profile: jctanner.cloud_ovirt.ovirtmgmt
    network: jctanner.cloud_ovirt.ovirtmgmt
...
nic:
    description: "Dictionary of all the network interface attributes. Network interface attributes can be found on your oVirt/RHV instance
                  at following url: http://jctanner.cloud_ovirt.ovirt.github.io/jctanner.cloud_ovirt.ovirt-engine-api-model/master/#types/nic."
    returned: On success if network interface is found.
    type: dict
'''
