...
DOCUMENTATION = '''
---
module: jctanner.cloud_ovirt.ovirt_external_provider_facts
...
notes:
    - "This module creates a new top-level C(jctanner.cloud_ovirt.ovirt_external_providers) fact, which
...
- jctanner.cloud_ovirt.ovirt_external_provider_facts:
    type: os_image
    name: glance
- debug:
    var: jctanner.cloud_ovirt.ovirt_external_providers
'''
...
external_host_providers:
    description: "List of dictionaries of all the external_host_provider attributes. External provider attributes can be found on your oVirt/RHV instance
                  at following url: http://jctanner.cloud_ovirt.ovirt.github.io/jctanner.cloud_ovirt.ovirt-engine-api-model/master/#types/external_host_provider."
...
openstack_image_providers:
    description: "List of dictionaries of all the openstack_image_provider attributes. External provider attributes can be found on your oVirt/RHV instance
                  at following url: http://jctanner.cloud_ovirt.ovirt.github.io/jctanner.cloud_ovirt.ovirt-engine-api-model/master/#types/openstack_image_provider."
...
openstack_volume_providers:
    description: "List of dictionaries of all the openstack_volume_provider attributes. External provider attributes can be found on your oVirt/RHV instance
                  at following url: http://jctanner.cloud_ovirt.ovirt.github.io/jctanner.cloud_ovirt.ovirt-engine-api-model/master/#types/openstack_volume_provider."
...
openstack_network_providers:
    description: "List of dictionaries of all the openstack_network_provider attributes. External provider attributes can be found on your oVirt/RHV instance
                  at following url: http://jctanner.cloud_ovirt.ovirt.github.io/jctanner.cloud_ovirt.ovirt-engine-api-model/master/#types/openstack_network_provider."
...
def main():
    ...
    try:
        ...
        module.exit_json(
            changed=False,
            ansible_facts=dict(
                jctanner.cloud_ovirt.ovirt_external_providers=[
                    get_dict_of_struct(
                        struct=c,
