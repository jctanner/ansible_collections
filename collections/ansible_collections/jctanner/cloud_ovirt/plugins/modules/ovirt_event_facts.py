...
DOCUMENTATION = '''
---
module: jctanner.cloud_ovirt.ovirt_event_facts
...
- name: Return all events
  jctanner.cloud_ovirt.ovirt_event_facts:
...
RETURN = '''
jctanner.cloud_ovirt.jctanner.cloud_ovirt.ovirt_facts:
...
def main():
    ...
    try:
        ...
        module.exit_json(
            changed=False,
            ansible_facts=dict(
                jctanner.cloud_ovirt.ovirt_events=[
                    get_dict_of_struct(
                        struct=c,
