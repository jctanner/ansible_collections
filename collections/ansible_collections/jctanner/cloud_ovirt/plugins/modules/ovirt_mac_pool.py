...
DOCUMENTATION = '''
---
module: jctanner.cloud_ovirt.ovirt_mac_pool
...
# Create MAC pool:
- jctanner.cloud_ovirt.ovirt_mac_pool:
    name: mymacpool
...
template:
    description: "Dictionary of all the MAC pool attributes. MAC pool attributes can be found on your oVirt/RHV instance
                  at following url: http://jctanner.cloud_ovirt.ovirt.github.io/jctanner.cloud_ovirt.ovirt-engine-api-model/master/#types/mac_pool."
    returned: On success if MAC pool is found.
    type: dict
'''
