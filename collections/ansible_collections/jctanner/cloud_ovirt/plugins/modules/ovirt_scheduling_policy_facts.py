...
DOCUMENTATION = '''
---
module: jctanner.cloud_ovirt.ovirt_scheduling_policy_facts
...
notes:
    - "This module creates a new top-level C(jctanner.cloud_ovirt.ovirt_scheduling_policies) fact,
...
- jctanner.cloud_ovirt.ovirt_scheduling_policy_facts:
    name: InClusterUpgrade
- debug:
    var: jctanner.cloud_ovirt.ovirt_scheduling_policies
'''

RETURN = '''
jctanner.cloud_ovirt.ovirt_scheduling_policies:
    description: "List of dictionaries describing the scheduling policies.
                  ...
                  url: https://jctanner.cloud_ovirt.ovirt.example.com/jctanner.cloud_ovirt.ovirt-engine/api/model#types/scheduling_policy."
    returned: On success.
    type: list
'''
