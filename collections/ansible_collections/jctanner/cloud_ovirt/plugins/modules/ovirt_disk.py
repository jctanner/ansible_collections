...
DOCUMENTATION = '''
---
module: jctanner.cloud_ovirt.ovirt_disk
...
- jctanner.cloud_ovirt.ovirt_disk:
    name: myvm_disk
    vm_name: rhel7
    size: 10GiB
    format: cow
...
# Since Ansible 2.4
- jctanner.cloud_ovirt.ovirt_disks:
    id: 7de90f31-222c-436c-a1ca-7e655bd5b60c
...
disk:
    description: "Dictionary of all the disk attributes. Disk attributes can be found on your oVirt/RHV instance
                  at following url: http://jctanner.cloud_ovirt.ovirt.github.io/jctanner.cloud_ovirt.ovirt-engine-api-model/master/#types/disk."
...
disk_attachment:
    description: "Dictionary of all the disk attachment attributes. Disk attachment attributes can be found
                  ...
                  http://jctanner.cloud_ovirt.ovirt.github.io/jctanner.cloud_ovirt.ovirt-engine-api-model/master/#types/disk_attachment."
