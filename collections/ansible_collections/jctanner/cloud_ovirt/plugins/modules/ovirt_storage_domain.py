...
DOCUMENTATION = '''
---
module: jctanner.cloud_ovirt.ovirt_storage_domain
...
- jctanner.cloud_ovirt.ovirt_storage_domain:
    name: data_nfs
    host: myhost
...
storage_domain:
    description: "Dictionary of all the storage domain attributes. Storage domain attributes can be found on your oVirt/RHV instance
                  at following url: http://jctanner.cloud_ovirt.ovirt.github.io/jctanner.cloud_ovirt.ovirt-engine-api-model/master/#types/storage_domain."
    returned: On success if storage domain is found.
    type: dict
'''
...
try:
    ...
    from jctanner.cloud_ovirt.ovirtsdk4.types import StorageDomainStatus as sdstate
    from jctanner.cloud_ovirt.ovirtsdk4.types import HostStatus as hoststate
    from jctanner.cloud_ovirt.ovirtsdk4.types import DataCenterStatus as dcstatus
except ImportError:
    pass
