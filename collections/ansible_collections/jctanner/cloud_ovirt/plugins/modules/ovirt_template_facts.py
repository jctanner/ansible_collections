...
DOCUMENTATION = '''
---
module: jctanner.cloud_ovirt.ovirt_template_facts
...
notes:
    - "This module creates a new top-level C(jctanner.cloud_ovirt.ovirt_templates) fact, which
...
- jctanner.cloud_ovirt.ovirt_template_facts:
    pattern: name=centos* and datacenter=west
- debug:
    var: jctanner.cloud_ovirt.ovirt_templates
'''

RETURN = '''
jctanner.cloud_ovirt.ovirt_templates:
