...
DOCUMENTATION = '''
---
module: jctanner.cloud_ovirt.ovirt_affinity_group
...
- name: Create(if not exists) and assign affinity group to VMs vm1 and vm2 and host host1
  jctanner.cloud_ovirt.ovirt_affinity_group:
    name: mygroup
    cluster: mycluster
    vm_enforcing: true
    vm_rule: positive
...
affinity_group:
    description: "Dictionary of all the affinity group attributes. Affinity group attributes can be found on your oVirt/RHV instance
                  at following url: http://jctanner.cloud_ovirt.ovirt.github.io/jctanner.cloud_ovirt.ovirt-engine-api-model/master/#types/affinity_group."
    returned: On success if affinity group is found.
    type: str
'''
