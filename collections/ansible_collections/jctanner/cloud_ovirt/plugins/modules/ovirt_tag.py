...
DOCUMENTATION = '''
---
module: jctanner.cloud_ovirt.ovirt_tag
...
- jctanner.cloud_ovirt.ovirt_tag:
    name: mytag
    vms:
      - vm1
      - vm2
...
tag:
    description: "Dictionary of all the tag attributes. Tag attributes can be found on your oVirt/RHV instance
                  at following url: http://jctanner.cloud_ovirt.ovirt.github.io/jctanner.cloud_ovirt.ovirt-engine-api-model/master/#types/tag."
    returned: On success if tag is found.
    type: dict
'''
