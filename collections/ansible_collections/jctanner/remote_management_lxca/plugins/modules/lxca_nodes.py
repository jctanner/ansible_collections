...
extends_documentation_fragment:
    - jctanner.remote_management_lxca.lxca_common
'''
...
from ansible_collections.jctanner.remote_management_lxca.plugins.module_utils.remote_management.lxca.common import LXCA_COMMON_ARGS, has_pylxca, connection_object
try:
