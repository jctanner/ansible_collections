...
DOCUMENTATION = '''
---
module: jctanner.network_fortios.fortios_firewall_service_category
...
- hosts: localhost
  ...
  - name: Configure service categories.
    jctanner.network_fortios.fortios_firewall_service_category:
      host:  "{{ host }}"
      username: "{{ username }}"
      password: "{{ password }}"
      vdom:  "{{ vdom }}"
...
def jctanner.network_fortios.fortios_firewall_service(data, fos):
    login(data)
...
def main():
    ...
    is_error, has_changed, result = jctanner.network_fortios.fortios_firewall_service(module.params, fos)
