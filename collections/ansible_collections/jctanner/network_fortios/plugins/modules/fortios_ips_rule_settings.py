...
DOCUMENTATION = '''
---
module: jctanner.network_fortios.fortios_ips_rule_settings
...
- hosts: localhost
  ...
  - name: Configure IPS rule setting.
    jctanner.network_fortios.fortios_ips_rule_settings:
      host:  "{{ host }}"
      username: "{{ username }}"
      password: "{{ password }}"
      vdom:  "{{ vdom }}"
...
def jctanner.network_fortios.fortios_ips(data, fos):
    login(data)
...
def main():
    ...
    is_error, has_changed, result = jctanner.network_fortios.fortios_ips(module.params, fos)
