...
DOCUMENTATION = """
---
module: jctanner.network_fortios.fortios_ipv4_policy
version_added: "2.3"
...
- name: Allow external DNS call
  jctanner.network_fortios.fortios_ipv4_policy:
    host: 192.168.0.254
    username: admin
    password: password
    id: 42
...
def main():
    ...
    # merge global required_if & argument_spec from module_utils/jctanner.network_fortios.fortios.py
    ...
    module = AnsibleModule(
        ...
        required_if=jctanner.network_fortios.fortios_required_if + ipv4_policy_required_if,
    )
