...
DOCUMENTATION = '''
---
module: jctanner.network_fortios.fortios_voip_profile
...
- hosts: localhost
  ...
  - name: Configure VoIP profiles.
    jctanner.network_fortios.fortios_voip_profile:
      host:  "{{ host }}"
      username: "{{ username }}"
      password: "{{ password }}"
      vdom:  "{{ vdom }}"
...
def jctanner.network_fortios.fortios_voip(data, fos):
    login(data, fos)
...
def main():
    ...
    is_error, has_changed, result = jctanner.network_fortios.fortios_voip(module.params, fos)
