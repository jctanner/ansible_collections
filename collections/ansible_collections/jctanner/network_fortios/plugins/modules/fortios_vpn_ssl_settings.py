...
DOCUMENTATION = '''
---
module: jctanner.network_fortios.fortios_vpn_ssl_settings
...
- hosts: localhost
  ...
  - name: Configure SSL VPN.
    jctanner.network_fortios.fortios_vpn_ssl_settings:
      host:  "{{ host }}"
      username: "{{ username }}"
      password: "{{ password }}"
      vdom:  "{{ vdom }}"
...
def jctanner.network_fortios.fortios_vpn_ssl(data, fos):
    login(data)
...
def main():
    ...
    is_error, has_changed, result = jctanner.network_fortios.fortios_vpn_ssl(module.params, fos)
