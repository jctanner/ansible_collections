...
DOCUMENTATION = '''
---
module: jctanner.network_fortios.fortios_log_webtrends_setting
...
- hosts: localhost
  ...
  - name: Settings for WebTrends.
    jctanner.network_fortios.fortios_log_webtrends_setting:
      host:  "{{ host }}"
      username: "{{ username }}"
      password: "{{ password }}"
      vdom:  "{{ vdom }}"
...
def jctanner.network_fortios.fortios_log_webtrends(data, fos):
    login(data)
...
def main():
    ...
    is_error, has_changed, result = jctanner.network_fortios.fortios_log_webtrends(module.params, fos)
