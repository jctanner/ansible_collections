...
DOCUMENTATION = '''
---
module: jctanner.network_fortios.fortios_log_disk_setting
...
- hosts: localhost
  ...
  - name: Settings for local disk logging.
    jctanner.network_fortios.fortios_log_disk_setting:
      host:  "{{ host }}"
      username: "{{ username }}"
      password: "{{ password }}"
      vdom:  "{{ vdom }}"
...
def jctanner.network_fortios.fortios_log_disk(data, fos):
    login(data)
...
def main():
    ...
    is_error, has_changed, result = jctanner.network_fortios.fortios_log_disk(module.params, fos)
