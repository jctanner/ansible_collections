...
DOCUMENTATION = '''
---
module: jctanner.network_fortios.fortios_system_dhcp_server
...
- hosts: localhost
  ...
  - name: Configure DHCP servers.
    jctanner.network_fortios.fortios_system_dhcp_server:
      host:  "{{ host }}"
      username: "{{ username }}"
      password: "{{ password }}"
      vdom:  "{{ vdom }}"
...
def jctanner.network_fortios.fortios_system_dhcp(data, fos):
    login(data)
...
def main():
    ...
    is_error, has_changed, result = jctanner.network_fortios.fortios_system_dhcp(module.params, fos)
