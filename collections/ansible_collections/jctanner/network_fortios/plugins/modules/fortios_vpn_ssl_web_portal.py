...
DOCUMENTATION = '''
---
module: jctanner.network_fortios.fortios_vpn_ssl_web_portal
...
- hosts: localhost
  ...
  tasks:
  - name: Portal.
    jctanner.network_fortios.fortios_vpn_ssl_web_portal:
      host:  "{{ host }}"
      username: "{{ username }}"
      password: "{{ password }}"
      vdom:  "{{ vdom }}"
...
def jctanner.network_fortios.fortios_vpn_ssl_web(data, fos):
    login(data)
...
def main():
    ...
    is_error, has_changed, result = jctanner.network_fortios.fortios_vpn_ssl_web(module.params, fos)
