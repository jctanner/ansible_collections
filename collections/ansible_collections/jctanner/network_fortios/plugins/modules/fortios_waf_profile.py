...
DOCUMENTATION = '''
---
module: jctanner.network_fortios.fortios_waf_profile
...
- hosts: localhost
  ...
  - name: Web application firewall configuration.
    jctanner.network_fortios.fortios_waf_profile:
      host:  "{{ host }}"
      username: "{{ username }}"
      password: "{{ password }}"
      vdom:  "{{ vdom }}"
...
def jctanner.network_fortios.fortios_waf(data, fos):
    login(data, fos)
...
def main():
    ...
    is_error, has_changed, result = jctanner.network_fortios.fortios_waf(module.params, fos)
