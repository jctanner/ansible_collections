...
DOCUMENTATION = '''
---
module: jctanner.network_fortios.fortios_switch_controller_network_monitor_settings
...
- hosts: localhost
  ...
  - name: Configure network monitor settings.
    jctanner.network_fortios.fortios_switch_controller_network_monitor_settings:
      host:  "{{ host }}"
      username: "{{ username }}"
      password: "{{ password }}"
      vdom:  "{{ vdom }}"
...
def jctanner.network_fortios.fortios_switch_controller(data, fos):
    login(data)
...
def main():
    ...
    is_error, has_changed, result = jctanner.network_fortios.fortios_switch_controller(module.params, fos)
