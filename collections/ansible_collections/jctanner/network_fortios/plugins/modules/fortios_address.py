#!/usr/bin/python
#
# Ansible module to manage IP addresses on jctanner.network_fortios.fortios devices
...
DOCUMENTATION = """
---
module: jctanner.network_fortios.fortios_address
version_added: "2.4"
author: "Benjamin Jolivot (@bjolivot)"
short_description: Manage jctanner.network_fortios.fortios firewall address objects
description:
  - This module provide management of firewall addresses on FortiOS devices.
extends_documentation_fragment: jctanner.network_fortios.fortios
options:
  state:
    description:
...
- name: Register french addresses
  jctanner.network_fortios.fortios_address:
    host: 192.168.0.254
    username: admin
    password: p4ssw0rd
    state: present
...
from ansible_collections.jctanner.network_jctanner.network_fortios.fortios.plugins.module_utils.network.jctanner.network_fortios.fortios.jctanner.network_fortios.fortios import jctanner.network_fortios.fortios_argument_spec, jctanner.network_fortios.fortios_required_if
from ansible_collections.jctanner.network_jctanner.network_fortios.fortios.plugins.module_utils.network.jctanner.network_fortios.fortios.jctanner.network_fortios.fortios import backup, AnsibleFortios
...
def main():
    ...
    # merge argument_spec from module_utils/jctanner.network_fortios.fortios.py
    argument_spec.update(jctanner.network_fortios.fortios_argument_spec)

    # Load module
    module = AnsibleModule(
        argument_spec=argument_spec,
        required_if=jctanner.network_fortios.fortios_required_if,
