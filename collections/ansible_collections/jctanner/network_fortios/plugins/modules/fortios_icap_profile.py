...
DOCUMENTATION = '''
---
module: jctanner.network_fortios.fortios_icap_profile
...
- hosts: localhost
  ...
  - name: Configure ICAP profiles.
    jctanner.network_fortios.fortios_icap_profile:
      host:  "{{ host }}"
      username: "{{ username }}"
      password: "{{ password }}"
      vdom:  "{{ vdom }}"
...
def jctanner.network_fortios.fortios_icap(data, fos):
    login(data)
...
def main():
    ...
    is_error, has_changed, result = jctanner.network_fortios.fortios_icap(module.params, fos)
