#!/usr/bin/python
#
# Ansible module to manage configuration on jctanner.network_fortios.fortios devices
...
DOCUMENTATION = """
---
module: jctanner.network_fortios.fortios_config
version_added: "2.3"
...
- name: Backup current config
  jctanner.network_fortios.fortios_config:
    host: 192.168.0.254
    username: admin
    password: password
    backup: yes
...
from ansible_collections.jctanner.network_jctanner.network_fortios.fortios.plugins.module_utils.network.jctanner.network_fortios.fortios.jctanner.network_fortios.fortios import backup

# check for pyFG lib
try:
    from pyFG import FortiOS, FortiConfig
    from pyFG.jctanner.network_fortios.fortios import logger
