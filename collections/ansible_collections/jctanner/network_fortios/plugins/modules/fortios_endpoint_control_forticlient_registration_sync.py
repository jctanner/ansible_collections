...
DOCUMENTATION = '''
---
module: jctanner.network_fortios.fortios_endpoint_control_forticlient_registration_sync
...
- hosts: localhost
  ...
  - name: Configure FortiClient registration synchronization settings.
    jctanner.network_fortios.fortios_endpoint_control_forticlient_registration_sync:
      host:  "{{ host }}"
      username: "{{ username }}"
      password: "{{ password }}"
      vdom:  "{{ vdom }}"
