...
DOCUMENTATION = '''
---
module: jctanner.network_fortios.fortios_log_fortianalyzer_override_setting
...
- hosts: localhost
  ...
  - name: Override FortiAnalyzer settings.
    jctanner.network_fortios.fortios_log_fortianalyzer_override_setting:
      host:  "{{ host }}"
      username: "{{ username }}"
      password: "{{ password }}"
      vdom:  "{{ vdom }}"
...
def jctanner.network_fortios.fortios_log_fortianalyzer(data, fos):
    login(data)
...
def main():
    ...
    is_error, has_changed, result = jctanner.network_fortios.fortios_log_fortianalyzer(module.params, fos)
