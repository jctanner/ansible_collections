...
extends_documentation_fragment:
  - jctanner.database_proxysql.proxysql.managing_config
  - jctanner.database_proxysql.proxysql.connectivity
'''
...
from ansible_collections.jctanner.database_proxysql.plugins.module_utils.mysql import mysql_connect, mysql_driver, mysql_driver_fail_msg
