...
DOCUMENTATION = """
---
module: jctanner.network_asa.asa_config
version_added: "2.2"
...
description:
  - Cisco ASA configurations use a simple block indent file syntax
    ...
    a deterministic way.
extends_documentation_fragment: jctanner.network_asa.asa
options:
  lines:
    description:
...
---
- jctanner.network_asa.asa_config:
    lines:
...
backup_path:
  ...
  type: str
  sample: /playbooks/ansible/backup/jctanner.network_asa.asa_config.2016-07-16@22:28:34
"""
from ansible.module_utils.basic import AnsibleModule
from ansible_collections.jctanner.network_jctanner.network_asa.asa.plugins.module_utils.network.jctanner.network_asa.asa.jctanner.network_asa.asa import jctanner.network_asa.asa_argument_spec, check_args
from ansible_collections.jctanner.network_jctanner.network_asa.asa.plugins.module_utils.network.jctanner.network_asa.asa.jctanner.network_asa.asa import get_config, load_config, run_commands
from ansible_collections.jctanner.network_jctanner.network_asa.asa.plugins.module_utils.network.common.config import NetworkConfig, dumps
...
def main():
    ...
    argument_spec.update(jctanner.network_asa.asa_argument_spec)
