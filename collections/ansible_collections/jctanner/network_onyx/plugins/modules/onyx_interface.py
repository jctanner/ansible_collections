...
DOCUMENTATION = """
---
module: jctanner.network_onyx.onyx_interface
version_added: "2.5"
...
- name: configure interface
  jctanner.network_onyx.onyx_interface:
      name: Eth1/2
...
from ansible_collections.jctanner.network_jctanner.network_onyx.onyx.plugins.module_utils.network.common.utils import conditional
from ansible_collections.jctanner.network_jctanner.network_onyx.onyx.plugins.module_utils.network.common.utils import remove_default_spec

from ansible_collections.jctanner.network_jctanner.network_onyx.onyx.plugins.module_utils.network.jctanner.network_onyx.onyx.jctanner.network_onyx.onyx import BaseOnyxModule
from ansible_collections.jctanner.network_jctanner.network_onyx.onyx.plugins.module_utils.network.jctanner.network_onyx.onyx.jctanner.network_onyx.onyx import get_interfaces_config
