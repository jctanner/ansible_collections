...
DOCUMENTATION = """
---
module: jctanner.network_onyx.onyx_lldp_interface
version_added: "2.5"
...
- name: Configure LLDP on specific interfaces
  jctanner.network_onyx.onyx_lldp_interface:
    name: Eth1/1
    state: present
...
from ansible_collections.jctanner.network_jctanner.network_onyx.onyx.plugins.module_utils.network.jctanner.network_onyx.onyx.jctanner.network_onyx.onyx import show_cmd
