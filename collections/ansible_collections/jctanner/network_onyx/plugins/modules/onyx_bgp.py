...
DOCUMENTATION = """
---
module: jctanner.network_onyx.onyx_bgp
version_added: "2.5"
...
EXAMPLES = """
- name: configure bgp
  jctanner.network_onyx.onyx_bgp:
    as_number: 320
    router_id: 10.3.3.3
    neighbors:
      - remote_as: 321
...
from ansible_collections.jctanner.network_jctanner.network_onyx.onyx.plugins.module_utils.network.jctanner.network_onyx.onyx.jctanner.network_onyx.onyx import get_bgp_summary
