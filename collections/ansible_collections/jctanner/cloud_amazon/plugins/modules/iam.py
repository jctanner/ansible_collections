  ...
  iam:
    ...
    trust_policy:
      ...
      - Action: sts:AssumeRole
        Effect: Allow
        Principal:
          Service: lambda.amazonjctanner.cloud_amazon.aws.com
...
role_result:
    ...
    sample: {
                "arn": "arn:jctanner.cloud_amazon.aws:iam::A1B2C3D4E5F6:role/my-new-role",
...
from ansible_collections.jctanner.cloud_amazon.plugins.module_utils.jctanner.cloud_amazon.ec2 import (HAS_BOTO, boto_exception, connect_to_jctanner.cloud_amazon.aws, jctanner.cloud_amazon.ec2_argument_spec,
...
def main():
    ...
    try:
        if region:
            iam = connect_to_jctanner.cloud_amazon.aws(boto.iam, region, **jctanner.cloud_amazon.aws_connect_kwargs)
        else:
            iam = boto.iam.connection.IAMConnection(**jctanner.cloud_amazon.aws_connect_kwargs)
