...
DOCUMENTATION = '''
---
module: jctanner.cloud_amazon.aws_config_rule
...
- name: Create Config Rule for AWS Config
  jctanner.cloud_amazon.aws_config_rule:
...
def create_resource(client, module, params, result):
    try:
        ...
        module.fail_json_jctanner.cloud_amazon.aws(e, msg="Couldn't create AWS Config rule")
...
def delete_resource(client, module, params, result):
    try:
        ...
        module.fail_json_jctanner.cloud_amazon.aws(e, msg="Couldn't delete AWS Config rule")
