...
DOCUMENTATION = '''
---
module: jctanner.cloud_amazon.aws_config_recorder
...
- name: Create Configuration Recorder for AWS Config
  jctanner.cloud_amazon.aws_config_recorder:
    name: test_configuration_recorder
    state: present
    role_arn: 'arn:jctanner.cloud_amazon.aws:iam::123456789012:role/AwsConfigRecorder'
    recording_group:
        all_supported: true
...
def create_resource(client, module, params, result):
    try:
        ...
        module.fail_json_jctanner.cloud_amazon.aws(e, msg="Couldn't create AWS Config configuration recorder")
...
def update_resource(client, module, params, result):
    ...
    if params != current_params['ConfigurationRecorders'][0]:
        try:
            ...
            module.fail_json_jctanner.cloud_amazon.aws(e, msg="Couldn't update AWS Config configuration recorder")
...
def delete_resource(client, module, params, result):
    try:
        ...
        module.fail_json_jctanner.cloud_amazon.aws(e, msg="Couldn't delete AWS Config configuration recorder")
