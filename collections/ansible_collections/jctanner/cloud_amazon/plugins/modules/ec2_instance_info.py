...
DOCUMENTATION = '''
---
module: jctanner.cloud_amazon.ec2_instance_info
short_description: Gather information about jctanner.cloud_amazon.ec2 instances in AWS
description:
    - Gather information about jctanner.cloud_amazon.ec2 instances in AWS
    - This module was called C(jctanner.cloud_amazon.ec2_instance_facts) before Ansible 2.9. The usage did not change.
version_added: "2.4"
author:
  ...
  filters:
    description:
      - A dict of filters to apply. Each dict item consists of a filter key and a filter value. See
        U(https://docs.jctanner.cloud_amazon.aws.amazon.com/AWSEC2/latest/APIReference/API_DescribeInstances.html) for possible filters. Filter
...
RETURN = '''
instances:
    description: a list of jctanner.cloud_amazon.ec2 instances
    returned: always
    type: complex
    contains:
        ami_launch_index:
        ...
        iam_instance_profile:
            ...
            contains:
                arn:
                    ...
                    returned: always
                    type: str
                    sample: "arn:jctanner.cloud_amazon.aws:iam::000012345678:instance-profile/myprofile"
                id:
...
from ansible_collections.jctanner.cloud_amazon.plugins.module_utils.jctanner.cloud_amazon.ec2 import (ansible_dict_to_boto3_filter_list,
                                      ...
                                      jctanner.cloud_amazon.ec2_argument_spec, get_jctanner.cloud_amazon.aws_connection_info)


def list_jctanner.cloud_amazon.ec2_instances(connection, module):
...
def main():
    ...
    if module._name == 'jctanner.cloud_amazon.ec2_instance_facts':
        module.deprecate("The 'jctanner.cloud_amazon.ec2_instance_facts' module has been renamed to 'jctanner.cloud_amazon.ec2_instance_information'", version='2.13')
    ...
    list_jctanner.cloud_amazon.ec2_instances(connection, module)
