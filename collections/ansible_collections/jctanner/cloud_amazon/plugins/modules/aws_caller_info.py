...
DOCUMENTATION = '''
---
module: jctanner.cloud_amazon.aws_caller_info
...
description:
    ...
    - This module was called C(jctanner.cloud_amazon.aws_caller_facts) before Ansible 2.9. The usage did not change.
version_added: "2.6"
...
arn:
    ...
    returned: success
    type: str
    sample: arn:jctanner.cloud_amazon.aws:sts::123456789012:federated-user/my-federated-user-name
user_id:
    description: |
...
def main():
    ...
    if module._name == 'jctanner.cloud_amazon.aws_caller_facts':
        module.deprecate("The 'jctanner.cloud_amazon.aws_caller_facts' module has been renamed to 'jctanner.cloud_amazon.aws_caller_info'", version='2.13')
    ...
    try:
        ...
        # see https://docs.jctanner.cloud_amazon.aws.amazon.com/cli/latest/reference/iam/list-account-aliases.html#output
