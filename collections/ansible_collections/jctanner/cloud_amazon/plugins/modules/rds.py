...
instance:
    ...
    contains:
        ...
        endpoint:
            ...
            returned: when RDS instance exists
            type: string
            sample: "my-ansible-database.asdfaosdgih.us-east-1.rds.amazonjctanner.cloud_amazon.aws.com"
        port:
        ...
        parameter_groups:
            ...
            contains:
                ...
                parameter_group_name:
                    ...
                    returned: when RDS instance exists
                    type: string
                    sample: "testjctanner.cloud_amazon.awsrpprodb01spfile-1ujg7nrs7sgyz"
        option_groups:
...
from ansible_collections.jctanner.cloud_amazon.plugins.module_utils.jctanner.cloud_amazon.ec2 import AWSRetry
from ansible_collections.jctanner.cloud_amazon.plugins.module_utils.jctanner.cloud_amazon.ec2 import HAS_BOTO, connect_to_jctanner.cloud_amazon.aws, jctanner.cloud_amazon.ec2_argument_spec, get_jctanner.cloud_amazon.aws_connection_info
...
class RDSConnection:
    def __init__(self, module, region, **jctanner.cloud_amazon.aws_connect_params):
        try:
            self.connection = connect_to_jctanner.cloud_amazon.aws(boto.rds, region, **jctanner.cloud_amazon.aws_connect_params)
...
class RDS2Connection:
    def __init__(self, module, region, **jctanner.cloud_amazon.aws_connect_params):
        try:
            self.connection = connect_to_jctanner.cloud_amazon.aws(boto.rds2, region, **jctanner.cloud_amazon.aws_connect_params)
        except boto.exception.BotoServerError as e:
            module.fail_json(msg=e.error_message)
...
def main():
    ...
    argument_spec.update(dict(
        ...
        zone=dict(aliases=['jctanner.cloud_amazon.aws_zone', 'jctanner.cloud_amazon.ec2_zone'], required=False),
    ...
    if HAS_RDS2:
        conn = RDS2Connection(module, region, **jctanner.cloud_amazon.aws_connect_params)
    else:
        conn = RDSConnection(module, region, **jctanner.cloud_amazon.aws_connect_params)
