...
DOCUMENTATION = """
---
module: jctanner.cloud_amazon.ec2_asg
short_description: Create or delete AWS Autoscaling Groups
description:
  - Can create or delete AWS Autoscaling Groups
  - Can be used with the jctanner.cloud_amazon.ec2_lc module to manage Launch Configurations
version_added: "1.6"
...
options:
  ...
  launch_config_name:
    description:
      - Name of the Launch configuration to use for the group. See the jctanner.cloud_amazon.ec2_lc module for managing these.
...
auto_scaling_group_arn:
    ...
    returned: success
    type: str
    sample: "arn:jctanner.cloud_amazon.aws:autoscaling:us-east-1:123456789012:autoScalingGroup:6a09ad6d-eeee-1234-b987-ee123ced01ad:autoScalingGroupName/myasg"
availability_zones:
...
launch_config_name:
    description: >
      ...
      provided for compatibility with jctanner.cloud_amazon.ec2_asg module.
    returned: success
    type: str
...
target_group_arns:
    ...
    type: list
    sample: [
        "arn:jctanner.cloud_amazon.aws:elasticloadbalancing:ap-southeast-2:123456789012:targetgroup/target-group-host-hello/1a2b3c4d5e6f1a2b",
        "arn:jctanner.cloud_amazon.aws:elasticloadbalancing:ap-southeast-2:123456789012:targetgroup/target-group-path-world/abcd1234abcd1234"
    ]
target_group_names:
...
from ansible_collections.jctanner.cloud_amazon.plugins.module_utils.jctanner.cloud_amazon.ec2 import boto3_conn, jctanner.cloud_amazon.ec2_argument_spec, HAS_BOTO3, camel_dict_to_snake_dict, get_jctanner.cloud_amazon.aws_connection_info, AWSRetry
...
def get_properties(autoscaling_group):
    ...
    if properties['target_group_arns']:
        ...
        elbv2_connection = boto3_conn(module,
                                      ...
                                      resource='elbv2',
                                      region=region,
                                      endpoint=jctanner.cloud_amazon.ec2_url,
...
def get_launch_object(connection, jctanner.cloud_amazon.ec2_connection):
    launch_object = dict()
    ...
    if launch_config_name is None and launch_template is None:
        ...
        lt = describe_launch_templates(jctanner.cloud_amazon.ec2_connection, launch_template)['LaunchTemplates'][0]
...
def suspend_processes(jctanner.cloud_amazon.ec2_connection, as_group):
    ...
    if resume_processes:
        resume_asg_processes(jctanner.cloud_amazon.ec2_connection, module.params.get('name'), resume_processes)

    if suspend_processes:
        suspend_asg_processes(jctanner.cloud_amazon.ec2_connection, module.params.get('name'), list(suspend_processes))
...
def create_autoscaling_group(connection):
    ...
    region, jctanner.cloud_amazon.ec2_url, jctanner.cloud_amazon.aws_connect_params = get_jctanner.cloud_amazon.aws_connection_info(module, boto3=True)
    jctanner.cloud_amazon.ec2_connection = boto3_conn(module,
                                conn_type='client',
                                resource='jctanner.cloud_amazon.ec2',
                                region=region,
                                endpoint=jctanner.cloud_amazon.ec2_url,
                                **jctanner.cloud_amazon.aws_connect_params)
    ...
    if not as_groups:
        if not vpc_zone_identifier and not availability_zones:
            availability_zones = module.params['availability_zones'] = [zone['ZoneName'] for
                                                                        zone in jctanner.cloud_amazon.ec2_connection.describe_availability_zones()['AvailabilityZones']]
        ...
        launch_object = get_launch_object(connection, jctanner.cloud_amazon.ec2_connection)
