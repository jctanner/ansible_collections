...
DOCUMENTATION = '''
module: jctanner.cloud_amazon.aws_waf_condition
short_description: create and delete WAF Conditions
description:
  - Read the AWS documentation for WAF
    U(https://jctanner.cloud_amazon.aws.amazon.com/documentation/waf/)
version_added: "2.5"
...
EXAMPLES = '''
  - name: create WAF byte condition
    jctanner.cloud_amazon.aws_waf_condition:
...
from ansible_collections.jctanner.cloud_amazon.plugins.module_utils.jctanner.cloud_amazon.ec2 import boto3_conn, get_jctanner.cloud_amazon.aws_connection_info, jctanner.cloud_amazon.ec2_argument_spec
from ansible_collections.jctanner.cloud_amazon.plugins.module_utils.jctanner.cloud_amazon.ec2 import camel_dict_to_snake_dict, AWSRetry, compare_policies
from ansible_collections.jctanner.cloud_amazon.plugins.module_utils.jctanner.cloud_amazon.aws.waf import run_func_with_change_token_backoff, MATCH_LOOKUP
from ansible_collections.jctanner.cloud_amazon.plugins.module_utils.jctanner.cloud_amazon.aws.waf import get_rule_with_backoff, list_rules_with_backoff, list_regional_rules_with_backoff
...
class Condition(object):
    ...
    def list_regex_patterns(self):
        ...
        while True:
            try:
                ...
                self.module.fail_json_jctanner.cloud_amazon.aws(e, msg='Could not list regex patterns')
    ...
    def delete_unused_regex_pattern(self, regex_pattern_set_id):
        try:
            ...
            if e.response['Error']['Code'] == 'WAFNonexistentItemException':
                return
            self.module.fail_json_jctanner.cloud_amazon.aws(e, msg='Could not delete regex pattern')
    ...
    def get_condition_by_id(self, condition_set_id):
        try:
            ...
            self.module.fail_json_jctanner.cloud_amazon.aws(e, msg='Could not get condition')
    ...
    def list_conditions(self):
        ...
        try:
            ...
            self.module.fail_json_jctanner.cloud_amazon.aws(e, msg='Could not list %s conditions' % self.type)
    ...
    def find_condition_in_rules(self, condition_set_id):
        ...
        try:
            ...
            self.module.fail_json_jctanner.cloud_amazon.aws(e, msg='Could not list rules')
        for rule in all_rules:
            try:
                rule_details = get_rule_with_backoff(self.client, rule['RuleId'])
            except (botocore.exceptions.ClientError, botocore.exceptions.BotoCoreError) as e:
                self.module.fail_json_jctanner.cloud_amazon.aws(e, msg='Could not get rule details')
    ...
    def find_and_delete_condition(self, condition_set_id):
        ...
        if current_condition[self.conditiontuples]:
            ...
            try:
                ...
                self.module.fail_json_jctanner.cloud_amazon.aws(e, msg='Could not delete filters from condition')
        ...
        try:
            ...
            self.module.fail_json_jctanner.cloud_amazon.aws(e, msg='Could not delete condition')
    ...
    def find_and_update_condition(self, condition_set_id):
        ...
        if changed:
            ...
            try:
                ...
                self.module.fail_json_jctanner.cloud_amazon.aws(e, msg='Could not update condition')
    ...
    def ensure_condition_present(self):
        ...
        if condition_set_id:
            ...
            try:
                ...
                self.module.fail_json_jctanner.cloud_amazon.aws(e, msg='Could not create condition')
...
def main():
    ...
    client = boto3_conn(module, conn_type='client', resource=resource, region=region, endpoint=jctanner.cloud_amazon.ec2_url, **jctanner.cloud_amazon.aws_connect_kwargs)

    condition = Condition(client, module)

    if state == 'present':
        (changed, results) = condition.ensure_condition_present()
        # return a condition agnostic ID for use by jctanner.cloud_amazon.aws_waf_rule
