...
DOCUMENTATION = '''
---
module: jctanner.cloud_amazon.ec2_ami_copy
...
EXAMPLES = '''
# Basic AMI Copy
- jctanner.cloud_amazon.ec2_ami_copy:
...
- jctanner.cloud_amazon.ec2_ami_copy:
    ...
    source_image_id: ami-xxxxxxx
    encrypted: yes
    kms_key_id: arn:jctanner.cloud_amazon.aws:kms:us-east-1:XXXXXXXXXXXX:key/746de6ea-50a4-4bcb-8fbc-e3b29f2d367b
'''
...
def copy_image(module, jctanner.cloud_amazon.ec2):
    """
    Copies an AMI
    ...
    try:
        ...
        module.fail_json_jctanner.cloud_amazon.aws(e, msg="Could not copy AMI")
...
def main():
    ...
    copy_image(module, jctanner.cloud_amazon.ec2)
