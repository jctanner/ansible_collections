...
DOCUMENTATION = '''
---
module: jctanner.cloud_amazon.ec2_elb_info
...
description:
    ...
    - This module was called C(jctanner.cloud_amazon.ec2_elb_facts) before Ansible 2.9. The usage did not change.
version_added: "2.0"
author:
...
options:
  names:
    ...
    aliases: ['elb_ids', 'jctanner.cloud_amazon.ec2_elbs']
...
# Output format tries to match jctanner.cloud_amazon.ec2_elb_lb module input parameters
...
from ansible_collections.jctanner.cloud_amazon.plugins.module_utils.jctanner.cloud_amazon.ec2 import (
    AWSRetry,
    connect_to_jctanner.cloud_amazon.aws,
...
class ElbInformation(object):
    ...
    def _get_elb_connection(self):
        return connect_to_jctanner.cloud_amazon.aws(boto.jctanner.cloud_amazon.ec2.elb, self.region, **self.jctanner.cloud_amazon.aws_connect_params)
...
def main():
    ...
    if module._name == 'jctanner.cloud_amazon.ec2_elb_facts':
        module.deprecate("The 'jctanner.cloud_amazon.ec2_elb_facts' module has been renamed to 'jctanner.cloud_amazon.ec2_elb_info'", version='2.13')
    ...
    try:
        ...
        elb_information = ElbInformation(
            module, names, region, **jctanner.cloud_amazon.aws_connect_params)

        jctanner.cloud_amazon.ec2_info_result = dict(changed=False,
    ...
    module.exit_json(**jctanner.cloud_amazon.ec2_info_result)
