...
DOCUMENTATION = '''
module: jctanner.cloud_amazon.aws_waf_info
...
description:
  ...
  - This module was called C(jctanner.cloud_amazon.aws_waf_facts) before Ansible 2.9. The usage did not change.
version_added: "2.4"
requirements: [ boto3 ]
options:
  name:
...
- name: obtain all WAF information
  jctanner.cloud_amazon.aws_waf_info:
...
from ansible_collections.jctanner.cloud_amazon.plugins.module_utils.jctanner.cloud_amazon.aws.waf import list_web_acls, get_web_acl
...
def main():
    ...
    if module._name == 'jctanner.cloud_amazon.aws_waf_facts':
        module.deprecate("The 'jctanner.cloud_amazon.aws_waf_facts' module has been renamed to 'jctanner.cloud_amazon.aws_waf_info'", version='2.13')
