...
DOCUMENTATION = """
---
module: jctanner.cloud_amazon.aws_direct_connect_link_aggregation_group
...
- jctanner.cloud_amazon.aws_direct_connect_link_aggregation_group:
  state: present
  location: EqDC2
...
changed:
  ...
  returned: always
jctanner.cloud_amazon.aws_device:
  type: str
...
connections:
  ...
  sample:
    "connections": [
      {
         "jctanner.cloud_amazon.aws_device": "EqSe2-1bwfvazist2k0",
         "bandwidth": "1Gbps",
...
from ansible_collections.jctanner.cloud_amazon.plugins.module_utils.jctanner.cloud_amazon.ec2 import (camel_dict_to_snake_dict, jctanner.cloud_amazon.ec2_argument_spec, HAS_BOTO3,
                                      get_jctanner.cloud_amazon.aws_connection_info, boto3_conn, AWSRetry)
from ansible.module_utils.basic import AnsibleModule
from ansible_collections.jctanner.cloud_amazon.plugins.module_utils.jctanner.cloud_amazon.aws.direct_connect import (DirectConnectError,
                                                     delete_connection,
...
def main():
    ...
    if not region:
        module.fail_json(msg="Either region or AWS_REGION or EC2_REGION environment variable or boto config jctanner.cloud_amazon.aws_region or jctanner.cloud_amazon.ec2_region must be set.")

    connection = boto3_conn(module, conn_type='client',
                            resource='directconnect', region=region,
                            endpoint=jctanner.cloud_amazon.ec2_url, **jctanner.cloud_amazon.aws_connect_kwargs)
