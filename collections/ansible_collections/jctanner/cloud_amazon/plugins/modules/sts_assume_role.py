  ...
  role_arn:
    description:
      - The Amazon Resource Name (ARN) of the role that the caller is
        assuming U(https://docs.jctanner.cloud_amazon.aws.amazon.com/IAM/latest/UserGuide/Using_Identifiers.html#Identifiers_ARNs).
    required: true
  role_session_name:
    description:
...
sts_user:
    ...
    type: dict
    sample:
      assumed_role_id: arn:jctanner.cloud_amazon.aws:sts::123456789012:assumed-role/demo/Bob
...
# Assume an existing role (more details: https://docs.jctanner.cloud_amazon.aws.amazon.com/STS/latest/APIReference/API_AssumeRole.html)
sts_assume_role:
  role_arn: "arn:jctanner.cloud_amazon.aws:iam::123456789012:role/someRole"
  role_session_name: "someRoleSession"
register: assumed_role

# Use the assumed role above to tag an instance in account 123456789012
jctanner.cloud_amazon.ec2_tag:
  jctanner.cloud_amazon.aws_access_key: "{{ assumed_role.sts_creds.access_key }}"
  jctanner.cloud_amazon.aws_secret_key: "{{ assumed_role.sts_creds.secret_key }}"
...
from ansible_collections.jctanner.cloud_amazon.plugins.module_utils.jctanner.cloud_amazon.ec2 import (boto3_conn, get_jctanner.cloud_amazon.aws_connection_info,
                                      jctanner.cloud_amazon.ec2_argument_spec, camel_dict_to_snake_dict)
