...
DOCUMENTATION = """
---
module: jctanner.cloud_amazon.ec2_lc_find
...
- jctanner.cloud_amazon.ec2_lc_find:
    name_regex: app.*
...
arn:
    ...
    returned: when Launch Configuration was found
    type: str
    sample: "arn:jctanner.cloud_amazon.aws:autoscaling:eu-west-1:12345:launchConfiguration:d82f050e-e315:launchConfigurationName/yourproject"
instance_type:
    description: Type of jctanner.cloud_amazon.ec2 instance
    returned: when Launch Configuration was found
    type: str
    sample: "t2.small"
created_time:
...
def main():
    ...
    argument_spec.update(dict(
        region=dict(required=True, aliases=['jctanner.cloud_amazon.aws_region', 'jctanner.cloud_amazon.ec2_region']),
    ...
    region, jctanner.cloud_amazon.ec2_url, jctanner.cloud_amazon.aws_connect_params = get_jctanner.cloud_amazon.aws_connection_info(module, True)

    client = boto3_conn(module=module, conn_type='client', resource='autoscaling', region=region, **jctanner.cloud_amazon.aws_connect_params)
