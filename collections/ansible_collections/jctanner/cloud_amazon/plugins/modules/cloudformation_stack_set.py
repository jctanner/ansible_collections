...
options:
  ...
  administration_role_arn:
    ...
    - This defaults to I(arn:jctanner.cloud_amazon.aws:iam::{{ account ID }}:role/AWSCloudFormationStackSetAdministrationRole) where I({{ account ID }}) is replaced with the
...
operations:
  ...
  sample:
  - action: CREATE
    administration_role_arn: arn:jctanner.cloud_amazon.aws:iam::1234567890:role/AWSCloudFormationStackSetAdministrationRole
    creation_timestamp: '2018-06-18T17:40:46.372000+00:00'
    end_timestamp: '2018-06-18T17:41:24.560000+00:00'
...
stack_set:
  ...
  sample:
    ...
    execution_role_name: AWSCloudFormationStackSetExecutionRole
    parameters: []
    stack_set_arn: arn:jctanner.cloud_amazon.aws:cloudformation:us-east-1:1234567890:stackset/TestStackPrime:19f3f684-aae9-467-ba36-e09f92cf5929
    stack_set_id: TestStackPrime:19f3f684-aae9-4e67-ba36-e09f92cf5929
...
from ansible_collections.jctanner.cloud_amazon.plugins.module_utils.jctanner.cloud_amazon.ec2 import AWSRetry, boto3_tag_list_to_ansible_dict, ansible_dict_to_boto3_tag_list, camel_dict_to_snake_dict
...
def create_stack_set(module, stack_params, cfn):
    try:
        cfn.create_stack_set(jctanner.cloud_amazon.aws_retry=True, **stack_params)
        return await_stack_set_exists(cfn, stack_params['StackSetName'])
    except (ClientError, BotoCoreError) as err:
        module.fail_json_jctanner.cloud_amazon.aws(err, msg="Failed to create stack set {0}.".format(stack_params.get('StackSetName')))
...
def update_stack_set(module, stack_params, cfn):
    ...
    try:
        ...
        module.fail_json_jctanner.cloud_amazon.aws(err, msg="Failed to find stack set. Check the name & region.")
    except is_boto3_error_code('StackInstanceNotFound') as err:  # pylint: disable=duplicate-except
        module.fail_json_jctanner.cloud_amazon.aws(err, msg="One or more stack instances were not found for this stack set. Double check "
        ...
        module.fail_json_jctanner.cloud_amazon.aws(err, msg="Could not update stack set.")
...
def await_stack_set_exists(cfn, stack_set_name):
    ...
    ss = cfn.describe_stack_set(StackSetName=stack_set_name, jctanner.cloud_amazon.aws_retry=True)['StackSet']
    ss['Tags'] = boto3_tag_list_to_ansible_dict(ss['Tags'])
...
def main():
    ...
    if state == 'present':
        ...
        try:
            ...
            module.fail_json_jctanner.cloud_amazon.aws(e, msg='Cannot delete stack {0} while there is an operation in progress'.format(module.params['name']))
            ...
            try:
                ...
                module.fail_json_jctanner.cloud_amazon.aws(exc, msg='Could not purge all stacks, or not all accounts/regions were chosen for deletion: ' + stack_states)
