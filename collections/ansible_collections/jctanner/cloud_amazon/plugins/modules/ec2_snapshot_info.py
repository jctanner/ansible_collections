...
DOCUMENTATION = '''
---
module: jctanner.cloud_amazon.ec2_snapshot_info
short_description: Gather information about jctanner.cloud_amazon.ec2 volume snapshots in AWS
description:
    - Gather information about jctanner.cloud_amazon.ec2 volume snapshots in AWS
    - This module was called C(jctanner.cloud_amazon.ec2_snapshot_facts) before Ansible 2.9. The usage did not change.
version_added: "2.1"
requirements: [ boto3 ]
...
options:
  ...
  filters:
    description:
      ...
      U(https://docs.jctanner.cloud_amazon.aws.amazon.com/AWSEC2/latest/APIReference/API_DescribeSnapshots.html) for possible filters. Filter \
...
data_encryption_key_id:
    ...
    type: str
    returned: always
    sample: "arn:jctanner.cloud_amazon.aws:kms:ap-southeast-2:012345678900:key/74c9742a-a1b2-45cb-b3fe-abcdef123456"
...
def list_jctanner.cloud_amazon.ec2_snapshots(connection, module):
...
def main():
    ...
    if module._name == 'jctanner.cloud_amazon.ec2_snapshot_facts':
        module.deprecate("The 'jctanner.cloud_amazon.ec2_snapshot_facts' module has been renamed to 'jctanner.cloud_amazon.ec2_snapshot_info'", version='2.13')
    ...
    list_jctanner.cloud_amazon.ec2_snapshots(connection, module)
