...
DOCUMENTATION = '''
---
module: jctanner.cloud_amazon.aws_glue_connection
short_description: Manage an AWS Glue connection
description:
    - Manage an AWS Glue connection. See U(https://jctanner.cloud_amazon.aws.amazon.com/glue/) for details.
version_added: "2.6"
requirements: [ boto3 ]
...
- jctanner.cloud_amazon.aws_glue_connection:
...
def create_or_update_glue_connection(connection, connection_jctanner.cloud_amazon.ec2, module, glue_connection):
    """
    ...
    if module.params.get("security_groups") is not None:
        ...
        security_group_ids = get_jctanner.cloud_amazon.ec2_security_group_ids_from_names(module.params.get('security_groups'), connection_jctanner.cloud_amazon.ec2, boto3=True)
...
def main():
    ...
    if module.params.get("state") == 'present':
        create_or_update_glue_connection(connection_glue, connection_jctanner.cloud_amazon.ec2, module, glue_connection)
    else:
