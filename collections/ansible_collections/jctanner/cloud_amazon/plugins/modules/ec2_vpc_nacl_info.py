...
DOCUMENTATION = '''
---
module: jctanner.cloud_amazon.ec2_vpc_nacl_info
short_description: Gather information about Network ACLs in an AWS VPC
description:
    - Gather information about Network ACLs in an AWS VPC
    - This module was called C(jctanner.cloud_amazon.ec2_vpc_nacl_facts) before Ansible 2.9. The usage did not change.
version_added: "2.2"
...
options:
  ...
  filters:
    description:
      ...
      U(https://docs.jctanner.cloud_amazon.aws.amazon.com/AWSEC2/latest/APIReference/API_DescribeNetworkAcls.html) for possible filters. Filter \
...
- name: Get All NACLs
  register: all_nacls
  jctanner.cloud_amazon.ec2_vpc_nacl_info:
    region: us-west-2
...
def list_jctanner.cloud_amazon.ec2_vpc_nacls(connection, module):
...
def main():
    ...
    if module._name == 'jctanner.cloud_amazon.ec2_vpc_nacl_facts':
        module.deprecate("The 'jctanner.cloud_amazon.ec2_vpc_nacl_facts' module has been renamed to 'jctanner.cloud_amazon.ec2_vpc_nacl_info'", version='2.13')
    ...
    list_jctanner.cloud_amazon.ec2_vpc_nacls(connection, module)
