...
snapshots:
  ...
  contains:
    ...
    db_snapshot_arn:
      ...
      returned: always
      type: str
      sample: arn:jctanner.cloud_amazon.aws:rds:us-west-2:111111111111:snapshot:rds:hello-world-rds-us1-2018-05-16-04-03
    db_snapshot_identifier:
    ...
    kms_key_id:
      ...
      returned: always
      type: str
      sample: arn:jctanner.cloud_amazon.aws:kms:us-west-2:111111111111:key/abcd1234-1234-aaaa-0000-1234567890ab
    license_model:
...
cluster_snapshots:
  ...
  contains:
    ...
    db_cluster_snapshot_arn:
      ...
      returned: always
      type: str
      sample: arn:jctanner.cloud_amazon.aws:rds:ca-central-1:111111111111:cluster-snapshot:test-aurora-snapshot
    db_cluster_snapshot_identifier:
    ...
    kms_key_id:
      ...
      returned: always
      type: str
      sample: arn:jctanner.cloud_amazon.aws:kms:ca-central-1:111111111111:key/abcd1234-abcd-1111-aaaa-0123456789ab
    license_model:
      description: License model
      returned: always
      type: str
...
from ansible_collections.jctanner.cloud_amazon.plugins.module_utils.jctanner.cloud_amazon.ec2 import AWSRetry, boto3_tag_list_to_ansible_dict, camel_dict_to_snake_dict
...
def common_snapshot_info(module, conn, method, prefix, params):
    ...
    try:
        ...
        module.fail_json_jctanner.cloud_amazon.aws(e, "trying to get snapshot information")
    ...
    for snapshot in results:
        try:
            ...
            module.fail_json_jctanner.cloud_amazon.aws(e, "Couldn't get tags for snapshot %s" % snapshot['%sIdentifier' % prefix])
