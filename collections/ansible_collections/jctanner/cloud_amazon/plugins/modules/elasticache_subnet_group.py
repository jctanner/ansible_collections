...
from ansible_collections.jctanner.cloud_amazon.plugins.module_utils.jctanner.cloud_amazon.ec2 import HAS_BOTO, jctanner.cloud_amazon.ec2_argument_spec, get_jctanner.cloud_amazon.aws_connection_info
...
def main():
    ...
    try:
        conn = connect_to_region(region_name=region, **jctanner.cloud_amazon.aws_connect_kwargs)
