    ...
    attributes:
        ...
        suboptions:
            ...
            value:
                ...
                required: false
    jctanner.cloud_amazon.ec2_instance_id:
        description:
...
- ecs_attribute:
    ...
    jctanner.cloud_amazon.ec2_instance_id: "{{ jctanner.cloud_amazon.ec2_id }}"
    attributes:
      - flavor: test
      - migrated
...
attributes:
    ...
    contains:
        cluster:
            ...
            type: str
        jctanner.cloud_amazon.ec2_instance_id:
            description: jctanner.cloud_amazon.ec2 instance id of ecs container instance
            type: str
        attributes:
...
class Ec2EcsInstance(object):
    ...
    def __init__(self, module, cluster, jctanner.cloud_amazon.ec2_id):
        self.module = module
        self.cluster = cluster
        self.jctanner.cloud_amazon.ec2_id = jctanner.cloud_amazon.ec2_id
    ...
    def _get_ecs_arn(self):
        try:
            ...
            jctanner.cloud_amazon.ec2_instances = self.ecs.describe_container_instances(cluster=self.cluster,
        ...
        try:
            ecs_arn = next(inst for inst in jctanner.cloud_amazon.ec2_instances
                           if inst['jctanner.cloud_amazon.ec2InstanceId'] == self.jctanner.cloud_amazon.ec2_id)['containerInstanceArn']
...
def main():
    ...
    argument_spec.update(dict(
        ...
        jctanner.cloud_amazon.ec2_instance_id=dict(required=True, type='str'),
        attributes=dict(required=True, type='list'),
    ))

    required_together = [['cluster', 'jctanner.cloud_amazon.ec2_instance_id', 'attributes']]
    ...
    jctanner.cloud_amazon.ec2_instance_id = module.params['jctanner.cloud_amazon.ec2_instance_id']
    attributes = module.params['attributes']

    conti = Ec2EcsInstance(module, cluster, jctanner.cloud_amazon.ec2_instance_id)
    attrs = EcsAttributes(module, attributes)

    results = {'changed': False,
               'attributes': [
                   {'cluster': cluster,
                    'jctanner.cloud_amazon.ec2_instance_id': jctanner.cloud_amazon.ec2_instance_id,
