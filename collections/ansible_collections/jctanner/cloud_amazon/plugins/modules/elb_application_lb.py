...
description:
    - Manage an AWS Application Elastic Load Balancer. See U(https://jctanner.cloud_amazon.aws.amazon.com/blogs/jctanner.cloud_amazon.aws/new-jctanner.cloud_amazon.aws-application-load-balancer/) for details.
version_added: "2.4"
requirements: [ boto3 ]
    ...
    listeners:
      - Protocol: HTTP # Required. The protocol for connections from clients to the load balancer (HTTP or HTTPS) (case-sensitive).
        ...
        Certificates: # The ARN of the certificate (only one certficate ARN should be provided)
          - CertificateArn: arn:jctanner.cloud_amazon.aws:iam::12345678987:server-certificate/test.domain.com
        DefaultActions:
...
dns_name:
    ...
    returned: when state is present
    type: str
    sample: internal-my-elb-123456789.ap-southeast-2.elb.amazonjctanner.cloud_amazon.aws.com
...
load_balancer_arn:
    ...
    returned: when state is present
    type: str
    sample: arn:jctanner.cloud_amazon.aws:elasticloadbalancing:ap-southeast-2:0123456789:loadbalancer/app/my-elb/001122334455
load_balancer_name:
...
from ansible_collections.jctanner.cloud_amazon.plugins.module_utils.jctanner.cloud_amazon.ec2 import boto3_conn, get_jctanner.cloud_amazon.aws_connection_info, camel_dict_to_snake_dict, jctanner.cloud_amazon.ec2_argument_spec, \
    boto3_tag_list_to_ansible_dict, compare_jctanner.cloud_amazon.aws_tags, HAS_BOTO3

from ansible_collections.jctanner.cloud_amazon.plugins.module_utils.jctanner.cloud_amazon.aws.elbv2 import ApplicationLoadBalancer, ELBListeners, ELBListener, ELBListenerRules, ELBListenerRule
from ansible_collections.jctanner.cloud_amazon.plugins.module_utils.jctanner.cloud_amazon.aws.elb_utils import get_elb_listener_rules
...
def create_or_update_elb(elb_obj):
    ...
    if elb_obj.elb:
        ...
        if elb_obj.tags is not None:
            ...
            tags_need_modify, tags_to_delete = compare_jctanner.cloud_amazon.aws_tags(boto3_tag_list_to_ansible_dict(elb_obj.elb['tags']),
...
def main():
    ...
    connection_jctanner.cloud_amazon.ec2 = module.client('jctanner.cloud_amazon.ec2')

    state = module.params.get("state")

    elb = ApplicationLoadBalancer(connection, connection_jctanner.cloud_amazon.ec2, module)
