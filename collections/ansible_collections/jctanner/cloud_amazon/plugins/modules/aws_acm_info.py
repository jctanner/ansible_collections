...
DOCUMENTATION = '''
module: jctanner.cloud_amazon.aws_acm_info
...
description:
  ...
  - This module was called C(jctanner.cloud_amazon.aws_acm_facts) before Ansible 2.9. The usage did not change.
version_added: "2.5"
options:
  domain_name:
    description:
...
- name: obtain all ACM certificates
  jctanner.cloud_amazon.aws_acm_info:
...
certificates:
  ...
  contains:
    ...
    certificate_arn:
      ...
      returned: always
      sample: arn:jctanner.cloud_amazon.aws:acm:ap-southeast-2:123456789012:certificate/abcd1234-abcd-1234-abcd-123456789abc
      type: str
    certificate_chain:
...
from ansible_collections.jctanner.cloud_amazon.plugins.module_utils.jctanner.cloud_amazon.ec2 import camel_dict_to_snake_dict, AWSRetry, HAS_BOTO3, boto3_tag_list_to_ansible_dict
...
def main():
    ...
    if module._name == 'jctanner.cloud_amazon.aws_acm_facts':
        module.deprecate("The 'jctanner.cloud_amazon.aws_acm_facts' module has been renamed to 'jctanner.cloud_amazon.aws_acm_info'", version='2.13')
