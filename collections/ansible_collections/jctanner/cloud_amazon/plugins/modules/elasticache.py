...
from ansible_collections.jctanner.cloud_amazon.plugins.module_utils.jctanner.cloud_amazon.ec2 import jctanner.cloud_amazon.ec2_argument_spec, get_jctanner.cloud_amazon.aws_connection_info, boto3_conn, HAS_BOTO3, camel_dict_to_snake_dict
...
class ElastiCacheManager(object):
    ...
    def __init__(self, module, name, engine, cache_engine_version, node_type,
                 ...
                 hard_modify, region, **jctanner.cloud_amazon.aws_connect_kwargs):
        self.module = module
        self.name = name
        ...
        self.region = region
        self.jctanner.cloud_amazon.aws_connect_kwargs = jctanner.cloud_amazon.aws_connect_kwargs
    ...
    def _get_elasticache_connection(self):
        ...
        region, jctanner.cloud_amazon.ec2_url, jctanner.cloud_amazon.aws_connect_params = get_jctanner.cloud_amazon.aws_connection_info(self.module, boto3=True)
        if region:
