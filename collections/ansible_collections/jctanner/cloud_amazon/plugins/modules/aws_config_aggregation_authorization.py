...
DOCUMENTATION = '''
---
module: jctanner.cloud_amazon.aws_config_aggregation_authorization
...
options:
  ...
  authorized_jctanner.cloud_amazon.aws_region:
    description:
...
- name: Get current account ID
  ...
  register: whoami
- jctanner.cloud_amazon.aws_config_aggregation_authorization:
    state: present
    authorized_account_id: '{{ whoami.account }}'
    authorzed_jctanner.cloud_amazon.aws_region: us-east-1
'''
...
def create_resource(client, module, params, result):
    try:
        ...
        module.fail_json_jctanner.cloud_amazon.aws(e, msg="Couldn't create AWS Aggregation authorization")
...
def delete_resource(client, module, params, result):
    try:
        ...
        module.fail_json_jctanner.cloud_amazon.aws(e, msg="Couldn't delete AWS Aggregation authorization")
...
def main():
    module = AnsibleAWSModule(
        argument_spec={
            ...
            'authorized_jctanner.cloud_amazon.aws_region': dict(type='str', required=True),
        },
    ...
    params = {
        ...
        'AuthorizedAwsRegion': module.params.get('authorized_jctanner.cloud_amazon.aws_region'),
    }
