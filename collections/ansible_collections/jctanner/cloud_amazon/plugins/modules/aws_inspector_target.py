...
DOCUMENTATION = '''
---
module: jctanner.cloud_amazon.aws_inspector_target
...
- name: Create my_target Assessment Target
  jctanner.cloud_amazon.aws_inspector_target:
    name: my_target
    tags:
      role: scan_target
...
arn:
  ...
  returned: success
  type: str
  sample: "arn:jctanner.cloud_amazon.aws:inspector:eu-west-1:123456789012:target/0-O4LnL7n1"
created_at:
...
resource_group_arn:
  ...
  returned: success
  type: str
  sample: "arn:jctanner.cloud_amazon.aws:inspector:eu-west-1:123456789012:resourcegroup/0-qY4gDel8"
tags:
