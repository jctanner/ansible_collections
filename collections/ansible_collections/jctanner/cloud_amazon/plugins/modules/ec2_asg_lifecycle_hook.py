...
DOCUMENTATION = """
---
module: jctanner.cloud_amazon.ec2_asg_lifecycle_hook
...
- jctanner.cloud_amazon.ec2_asg_lifecycle_hook:
    region: eu-central-1
    state: present
...
def create_lifecycle_hook(connection, module):
    ...
    try:
        ...
        module.fail_json_jctanner.cloud_amazon.aws(e, msg="Failed to get Lifecycle Hook")
    ...
    if changed:
        try:
            ...
            module.fail_json_jctanner.cloud_amazon.aws(e, msg="Failed to create LifecycleHook")
...
def delete_lifecycle_hook(connection, module):
    ...
    try:
        ...
        module.fail_json_jctanner.cloud_amazon.aws(e, msg="Failed to get Lifecycle Hooks")
    ...
    for hook in all_hooks['LifecycleHooks']:
        if hook['LifecycleHookName'] == lch_name:
            ...
            try:
                ...
                module.fail_json_jctanner.cloud_amazon.aws(e, msg="Failed to delete LifecycleHook")
        else:
            pass
