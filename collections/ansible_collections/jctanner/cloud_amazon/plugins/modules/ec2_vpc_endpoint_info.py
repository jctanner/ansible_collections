...
DOCUMENTATION = '''
module: jctanner.cloud_amazon.ec2_vpc_endpoint_info
short_description: Retrieves AWS VPC endpoints details using AWS methods.
description:
  - Gets various details related to AWS VPC Endpoints
  - This module was called C(jctanner.cloud_amazon.ec2_vpc_endpoint_facts) before Ansible 2.9. The usage did not change.
version_added: "2.4"
requirements: [ boto3 ]
options:
  query:
  ...
  filters:
    description:
      - A dict of filters to apply. Each dict item consists of a filter key and a filter value.
        See U(https://docs.jctanner.cloud_amazon.aws.amazon.com/AWSEC2/latest/APIReference/API_DescribeVpcEndpoints.html)
...
- name: List supported AWS endpoint services
  jctanner.cloud_amazon.ec2_vpc_endpoint_info:
    query: services
...
service_names:
  ...
  sample:
    service_names:
    - com.amazonjctanner.cloud_amazon.aws.ap-southeast-2.s3
vpc_endpoints:
  description:
  ...
  sample:
    ...
    - creation_timestamp: "2017-02-16T11:06:48+00:00"
      policy_document: >
        ...
        \"Principal\":\"*\",\"Action\":\"s3:*\",\"Resource\":[\"arn:jctanner.cloud_amazon.aws:s3:::*/*\",\"arn:jctanner.cloud_amazon.aws:s3:::*\"]}]}"
      route_table_ids:
      - rtb-abcd1234
      service_name: "com.amazonjctanner.cloud_amazon.aws.ap-southeast-2.s3"
      state: "available"
...
def main():
    ...
    if module._name == 'jctanner.cloud_amazon.ec2_vpc_endpoint_facts':
        module.deprecate("The 'jctanner.cloud_amazon.ec2_vpc_endpoint_facts' module has been renamed to 'jctanner.cloud_amazon.ec2_vpc_endpoint_info'", version='2.13')
