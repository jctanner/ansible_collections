...
- name: Start a task
  ecs_task:
      ...
      cluster: console-sample-app-static-cluster
      task_definition: console-sample-app-static-taskdef
      task: "arn:jctanner.cloud_amazon.aws:ecs:us-west-2:172139249013:task/3f8353d1-29a8-4689-bbf6-ad79937ffe8a"
      container_instances:
      - arn:jctanner.cloud_amazon.aws:ecs:us-west-2:172139249013:container-instance/79c23f22-876c-438a-bddf-55c98a3538a8
      started_by: ansible_user
      network_configuration:
        subnets:
        - subnet-abcd1234
...
from ansible_collections.jctanner.cloud_amazon.plugins.module_utils.jctanner.cloud_amazon.ec2 import jctanner.cloud_amazon.ec2_argument_spec, get_jctanner.cloud_amazon.ec2_security_group_ids_from_names
...
class EcsExecManager:
    ...
    def run_task(self, cluster, task_definition, overrides, count, startedBy, launch_type):
        ...
        try:
            ...
            self.module.fail_json_jctanner.cloud_amazon.aws(e, msg="Couldn't run task")
    ...
    def start_task(self, cluster, task_definition, overrides, container_instances, startedBy):
        ...
        try:
            ...
            self.module.fail_json_jctanner.cloud_amazon.aws(e, msg="Couldn't start task")
        # include tasks and failures
        return response['tasks']
