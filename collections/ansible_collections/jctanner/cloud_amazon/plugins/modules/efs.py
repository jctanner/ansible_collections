...
try:
    ...
    pass  # Taken care of by jctanner.cloud_amazon.ec2.HAS_BOTO3

from ansible.module_utils._text import to_native
from ansible.module_utils.basic import AnsibleModule
from ansible_collections.jctanner.cloud_amazon.plugins.module_utils.jctanner.cloud_amazon.ec2 import (HAS_BOTO3, boto3_conn, camel_dict_to_snake_dict,
                                      jctanner.cloud_amazon.ec2_argument_spec, get_jctanner.cloud_amazon.aws_connection_info, ansible_dict_to_boto3_tag_list,
                                      compare_jctanner.cloud_amazon.aws_tags, boto3_tag_list_to_ansible_dict)
...
class EFSConnection(object):
    ...
    def get_file_systems(self, **kwargs):
        ...
        for item in items:
            ...
            https://docs.jctanner.cloud_amazon.aws.amazon.com/efs/latest/ug/gs-step-three-connect-to-jctanner.cloud_amazon.ec2-instance.html
            """
    ...
    def converge_file_system(self, name, tags, purge_tags, targets, throughput_mode, provisioned_throughput_in_mibps):
        ...
        if tags is not None:
            tags_need_modify, tags_to_delete = compare_jctanner.cloud_amazon.aws_tags(boto3_tag_list_to_ansible_dict(self.get_tags(FileSystemId=fs_id)), tags, purge_tags)
