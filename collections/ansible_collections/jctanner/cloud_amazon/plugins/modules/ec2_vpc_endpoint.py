...
DOCUMENTATION = '''
module: jctanner.cloud_amazon.ec2_vpc_endpoint
...
options:
  ...
  service:
    description:
      - An AWS supported vpc endpoint service. Use the M(jctanner.cloud_amazon.ec2_vpc_endpoint_info)
...
- name: Create new vpc endpoint with a json template for policy
  jctanner.cloud_amazon.ec2_vpc_endpoint:
    state: present
    region: ap-southeast-2
    vpc_id: vpc-12345678
    service: com.amazonjctanner.cloud_amazon.aws.ap-southeast-2.s3
          ...
          "Statement": [
            {
              ...
              "Principal": "*",
              "Resource": [
                "arn:jctanner.cloud_amazon.aws:s3:::*/*",
                "arn:jctanner.cloud_amazon.aws:s3:::*"
              ],
...
from ansible_collections.jctanner.cloud_amazon.plugins.module_utils.jctanner.cloud_amazon.ec2 import (get_jctanner.cloud_amazon.aws_connection_info, boto3_conn, jctanner.cloud_amazon.ec2_argument_spec, HAS_BOTO3,
...
def main():
    ...
    if state == 'present':
        (changed, results) = setup_creation(jctanner.cloud_amazon.ec2, module)
    else:
        (changed, results) = setup_removal(jctanner.cloud_amazon.ec2, module)
