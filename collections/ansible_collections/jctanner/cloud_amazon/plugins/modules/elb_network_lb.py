...
description:
    - Manage an AWS Network Elastic Load Balancer. See
      U(https://jctanner.cloud_amazon.aws.amazon.com/blogs/jctanner.cloud_amazon.aws/new-network-load-balancer-effortless-scaling-to-millions-of-requests-per-second/) for details.
version_added: "2.6"
requirements: [ boto3 ]
...
from ansible_collections.jctanner.cloud_amazon.plugins.module_utils.jctanner.cloud_amazon.ec2 import camel_dict_to_snake_dict, boto3_tag_list_to_ansible_dict, compare_jctanner.cloud_amazon.aws_tags
from ansible_collections.jctanner.cloud_amazon.plugins.module_utils.jctanner.cloud_amazon.aws.elbv2 import NetworkLoadBalancer, ELBListeners, ELBListener
...
def main():
    ...
    elb = NetworkLoadBalancer(connection, connection_jctanner.cloud_amazon.ec2, module)
