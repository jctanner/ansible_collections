...
DOCUMENTATION = '''
module: jctanner.cloud_amazon.ec2_vpc_peering_info
short_description: Retrieves AWS VPC Peering details using AWS methods.
description:
  - Gets various details related to AWS VPC Peers
  - This module was called C(jctanner.cloud_amazon.ec2_vpc_peering_facts) before Ansible 2.9. The usage did not change.
version_added: "2.4"
requirements: [ boto3 ]
options:
  peer_connection_ids:
  ...
  filters:
    description:
      - A dict of filters to apply. Each dict item consists of a filter key and a filter value.
        See U(https://docs.jctanner.cloud_amazon.aws.amazon.com/AWSEC2/latest/APIReference/API_DescribeVpcPeeringConnections.html)
...
- name: List all vpc peers
  jctanner.cloud_amazon.ec2_vpc_peering_info:
...
from ansible_collections.jctanner.cloud_amazon.plugins.module_utils.jctanner.cloud_amazon.ec2 import (boto3_tag_list_to_ansible_dict,
                                      jctanner.cloud_amazon.ec2_argument_spec, boto3_conn, get_jctanner.cloud_amazon.aws_connection_info,
