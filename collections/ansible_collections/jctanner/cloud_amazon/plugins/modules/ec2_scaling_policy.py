...
DOCUMENTATION = """
module: jctanner.cloud_amazon.ec2_scaling_policy
...
EXAMPLES = '''
- jctanner.cloud_amazon.ec2_scaling_policy:
    state: present
    region: US-XXX
...
try:
    ...
    from boto.jctanner.cloud_amazon.ec2.autoscale import ScalingPolicy
...
def main():
    ...
    try:
        connection = connect_to_jctanner.cloud_amazon.aws(boto.jctanner.cloud_amazon.ec2.autoscale, region, **jctanner.cloud_amazon.aws_connect_params)
