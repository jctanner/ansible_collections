...
DOCUMENTATION = '''
module: jctanner.cloud_amazon.ec2_vpc_peer
...
description:
  - Read the AWS documentation for VPC Peering Connections
    U(https://docs.jctanner.cloud_amazon.aws.amazon.com/AmazonVPC/latest/UserGuide/vpc-peering.html).
version_added: "2.2"
options:
  vpc_id:
    description:
...
- name: Create local account VPC peering Connection
  jctanner.cloud_amazon.ec2_vpc_peer:
...
from ansible_collections.jctanner.cloud_amazon.plugins.module_utils.jctanner.cloud_amazon.ec2 import boto3_conn, jctanner.cloud_amazon.ec2_argument_spec, get_jctanner.cloud_amazon.aws_connection_info, HAS_BOTO3
