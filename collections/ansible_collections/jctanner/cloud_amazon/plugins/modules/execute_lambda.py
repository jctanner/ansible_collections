  ...
  version_qualifier:
    description:
      - Which version/alias of the function to run. This defaults to the
        ...
        See U(https://docs.jctanner.cloud_amazon.aws.amazon.com/lambda/latest/dg/versioning-aliases.html)
        for details.
    default: LATEST
  payload:
    description:
...
# another account
- execute_lambda:
    function_arn: arn:jctanner.cloud_amazon.aws:lambda:us-east-1:123456789012:function/some-function
    dry_run: true
...
def main():
    ...
    region, jctanner.cloud_amazon.ec2_url, jctanner.cloud_amazon.aws_connect_kwargs = get_jctanner.cloud_amazon.aws_connection_info(module, boto3=HAS_BOTO3)
    if not region:
