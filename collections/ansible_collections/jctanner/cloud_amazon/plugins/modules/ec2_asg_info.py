...
DOCUMENTATION = '''
---
module: jctanner.cloud_amazon.ec2_asg_info
short_description: Gather information about jctanner.cloud_amazon.ec2 Auto Scaling Groups (ASGs) in AWS
description:
  - Gather information about jctanner.cloud_amazon.ec2 Auto Scaling Groups (ASGs) in AWS
  - This module was called C(jctanner.cloud_amazon.ec2_asg_facts) before Ansible 2.9. The usage did not change.
version_added: "2.2"
requirements: [ boto3 ]
...
# Find all groups
- jctanner.cloud_amazon.ec2_asg_info:
  register: asgs
...
auto_scaling_group_arn:
    ...
    returned: success
    type: str
    sample: "arn:jctanner.cloud_amazon.aws:autoscaling:us-west-2:1234567890:autoScalingGroup:10787c52-0bcb-427d-82ba-c8e4b008ed2e:autoScalingGroupName/public-webapp-production-1"
...
from ansible_collections.jctanner.cloud_amazon.plugins.module_utils.jctanner.cloud_amazon.ec2 import (get_jctanner.cloud_amazon.aws_connection_info, boto3_conn, jctanner.cloud_amazon.ec2_argument_spec,
...
def find_asgs(conn, module, name=None, tags=None):
    ...
    Returns:
        ...
        [
            {
                "auto_scaling_group_arn": (
                    "arn:jctanner.cloud_amazon.aws:autoscaling:us-west-2:275977225706:autoScalingGroup:58abc686-9783-4528-b338-3ad6f1cbbbaf:"
    ...
    try:
        ...
        elbv2 = boto3_conn(module, conn_type='client', resource='elbv2', region=region, endpoint=jctanner.cloud_amazon.ec2_url, **jctanner.cloud_amazon.aws_connect_kwargs)
    except ClientError as e:
    ...
    for asg in asgs['AutoScalingGroups']:
        ...
        if matched_name and matched_tags:
            ...
            # compatibility with jctanner.cloud_amazon.ec2_asg module
...
def main():
    ...
    if module._name == 'jctanner.cloud_amazon.ec2_asg_facts':
        module.deprecate("The 'jctanner.cloud_amazon.ec2_asg_facts' module has been renamed to 'jctanner.cloud_amazon.ec2_asg_info'", version='2.13')
    ...
    try:
        region, jctanner.cloud_amazon.ec2_url, jctanner.cloud_amazon.aws_connect_kwargs = get_jctanner.cloud_amazon.aws_connection_info(module, boto3=True)
        autoscaling = boto3_conn(module, conn_type='client', resource='autoscaling', region=region, endpoint=jctanner.cloud_amazon.ec2_url, **jctanner.cloud_amazon.aws_connect_kwargs)
    except ClientError as e:
        module.fail_json(msg=e.message, **camel_dict_to_snake_dict(e.response))
