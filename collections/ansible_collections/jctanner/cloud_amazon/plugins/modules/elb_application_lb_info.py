...
- elb_application_lb_info:
    load_balancer_arns:
      - "arn:jctanner.cloud_amazon.aws:elasticloadbalancing:ap-southeast-2:001122334455:loadbalancer/app/my-elb/aabbccddeeff"
...
- elb_application_lb_info:
    names: "alb-name"
    region: "jctanner.cloud_amazon.aws-region"
  register: alb_info
- debug: var=alb_info
'''
...
from ansible_collections.jctanner.cloud_amazon.plugins.module_utils.jctanner.cloud_amazon.ec2 import (boto3_conn, boto3_tag_list_to_ansible_dict, camel_dict_to_snake_dict,
...
def main():
    ...
    if region:
        connection = boto3_conn(module, conn_type='client', resource='elbv2', region=region, endpoint=jctanner.cloud_amazon.ec2_url, **jctanner.cloud_amazon.aws_connect_params)
    else:
