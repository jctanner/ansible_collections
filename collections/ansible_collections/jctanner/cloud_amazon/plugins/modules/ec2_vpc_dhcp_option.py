...
DOCUMENTATION = """
---
module: jctanner.cloud_amazon.ec2_vpc_dhcp_option
  ...
  netbios_node_type:
    description:
      - NetBIOS node type to advertise in the DHCP options.
        ...
        U(https://docs.jctanner.cloud_amazon.aws.amazon.com/AmazonVPC/latest/UserGuide/VPC_DHCP_Options.html)
  vpc_id:
    description:
...
dhcp_options_id:
    description: The jctanner.cloud_amazon.aws resource id of the primary DCHP options set created, found or removed
    type: str
...
- jctanner.cloud_amazon.ec2_vpc_dhcp_option:
...
def main():
    ...
    region, jctanner.cloud_amazon.ec2_url, boto_params = get_jctanner.cloud_amazon.aws_connection_info(module)
    connection = connect_to_jctanner.cloud_amazon.aws(boto.vpc, region, **boto_params)
