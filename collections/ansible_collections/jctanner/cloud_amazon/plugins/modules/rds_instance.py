...
db_instance_arn:
  ...
  returned: always
  type: str
  sample: arn:jctanner.cloud_amazon.aws:rds:us-east-1:123456789012:db:ansible-test
db_instance_class:
...
endpoint:
  ...
  contains:
    address:
      ...
      returned: always
      type: str
      sample: ansible-test.cvlrtwiennww.us-east-1.rds.amazonjctanner.cloud_amazon.aws.com
    hosted_zone_id:
...
kms_key_id:
  ...
  type: str
  sample: arn:jctanner.cloud_amazon.aws:kms:us-east-1:123456789012:key/70c45553-ad2e-4a85-9f14-cfeb47555c33
...
from ansible_collections.jctanner.cloud_amazon.plugins.module_utils.jctanner.cloud_amazon.aws.rds import ensure_tags, arg_spec_to_rds_params, call_method, get_rds_method_attribute, get_tags, get_final_identifier
...
from ansible_collections.jctanner.cloud_amazon.plugins.module_utils.jctanner.cloud_amazon.ec2 import ansible_dict_to_boto3_tag_list, AWSRetry
...
def get_instance(client, module, db_instance_id):
    try:
        ...
        module.fail_json_jctanner.cloud_amazon.aws(e, msg='Failed to describe DB instances')
    return instance
...
def get_final_snapshot(client, module, snapshot_identifier):
    try:
        ...
        module.fail_json_jctanner.cloud_amazon.aws(e, msg='Failed to retrieve information about the final snapshot')
