...
DOCUMENTATION = '''
---
module: jctanner.cloud_amazon.ec2_group_info
short_description: Gather information about jctanner.cloud_amazon.ec2 security groups in AWS.
description:
    - Gather information about jctanner.cloud_amazon.ec2 security groups in AWS.
    - This module was called C(jctanner.cloud_amazon.ec2_group_facts) before Ansible 2.9. The usage did not change.
version_added: "2.3"
requirements: [ boto3 ]
author:
...
options:
  filters:
    description:
      ...
      U(https://docs.jctanner.cloud_amazon.aws.amazon.com/AWSEC2/latest/APIReference/API_DescribeSecurityGroups.html) for \
...
- jctanner.cloud_amazon.ec2_group_info:
...
from ansible_collections.jctanner.cloud_amazon.plugins.module_utils.jctanner.cloud_amazon.ec2 import (jctanner.cloud_amazon.ec2_argument_spec, boto3_conn, HAS_BOTO3, get_jctanner.cloud_amazon.aws_connection_info,
...
def main():
    ...
    if module._name == 'jctanner.cloud_amazon.ec2_group_facts':
        module.deprecate("The 'jctanner.cloud_amazon.ec2_group_facts' module has been renamed to 'jctanner.cloud_amazon.ec2_group_info'", version='2.13')
