...
options:
  function_name:
    description:
      ...
      - "function (for example, arn:jctanner.cloud_amazon.aws:lambda:us-west-2:account-id:function:ThumbNail ). AWS Lambda also allows you to"
  ...
  principal:
    description:
      -  "The principal who is getting this permission. It can be Amazon S3 service Principal (s3.amazonjctanner.cloud_amazon.aws.com ) if
         you want Amazon S3 to invoke the function, an AWS account ID if you are granting cross-account permission, or
         any valid AWS service principal such as sns.amazonjctanner.cloud_amazon.aws.com . For example, you might want to allow a custom
...
- hosts: localhost
  ...
  - name: Lambda S3 event notification
    lambda_policy:
      ...
      principal: s3.amazonjctanner.cloud_amazon.aws.com
      source_arn: arn:jctanner.cloud_amazon.aws:s3:eu-central-1:123456789012:bucketName
...
from ansible_collections.jctanner.cloud_amazon.plugins.module_utils.jctanner.cloud_amazon.ec2 import get_jctanner.cloud_amazon.aws_connection_info, boto3_conn
...
def get_policy_statement(module, client):
    ...
    try:
        ...
        try:
            ...
            pass
        module.fail_json_jctanner.cloud_amazon.aws(e, msg="retrieving function policy")
...
def add_policy_permission(module, client):
    ...
    if not module.check_mode:
        try:
            ...
            module.fail_json_jctanner.cloud_amazon.aws(e, msg="adding permission to policy")
        changed = True
...
def remove_policy_permission(module, client):
    ...
    try:
        ...
        module.fail_json_jctanner.cloud_amazon.aws(e, msg="removing permission from policy")
...
def setup_client(module):
    ...
    if region:
        connection = boto3_conn(module, conn_type='client', resource='lambda', region=region, endpoint=jctanner.cloud_amazon.ec2_url, **jctanner.cloud_amazon.aws_connect_params)
    else:
