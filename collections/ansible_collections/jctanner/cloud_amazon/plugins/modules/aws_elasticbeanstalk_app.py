...
DOCUMENTATION = '''
---
module: jctanner.cloud_amazon.aws_elasticbeanstalk_app
...
def list_apps(ebs, app_name, module):
    try:
        ...
        module.fail_json_jctanner.cloud_amazon.aws(e, msg="Could not describe application")
    ...
    if state == 'present':
        if app is None:
            try:
                ...
                module.fail_json_jctanner.cloud_amazon.aws(e, msg="Could not create application")
            ...
            if app.get("Description", None) != description:
                try:
                    ...
                    module.fail_json_jctanner.cloud_amazon.aws(e, msg="Could not update application")
        ...
        if app is None:
            ...
            try:
                ...
                module.fail_json_jctanner.cloud_amazon.aws(e, msg="Cannot terminate app")
