...
services:
    ...
    contains:
        ...
        runningCount:
            ...
            type: int
        serviceArn:
            description: The Amazon Resource Name (ARN) that identifies the service. The ARN contains the arn:jctanner.cloud_amazon.aws:ecs namespace, followed by the region of the service, the AWS account ID of the service owner, the service namespace, and then the service name. For example, arn:jctanner.cloud_amazon.aws:ecs:region :012345678910 :service/my-service .
            returned: always
            type: str
        serviceName:
...
from ansible_collections.jctanner.cloud_amazon.plugins.module_utils.jctanner.cloud_amazon.ec2 import jctanner.cloud_amazon.ec2_argument_spec, AWSRetry
...
class EcsServiceManager:
    ...
    def list_services_with_backoff(self, **kwargs):
        ...
        try:
            ...
            if e.response['Error']['Code'] == 'ClusterNotFoundException':
                self.module.fail_json_jctanner.cloud_amazon.aws(e, "Could not find cluster to list services")
            else:
                raise
    ...
    def list_services(self, cluster):
        ...
        try:
            ...
            self.module.fail_json_jctanner.cloud_amazon.aws(e, msg="Couldn't list ECS services")
    ...
    def describe_services(self, cluster, services):
        ...
        try:
            ...
            self.module.fail_json_jctanner.cloud_amazon.aws(e, msg="Couldn't describe ECS services")
