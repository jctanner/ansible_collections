...
nameservers:
  ...
  type: list
  sample:
  - ns-1036.jctanner.cloud_amazon.awsdns-00.org.
  - ns-516.jctanner.cloud_amazon.awsdns-00.net.
  - ns-1504.jctanner.cloud_amazon.awsdns-00.co.uk.
  - ns-1.jctanner.cloud_amazon.awsdns-00.com.
set:
...
def main():
    ...
    try:
        conn = Route53Connection(**jctanner.cloud_amazon.aws_connect_kwargs)
    except boto.exception.BotoServerError as e:
