...
options:
    ...
    region:
       description:
          - jctanner.cloud_amazon.aws region, should be read from the running jctanner.cloud_amazon.aws config
    jctanner.cloud_amazon.ec2_region:
       description:
          - alias for region
    jctanner.cloud_amazon.aws_region:
       description:
          - alias for region
author:
...
from ansible_collections.jctanner.cloud_amazon.plugins.module_utils.jctanner.cloud_amazon.ec2 import boto3_conn, HAS_BOTO3, \
    camel_dict_to_snake_dict, get_jctanner.cloud_amazon.aws_connection_info, AWSRetry
try:
    import botocore
except ImportError:
...
def get_dms_client(jctanner.cloud_amazon.aws_connect_params, client_region, jctanner.cloud_amazon.ec2_url):
    client_params = dict(
        module=module,
        conn_type='client',
        resource='dms',
...
def create_dms_endpoint(connection):
    ...
    :param connection: boto3 jctanner.cloud_amazon.aws connection
...
def main():
    ...
    jctanner.cloud_amazon.aws_config_region, jctanner.cloud_amazon.ec2_url, jctanner.cloud_amazon.aws_connect_params = \
        get_jctanner.cloud_amazon.aws_connection_info(module, boto3=True)
    dmsclient = get_dms_client(jctanner.cloud_amazon.aws_connect_params, jctanner.cloud_amazon.aws_config_region, jctanner.cloud_amazon.ec2_url)
