...
try:
    import botocore
    from ansible_collections.jctanner.cloud_amazon.plugins.module_utils.jctanner.cloud_amazon.ec2 import ansible_dict_to_boto3_tag_list, boto3_conn
    HAS_BOTO3 = True
except ImportError:
    HAS_BOTO3 = False
...
def main():
    ...
    try:
        connection = connect_to_jctanner.cloud_amazon.aws(boto.dynamodb2, region, **jctanner.cloud_amazon.aws_connect_params)
    ...
    if module.params.get('tags'):
        try:
            ...
            boto3_dynamodb = boto3_conn(module, conn_type='client', resource='dynamodb', region=region, endpoint=jctanner.cloud_amazon.ec2_url, **jctanner.cloud_amazon.aws_connect_kwargs)
            ...
            boto3_sts = boto3_conn(module, conn_type='client', resource='sts', region=region, endpoint=jctanner.cloud_amazon.ec2_url, **jctanner.cloud_amazon.aws_connect_kwargs)
