...
DOCUMENTATION = '''
---
module: jctanner.cloud_amazon.ec2_vpc_vgw_info
short_description: Gather information about virtual gateways in AWS
description:
    - Gather information about virtual gateways in AWS.
    - This module was called C(jctanner.cloud_amazon.ec2_vpc_vgw_facts) before Ansible 2.9. The usage did not change.
version_added: "2.3"
requirements: [ boto3 ]
options:
  filters:
...
- name: Gather information about all virtual gateways for an account or profile
  jctanner.cloud_amazon.ec2_vpc_vgw_info:
...
def main():
    ...
    if module._name == 'jctanner.cloud_amazon.ec2_vpc_vgw_facts':
        module.deprecate("The 'jctanner.cloud_amazon.ec2_vpc_vgw_facts' module has been renamed to 'jctanner.cloud_amazon.ec2_vpc_vgw_info'", version='2.13')
