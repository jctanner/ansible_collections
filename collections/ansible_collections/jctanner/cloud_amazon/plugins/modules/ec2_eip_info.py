...
DOCUMENTATION = '''
---
module: jctanner.cloud_amazon.ec2_eip_info
short_description: List EC2 EIP details
description:
    - List details of EC2 Elastic IP addresses.
    - This module was called C(jctanner.cloud_amazon.ec2_eip_facts) before Ansible 2.9. The usage did not change.
version_added: "2.6"
  ...
  filters:
    description:
      - A dict of filters to apply. Each dict item consists of a filter key and filter
        value.  See U(https://docs.jctanner.cloud_amazon.aws.amazon.com/cli/latest/reference/jctanner.cloud_amazon.ec2/describe-addresses.html#options)
...
- jctanner.cloud_amazon.ec2_eip_info:
...
def main():
    ...
    if module._module._name == 'jctanner.cloud_amazon.ec2_eip_facts':
        module._module.deprecate("The 'jctanner.cloud_amazon.ec2_eip_facts' module has been renamed to 'jctanner.cloud_amazon.ec2_eip_info'", version='2.13')
