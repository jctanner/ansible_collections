...
DOCUMENTATION = '''
module: jctanner.cloud_amazon.ec2_vpc_vgw
...
- name: Create a new vgw attached to a specific VPC
  jctanner.cloud_amazon.ec2_vpc_vgw:
    state: present
...
from ansible_collections.jctanner.cloud_amazon.plugins.module_utils.jctanner.cloud_amazon.aws.core import is_boto3_error_code
...
from ansible_collections.jctanner.cloud_amazon.plugins.module_utils.jctanner.cloud_amazon.ec2 import HAS_BOTO3, boto3_conn, jctanner.cloud_amazon.ec2_argument_spec, get_jctanner.cloud_amazon.aws_connection_info, AWSRetry
