  ...
  filters:
    description:
      - A filter that specifies one or more DB instances to describe.
        See U(https://docs.jctanner.cloud_amazon.aws.amazon.com/AmazonRDS/latest/APIReference/API_DescribeDBInstances.html)
requirements:
    - "python >= 2.7"
    - "boto3"
author:
...
instances:
  ...
  contains:
    ...
    db_instance_arn:
      ...
      returned: always
      type: str
      sample: arn:jctanner.cloud_amazon.aws:rds:us-west-2:111111111111:db:helloworld-rds
    db_instance_class:
    ...
    endpoint:
      ...
      contains:
        address:
          ...
          returned: always
          type: str
          sample: helloworld-rds.ctrqpe3so1sf.us-west-2.rds.amazonjctanner.cloud_amazon.aws.com
        hosted_zone_id:
    ...
    kms_key_id:
      ...
      returned: always
      type: str
      sample: arn:jctanner.cloud_amazon.aws:kms:us-west-2:111111111111:key/abcd1234-0000-abcd-1111-0123456789ab
...
from ansible_collections.jctanner.cloud_amazon.plugins.module_utils.jctanner.cloud_amazon.ec2 import ansible_dict_to_boto3_filter_list, boto3_tag_list_to_ansible_dict, AWSRetry, camel_dict_to_snake_dict
...
def instance_info(module, conn):
    ...
    try:
        ...
        module.fail_json_jctanner.cloud_amazon.aws(e, "Couldn't get instance information")
    ...
    for instance in results:
        try:
            ...
            module.fail_json_jctanner.cloud_amazon.aws(e, "Couldn't get tags for instance %s" % instance['DBInstanceIdentifier'])
