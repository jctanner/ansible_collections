...
DOCUMENTATION = '''
---
module: jctanner.cloud_amazon.ec2_vpc_dhcp_option_info
short_description: Gather information about dhcp options sets in AWS
description:
    - Gather information about dhcp options sets in AWS
    - This module was called C(jctanner.cloud_amazon.ec2_vpc_dhcp_option_facts) before Ansible 2.9. The usage did not change.
version_added: "2.2"
requirements: [ boto3 ]
  ...
  filters:
    description:
      - A dict of filters to apply. Each dict item consists of a filter key and a filter value.
        See U(https://docs.jctanner.cloud_amazon.aws.amazon.com/AWSEC2/latest/APIReference/API_DescribeDhcpOptions.html) for possible filters.
  dhcp_options_ids:
    description:
...
- name: Gather information about all DHCP Option sets for an account or profile
  jctanner.cloud_amazon.ec2_vpc_dhcp_option_info:
...
from ansible_collections.jctanner.cloud_amazon.plugins.module_utils.jctanner.cloud_amazon.ec2 import (jctanner.cloud_amazon.ec2_argument_spec, boto3_conn, HAS_BOTO3,
                                      ansible_dict_to_boto3_filter_list, get_jctanner.cloud_amazon.aws_connection_info,
...
def main():
    ...
    if module._name == 'jctanner.cloud_amazon.ec2_vpc_dhcp_option_facts':
        module.deprecate("The 'jctanner.cloud_amazon.ec2_vpc_dhcp_option_facts' module has been renamed to 'jctanner.cloud_amazon.ec2_vpc_dhcp_option_info'", version='2.13')
