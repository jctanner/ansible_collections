  ...
  sample:
    elbs:
      - attributes:
        ...
        canonical_hosted_zone_name: test-lb-XXXXXXXXXXXX.us-east-1.elb.amazonjctanner.cloud_amazon.aws.com
        canonical_hosted_zone_name_id: XXXXXXXXXXXXXX
        created_time: 2017-08-23T18:25:03.280000+00:00
        dns_name: test-lb-XXXXXXXXXXXX.us-east-1.elb.amazonjctanner.cloud_amazon.aws.com
        health_check:
...
def main():
    ...
    connection = boto3_conn(module, conn_type='client', resource='elb', region=region, endpoint=jctanner.cloud_amazon.ec2_url, **jctanner.cloud_amazon.aws_connect_params)

    try:
        elbs = list_elbs(connection, module.params.get('names'))
    except (botocore.exceptions.ClientError, botocore.exceptions.BotoCoreError) as e:
        module.fail_json_jctanner.cloud_amazon.aws(e, msg="Failed to get load balancer information.")
