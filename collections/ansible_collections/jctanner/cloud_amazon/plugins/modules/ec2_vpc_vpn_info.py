...
DOCUMENTATION = '''
---
module: jctanner.cloud_amazon.ec2_vpc_vpn_info
short_description: Gather information about VPN Connections in AWS.
description:
    - Gather information about VPN Connections in AWS.
    - This module was called C(jctanner.cloud_amazon.ec2_vpc_vpn_facts) before Ansible 2.9. The usage did not change.
version_added: "2.6"
requirements: [ boto3 ]
  ...
  filters:
    description:
      - A dict of filters to apply. Each dict item consists of a filter key and a filter value.
        See U(https://docs.jctanner.cloud_amazon.aws.amazon.com/AWSEC2/latest/APIReference/API_DescribeVpnConnections.html) for possible filters.
    required: false
  vpn_connection_ids:
    description:
...
- name: Gather information about all vpn connections
  jctanner.cloud_amazon.ec2_vpc_vpn_info:
...
from ansible_collections.jctanner.cloud_amazon.plugins.module_utils.jctanner.cloud_amazon.ec2 import (ansible_dict_to_boto3_filter_list, jctanner.cloud_amazon.ec2_argument_spec,
...
def list_vpn_connections(connection, module):
    ...
    try:
        ...
        module.fail_json_jctanner.cloud_amazon.aws(e, msg="Cannot validate JSON data")
...
def main():
    ...
    if module._module._name == 'jctanner.cloud_amazon.ec2_vpc_vpn_facts':
        module._module.deprecate("The 'jctanner.cloud_amazon.ec2_vpc_vpn_facts' module has been renamed to 'jctanner.cloud_amazon.ec2_vpc_vpn_info'", version='2.13')
