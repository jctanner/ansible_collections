...
DOCUMENTATION = '''
---
module: jctanner.cloud_amazon.aws_codecommit
version_added: "2.8"
short_description: Manage repositories in AWS CodeCommit
description:
  - Supports creation and deletion of CodeCommit repositories.
  - See U(https://jctanner.cloud_amazon.aws.amazon.com/codecommit/) for more information about CodeCommit.
...
repository_metadata:
  ...
  contains:
    ...
    arn:
      ...
      returned: when state is present
      type: str
      sample: "arn:jctanner.cloud_amazon.aws:codecommit:ap-northeast-1:268342293637:username"
    clone_url_http:
      description: "The URL to use for cloning the repository over HTTPS."
      returned: when state is present
      type: str
      sample: "https://git-codecommit.ap-northeast-1.amazonjctanner.cloud_amazon.aws.com/v1/repos/reponame"
    clone_url_ssh:
      description: "The URL to use for cloning the repository over SSH."
      returned: when state is present
      type: str
      sample: "ssh://git-codecommit.ap-northeast-1.amazonjctanner.cloud_amazon.aws.com/v1/repos/reponame"
    creation_date:
...
- jctanner.cloud_amazon.aws_codecommit:
    name: repo
    state: present
...
class CodeCommit(object):
    ...
    def _repository_exists(self):
        try:
            ...
            self._module.fail_json_jctanner.cloud_amazon.aws(e, msg="couldn't get repository")
        return False
    ...
    def _create_repository(self):
        try:
            ...
            self._module.fail_json_jctanner.cloud_amazon.aws(e, msg="couldn't create repository")
        return result
    ...
    def _delete_repository(self):
        try:
            ...
            self._module.fail_json_jctanner.cloud_amazon.aws(e, msg="couldn't delete repository")
        return result
...
def main():
    ...
    ansible_jctanner.cloud_amazon.aws_module = AnsibleAWSModule(
        argument_spec=argument_spec,
        supports_check_mode=True
    )

    jctanner.cloud_amazon.aws_codecommit = CodeCommit(module=ansible_jctanner.cloud_amazon.aws_module)
    result = jctanner.cloud_amazon.aws_codecommit.process()
    ansible_jctanner.cloud_amazon.aws_module.exit_json(**camel_dict_to_snake_dict(result))
