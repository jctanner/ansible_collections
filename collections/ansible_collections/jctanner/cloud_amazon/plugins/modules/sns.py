...
def arn_topic_lookup(module, client, short_topic):
    ...
    try:
        ...
        module.fail_json_jctanner.cloud_amazon.aws(e, msg='Failed to look up topic ARN')
...
def main():
    ...
    try:
        ...
        module.fail_json_jctanner.cloud_amazon.aws(e, msg='Failed to publish message')
