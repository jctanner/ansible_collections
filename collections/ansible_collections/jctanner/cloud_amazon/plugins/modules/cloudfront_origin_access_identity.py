...
from ansible_collections.jctanner.cloud_amazon.plugins.module_utils.jctanner.cloud_amazon.ec2 import get_jctanner.cloud_amazon.aws_connection_info, jctanner.cloud_amazon.ec2_argument_spec
from ansible_collections.jctanner.cloud_amazon.plugins.module_utils.jctanner.cloud_amazon.ec2 import boto3_conn
...
class CloudFrontOriginAccessIdentityServiceManager(object):
    """
    Handles cloudfront origin access identity service calls to jctanner.cloud_amazon.aws
    """
    ...
    def create_client(self, resource):
        try:
            ...
            self.module.fail_json_jctanner.cloud_amazon.aws(e, msg="Unable to establish connection.")
    ...
    def create_origin_access_identity(self, caller_reference, comment):
        try:
            ...
            self.module.fail_json_jctanner.cloud_amazon.aws(e, msg="Error creating cloud front origin access identity.")
    ...
    def delete_origin_access_identity(self, origin_access_identity_id, e_tag):
        try:
            ...
            self.module.fail_json_jctanner.cloud_amazon.aws(e, msg="Error updating Origin Access Identity.")
    ...
    def update_origin_access_identity(self, caller_reference, comment, origin_access_identity_id, e_tag):
        ...
        try:
            ...
            self.module.fail_json_jctanner.cloud_amazon.aws(e, msg="Error getting Origin Access Identity config.")
...
class CloudFrontOriginAccessIdentityValidationManager(object):
    ...
    def validate_etag_from_origin_access_identity_id(self, origin_access_identity_id):
        try:
            ...
            self.module.fail_json_jctanner.cloud_amazon.aws(e, msg="Error getting etag from origin_access_identity.")
    ...
    def validate_origin_access_identity_id_from_caller_reference(
        ...
        try:
            ...
            self.module.fail_json_jctanner.cloud_amazon.aws(e, msg="Error getting Origin Access Identity from caller_reference.")
