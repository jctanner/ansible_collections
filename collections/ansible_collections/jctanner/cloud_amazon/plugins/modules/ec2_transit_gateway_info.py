...
DOCUMENTATION = '''
module: jctanner.cloud_amazon.ec2_transit_gateway_info
short_description: Gather information about jctanner.cloud_amazon.ec2 transit gateways in AWS
description:
    - Gather information about jctanner.cloud_amazon.ec2 transit gateways in AWS
version_added: "2.8"
  ...
  filters:
    description:
      - A dict of filters to apply. Each dict item consists of a filter key and a filter value.
        See U(https://docs.jctanner.cloud_amazon.aws.amazon.com/AWSEC2/latest/APIReference/API_DescribeTransitGateways.html) for filters.
    type: dict
...
- jctanner.cloud_amazon.ec2_transit_gateway_info:
...
transit_gateways:
    ...
    contains:
        ...
        transit_gateway_arn:
            ...
            returned: always
            type: str
            sample: "arn:jctanner.cloud_amazon.aws:jctanner.cloud_amazon.ec2:us-west-2:1234567654323:transit-gateway/tgw-02c42332e6b7da829"
        transit_gateway_id:
...
class AnsibleEc2TgwInfo(object):
    ...
    def __init__(self, module, results):
        ...
        self._connection = self._module.client('jctanner.cloud_amazon.ec2')
