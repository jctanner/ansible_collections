...
DOCUMENTATION = '''
---
module: jctanner.cloud_amazon.ec2_placement_group
...
description:
    - Create an EC2 Placement Group; if the placement group already exists,
      ...
      U(https://docs.jctanner.cloud_amazon.aws.amazon.com/AWSEC2/latest/UserGuide/placement-groups.html)
version_added: "2.5"
...
- jctanner.cloud_amazon.ec2_placement_group:
    name: my-cluster
    state: present
