...
elasticache_clusters:
  ...
  contains:
        ...
        endpoint:
          ...
          contains:
            address:
              ...
              returned: always
              type: str
              sample: abcd-1234-001.bgiz2p.0001.apse2.cache.amazonjctanner.cloud_amazon.aws.com
            port:
    ...
    client_download_landing_page:
      ...
      returned: always
      type: str
      sample: 'https://console.jctanner.cloud_amazon.aws.amazon.com/elasticache/home#client-download:'
    engine:
    ...
    notification_configuration:
      ...
      contains:
        topic_arn:
          ...
          returned: if notifications are enabled
          type: str
          sample: arn:jctanner.cloud_amazon.aws:sns:*:123456789012:my_topic
        topic_name:
...
def get_jctanner.cloud_amazon.aws_account_id(module):
    try:
        ...
        module.fail_json_jctanner.cloud_amazon.aws(e, msg="Can't authorize connection")

    try:
        return client.get_caller_identity()['Account']
    except (botocore.exceptions.ClientError, botocore.exceptions.BotoCoreError) as e:
        module.fail_json_jctanner.cloud_amazon.aws(e, msg="Couldn't obtain AWS account id")
