...
short_description: create, update and delete jctanner.cloud_amazon.aws cloudfront distributions.
...
options:
    ...
    price_class:
      description:
        - A string that specifies the pricing class of the distribution. As per
          U(https://jctanner.cloud_amazon.aws.amazon.com/cloudfront/pricing/)
      ...
      default: jctanner.cloud_amazon.aws defaults this to 'PriceClass_All'
    ...
    http_version:
      ...
      default: jctanner.cloud_amazon.aws defaults this to 'http2'
...
- cloudfront_distribution:
    ...
    logging:
      ...
      bucket: mylogbucket.s3.amazonjctanner.cloud_amazon.aws.com
      prefix: myprefix/
    enabled: false
...
arn:
  ...
  returned: always
  type: str
  sample: arn:jctanner.cloud_amazon.aws:cloudfront::123456789012:distribution/E1234ABCDEFGHI
cache_behaviors:
        ...
        lambda_function_associations:
          ...
          contains:
            ...
            items:
              ...
              type: list
              sample:
              - lambda_function_arn: arn:jctanner.cloud_amazon.aws:lambda:123456789012:us-east-1/lambda/lambda-function
...
logging:
  ...
  contains:
    bucket:
      ...
      returned: always
      type: str
      sample: logs-example-com.s3.amazonjctanner.cloud_amazon.aws.com
    enabled:
...
viewer_certificate:
  ...
  contains:
    acm_certificate_arn:
      ...
      type: str
      sample: arn:jctanner.cloud_amazon.aws:acm:us-east-1:123456789012:certificate/abcd1234-1234-1234-abcd-123456abcdef
    certificate:
...
from ansible_collections.jctanner.cloud_amazon.plugins.module_utils.jctanner.cloud_amazon.aws.cloudfront_facts import CloudFrontFactsServiceManager
from ansible.module_utils.common.dict_transformations import recursive_diff
from ansible_collections.jctanner.cloud_amazon.plugins.module_utils.jctanner.cloud_amazon.ec2 import get_jctanner.cloud_amazon.aws_connection_info
from ansible_collections.jctanner.cloud_amazon.plugins.module_utils.jctanner.cloud_amazon.ec2 import jctanner.cloud_amazon.ec2_argument_spec, boto3_conn, compare_jctanner.cloud_amazon.aws_tags
from ansible_collections.jctanner.cloud_amazon.plugins.module_utils.jctanner.cloud_amazon.ec2 import camel_dict_to_snake_dict, ansible_dict_to_boto3_tag_list
from ansible_collections.jctanner.cloud_amazon.plugins.module_utils.jctanner.cloud_amazon.ec2 import snake_dict_to_camel_dict, boto3_tag_list_to_ansible_dict
import datetime
...
def create_distribution(client, module, config, tags):
    try:
        ...
        module.fail_json_jctanner.cloud_amazon.aws(e, msg="Error creating distribution")
...
def delete_distribution(client, module, distribution):
    try:
        ...
        module.fail_json_jctanner.cloud_amazon.aws(e, msg="Error deleting distribution %s" % to_native(distribution['Distribution']))
...
def update_distribution(client, module, config, distribution_id, e_tag):
    try:
        ...
        module.fail_json_jctanner.cloud_amazon.aws(e, msg="Error updating distribution to %s" % to_native(config))
...
def tag_resource(client, module, arn, tags):
    try:
        ...
        module.fail_json_jctanner.cloud_amazon.aws(e, msg="Error tagging resource")
...
def untag_resource(client, module, arn, tag_keys):
    try:
        ...
        module.fail_json_jctanner.cloud_amazon.aws(e, msg="Error untagging resource")
...
def list_tags_for_resource(client, module, arn):
    try:
        ...
        module.fail_json_jctanner.cloud_amazon.aws(e, msg="Error listing tags for resource")


def update_tags(client, module, existing_tags, valid_tags, purge_tags, arn):
    changed = False
    to_add, to_remove = compare_jctanner.cloud_amazon.aws_tags(existing_tags, valid_tags, purge_tags)
    if to_remove:
...
class CloudFrontValidationManager(object):
    ...
    def __init__(self, module):
        ...
        self.__s3_bucket_domain_identifier = '.s3.amazonjctanner.cloud_amazon.aws.com'
    ...
    def add_key_else_validate(self, dict_object, key_name, attribute_name, value_to_set, valid_values, to_jctanner.cloud_amazon.aws_list=False):
        if key_name in dict_object:
            self.validate_attribute_with_allowed_values(value_to_set, attribute_name, valid_values)
        else:
            if to_jctanner.cloud_amazon.aws_list:
    ...
    def validate_logging(self, logging):
        try:
            ...
            self.module.fail_json_jctanner.cloud_amazon.aws(e, msg="Error validating distribution logging")
    ...
    def validate_origins(self, client, config, origins, default_origin_domain_name,
        ...
        try:
            ...
            self.module.fail_json_jctanner.cloud_amazon.aws(e, msg="Error validating distribution origins")
    ...
    def validate_s3_origin_configuration(self, client, existing_config, origin):
        ...
        try:
            ...
            self.module.fail_json_jctanner.cloud_amazon.aws(e, msg="Couldn't create Origin Access Identity for id %s" % origin['id'])
    ...
    def validate_origin(self, client, existing_config, origin, default_origin_path):
        try:
            ...
            self.module.fail_json_jctanner.cloud_amazon.aws(e, msg="Error validating distribution origin")
    ...
    def validate_cache_behaviors(self, config, cache_behaviors, valid_origins, purge_cache_behaviors=False):
        try:
            ...
            self.module.fail_json_jctanner.cloud_amazon.aws(e, msg="Error validating distribution cache behaviors")
    ...
    def validate_cache_behavior_first_level_keys(self, config, cache_behavior, valid_origins, is_default_cache):
        try:
            ...
            self.module.fail_json_jctanner.cloud_amazon.aws(e, msg="Error validating distribution cache behavior first level keys")
    ...
    def validate_forwarded_values(self, config, forwarded_values, cache_behavior):
        try:
            ...
            self.module.fail_json_jctanner.cloud_amazon.aws(e, msg="Error validating forwarded values")
    ...
    def validate_lambda_function_associations(self, config, lambda_function_associations, cache_behavior):
        try:
            ...
            self.module.fail_json_jctanner.cloud_amazon.aws(e, msg="Error validating lambda function associations")
    ...
    def validate_allowed_methods(self, config, allowed_methods, cache_behavior):
        try:
            ...
            self.module.fail_json_jctanner.cloud_amazon.aws(e, msg="Error validating allowed methods")
    ...
    def validate_trusted_signers(self, config, trusted_signers, cache_behavior):
        try:
            ...
            self.module.fail_json_jctanner.cloud_amazon.aws(e, msg="Error validating trusted signers")
    ...
    def validate_viewer_certificate(self, viewer_certificate):
        try:
            ...
            self.module.fail_json_jctanner.cloud_amazon.aws(e, msg="Error validating viewer certificate")
    ...
    def validate_custom_error_responses(self, config, custom_error_responses, purge_custom_error_responses):
        try:
            ...
            self.module.fail_json_jctanner.cloud_amazon.aws(e, msg="Error validating custom error responses")
    ...
    def validate_restrictions(self, config, restrictions, purge_restrictions=False):
        try:
            ...
            self.module.fail_json_jctanner.cloud_amazon.aws(e, msg="Error validating restrictions")
    ...
    def validate_distribution_config_parameters(self, config, default_root_object, ipv6_enabled, http_version, web_acl_id):
        try:
            ...
            self.module.fail_json_jctanner.cloud_amazon.aws(e, msg="Error validating distribution config parameters")
    ...
    def validate_common_distribution_parameters(self, config, enabled, aliases, logging, price_class, purge_aliases=False):
        try:
            ...
            self.module.fail_json_jctanner.cloud_amazon.aws(e, msg="Error validating common distribution parameters")
    ...
    def get_first_origin_id_for_default_cache_behavior(self, valid_origins):
        try:
            ...
            self.module.fail_json_jctanner.cloud_amazon.aws(e, msg="Error getting first origin_id for default cache behavior")
    ...
    def validate_attribute_list_with_allowed_list(self, attribute_list, attribute_list_name, allowed_list):
        try:
            ...
            self.module.fail_json_jctanner.cloud_amazon.aws(e, msg="Error validating attribute list with allowed value list")
    ...
    def validate_distribution_from_caller_reference(self, caller_reference):
        try:
            ...
            self.module.fail_json_jctanner.cloud_amazon.aws(e, msg="Error validating distribution from caller reference")
    ...
    def validate_distribution_from_aliases_caller_reference(self, distribution_id, aliases, caller_reference):
        try:
            ...
            self.module.fail_json_jctanner.cloud_amazon.aws(e, msg="Error validating distribution_id from alias, aliases and caller reference")
    ...
    def wait_until_processed(self, client, wait_timeout, distribution_id, caller_reference):
        ...
        try:
            ...
            self.module.fail_json_jctanner.cloud_amazon.aws(e, msg="Error getting distribution {0}".format(distribution_id))
...
def main():
    ...
    client = boto3_conn(module, conn_type='client', resource='cloudfront', region=region, endpoint=jctanner.cloud_amazon.ec2_url, **jctanner.cloud_amazon.aws_connect_kwargs)
