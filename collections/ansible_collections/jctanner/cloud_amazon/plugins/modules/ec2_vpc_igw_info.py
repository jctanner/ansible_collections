...
DOCUMENTATION = '''
---
module: jctanner.cloud_amazon.ec2_vpc_igw_info
short_description: Gather information about internet gateways in AWS
description:
    - Gather information about internet gateways in AWS.
    - This module was called C(jctanner.cloud_amazon.ec2_vpc_igw_facts) before Ansible 2.9. The usage did not change.
version_added: "2.3"
requirements: [ boto3 ]
  ...
  filters:
    description:
      - A dict of filters to apply. Each dict item consists of a filter key and a filter value.
        See U(https://docs.jctanner.cloud_amazon.aws.amazon.com/AWSEC2/latest/APIReference/API_DescribeInternetGateways.html) for possible filters.
...
- name: Gather information about all Internet Gateways for an account or profile
  jctanner.cloud_amazon.ec2_vpc_igw_info:
...
def main():
    ...
    if module._name == 'jctanner.cloud_amazon.ec2_vpc_igw_facts':
        module.deprecate("The 'jctanner.cloud_amazon.ec2_vpc_igw_facts' module has been renamed to 'jctanner.cloud_amazon.ec2_vpc_igw_info'", version='2.13')
