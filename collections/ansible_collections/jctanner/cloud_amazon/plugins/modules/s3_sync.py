...
options:
  ...
  permission:
    ...
    required: false
    choices: [ '', private, public-read, public-read-write, authenticated-read, jctanner.cloud_amazon.aws-exec-read, bucket-owner-read, bucket-owner-full-control ]
  mime_map:
    description:
    - >
...
from ansible_collections.jctanner.cloud_amazon.plugins.module_utils.jctanner.cloud_amazon.ec2 import camel_dict_to_snake_dict, jctanner.cloud_amazon.ec2_argument_spec, boto3_conn, get_jctanner.cloud_amazon.aws_connection_info, HAS_BOTO3, boto_exception
...
def main():
    ...
    argument_spec.update(dict(
        ...
        permission=dict(required=False, choices=['private', 'public-read', 'public-read-write', 'authenticated-read',
                                                 'jctanner.cloud_amazon.aws-exec-read', 'bucket-owner-read', 'bucket-owner-full-control']),
    ...
    s3 = boto3_conn(module, conn_type='client', resource='s3', region=region, endpoint=jctanner.cloud_amazon.ec2_url, **jctanner.cloud_amazon.aws_connect_kwargs)
