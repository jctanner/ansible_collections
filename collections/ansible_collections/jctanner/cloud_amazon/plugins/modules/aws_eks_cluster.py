...
DOCUMENTATION = '''
---
module: jctanner.cloud_amazon.aws_eks_cluster
...
- name: Create an EKS cluster
  jctanner.cloud_amazon.aws_eks_cluster:
    name: my_cluster
    version: v1.10.0
...
arn:
  ...
  type: str
  sample: arn:jctanner.cloud_amazon.aws:eks:us-west-2:111111111111:cluster/my-eks-cluster
...
endpoint:
  ...
  returned: when the cluster has been created and is active
  type: str
  sample: https://API_SERVER_ENDPOINT.yl4.us-west-2.eks.amazonjctanner.cloud_amazon.aws.com
created_at:
...
role_arn:
  ...
  returned: when state is present
  type: str
  sample: arn:jctanner.cloud_amazon.aws:iam::111111111111:role/jctanner.cloud_amazon.aws_eks_cluster_role
status:
...
from ansible_collections.jctanner.cloud_amazon.plugins.module_utils.jctanner.cloud_amazon.ec2 import camel_dict_to_snake_dict, get_jctanner.cloud_amazon.ec2_security_group_ids_from_names
...
def ensure_present(client, module):
    ...
    try:
        ...
        vpc_id = jctanner.cloud_amazon.ec2.describe_subnets(SubnetIds=[subnets[0]])['Subnets'][0]['VpcId']
        groups = get_jctanner.cloud_amazon.ec2_security_group_ids_from_names(groups, jctanner.cloud_amazon.ec2, vpc_id)
    except (botocore.exceptions.BotoCoreError, botocore.exceptions.ClientError) as e:
        module.fail_json_jctanner.cloud_amazon.aws(e, msg="Couldn't lookup security groups")
    ...
    try:
        ...
        module.fail_json_jctanner.cloud_amazon.aws(e, msg="Couldn't create cluster %s" % name)
...
def ensure_absent(client, module):
    ...
    if not module.check_mode:
        try:
            ...
            module.fail_json_jctanner.cloud_amazon.aws(e, msg="Couldn't delete cluster %s" % name)
    module.exit_json(changed=True)
...
def main():
    ...
    if not module.botocore_at_least("1.10.32"):
        module.fail_json(msg="jctanner.cloud_amazon.aws_eks_cluster module requires botocore >= 1.10.32")
