...
DOCUMENTATION = """
---
module: jctanner.cloud_amazon.ec2_elb_lb
description:
...
EXAMPLES = """
# Note: None of these examples set jctanner.cloud_amazon.aws_access_key, jctanner.cloud_amazon.aws_secret_key, or region.
...
- local_action:
    ...
    listeners:
      ...
      - protocol: https
        ...
        ssl_certificate_id: "arn:jctanner.cloud_amazon.aws:iam::123456789012:server-certificate/company/servercerts/ProdServerCert"
...
try:
    ...
    import boto.jctanner.cloud_amazon.ec2.elb.attributes
    import boto.vpc
    from boto.jctanner.cloud_amazon.ec2.elb.healthcheck import HealthCheck
    from boto.jctanner.cloud_amazon.ec2.tag import Tag
    HAS_BOTO = True
except ImportError:
    HAS_BOTO = False

from ansible.module_utils.basic import AnsibleModule
from ansible_collections.jctanner.cloud_amazon.plugins.module_utils.jctanner.cloud_amazon.ec2 import jctanner.cloud_amazon.ec2_argument_spec, connect_to_jctanner.cloud_amazon.aws, AnsibleAWSError, get_jctanner.cloud_amazon.aws_connection_info
...
def _get_vpc_connection(module, region, jctanner.cloud_amazon.aws_connect_params):
    try:
        return connect_to_jctanner.cloud_amazon.aws(boto.vpc, region, **jctanner.cloud_amazon.aws_connect_params)
...
class ElbManager(object):
    ...
    def __init__(self, module, name, listeners=None, purge_listeners=None,
                 ...
                 region=None,
                 instance_ids=None, purge_instance_ids=None, **jctanner.cloud_amazon.aws_connect_params):
        ...
        self.jctanner.cloud_amazon.ec2_conn = self._get_jctanner.cloud_amazon.ec2_connection()
    ...
    def _wait_for_elb_interface_removed(self):
        ...
        elb_interfaces = self.jctanner.cloud_amazon.ec2_conn.get_all_network_interfaces(
        ...
        for x in range(0, max_retries):
            for interface in elb_interfaces:
                try:
                    result = self.jctanner.cloud_amazon.ec2_conn.get_all_network_interfaces(interface.id)
                    if result == []:
                        status_achieved = True
                        break
                    else:
    ...
    def _get_elb_connection(self):
        try:
            return connect_to_jctanner.cloud_amazon.aws(boto.jctanner.cloud_amazon.ec2.elb, self.region,
                                  **self.jctanner.cloud_amazon.aws_connect_params)
        except (boto.exception.NoAuthHandlerFound, AnsibleAWSError) as e:
            self.module.fail_json(msg=str(e))

    def _get_jctanner.cloud_amazon.ec2_connection(self):
        try:
            return connect_to_jctanner.cloud_amazon.aws(boto.jctanner.cloud_amazon.ec2, self.region,
                                  **self.jctanner.cloud_amazon.aws_connect_params)
    ...
    def _check_attribute_support(self, attr):
        return hasattr(boto.jctanner.cloud_amazon.ec2.elb.attributes.LbAttributes(), attr)
    ...
    def _policy_name(self, policy_type):
        return 'jctanner.cloud_amazon.ec2-elb-lb-{0}'.format(to_native(policy_type, errors='surrogate_or_strict'))
...
def main():
    ...
    if security_group_names:
        ...
        try:
            ...
            if subnets:  # We have at least one subnet, ergo this is a VPC
                vpc_conn = _get_vpc_connection(module=module, region=region, jctanner.cloud_amazon.aws_connect_params=jctanner.cloud_amazon.aws_connect_params)
                vpc_id = vpc_conn.get_all_subnets([subnets[0]])[0].vpc_id
                filters = {'vpc_id': vpc_id}
            else:
                filters = None
            grp_details = jctanner.cloud_amazon.ec2.get_all_security_groups(filters=filters)
    ...
    elb_man = ElbManager(module, name, listeners, purge_listeners, zones,
                         ...
                         **jctanner.cloud_amazon.aws_connect_params)
    ...
    ansible_facts = {'jctanner.cloud_amazon.ec2_elb': 'info'}
    jctanner.cloud_amazon.ec2_facts_result = dict(changed=elb_man.changed,
