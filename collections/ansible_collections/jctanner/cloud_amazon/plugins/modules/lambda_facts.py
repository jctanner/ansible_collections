...
from ansible_collections.jctanner.cloud_amazon.plugins.module_utils.jctanner.cloud_amazon.ec2 import camel_dict_to_snake_dict, get_jctanner.cloud_amazon.aws_connection_info, boto3_conn
import json
import datetime
import sys
import re
    ...
    if function_name:
        ...
        try:
            ...
            if e.response['Error']['Code'] == 'ResourceNotFoundException':
                ...
                module.fail_json_jctanner.cloud_amazon.aws(e, msg="Trying to get aliases")
    else:
    ...
    if function_name:
        try:
            ...
            if e.response['Error']['Code'] == 'ResourceNotFoundException':
                ...
                module.fail_json_jctanner.cloud_amazon.aws(e, msg="Trying to get {0} configuration".format(function_name))
    else:
        params = dict()
        if module.params.get('max_items'):
            params['MaxItems'] = module.params.get('max_items')
        ...
        try:
            ...
            if e.response['Error']['Code'] == 'ResourceNotFoundException':
                ...
                module.fail_json_jctanner.cloud_amazon.aws(e, msg="Trying to get function list")
...
def mapping_details(client, module):
    ...
    try:
        ...
        if e.response['Error']['Code'] == 'ResourceNotFoundException':
            ...
            module.fail_json_jctanner.cloud_amazon.aws(e, msg="Trying to get source event mappings")
    ...
    if function_name:
        try:
            ...
            if e.response['Error']['Code'] == 'ResourceNotFoundException':
                ...
                module.fail_json_jctanner.cloud_amazon.aws(e, msg="Trying to get {0} policy".format(function_name))
    else:
    ...
    if function_name:
        ...
        try:
            ...
            if e.response['Error']['Code'] == 'ResourceNotFoundException':
                ...
                module.fail_json_jctanner.cloud_amazon.aws(e, msg="Trying to get {0} versions".format(function_name))
    else:
...
def main():
    ...
    try:
        region, endpoint, jctanner.cloud_amazon.aws_connect_kwargs = get_jctanner.cloud_amazon.aws_connection_info(module, boto3=True)
        jctanner.cloud_amazon.aws_connect_kwargs.update(dict(region=region,
                                       endpoint=endpoint,
                                       conn_type='client',
                                       resource='lambda'
                                       ))
        client = boto3_conn(module, **jctanner.cloud_amazon.aws_connect_kwargs)
    except ClientError as e:
        module.fail_json_jctanner.cloud_amazon.aws(e, "trying to set up boto connection")
