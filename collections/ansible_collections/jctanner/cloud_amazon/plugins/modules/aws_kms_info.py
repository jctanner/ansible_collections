...
DOCUMENTATION = '''
---
module: jctanner.cloud_amazon.aws_kms_info
short_description: Gather information about AWS KMS keys
description:
    - Gather information about AWS KMS keys including tags and grants
    - This module was called C(jctanner.cloud_amazon.aws_kms_facts) before Ansible 2.9. The usage did not change.
version_added: "2.5"
...
from ansible_collections.jctanner.cloud_amazon.plugins.module_utils.jctanner.cloud_amazon.ec2 import AWSRetry, camel_dict_to_snake_dict, HAS_BOTO3
from ansible_collections.jctanner.cloud_amazon.plugins.module_utils.jctanner.cloud_amazon.ec2 import boto3_tag_list_to_ansible_dict
...
def main():
    ...
    if module._name == 'jctanner.cloud_amazon.aws_kms_facts':
        module.deprecate("The 'jctanner.cloud_amazon.aws_kms_facts' module has been renamed to 'jctanner.cloud_amazon.aws_kms_info'", version='2.13')
    ...
    if region:
        connection = boto3_conn(module, conn_type='client', resource='kms', region=region, endpoint=jctanner.cloud_amazon.ec2_url, **jctanner.cloud_amazon.aws_connect_params)
    else:
