...
DOCUMENTATION = '''
---
module: jctanner.cloud_amazon.ec2_vol_info
short_description: Gather information about jctanner.cloud_amazon.ec2 volumes in AWS
description:
    - Gather information about jctanner.cloud_amazon.ec2 volumes in AWS
    - This module was called C(jctanner.cloud_amazon.ec2_vol_facts) before Ansible 2.9. The usage did not change.
version_added: "2.1"
requirements: [ boto3 ]
  ...
  filters:
    description:
      - A dict of filters to apply. Each dict item consists of a filter key and a filter value.
        See U(https://docs.jctanner.cloud_amazon.aws.amazon.com/AWSEC2/latest/APIReference/API_DescribeVolumes.html) for possible filters.
...
- jctanner.cloud_amazon.ec2_vol_info:
...
from ansible_collections.jctanner.cloud_amazon.plugins.module_utils.jctanner.cloud_amazon.ec2 import jctanner.cloud_amazon.ec2_argument_spec, get_jctanner.cloud_amazon.aws_connection_info, boto3_conn, HAS_BOTO3, boto3_tag_list_to_ansible_dict
from ansible_collections.jctanner.cloud_amazon.plugins.module_utils.jctanner.cloud_amazon.ec2 import ansible_dict_to_boto3_filter_list, camel_dict_to_snake_dict
...
def list_jctanner.cloud_amazon.ec2_volumes(connection, module, region):
...
def main():
    ...
    if module._name == 'jctanner.cloud_amazon.ec2_vol_facts':
        module.deprecate("The 'jctanner.cloud_amazon.ec2_vol_facts' module has been renamed to 'jctanner.cloud_amazon.ec2_vol_info'", version='2.13')
    ...
    list_jctanner.cloud_amazon.ec2_volumes(connection, module, region)
