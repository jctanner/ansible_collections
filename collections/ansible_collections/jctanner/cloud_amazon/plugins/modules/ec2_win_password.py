...
DOCUMENTATION = '''
---
module: jctanner.cloud_amazon.ec2_win_password
short_description: gets the default administrator password for jctanner.cloud_amazon.ec2 windows instances
description:
...
- name: get the Administrator password
  jctanner.cloud_amazon.ec2_win_password:
    profile: my-boto-profile
    instance_id: i-XXXXXX
    region: us-east-1
    key_file: "~/jctanner.cloud_amazon.aws-creds/my_test_key.pem"
...
- name: get the Administrator password
  jctanner.cloud_amazon.ec2_win_password:
    ...
    instance_id: i-XXXXXX
    region: us-east-1
    key_data: "{{ jctanner.cloud_amazon.ec2_private_key }}"
...
- name: get the Administrator password
  jctanner.cloud_amazon.ec2_win_password:
    ...
    instance_id: i-XXXXXX
    region: us-east-1
    key_file: "~/jctanner.cloud_amazon.aws-creds/my_protected_test_key.pem"
...
def main():
    ...
    if wait:
        ...
        while datetime.datetime.now() < end:
            data = jctanner.cloud_amazon.ec2.get_password_data(instance_id)
