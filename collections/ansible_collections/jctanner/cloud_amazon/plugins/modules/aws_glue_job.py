...
DOCUMENTATION = '''
---
module: jctanner.cloud_amazon.aws_glue_job
short_description: Manage an AWS Glue job
description:
    - Manage an AWS Glue job. See U(https://jctanner.cloud_amazon.aws.amazon.com/glue/) for details.
version_added: "2.6"
requirements: [ boto3 ]
...
- jctanner.cloud_amazon.aws_glue_job:
