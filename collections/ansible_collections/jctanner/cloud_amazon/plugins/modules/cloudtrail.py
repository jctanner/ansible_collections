...
options:
  ...
  s3_bucket_name:
    description:
      ...
      - See U(https://docs.jctanner.cloud_amazon.aws.amazon.com/jctanner.cloud_amazon.awscloudtrail/latest/userguide/aggregating_logs_regions_bucket_policy.html).
  ...
  cloudwatch_logs_role_arn:
    description:
      ...
      - See U(https://docs.jctanner.cloud_amazon.aws.amazon.com/jctanner.cloud_amazon.awscloudtrail/latest/userguide/send-cloudtrail-events-to-cloudwatch-logs.html).
  ...
  kms_key_id:
    description:
      ...
      - See U(https://docs.jctanner.cloud_amazon.aws.amazon.com/jctanner.cloud_amazon.awscloudtrail/latest/userguide/encrypting-cloudtrail-log-files-with-jctanner.cloud_amazon.aws-kms.html).
    version_added: "2.4"
  tags:
    description:
...
- name: create multi-region trail with validation and tags
  cloudtrail:
    ...
    cloudwatch_logs_role_arn: "arn:jctanner.cloud_amazon.aws:iam::123456789012:role/CloudTrail_CloudWatchLogs_Role"
    cloudwatch_logs_log_group_arn: "arn:jctanner.cloud_amazon.aws:logs:us-east-1:123456789012:log-group:CloudTrail/DefaultLogGroup:*"
...
- name: show another valid kms_key_id
  cloudtrail:
    ...
    name: default
    s3_bucket_name: mylogbucket
    kms_key_id: "arn:jctanner.cloud_amazon.aws:kms:us-east-1:123456789012:key/12345678-1234-1234-1234-123456789012"
...
trail:
    ...
    contains:
        trail_arn:
            ...
            returned: success
            type: str
            sample: arn:jctanner.cloud_amazon.aws:cloudtrail:us-east-1:123456789012:trail/default
        name:
        ...
        sns_topic_arn:
            ...
            returned: success when present
            type: str
            sample: arn:jctanner.cloud_amazon.aws:sns:us-east-1:123456789012:topic/myTopic
        cloud_watch_logs_log_group_arn:
            description: Full ARN of the CloudWatch Logs log group where events are delivered.
            returned: success when present
            type: str
            sample: arn:jctanner.cloud_amazon.aws:logs:us-east-1:123456789012:log-group:CloudTrail/DefaultLogGroup:*
        cloud_watch_logs_role_arn:
            description: Full ARN of the IAM role that CloudTrail assumes to deliver events.
            returned: success when present
            type: str
            sample: arn:jctanner.cloud_amazon.aws:iam::123456789012:role/CloudTrail_CloudWatchLogs_Role
        kms_key_id:
            description: Full ARN of the KMS Key used to encrypt log files.
            returned: success when present
            type: str
            sample: arn:jctanner.cloud_amazon.aws:kms::123456789012:key/12345678-1234-1234-1234-123456789012
        tags:
...
from ansible_collections.jctanner.cloud_amazon.plugins.module_utils.jctanner.cloud_amazon.ec2 import (boto3_conn, jctanner.cloud_amazon.ec2_argument_spec, get_jctanner.cloud_amazon.aws_connection_info,
...
def main():
    ...
    try:
        ...
        client = boto3_conn(module, conn_type='client', resource='cloudtrail', region=region, endpoint=jctanner.cloud_amazon.ec2_url, **jctanner.cloud_amazon.aws_connect_params)
    except ClientError as err:
        module.fail_json(msg=err.message, exception=traceback.format_exc(), **camel_dict_to_snake_dict(err.response))
    ...
    if state == 'absent' and results['exists']:
        ...
        if module.check_mode:
            ...
            try:
                sts_client = boto3_conn(module, conn_type='client', resource='sts', region=region, endpoint=jctanner.cloud_amazon.ec2_url, **jctanner.cloud_amazon.aws_connect_params)
            ...
            fake_arn = 'arn:jctanner.cloud_amazon.aws:cloudtrail:' + region + ':' + acct_id + ':trail/' + ct_params['Name']
