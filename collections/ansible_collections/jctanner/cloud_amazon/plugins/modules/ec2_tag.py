...
DOCUMENTATION = '''
---
module: jctanner.cloud_amazon.ec2_tag
short_description: create and remove tags on jctanner.cloud_amazon.ec2 resources.
description:
...
- name: Ensure all volumes are tagged
  jctanner.cloud_amazon.ec2_tag:
    ...
    tags:
      Name: dbserver
      Env: production
  loop: '{{ jctanner.cloud_amazon.ec2_vol.volumes }}'
...
- name: Retrieve all tags on an instance
  jctanner.cloud_amazon.ec2_tag:
    ...
    state: list
  register: jctanner.cloud_amazon.ec2_tags
