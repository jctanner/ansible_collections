...
DOCUMENTATION = '''
---
module: jctanner.cloud_amazon.ec2_customer_gateway_info
short_description: Gather information about customer gateways in AWS
description:
    - Gather information about customer gateways in AWS
    - This module was called C(jctanner.cloud_amazon.ec2_customer_gateway_facts) before Ansible 2.9. The usage did not change.
version_added: "2.5"
requirements: [ boto3 ]
  ...
  filters:
    description:
      - A dict of filters to apply. Each dict item consists of a filter key and a filter value.
        See U(https://docs.jctanner.cloud_amazon.aws.amazon.com/AWSEC2/latest/APIReference/API_DescribeCustomerGateways.html) for possible filters.
...
- name: Gather information about all customer gateways
  jctanner.cloud_amazon.ec2_customer_gateway_info:
...
def main():
    ...
    if module._module._name == 'jctanner.cloud_amazon.ec2_customer_gateway_facts':
        module._module.deprecate("The 'jctanner.cloud_amazon.ec2_customer_gateway_facts' module has been renamed to 'jctanner.cloud_amazon.ec2_customer_gateway_info'", version='2.13')
