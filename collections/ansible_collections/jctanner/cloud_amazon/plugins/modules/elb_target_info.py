...
# practical use case - dynamically deregistering and reregistering nodes
  ...
  - name: Get EC2 Metadata
    action: jctanner.cloud_amazon.ec2_metadata_facts

  - name: Get initial list of target groups
    delegate_to: localhost
    elb_target_info:
      instance_id: "{{ ansible_jctanner.cloud_amazon.ec2_instance_id }}"
      region: "{{ ansible_jctanner.cloud_amazon.ec2_placement_region }}"
...
#            rollback is required
  - name: "reregistration commands: ELBv2s"
    debug:
      msg: >
             jctanner.cloud_amazon.aws --region {{ansible_jctanner.cloud_amazon.ec2_placement_region}} elbv2
...
instance_target_groups:
    ...
    contains:
        target_group_arn:
            ...
            returned: always
            sample:
                - "arn:jctanner.cloud_amazon.aws:elasticloadbalancing:eu-west-1:111111111111:targetgroup/target-group/deadbeefdeadbeef"
        target_group_type:
...
try:
    ...
    # we can handle the lack of boto3 based on the jctanner.cloud_amazon.ec2 module
    pass
...
from ansible_collections.jctanner.cloud_amazon.plugins.module_utils.jctanner.cloud_amazon.ec2 import (HAS_BOTO3, camel_dict_to_snake_dict,
                                      AWSRetry)
...
class TargetInfoGatherer(object):
    ...
    def __init__(self, module, instance_id, get_unused_target_groups):
        self.module = module
        try:
            self.jctanner.cloud_amazon.ec2 = self.module.client(
                "jctanner.cloud_amazon.ec2",
                retry_decorator=AWSRetry.jittered_backoff(retries=10)
            )
        except (ClientError, BotoCoreError) as e:
            self.module.fail_json_jctanner.cloud_amazon.aws(e,
                                      msg="Couldn't connect to jctanner.cloud_amazon.ec2"
                                      )
    ...
    def _get_instance_ips(self):
        ...
        try:
            ...
            reservations = self.jctanner.cloud_amazon.ec2.describe_instances(
