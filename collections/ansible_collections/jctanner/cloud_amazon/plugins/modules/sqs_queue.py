...
queue_arn:
    ...
    sample: 'arn:jctanner.cloud_amazon.aws:sqs:us-east-1:199999999999:queuename-987d2de0'
receive_message_wait_time:
...
- sqs_queue:
    ...
    redrive_policy:
      maxReceiveCount: 5
      deadLetterTargetArn: arn:jctanner.cloud_amazon.aws:sqs:eu-west-1:123456789012:my-dead-queue
...
def main():
    ...
    try:
        connection = connect_to_jctanner.cloud_amazon.aws(boto.sqs, region, **jctanner.cloud_amazon.aws_connect_params)
