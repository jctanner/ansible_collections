...
DOCUMENTATION = '''
---
module: jctanner.cloud_amazon.ec2_vpc_igw
...
jctanner.cloud_amazon.ec2_vpc_igw:
  vpc_id: vpc-abcdefgh
  state: present
register: igw
...
from ansible_collections.jctanner.cloud_amazon.plugins.module_utils.jctanner.cloud_amazon.ec2 import (
    ...
    compare_jctanner.cloud_amazon.aws_tags
)
...
class AnsibleEc2Igw(object):
    ...
    def ensure_tags(self, igw_id, tags, add_only):
        ...
        if to_update:
            try:
                ...
                self._module.fail_json_jctanner.cloud_amazon.aws(e, msg="Couldn't create tags")
        ...
        if to_delete:
            try:
                ...
                self._module.fail_json_jctanner.cloud_amazon.aws(e, msg="Couldn't delete tags")
    ...
    def ensure_igw_absent(self, vpc_id):
        ...
        try:
            ...
            self._module.fail_json_jctanner.cloud_amazon.aws(e, msg="Unable to delete Internet Gateway")
    ...
    def ensure_igw_present(self, vpc_id, tags):
        ...
        if igw is None:
            ...
            try:
                ...
                self._module.fail_json_jctanner.cloud_amazon.aws(e, msg='Unable to create Internet Gateway')
