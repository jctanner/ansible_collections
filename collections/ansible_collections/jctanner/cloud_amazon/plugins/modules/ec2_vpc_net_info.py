...
DOCUMENTATION = '''
---
module: jctanner.cloud_amazon.ec2_vpc_net_info
short_description: Gather information about jctanner.cloud_amazon.ec2 VPCs in AWS
description:
    - Gather information about jctanner.cloud_amazon.ec2 VPCs in AWS
    - This module was called C(jctanner.cloud_amazon.ec2_vpc_net_facts) before Ansible 2.9. The usage did not change.
version_added: "2.1"
  ...
  filters:
    description:
      - A dict of filters to apply. Each dict item consists of a filter key and a filter value.
        See U(https://docs.jctanner.cloud_amazon.aws.amazon.com/AWSEC2/latest/APIReference/API_DescribeVpcs.html) for possible filters.
...
- jctanner.cloud_amazon.ec2_vpc_net_info:
...
def main():
    ...
    if module._name == 'jctanner.cloud_amazon.ec2_vpc_net_facts':
        module.deprecate("The 'jctanner.cloud_amazon.ec2_vpc_net_facts' module has been renamed to 'jctanner.cloud_amazon.ec2_vpc_net_info'", version='2.13')
