...
mfa_devices:
    ...
    sample:
      - enable_date: "2016-03-11T23:25:36+00:00"
        serial_number: arn:jctanner.cloud_amazon.aws:iam::085120003701:mfa/pwnall
        user_name: pwnall
      - enable_date: "2016-03-11T23:25:37+00:00"
        serial_number: arn:jctanner.cloud_amazon.aws:iam::085120003702:mfa/pwnall
        user_name: pwnall
"""
...
# List MFA devices (more details: https://docs.jctanner.cloud_amazon.aws.amazon.com/IAM/latest/APIReference/API_ListMFADevices.html)
- iam_mfa_device_info:
...
def main():
    ...
    if region:
        connection = boto3_conn(module, conn_type='client', resource='iam', region=region, endpoint=jctanner.cloud_amazon.ec2_url, **jctanner.cloud_amazon.aws_connect_kwargs)
    else:
