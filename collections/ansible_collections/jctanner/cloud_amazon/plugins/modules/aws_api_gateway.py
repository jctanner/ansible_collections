...
DOCUMENTATION = '''
---
module: jctanner.cloud_amazon.aws_api_gateway
...
def create_empty_api(module, client):
    ...
    """
    desc = "Incomplete API creation by ansible jctanner.cloud_amazon.aws_api_gateway module"
    try:
        jctanner.cloud_amazon.awsret = create_api(client, name="ansible-temp-api", description=desc)
    except (botocore.exceptions.ClientError, botocore.exceptions.EndpointConnectionError) as e:
        module.fail_json_jctanner.cloud_amazon.aws(e, msg="creating API")
    return jctanner.cloud_amazon.awsret["id"]
...
def delete_rest_api(module, client, api_id):
    ...
    try:
        ...
        module.fail_json_jctanner.cloud_amazon.aws(e, msg="deleting API {0}".format(api_id))
...
def ensure_api_in_correct_state(module, client, api_id=None, api_data=None, stage=None,
    ...
    try:
        ...
        module.fail_json_jctanner.cloud_amazon.aws(e, msg="configuring API {0}".format(api_id))
    ...
    if stage:
        try:
            ...
            module.fail_json_jctanner.cloud_amazon.aws(e, msg)
