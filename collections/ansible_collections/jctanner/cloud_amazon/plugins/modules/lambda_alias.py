...
- hosts: localhost
  ...
  - name: AWS Lambda Function
    lambda:
      ...
      memory_size: 128
      role: "arn:jctanner.cloud_amazon.aws:iam::{{ account }}:role/API2LambdaExecRole"
...
alias_arn:
    ...
    returned: success
    type: str
    sample: arn:jctanner.cloud_amazon.aws:lambda:us-west-2:123456789012:function:myFunction:dev
description:
...
class AWSConnection:
    ...
    def __init__(self, ansible_obj, resources, boto3_=True):
        ...
        try:
            self.region, self.endpoint, jctanner.cloud_amazon.aws_connect_kwargs = get_jctanner.cloud_amazon.aws_connection_info(ansible_obj, boto3=boto3_)
...
def validate_params(module, jctanner.cloud_amazon.aws):
    ...
    :param jctanner.cloud_amazon.aws: AWS client connection
    :return:
    """
...
def get_lambda_alias(module, jctanner.cloud_amazon.aws):
    """
...
def lambda_alias(module, jctanner.cloud_amazon.aws):
    """
    ...
    facts = get_lambda_alias(module, jctanner.cloud_amazon.aws)
    if facts:
...
def main():
    ...
    results = lambda_alias(module, jctanner.cloud_amazon.aws)
