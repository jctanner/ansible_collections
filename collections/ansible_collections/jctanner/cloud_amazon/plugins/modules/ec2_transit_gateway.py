...
DOCUMENTATION = '''
module: jctanner.cloud_amazon.ec2_transit_gateway
...
- name: Create a new transit gateway using defaults
  jctanner.cloud_amazon.ec2_transit_gateway:
    state: present
    region: us-east-1
    ...
    def ensure_tgw_present(self, tgw_id=None, description=None):
        ...
        if tgw is None:
            ...
            try:
                ...
                self._module.fail_json_jctanner.cloud_amazon.aws(e, msg='Unable to create Transit Gateway')
    ...
    def ensure_tgw_absent(self, tgw_id=None, description=None):
        ...
        if tgw is not None:
            ...
            try:
                ...
                self._module.fail_json_jctanner.cloud_amazon.aws(e, msg='Unable to delete Transit Gateway')
