...
DOCUMENTATION = '''
---
module: jctanner.cloud_amazon.aws_application_scaling_policy
...
options:
    ...
    service_namespace:
        ...
        required: yes
        choices: ['ecs', 'elasticmapreduce', 'jctanner.cloud_amazon.ec2', 'appstream', 'dynamodb']
    resource_id:
    ...
    scalable_dimension:
        ...
        choices: [ 'ecs:service:DesiredCount',
                   'jctanner.cloud_amazon.ec2:spot-fleet-request:TargetCapacity',
...
- name: scaling_policy
  jctanner.cloud_amazon.aws_application_scaling_policy:
    state: present
...
role_arn:
    ...
    returned: when state present
    type: str
    sample: arn:jctanner.cloud_amazon.aws:iam::123456789123:role/roleName
step_scaling_policy_configuration:
...
from ansible_collections.jctanner.cloud_amazon.plugins.module_utils.jctanner.cloud_amazon.ec2 import _camel_to_snake, camel_dict_to_snake_dict, jctanner.cloud_amazon.ec2_argument_spec
...
def delete_scaling_policy(connection, module):
    ...
    try:
        ...
        module.fail_json_jctanner.cloud_amazon.aws(e, msg="Failed to describe scaling policies")
    ...
    if scaling_policy['ScalingPolicies']:
        try:
            ...
            module.fail_json_jctanner.cloud_amazon.aws(e, msg="Failed to delete scaling policy")
...
def create_scalable_target(connection, module):
    ...
    try:
        ...
        module.fail_json_jctanner.cloud_amazon.aws(e, msg="Failed to describe scalable targets")
    ...
    if (
        ...
        try:
            ...
            module.fail_json_jctanner.cloud_amazon.aws(e, msg="Failed to register scalable target")
...
def create_scaling_policy(connection, module):
    ...
    if changed:
        try:
            ...
            module.fail_json_jctanner.cloud_amazon.aws(e, msg="Failed to create scaling policy")
...
def main():
    ...
    argument_spec.update(
        ...
        service_namespace=dict(type='str', required=True, choices=['appstream', 'dynamodb', 'jctanner.cloud_amazon.ec2', 'ecs', 'elasticmapreduce']),
