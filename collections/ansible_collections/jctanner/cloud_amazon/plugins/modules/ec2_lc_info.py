...
DOCUMENTATION = '''
---
module: jctanner.cloud_amazon.ec2_lc_info
...
description:
    ...
    - This module was called C(jctanner.cloud_amazon.ec2_lc_facts) before Ansible 2.9. The usage did not change.
version_added: "2.3"
...
- jctanner.cloud_amazon.ec2_lc_info:
...
launch_configuration_arn:
    ...
    type: str
    returned: always
    sample: "arn:jctanner.cloud_amazon.aws:autoscaling:us-east-1:666612345678:launchConfiguration:ba785e3a-dd42-6f02-4585-ea1a2b458b3d:launchConfigurationName/lc-app"
...
def main():
    ...
    if module._name == 'jctanner.cloud_amazon.ec2_lc_facts':
        module.deprecate("The 'jctanner.cloud_amazon.ec2_lc_facts' module has been renamed to 'jctanner.cloud_amazon.ec2_lc_info'", version='2.13')
    ...
    if region:
        connection = boto3_conn(module, conn_type='client', resource='autoscaling', region=region, endpoint=jctanner.cloud_amazon.ec2_url, **jctanner.cloud_amazon.aws_connect_params)
    else:
