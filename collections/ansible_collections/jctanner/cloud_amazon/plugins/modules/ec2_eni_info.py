...
DOCUMENTATION = '''
---
module: jctanner.cloud_amazon.ec2_eni_info
short_description: Gather information about jctanner.cloud_amazon.ec2 ENI interfaces in AWS
description:
    - Gather information about jctanner.cloud_amazon.ec2 ENI interfaces in AWS
    - This module was called C(jctanner.cloud_amazon.ec2_eni_facts) before Ansible 2.9. The usage did not change.
version_added: "2.0"
  ...
  filters:
    description:
      - A dict of filters to apply. Each dict item consists of a filter key and a filter value.
        See U(https://docs.jctanner.cloud_amazon.aws.amazon.com/AWSEC2/latest/APIReference/API_DescribeNetworkInterfaces.html) for possible filters.
...
- jctanner.cloud_amazon.ec2_eni_info:
  ...
  contains:
    association:
      ...
      sample: {
          ...
          public_dns_name: "jctanner.cloud_amazon.ec2-52-1-0-63.compute-1.amazonjctanner.cloud_amazon.aws.com",
          public_ip: "52.1.0.63"
        }
    attachment:
      description: Infor about attached jctanner.cloud_amazon.ec2 instance
      ...
      sample: [
        {
          ...
          group_name: "my_jctanner.cloud_amazon.ec2_security_group"
        }
      ]
    id:
    ...
    private_dns_name:
      ...
      returned: always
      type: str
      sample: "ip-172-16-1-180.jctanner.cloud_amazon.ec2.internal"
    private_ip_address:
...
from ansible_collections.jctanner.cloud_amazon.plugins.module_utils.jctanner.cloud_amazon.ec2 import ansible_dict_to_boto3_filter_list, boto3_conn
from ansible_collections.jctanner.cloud_amazon.plugins.module_utils.jctanner.cloud_amazon.ec2 import boto3_tag_list_to_ansible_dict, camel_dict_to_snake_dict
...
def main():
    ...
    if module._name == 'jctanner.cloud_amazon.ec2_eni_facts':
        module.deprecate("The 'jctanner.cloud_amazon.ec2_eni_facts' module has been renamed to 'jctanner.cloud_amazon.ec2_eni_info'", version='2.13')
