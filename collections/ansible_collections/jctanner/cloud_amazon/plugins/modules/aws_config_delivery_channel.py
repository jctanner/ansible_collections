...
DOCUMENTATION = '''
---
module: jctanner.cloud_amazon.aws_config_delivery_channel
...
- name: Create Delivery Channel for AWS Config
  jctanner.cloud_amazon.aws_config_delivery_channel:
    name: test_delivery_channel
    state: present
    s3_bucket: 'test_jctanner.cloud_amazon.aws_config_bucket'
    sns_topic_arn: 'arn:jctanner.cloud_amazon.aws:sns:us-east-1:123456789012:jctanner.cloud_amazon.aws_config_topic:1234ab56-cdef-7g89-01hi-2jk34l5m67no'
...
from ansible_collections.jctanner.cloud_amazon.plugins.module_utils.jctanner.cloud_amazon.ec2 import boto3_conn, get_jctanner.cloud_amazon.aws_connection_info, AWSRetry
...
def create_resource(client, module, params, result):
    try:
        ...
        module.fail_json_jctanner.cloud_amazon.aws(e, msg="The `s3_prefix` parameter was invalid. Try '/' for no prefix")
    except is_boto3_error_code('InsufficientDeliveryPolicyException') as e:  # pylint: disable=duplicate-except
        module.fail_json_jctanner.cloud_amazon.aws(e, msg="The `s3_prefix` or `s3_bucket` parameter is invalid. "
                             "Make sure the bucket exists and is available")
    except (botocore.exceptions.ClientError, botocore.exceptions.BotoCoreError) as e:  # pylint: disable=duplicate-except
        module.fail_json_jctanner.cloud_amazon.aws(e, msg="Couldn't create AWS Config delivery channel")
...
def delete_resource(client, module, params, result):
    try:
        ...
        module.fail_json_jctanner.cloud_amazon.aws(e, msg="Couldn't delete AWS Config delivery channel")
