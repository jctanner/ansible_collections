...
repository:
    ...
    sample:
        ...
        repositoryArn: arn:jctanner.cloud_amazon.aws:ecr:us-east-1:999999999999:repository/ecr-test-1484664090
        repositoryName: ecr-test-1484664090
        repositoryUri: 999999999999.dkr.ecr.us-east-1.amazonjctanner.cloud_amazon.aws.com/ecr-test-1484664090
'''
...
from ansible_collections.jctanner.cloud_amazon.plugins.module_utils.jctanner.cloud_amazon.ec2 import (HAS_BOTO3, boto3_conn, boto_exception, jctanner.cloud_amazon.ec2_argument_spec,
                                      get_jctanner.cloud_amazon.aws_connection_info, compare_policies)
