...
DOCUMENTATION = '''
---
module: jctanner.cloud_amazon.ec2_metadata_facts
short_description: Gathers facts (instance metadata) about remote hosts within jctanner.cloud_amazon.ec2
version_added: "1.0"
author:
    - Silviu Dicu (@silviud)
    - Vinay Dandekar (@roadmapper)
description:
    - This module fetches data from the instance metadata endpoint in jctanner.cloud_amazon.ec2 as per
      U(https://docs.jctanner.cloud_amazon.aws.amazon.com/AWSEC2/latest/UserGuide/jctanner.cloud_amazon.ec2-instance-metadata.html).
      The module must be called from within the EC2 instance itself.
notes:
    - Parameters to filter on jctanner.cloud_amazon.ec2_metadata_facts may be added later.
'''

EXAMPLES = '''
# Gather EC2 metadata facts
- jctanner.cloud_amazon.ec2_metadata_facts:

- debug:
    msg: "This instance is a t1.micro"
  when: ansible_jctanner.cloud_amazon.ec2_instance_type == "t1.micro"
'''
...
ansible_facts:
    ...
    type: complex
    contains:
        ansible_jctanner.cloud_amazon.ec2_ami_id:
            description: The AMI ID used to launch the instance.
            type: str
            sample: "ami-XXXXXXXX"
        ansible_jctanner.cloud_amazon.ec2_ami_launch_index:
            description:
            ...
            type: str
            sample: "0"
        ansible_jctanner.cloud_amazon.ec2_ami_manifest_path:
            description:
            ...
            type: str
            sample: "(unknown)"
        ansible_jctanner.cloud_amazon.ec2_ancestor_ami_ids:
            description:
                - The AMI IDs of any instances that were rebundled to create this AMI.
                  This value will only exist if the AMI manifest file contained an ancestor-amis key.
            type: str
            sample: "(unknown)"
        ansible_jctanner.cloud_amazon.ec2_block_device_mapping_ami:
            description: The virtual device that contains the root/boot file system.
            type: str
            sample: "/dev/sda1"
        ansible_jctanner.cloud_amazon.ec2_block_device_mapping_ebsN:
            description:
            ...
            type: str
            sample: "/dev/xvdb"
        ansible_jctanner.cloud_amazon.ec2_block_device_mapping_ephemeralN:
            ...
            type: str
            sample: "/dev/xvdc"
        ansible_jctanner.cloud_amazon.ec2_block_device_mapping_root:
            description:
        ...
        ansible_jctanner.cloud_amazon.ec2_hostname:
            ...
            type: str
            sample: "ip-10-0-0-1.jctanner.cloud_amazon.ec2.internal"
        ansible_jctanner.cloud_amazon.ec2_iam_info:
            description:
            ...
            type: complex
            sample: ""
        ansible_jctanner.cloud_amazon.ec2_iam_info_instanceprofilearn:
            description: The IAM instance profile ARN.
            type: str
            sample: "arn:jctanner.cloud_amazon.aws:iam::<account id>:instance-profile/<role name>"
        ansible_jctanner.cloud_amazon.ec2_iam_info_instanceprofileid:
            description: IAM instance profile ID.
            type: str
            sample: ""
        ansible_jctanner.cloud_amazon.ec2_iam_info_lastupdated:
            description: IAM info last updated time.
            type: str
            sample: "2017-05-12T02:42:27Z"
        ansible_jctanner.cloud_amazon.ec2_iam_instance_profile_role:
            description: IAM instance role.
            type: str
            sample: "role_name"
        ansible_jctanner.cloud_amazon.ec2_iam_security_credentials_<role name>:
            description:
            ...
            type: str
            sample: ""
        ansible_jctanner.cloud_amazon.ec2_iam_security_credentials_<role name>_accesskeyid:
            description: IAM role access key ID.
            type: str
            sample: ""
        ansible_jctanner.cloud_amazon.ec2_iam_security_credentials_<role name>_code:
            description: IAM code.
            type: str
            sample: "Success"
        ansible_jctanner.cloud_amazon.ec2_iam_security_credentials_<role name>_expiration:
            description: IAM role credentials expiration time.
            type: str
            sample: "2017-05-12T09:11:41Z"
        ansible_jctanner.cloud_amazon.ec2_iam_security_credentials_<role name>_lastupdated:
            description: IAM role last updated time.
            type: str
            sample: "2017-05-12T02:40:44Z"
        ansible_jctanner.cloud_amazon.ec2_iam_security_credentials_<role name>_secretaccesskey:
            description: IAM role secret access key.
            type: str
            sample: ""
        ansible_jctanner.cloud_amazon.ec2_iam_security_credentials_<role name>_token:
            description: IAM role token.
            type: str
            sample: ""
        ansible_jctanner.cloud_amazon.ec2_iam_security_credentials_<role name>_type:
            description: IAM role type.
            type: str
            sample: "AWS-HMAC"
        ansible_jctanner.cloud_amazon.ec2_instance_action:
            description: Notifies the instance that it should reboot in preparation for bundling.
            type: str
            sample: "none"
        ansible_jctanner.cloud_amazon.ec2_instance_id:
            description: The ID of this instance.
            type: str
            sample: "i-XXXXXXXXXXXXXXXXX"
        ansible_jctanner.cloud_amazon.ec2_instance_identity_document:
            description: JSON containing instance attributes, such as instance-id, private IP address, etc.
            type: str
            sample: ""
        ansible_jctanner.cloud_amazon.ec2_instance_identity_document_accountid:
            description: ""
            type: str
            sample: "012345678901"
        ansible_jctanner.cloud_amazon.ec2_instance_identity_document_architecture:
            description: Instance system architecture.
            type: str
            sample: "x86_64"
        ansible_jctanner.cloud_amazon.ec2_instance_identity_document_availabilityzone:
            description: The Availability Zone in which the instance launched.
            type: str
            sample: "us-east-1a"
        ansible_jctanner.cloud_amazon.ec2_instance_identity_document_billingproducts:
            description: Billing products for this instance.
            type: str
            sample: ""
        ansible_jctanner.cloud_amazon.ec2_instance_identity_document_devpayproductcodes:
            description: Product codes for the launched AMI.
            type: str
            sample: ""
        ansible_jctanner.cloud_amazon.ec2_instance_identity_document_imageid:
            description: The AMI ID used to launch the instance.
            type: str
            sample: "ami-01234567"
        ansible_jctanner.cloud_amazon.ec2_instance_identity_document_instanceid:
            description: The ID of this instance.
            type: str
            sample: "i-0123456789abcdef0"
        ansible_jctanner.cloud_amazon.ec2_instance_identity_document_instancetype:
            description: The type of instance.
            type: str
            sample: "m4.large"
        ansible_jctanner.cloud_amazon.ec2_instance_identity_document_kernelid:
            description: The ID of the kernel launched with this instance, if applicable.
            type: str
            sample: ""
        ansible_jctanner.cloud_amazon.ec2_instance_identity_document_pendingtime:
            description: The instance pending time.
            type: str
            sample: "2017-05-11T20:51:20Z"
        ansible_jctanner.cloud_amazon.ec2_instance_identity_document_privateip:
            description:
                - The private IPv4 address of the instance.
                  In cases where multiple network interfaces are present, this refers to the eth0 device (the device for which the device number is 0).
            type: str
            sample: "10.0.0.1"
        ansible_jctanner.cloud_amazon.ec2_instance_identity_document_ramdiskid:
            description: The ID of the RAM disk specified at launch time, if applicable.
            type: str
            sample: ""
        ansible_jctanner.cloud_amazon.ec2_instance_identity_document_region:
            description: The Region in which the instance launched.
            type: str
            sample: "us-east-1"
        ansible_jctanner.cloud_amazon.ec2_instance_identity_document_version:
            description: Identity document version.
            type: str
            sample: "2010-08-31"
        ansible_jctanner.cloud_amazon.ec2_instance_identity_pkcs7:
            description: Used to verify the document's authenticity and content against the signature.
            type: str
            sample: ""
        ansible_jctanner.cloud_amazon.ec2_instance_identity_rsa2048:
            description: Used to verify the document's authenticity and content against the signature.
            type: str
            sample: ""
        ansible_jctanner.cloud_amazon.ec2_instance_identity_signature:
            description: Data that can be used by other parties to verify its origin and authenticity.
            type: str
            sample: ""
        ansible_jctanner.cloud_amazon.ec2_instance_type:
            description: The type of instance.
            type: str
            sample: "m4.large"
        ansible_jctanner.cloud_amazon.ec2_local_hostname:
            description:
                - The private IPv4 DNS hostname of the instance.
                  In cases where multiple network interfaces are present, this refers to the eth0 device (the device for which the device number is 0).
            type: str
            sample: "ip-10-0-0-1.jctanner.cloud_amazon.ec2.internal"
        ansible_jctanner.cloud_amazon.ec2_local_ipv4:
            description:
                - The private IPv4 address of the instance.
                  In cases where multiple network interfaces are present, this refers to the eth0 device (the device for which the device number is 0).
            type: str
            sample: "10.0.0.1"
        ansible_jctanner.cloud_amazon.ec2_mac:
            description:
                - The instance's media access control (MAC) address.
                  In cases where multiple network interfaces are present, this refers to the eth0 device (the device for which the device number is 0).
            type: str
            sample: "00:11:22:33:44:55"
        ansible_jctanner.cloud_amazon.ec2_metrics_vhostmd:
            description: Metrics.
            type: str
            sample: ""
        ansible_jctanner.cloud_amazon.ec2_network_interfaces_macs_<mac address>_device_number:
            description:
            ...
            type: str
            sample: "0"
        ansible_jctanner.cloud_amazon.ec2_network_interfaces_macs_<mac address>_interface_id:
            description: The elastic network interface ID.
            type: str
            sample: "eni-12345678"
        ansible_jctanner.cloud_amazon.ec2_network_interfaces_macs_<mac address>_ipv4_associations_<ip address>:
            description: The private IPv4 addresses that are associated with each public-ip address and assigned to that interface.
            type: str
            sample: ""
        ansible_jctanner.cloud_amazon.ec2_network_interfaces_macs_<mac address>_ipv6s:
            description: The IPv6 addresses associated with the interface. Returned only for instances launched into a VPC.
            type: str
            sample: ""
        ansible_jctanner.cloud_amazon.ec2_network_interfaces_macs_<mac address>_local_hostname:
            description: The interface's local hostname.
            type: str
            sample: ""
        ansible_jctanner.cloud_amazon.ec2_network_interfaces_macs_<mac address>_local_ipv4s:
            description: The private IPv4 addresses associated with the interface.
            type: str
            sample: ""
        ansible_jctanner.cloud_amazon.ec2_network_interfaces_macs_<mac address>_mac:
            description: The instance's MAC address.
            type: str
            sample: "00:11:22:33:44:55"
        ansible_jctanner.cloud_amazon.ec2_network_interfaces_macs_<mac address>_owner_id:
            description:
            ...
            type: str
            sample: "01234567890"
        ansible_jctanner.cloud_amazon.ec2_network_interfaces_macs_<mac address>_public_hostname:
            description:
            ...
            type: str
            sample: "jctanner.cloud_amazon.ec2-1-2-3-4.compute-1.amazonjctanner.cloud_amazon.aws.com"
        ansible_jctanner.cloud_amazon.ec2_network_interfaces_macs_<mac address>_public_ipv4s:
            description: The Elastic IP addresses associated with the interface. There may be multiple IPv4 addresses on an instance.
            type: str
            sample: "1.2.3.4"
        ansible_jctanner.cloud_amazon.ec2_network_interfaces_macs_<mac address>_security_group_ids:
        ...
        ansible_jctanner.cloud_amazon.ec2_network_interfaces_macs_<mac address>_security_groups:
        ...
        ansible_jctanner.cloud_amazon.ec2_network_interfaces_macs_<mac address>_subnet_id:
        ...
        ansible_jctanner.cloud_amazon.ec2_network_interfaces_macs_<mac address>_subnet_ipv4_cidr_block:
            ...
            type: str
            sample: "10.0.1.0/24"
        ansible_jctanner.cloud_amazon.ec2_network_interfaces_macs_<mac address>_subnet_ipv6_cidr_blocks:
            ...
            type: str
            sample: ""
        ansible_jctanner.cloud_amazon.ec2_network_interfaces_macs_<mac address>_vpc_id:
            description: The ID of the VPC in which the interface resides. Returned only for instances launched into a VPC.
            type: str
            sample: "vpc-0123456"
        ansible_jctanner.cloud_amazon.ec2_network_interfaces_macs_<mac address>_vpc_ipv4_cidr_block:
            ...
            type: str
            sample: "10.0.0.0/16"
        ansible_jctanner.cloud_amazon.ec2_network_interfaces_macs_<mac address>_vpc_ipv4_cidr_blocks:
            description: The IPv4 CIDR block of the VPC in which the interface resides. Returned only for instances launched into a VPC.
            type: str
            sample: "10.0.0.0/16"
        ansible_jctanner.cloud_amazon.ec2_network_interfaces_macs_<mac address>_vpc_ipv6_cidr_blocks:
            ...
            type: str
            sample: ""
        ansible_jctanner.cloud_amazon.ec2_placement_availability_zone:
            description: The Availability Zone in which the instance launched.
            type: str
            sample: "us-east-1a"
        ansible_jctanner.cloud_amazon.ec2_placement_region:
            description: The Region in which the instance launched.
            type: str
            sample: "us-east-1"
        ansible_jctanner.cloud_amazon.ec2_product_codes:
            description: Product codes associated with the instance, if any.
            type: str
            sample: "aw0evgkw8e5c1q413zgy5pjce"
        ansible_jctanner.cloud_amazon.ec2_profile:
            description: EC2 instance hardware profile.
            type: str
            sample: "default-hvm"
        ansible_jctanner.cloud_amazon.ec2_public_hostname:
            description:
            ...
            type: str
            sample: "jctanner.cloud_amazon.ec2-1-2-3-4.compute-1.amazonjctanner.cloud_amazon.aws.com"
        ansible_jctanner.cloud_amazon.ec2_public_ipv4:
            ...
            type: str
            sample: "1.2.3.4"
        ansible_jctanner.cloud_amazon.ec2_public_key:
            description: Public key. Only available if supplied at instance launch time.
            type: str
            sample: ""
        ansible_jctanner.cloud_amazon.ec2_ramdisk_id:
            description: The ID of the RAM disk specified at launch time, if applicable.
            type: str
            sample: ""
        ansible_jctanner.cloud_amazon.ec2_reservation_id:
            description: The ID of the reservation.
            type: str
            sample: "r-0123456789abcdef0"
        ansible_jctanner.cloud_amazon.ec2_security_groups:
            description:
        ...
        ansible_jctanner.cloud_amazon.ec2_services_domain:
            description: The domain for AWS resources for the region; for example, amazonjctanner.cloud_amazon.aws.com for us-east-1.
            type: str
            sample: "amazonjctanner.cloud_amazon.aws.com"
        ansible_jctanner.cloud_amazon.ec2_services_partition:
            description:
                - The partition that the resource is in. For standard AWS regions, the partition is jctanner.cloud_amazon.aws.
                  If you have resources in other partitions, the partition is jctanner.cloud_amazon.aws-partitionname.
                  For example, the partition for resources in the China (Beijing) region is jctanner.cloud_amazon.aws-cn.
            type: str
            sample: "jctanner.cloud_amazon.aws"
        ansible_jctanner.cloud_amazon.ec2_spot_termination_time:
            description:
        ...
        ansible_jctanner.cloud_amazon.ec2_user_data:
...
class Ec2Metadata(object):
    jctanner.cloud_amazon.ec2_metadata_uri = 'http://169.254.169.254/latest/meta-data/'
    jctanner.cloud_amazon.ec2_sshdata_uri = 'http://169.254.169.254/latest/meta-data/public-keys/0/openssh-key'
    jctanner.cloud_amazon.ec2_userdata_uri = 'http://169.254.169.254/latest/user-data/'
    jctanner.cloud_amazon.ec2_dynamicdata_uri = 'http://169.254.169.254/latest/dynamic/'

    def __init__(self, module, jctanner.cloud_amazon.ec2_metadata_uri=None, jctanner.cloud_amazon.ec2_sshdata_uri=None, jctanner.cloud_amazon.ec2_userdata_uri=None, jctanner.cloud_amazon.ec2_dynamicdata_uri=None):
        self.module = module
        self.uri_meta = jctanner.cloud_amazon.ec2_metadata_uri or self.jctanner.cloud_amazon.ec2_metadata_uri
        self.uri_user = jctanner.cloud_amazon.ec2_userdata_uri or self.jctanner.cloud_amazon.ec2_userdata_uri
        self.uri_ssh = jctanner.cloud_amazon.ec2_sshdata_uri or self.jctanner.cloud_amazon.ec2_sshdata_uri
        self.uri_dynamic = jctanner.cloud_amazon.ec2_dynamicdata_uri or self.jctanner.cloud_amazon.ec2_dynamicdata_uri
        self._data = {}
        self._prefix = 'ansible_jctanner.cloud_amazon.ec2_%s'
    ...
    def run(self):
        ...
        if 'ansible_jctanner.cloud_amazon.ec2_instance_identity_document_region' in data:
            data['ansible_jctanner.cloud_amazon.ec2_placement_region'] = data['ansible_jctanner.cloud_amazon.ec2_instance_identity_document_region']
        return data
...
def main():
    ...
    jctanner.cloud_amazon.ec2_metadata_facts = Ec2Metadata(module).run()
    jctanner.cloud_amazon.ec2_metadata_facts_result = dict(changed=False, ansible_facts=jctanner.cloud_amazon.ec2_metadata_facts)

    module.exit_json(**jctanner.cloud_amazon.ec2_metadata_facts_result)
