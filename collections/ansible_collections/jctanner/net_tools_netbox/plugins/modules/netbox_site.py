...
from ansible_collections.jctanner.net_tools_netbox.plugins.module_utils.net_tools.netbox.netbox_utils import (
    find_ids,
    normalize_data,
...
from ansible_collections.jctanner.net_tools_netbox.plugins.module_utils.compat import ipaddress
