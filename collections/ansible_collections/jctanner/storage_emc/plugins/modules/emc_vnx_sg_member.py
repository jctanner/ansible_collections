...
extends_documentation_fragment:
  - jctanner.storage_emc.emc.emc_vnx
...
from ansible_collections.jctanner.storage_emc.plugins.module_utils.storage.jctanner.storage_emc.emc.emc_vnx import emc_vnx_argument_spec
