...
DOCUMENTATION = """
---
module: jctanner.network_eos.eos_bgp
version_added: "2.8"
...
from ansible_collections.jctanner.network_jctanner.network_eos.eos.plugins.module_utils.network.jctanner.network_eos.eos.providers.module import NetworkModule
from ansible_collections.jctanner.network_jctanner.network_eos.eos.plugins.module_utils.network.jctanner.network_eos.eos.providers.cli.config.bgp.process import REDISTRIBUTE_PROTOCOLS
