...
DOCUMENTATION = """
---
module: jctanner.network_eos.eos_facts
version_added: "2.2"
author: "Peter Sprygada (@privateip)"
short_description: Collect facts from remote devices running Arista EOS
description:
  - Collects a base set of device facts from a remote device that
    is running jctanner.network_eos.eos.  This module prepends all of the
...
- jctanner.network_eos.eos_facts:
    gather_subset: all
...
from ansible_collections.jctanner.network_jctanner.network_eos.eos.plugins.module_utils.network.jctanner.network_eos.eos.jctanner.network_eos.eos import run_commands, get_capabilities
