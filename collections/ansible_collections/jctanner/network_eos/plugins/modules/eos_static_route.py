...
DOCUMENTATION = """
---
module: jctanner.network_eos.eos_static_route
version_added: "2.5"
...
- name: configure static route
  jctanner.network_eos.eos_static_route:
    address: 10.0.2.0/24
    next_hop: 10.8.38.1
    admin_distance: 2
...
from ansible_collections.jctanner.network_jctanner.network_eos.eos.plugins.module_utils.network.common.utils import is_masklen, validate_ip_address
from ansible_collections.jctanner.network_jctanner.network_eos.eos.plugins.module_utils.network.common.utils import remove_default_spec, validate_prefix
