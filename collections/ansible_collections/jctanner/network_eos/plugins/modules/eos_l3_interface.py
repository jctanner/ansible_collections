...
DOCUMENTATION = """
---
module: jctanner.network_eos.eos_l3_interface
version_added: "2.5"
...
- name: Remove ethernet1 IPv4 and IPv6 address
  jctanner.network_eos.eos_l3_interface:
    name: ethernet1
    state: absent
...
from ansible_collections.jctanner.network_jctanner.network_eos.eos.plugins.module_utils.network.common.config import NetworkConfig
from ansible_collections.jctanner.network_jctanner.network_eos.eos.plugins.module_utils.network.common.utils import remove_default_spec
from ansible_collections.jctanner.network_jctanner.network_eos.eos.plugins.module_utils.network.jctanner.network_eos.eos.jctanner.network_eos.eos import get_config, load_config
...
from ansible_collections.jctanner.network_jctanner.network_eos.eos.plugins.module_utils.network.common.utils import is_masklen
