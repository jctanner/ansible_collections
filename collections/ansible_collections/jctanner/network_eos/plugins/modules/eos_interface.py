...
DOCUMENTATION = """
---
module: jctanner.network_eos.eos_interface
version_added: "2.5"
...
- name: configure interface
  jctanner.network_eos.eos_interface:
      name: ethernet1
...
from ansible_collections.jctanner.network_jctanner.network_eos.eos.plugins.module_utils.network.common.utils import conditional, remove_default_spec
from ansible_collections.jctanner.network_jctanner.network_eos.eos.plugins.module_utils.network.jctanner.network_eos.eos.jctanner.network_eos.eos import get_config, load_config, run_commands
