...
DOCUMENTATION = """
---
module: jctanner.network_eos.eos_config
version_added: "2.1"
...
description:
  - Arista EOS configurations use a simple block indent file syntax
    ...
    transports.
extends_documentation_fragment: jctanner.network_eos.eos
notes:
...
- name: configure top level settings
  jctanner.network_eos.eos_config:
...
- name: load configuration from file
  jctanner.network_eos.eos_config:
    src: jctanner.network_eos.eos.cfg

- name: render a Jinja2 template onto an Arista switch
  jctanner.network_eos.eos_config:
    backup: yes
    src: jctanner.network_eos.eos_template.j2
...
backup_path:
  ...
  type: str
  sample: /playbooks/ansible/backup/jctanner.network_eos.eos_config.2016-07-16@22:28:34
filename:
  description: The name of the backup file
  returned: when backup is yes and filename is not specified in backup options
  type: str
  sample: jctanner.network_eos.eos_config.2016-07-16@22:28:34
shortname:
  description: The full path to the backup file excluding the timestamp
  returned: when backup is yes and filename is not specified in backup options
  type: str
  sample: /playbooks/ansible/backup/jctanner.network_eos.eos_config
date:
...
from ansible_collections.jctanner.network_jctanner.network_eos.eos.plugins.module_utils.connection import ConnectionError
from ansible_collections.jctanner.network_jctanner.network_eos.eos.plugins.module_utils.network.common.config import NetworkConfig, dumps
from ansible_collections.jctanner.network_jctanner.network_eos.eos.plugins.module_utils.network.jctanner.network_eos.eos.jctanner.network_eos.eos import get_config, load_config, get_connection
from ansible_collections.jctanner.network_jctanner.network_eos.eos.plugins.module_utils.network.jctanner.network_eos.eos.jctanner.network_eos.eos import run_commands
from ansible_collections.jctanner.network_jctanner.network_eos.eos.plugins.module_utils.network.jctanner.network_eos.eos.jctanner.network_eos.eos import jctanner.network_eos.eos_argument_spec
from ansible_collections.jctanner.network_jctanner.network_eos.eos.plugins.module_utils.network.jctanner.network_eos.eos.jctanner.network_eos.eos import check_args
...
def main():
    ...
    argument_spec.update(jctanner.network_eos.eos_argument_spec)
