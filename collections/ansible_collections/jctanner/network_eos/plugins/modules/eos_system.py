...
DOCUMENTATION = """
---
module: jctanner.network_eos.eos_system
version_added: "2.3"
...
- name: configure hostname and domain-name
  jctanner.network_eos.eos_system:
    hostname: jctanner.network_eos.eos01
...
from ansible_collections.jctanner.network_jctanner.network_eos.eos.plugins.module_utils.network.common.utils import ComplexList
from ansible_collections.jctanner.network_jctanner.network_eos.eos.plugins.module_utils.network.jctanner.network_eos.eos.jctanner.network_eos.eos import load_config, get_config
