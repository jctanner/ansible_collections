...
DOCUMENTATION = """
---
module: jctanner.network_iosxr.iosxr_facts
version_added: "2.2"
...
- jctanner.network_iosxr.iosxr_facts:
    gather_subset: all
...
from ansible_collections.jctanner.network_jctanner.network_iosxr.iosxr.plugins.module_utils.network.jctanner.network_iosxr.iosxr.jctanner.network_iosxr.iosxr import jctanner.network_iosxr.iosxr_argument_spec, run_commands, get_capabilities
...
def main():
    ...
    spec.update(jctanner.network_iosxr.iosxr_argument_spec)
