...
DOCUMENTATION = """
---
module: jctanner.network_iosxr.iosxr_netconf
version_added: "2.5"
...
options:
  ...
  state:
    description:
      - Specifies the state of the C(jctanner.network_iosxr.iosxr_netconf) resource on
...
- name: enable netconf service on port 830
  jctanner.network_iosxr.iosxr_netconf:
    listens_on: 830
    state: present
