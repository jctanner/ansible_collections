...
DOCUMENTATION = """
---
module: jctanner.network_iosxr.iosxr_system
version_added: "2.3"
author:
...
- name: configure hostname and domain-name (default vrf=default)
  jctanner.network_iosxr.iosxr_system:
    hostname: jctanner.network_iosxr.iosxr01
...
from ansible_collections.jctanner.network_jctanner.network_iosxr.iosxr.plugins.module_utils.network.jctanner.network_iosxr.iosxr.jctanner.network_iosxr.iosxr import get_config, load_config, etree_findall
from ansible_collections.jctanner.network_jctanner.network_iosxr.iosxr.plugins.module_utils.network.jctanner.network_iosxr.iosxr.jctanner.network_iosxr.iosxr import is_cliconf, is_netconf, etree_find
from ansible_collections.jctanner.network_jctanner.network_iosxr.iosxr.plugins.module_utils.network.jctanner.network_iosxr.iosxr.jctanner.network_iosxr.iosxr import jctanner.network_iosxr.iosxr_argument_spec, build_xml
