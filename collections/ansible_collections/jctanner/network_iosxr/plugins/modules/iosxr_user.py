...
DOCUMENTATION = """
---
module: jctanner.network_iosxr.iosxr_user
version_added: "2.4"
author:
...
- name: create a new user
  jctanner.network_iosxr.iosxr_user:
    name: ansible
...
from ansible_collections.jctanner.network_jctanner.network_iosxr.iosxr.plugins.module_utils.compat.paramiko import paramiko
...
from ansible_collections.jctanner.network_jctanner.network_iosxr.iosxr.plugins.module_utils.network.jctanner.network_iosxr.iosxr.jctanner.network_iosxr.iosxr import get_config, load_config, is_netconf, is_cliconf
from ansible_collections.jctanner.network_jctanner.network_iosxr.iosxr.plugins.module_utils.network.jctanner.network_iosxr.iosxr.jctanner.network_iosxr.iosxr import jctanner.network_iosxr.iosxr_argument_spec, build_xml, etree_findall
