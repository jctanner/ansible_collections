...
DOCUMENTATION = """
---
module: jctanner.network_iosxr.iosxr_config
version_added: "2.1"
...
description:
  - Cisco IOS XR configurations use a simple block indent file syntax
    ...
    a deterministic way.
extends_documentation_fragment: jctanner.network_iosxr.iosxr
notes:
...
options:
  ...
  comment:
    ...
    default: 'configured by jctanner.network_iosxr.iosxr_config'
    version_added: "2.2"
  admin:
    description:
...
- name: configure top level configuration
  jctanner.network_iosxr.iosxr_config:
...
backup_path:
  ...
  type: str
  sample: /playbooks/ansible/backup/jctanner.network_iosxr.iosxr01_config.2016-07-16@22:28:34
filename:
  description: The name of the backup file
  returned: when backup is yes and filename is not specified in backup options
  type: str
  sample: jctanner.network_iosxr.iosxr01_config.2016-07-16@22:28:34
shortname:
  description: The full path to the backup file excluding the timestamp
  returned: when backup is yes and filename is not specified in backup options
  type: str
  sample: /playbooks/ansible/backup/jctanner.network_iosxr.iosxr01_config
date:
...
from ansible_collections.jctanner.network_jctanner.network_iosxr.iosxr.plugins.module_utils.connection import ConnectionError
from ansible_collections.jctanner.network_jctanner.network_iosxr.iosxr.plugins.module_utils.network.jctanner.network_iosxr.iosxr.jctanner.network_iosxr.iosxr import load_config, get_config, get_connection
from ansible_collections.jctanner.network_jctanner.network_iosxr.iosxr.plugins.module_utils.network.jctanner.network_iosxr.iosxr.jctanner.network_iosxr.iosxr import jctanner.network_iosxr.iosxr_argument_spec, copy_file
from ansible_collections.jctanner.network_jctanner.network_iosxr.iosxr.plugins.module_utils.network.common.config import NetworkConfig, dumps

DEFAULT_COMMIT_COMMENT = 'configured by jctanner.network_iosxr.iosxr_config'
...
def main():
    ...
    argument_spec.update(jctanner.network_iosxr.iosxr_argument_spec)
