...
DOCUMENTATION = """
---
module: jctanner.network_iosxr.iosxr_banner
version_added: "2.4"
author:
...
- name: configure the login banner
  jctanner.network_iosxr.iosxr_banner:
    banner: login
    text: |
...
from ansible_collections.jctanner.network_jctanner.network_iosxr.iosxr.plugins.module_utils.network.jctanner.network_iosxr.iosxr.jctanner.network_iosxr.iosxr import get_config, load_config
from ansible_collections.jctanner.network_jctanner.network_iosxr.iosxr.plugins.module_utils.network.jctanner.network_iosxr.iosxr.jctanner.network_iosxr.iosxr import jctanner.network_iosxr.iosxr_argument_spec
from ansible_collections.jctanner.network_jctanner.network_iosxr.iosxr.plugins.module_utils.network.jctanner.network_iosxr.iosxr.jctanner.network_iosxr.iosxr import build_xml, is_cliconf
from ansible_collections.jctanner.network_jctanner.network_iosxr.iosxr.plugins.module_utils.network.jctanner.network_iosxr.iosxr.jctanner.network_iosxr.iosxr import etree_find, is_netconf
