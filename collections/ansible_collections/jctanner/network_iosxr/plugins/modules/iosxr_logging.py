...
DOCUMENTATION = """
---
module: jctanner.network_iosxr.iosxr_logging
version_added: "2.4"
author:
...
- name: configure logging for syslog server host
  jctanner.network_iosxr.iosxr_logging:
    dest: host
    name: 10.10.10.1
    level: critical
    state: present
...
from ansible_collections.jctanner.network_jctanner.network_iosxr.iosxr.plugins.module_utils.network.jctanner.network_iosxr.iosxr.jctanner.network_iosxr.iosxr import jctanner.network_iosxr.iosxr_argument_spec, etree_findall
from ansible_collections.jctanner.network_jctanner.network_iosxr.iosxr.plugins.module_utils.network.jctanner.network_iosxr.iosxr.jctanner.network_iosxr.iosxr import is_netconf, is_cliconf, etree_find
from ansible_collections.jctanner.network_jctanner.network_iosxr.iosxr.plugins.module_utils.network.common.utils import remove_default_spec
