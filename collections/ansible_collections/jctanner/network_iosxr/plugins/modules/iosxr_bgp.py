...
DOCUMENTATION = """
---
module: jctanner.network_iosxr.iosxr_bgp
version_added: "2.8"
...
- name: configure global bgp as 65000
  jctanner.network_iosxr.iosxr_bgp:
    bgp_as: 65000
    router_id: 1.1.1.1
    neighbors:
...
from ansible_collections.jctanner.network_jctanner.network_iosxr.iosxr.plugins.module_utils.network.jctanner.network_iosxr.iosxr.providers.module import NetworkModule
from ansible_collections.jctanner.network_jctanner.network_iosxr.iosxr.plugins.module_utils.network.jctanner.network_iosxr.iosxr.providers.cli.config.bgp.process import REDISTRIBUTE_PROTOCOLS
