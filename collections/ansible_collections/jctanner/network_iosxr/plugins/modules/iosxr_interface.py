...
DOCUMENTATION = """
---
module: jctanner.network_iosxr.iosxr_interface
version_added: "2.4"
author:
...
- name: configure interface
  jctanner.network_iosxr.iosxr_interface:
...
from ansible_collections.jctanner.network_jctanner.network_iosxr.iosxr.plugins.module_utils.network.jctanner.network_iosxr.iosxr.jctanner.network_iosxr.iosxr import get_config, load_config, build_xml
from ansible_collections.jctanner.network_jctanner.network_iosxr.iosxr.plugins.module_utils.network.jctanner.network_iosxr.iosxr.jctanner.network_iosxr.iosxr import run_commands, jctanner.network_iosxr.iosxr_argument_spec, get_oper
from ansible_collections.jctanner.network_jctanner.network_iosxr.iosxr.plugins.module_utils.network.jctanner.network_iosxr.iosxr.jctanner.network_iosxr.iosxr import is_netconf, is_cliconf, etree_findall, etree_find
from ansible_collections.jctanner.network_jctanner.network_iosxr.iosxr.plugins.module_utils.network.common.utils import conditional, remove_default_spec
...
def main():
    ...
    if is_cliconf(module):
        ...
        # module.deprecate("cli support for 'jctanner.network_iosxr.iosxr_interface' is deprecated. Use transport netconf instead",
        #                  version='2.9')
