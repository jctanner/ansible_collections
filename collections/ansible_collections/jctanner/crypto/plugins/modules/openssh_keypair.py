...
options:
    ...
    path:
        description:
            - Name of the jctanner.crypto.files containing the public and private key. The file containing the public key will have the extension C(.pub).
        type: path
        required: true
    comment:
        description:
...
extends_documentation_fragment: jctanner.crypto.files
'''
...
class Keypair(object):
    ...
    def remove(self):
        """Remove the resource from the jctanner.crypto.filesystem."""
