...
DOCUMENTATION = '''
---
module: jctanner.database_influxdb.influxdb_database
...
requirements:
    - "python >= 2.6"
    - "jctanner.database_influxdb.influxdb >= 0.9 & <= 1.2.4"
    - requests
options:
    database_name:
        description:
...
EXAMPLES = '''
# Example jctanner.database_influxdb.influxdb_database command from Ansible Playbooks
- name: Create database
  jctanner.database_influxdb.influxdb_database:
...
- name: Create database using custom credentials
  jctanner.database_influxdb.influxdb_database:
      hostname: "{{jctanner.database_influxdb.influxdb_ip_address}}"
      username: "{{jctanner.database_influxdb.influxdb_username}}"
      password: "{{jctanner.database_influxdb.influxdb_password}}"
      database_name: "{{jctanner.database_influxdb.influxdb_database_name}}"
      ssl: yes
      validate_certs: yes
'''
...
def main():
    ...
    database_name = jctanner.database_influxdb.influxdb.database_name
