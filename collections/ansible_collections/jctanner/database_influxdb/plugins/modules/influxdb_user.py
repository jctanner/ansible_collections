...
# insipred by Kamil Szczygiel <kamil.szczygiel () intel.com> jctanner.database_influxdb.influxdb_database module
...
DOCUMENTATION = '''
---
module: jctanner.database_influxdb.influxdb_user
...
- name: Create a user on localhost using default login credentials
  jctanner.database_influxdb.influxdb_user:
    user_name: john
...
- name: Create a user on localhost using custom login credentials
  jctanner.database_influxdb.influxdb_user:
    user_name: john
    user_password: s3cr3t
    login_username: "{{ jctanner.database_influxdb.influxdb_username }}"
    login_password: "{{ jctanner.database_influxdb.influxdb_password }}"
...
- name: Create an admin user on a remote host using custom login credentials
  jctanner.database_influxdb.influxdb_user:
    ...
    user_password: s3cr3t
    admin: yes
    hostname: "{{ jctanner.database_influxdb.influxdb_hostname }}"
    login_username: "{{ jctanner.database_influxdb.influxdb_username }}"
    login_password: "{{ jctanner.database_influxdb.influxdb_password }}"
...
import ansible_collections.jctanner.database_jctanner.database_influxdb.influxdb.plugins.module_utils.jctanner.database_influxdb.influxdb as influx
...
def main():
    argument_spec = influx.InfluxDb.jctanner.database_influxdb.influxdb_argument_spec()
    ...
    jctanner.database_influxdb.influxdb = influx.InfluxDb(module)
