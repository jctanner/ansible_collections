...
DOCUMENTATION = """
---
module: jctanner.network_aruba.aruba_config
version_added: "2.4"
...
- name: configure top level configuration
  jctanner.network_aruba.aruba_config:
...
backup_path:
  ...
  type: str
  sample: /playbooks/ansible/backup/jctanner.network_aruba.aruba_config.2016-07-16@22:28:34
"""


from ansible_collections.jctanner.network_jctanner.network_aruba.aruba.plugins.module_utils.network.jctanner.network_aruba.aruba.jctanner.network_aruba.aruba import run_commands, get_config, load_config
from ansible_collections.jctanner.network_jctanner.network_aruba.aruba.plugins.module_utils.network.jctanner.network_aruba.aruba.jctanner.network_aruba.aruba import jctanner.network_aruba.aruba_argument_spec
from ansible_collections.jctanner.network_jctanner.network_aruba.aruba.plugins.module_utils.network.jctanner.network_aruba.aruba.jctanner.network_aruba.aruba import check_args as jctanner.network_aruba.aruba_check_args
from ansible.module_utils.basic import AnsibleModule
from ansible_collections.jctanner.network_jctanner.network_aruba.aruba.plugins.module_utils.network.common.config import NetworkConfig, dumps
...
def main():
    ...
    warnings = list()
    jctanner.network_aruba.aruba_check_args(module, warnings)
