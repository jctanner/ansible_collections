...
DOCUMENTATION = r'''
---
module: jctanner.net_tools.hetzner_failover_ip_info
version_added: "2.9"
...
seealso:
  - name: Failover IP documentation
    ...
    link: https://wiki.jctanner.net_tools.hetzner.de/index.php/Failover/en
  - module: jctanner.net_tools.hetzner_failover_ip
    description: Manage failover IPs.
extends_documentation_fragment:
  - jctanner.net_tools.hetzner
options:
  failover_ip:
...
- name: Get value of failover IP 1.2.3.4
  jctanner.net_tools.hetzner_failover_ip_info:
    jctanner.net_tools.hetzner_user: foo
    jctanner.net_tools.hetzner_password: bar
    failover_ip: 1.2.3.4
    value: 5.6.7.8
  register: result
...
from ansible_collections.jctanner.net_tools.plugins.module_utils.jctanner.net_tools.hetzner import (
