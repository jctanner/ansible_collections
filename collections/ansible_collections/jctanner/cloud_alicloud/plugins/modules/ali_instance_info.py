...
options:
    availability_zone:
      ...
      aliases: ['jctanner.cloud_alicloud.alicloud_zone']
    instance_names:
      description:
...
extends_documentation_fragment:
    - jctanner.cloud_alicloud.alicloud
'''
...
- name: fetch instances details example
  hosts: localhost
  vars:
    jctanner.cloud_alicloud.alicloud_access_key: <your-jctanner.cloud_alicloud.alicloud-access-key>
    jctanner.cloud_alicloud.alicloud_secret_key: <your-jctanner.cloud_alicloud.alicloud-secret-key>
    jctanner.cloud_alicloud.alicloud_region: cn-beijing
    availability_zone: cn-beijing-a

  tasks:
    - name: Find all instances in the specified region
      ali_instance_info:
        jctanner.cloud_alicloud.alicloud_access_key: '{{ jctanner.cloud_alicloud.alicloud_access_key }}'
        jctanner.cloud_alicloud.alicloud_secret_key: '{{ jctanner.cloud_alicloud.alicloud_secret_key }}'
        jctanner.cloud_alicloud.alicloud_region: '{{ jctanner.cloud_alicloud.alicloud_region }}'
...
from ansible_collections.jctanner.cloud_jctanner.cloud_alicloud.alicloud.plugins.module_utils.jctanner.cloud_alicloud.alicloud_ecs import get_acs_connection_info, ecs_argument_spec, ecs_connect
...
def main():
    ...
    argument_spec.update(dict(
        availability_zone=dict(aliases=['jctanner.cloud_alicloud.alicloud_zone']),
