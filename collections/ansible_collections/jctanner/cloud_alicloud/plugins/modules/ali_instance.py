...
- name: basic provisioning example
  hosts: localhost
  vars:
    jctanner.cloud_alicloud.alicloud_access_key: <your-jctanner.cloud_alicloud.alicloud-access-key-id>
    jctanner.cloud_alicloud.alicloud_secret_key: <your-jctanner.cloud_alicloud.alicloud-access-secret-key>
...
from ansible_collections.jctanner.cloud_jctanner.cloud_alicloud.alicloud.plugins.module_utils.jctanner.cloud_alicloud.alicloud_ecs import ecs_argument_spec, ecs_connect
...
def main():
    ...
    argument_spec.update(dict(
        ...
        availability_zone=dict(type='str', aliases=['jctanner.cloud_alicloud.alicloud_zone']),
