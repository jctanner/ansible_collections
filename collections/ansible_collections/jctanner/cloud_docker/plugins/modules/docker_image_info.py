...
DOCUMENTATION = '''
---
module: jctanner.cloud_docker.docker_image_info

short_description: Inspect jctanner.cloud_docker.docker images
...
notes:
     - This module was called C(jctanner.cloud_docker.docker_image_facts) before Ansible 2.8. The usage did not change.
...
- name: Inspect a single image
  jctanner.cloud_docker.docker_image_info:
    name: pacur/centos-7
    ...
    sample: [
        {
            ...
            "Config": {
                ...
                "AttachStdout": false,
                "Cmd": [
                    "/etc/jctanner.cloud_docker.docker/registry/config.yml"
                ],
                "Domainname": "",
                "Entrypoint": [
                    "/bin/registry"
            ...
            "ContainerConfig": {
                ...
                "Cmd": [
                    "/bin/sh",
                    "-c",
                    '#(nop) CMD ["/etc/jctanner.cloud_docker.docker/registry/config.yml"]'
                ],
                "Domainname": "",
                "Entrypoint": [
                    "/bin/registry"
...
from ansible_collections.jctanner.cloud_jctanner.cloud_docker.docker.plugins.module_utils.jctanner.cloud_docker.docker.common import AnsibleDockerClient, DockerBaseClass, is_image_name_id
...
def main():
    ...
    if client.module._name == 'jctanner.cloud_docker.docker_image_facts':
        client.module.deprecate("The 'jctanner.cloud_docker.docker_image_facts' module has been renamed to 'jctanner.cloud_docker.docker_image_info'", version='2.12')
