...
DOCUMENTATION = '''
---
module: jctanner.cloud_docker.docker_swarm_service
author:
  - "Dario Zanzico (@dariko)"
  - "Jason Witkowski (@jwitko)"
  - "Hannes Ljungberg (@hannseman)"
short_description: jctanner.cloud_docker.docker swarm service
description:
  - Manages jctanner.cloud_docker.docker services via a swarm manager node.
version_added: "2.7"
options:
  args:
    description:
      - List arguments to be passed to the container.
      - Corresponds to the C(ARG) parameter of C(jctanner.cloud_docker.docker service create).
    type: list
  command:
    description:
      - Command to execute when the container starts.
      - A command may be either a string or a list or a list of strings.
      - Corresponds to the C(COMMAND) parameter of C(jctanner.cloud_docker.docker service create).
    type: raw
    version_added: 2.8
  configs:
    description:
      - List of dictionaries describing the service configs.
      - Corresponds to the C(--config) option of C(jctanner.cloud_docker.docker service create).
  ...
  constraints:
    description:
      ...
      - Corresponds to the C(--constraint) option of C(jctanner.cloud_docker.docker service create).
      - Deprecated in 2.8, will be removed in 2.12. Use parameter C(placement.constraints) instead.
    type: list
  container_labels:
    description:
      - Dictionary of key value pairs.
      - Corresponds to the C(--container-label) option of C(jctanner.cloud_docker.docker service create).
    type: dict
  dns:
    description:
      - List of custom DNS servers.
      - Corresponds to the C(--dns) option of C(jctanner.cloud_docker.docker service create).
      - Requires API version >= 1.25.
    type: list
  dns_search:
    description:
      - List of custom DNS search domains.
      - Corresponds to the C(--dns-search) option of C(jctanner.cloud_docker.docker service create).
      - Requires API version >= 1.25.
    type: list
  dns_options:
    description:
      - List of custom DNS options.
      - Corresponds to the C(--dns-option) option of C(jctanner.cloud_docker.docker service create).
      - Requires API version >= 1.25.
    type: list
  endpoint_mode:
    description:
      - Service endpoint mode.
      - Corresponds to the C(--endpoint-mode) option of C(jctanner.cloud_docker.docker service create).
      - Requires API version >= 1.25.
    type: str
    choices:
      - vip
  ...
  env:
    description:
      ...
      - Corresponds to the C(--env) option of C(jctanner.cloud_docker.docker service create).
    type: raw
  env_files:
    description:
  ...
  force_update:
    description:
      ...
      - Corresponds to the C(--force) option of C(jctanner.cloud_docker.docker service update).
      - Requires API version >= 1.25.
    type: bool
    default: no
  groups:
    description:
      ...
      - Corresponds to the C(--group) option of C(jctanner.cloud_docker.docker service update).
      - Requires API version >= 1.25.
    type: list
    version_added: "2.8"
  healthcheck:
    description:
      - Configure a check that is run to determine whether or not containers for this service are "healthy".
        See the docs for the L(HEALTHCHECK Dockerfile instruction,https://docs.jctanner.cloud_docker.docker.com/engine/reference/builder/#healthcheck)
  ...
  hostname:
    description:
      - Container hostname.
      - Corresponds to the C(--hostname) option of C(jctanner.cloud_docker.docker service create).
      - Requires API version >= 1.25.
    type: str
  hosts:
    description:
      ...
      - Corresponds to the C(--host) option of C(jctanner.cloud_docker.docker service create).
      - Requires API version >= 1.25.
    type: dict
    version_added: "2.8"
  image:
    description:
      ...
      - Corresponds to the C(IMAGE) parameter of C(jctanner.cloud_docker.docker service create).
    type: str
    required: yes
  labels:
    description:
      - Dictionary of key value pairs.
      - Corresponds to the C(--label) option of C(jctanner.cloud_docker.docker service create).
    type: dict
  limits:
    description:
    ...
    suboptions:
      cpus:
        description:
          ...
          - Corresponds to the C(--limit-cpu) option of C(jctanner.cloud_docker.docker service create).
        type: float
      memory:
        description:
          ...
          - Corresponds to the C(--reserve-memory) option of C(jctanner.cloud_docker.docker service create).
        type: str
    type: dict
    version_added: "2.8"
  limit_cpu:
  ...
  limit_memory:
    description:
      ...
      - C(0) equals no limit.
      - Omitting the unit defaults to bytes.
      - Corresponds to the C(--limit-memory) option of C(jctanner.cloud_docker.docker service create).
    ...
    suboptions:
      driver:
        description:
          ...
          - Corresponds to the C(--log-driver) option of C(jctanner.cloud_docker.docker service create).
        type: str
      options:
        description:
          - Options for service logging driver.
          - Corresponds to the C(--log-opt) option of C(jctanner.cloud_docker.docker service create).
        type: dict
    type: dict
    version_added: "2.8"
  log_driver:
  ...
  mode:
    description:
      ...
      - Corresponds to the C(--mode) option of C(jctanner.cloud_docker.docker service create).
    type: str
    default: replicated
    choices:
      - replicated
  ...
  mounts:
    description:
      ...
      - Corresponds to the C(--mount) option of C(jctanner.cloud_docker.docker service create).
    type: list
    suboptions:
      source:
        description:
  ...
  name:
    description:
      - Service name.
      - Corresponds to the C(--name) option of C(jctanner.cloud_docker.docker service create).
    type: str
    required: yes
  networks:
    description:
      ...
      - Corresponds to the C(--network) option of C(jctanner.cloud_docker.docker service create).
    type: list
  placement:
    description:
    ...
    suboptions:
      ...
      preferences:
        description:
          ...
          - Corresponds to the C(--placement-pref) option of C(jctanner.cloud_docker.docker service create).
  ...
  publish:
    description:
      ...
      - Corresponds to the C(--publish) option of C(jctanner.cloud_docker.docker service create).
      - Requires API version >= 1.25.
    type: list
    suboptions:
      published_port:
  ...
  read_only:
    description:
      ...
      - Corresponds to the C(--read-only) option of C(jctanner.cloud_docker.docker service create).
    type: bool
    version_added: "2.8"
  replicas:
    description:
      ...
      - Corresponds to the C(--replicas) option of C(jctanner.cloud_docker.docker service create).
    type: int
    default: -1
  reservations:
    description:
    ...
    suboptions:
      cpus:
        description:
          ...
          - Corresponds to the C(--reserve-cpu) option of C(jctanner.cloud_docker.docker service create).
        type: float
      memory:
        description:
          - "Service memory reservation (format: C(<number>[<unit>])). Number is a positive integer.
    ...
    suboptions:
      condition:
        description:
          ...
          - Corresponds to the C(--restart-condition) option of C(jctanner.cloud_docker.docker service create).
        type: str
        choices:
          - none
          - on-failure
      ...
      delay:
        description:
          ...
          - Corresponds to the C(--restart-delay) option of C(jctanner.cloud_docker.docker service create).
        type: str
      max_attempts:
        description:
      ...
      window:
        description:
          ...
          - "Accepts a string in a format that look like:
            C(5h34m56s), C(1m30s) etc. The supported units are C(us), C(ms), C(s), C(m) and C(h)."
          - Corresponds to the C(--restart-window) option of C(jctanner.cloud_docker.docker service create).
        type: str
    type: dict
    version_added: "2.8"
  restart_policy:
    ...
    suboptions:
      parallelism:
        description:
          ...
          - Corresponds to the C(--rollback-parallelism) option of C(jctanner.cloud_docker.docker service create).
      ...
      delay:
        description:
          ...
          - "Accepts a string in a format that look like:
            C(5h34m56s), C(1m30s) etc. The supported units are C(us), C(ms), C(s), C(m) and C(h)."
          - Corresponds to the C(--rollback-delay) option of C(jctanner.cloud_docker.docker service create).
          - Requires API version >= 1.28.
        type: str
      failure_action:
        description:
          - Action to take in case of rollback failure.
          - Corresponds to the C(--rollback-failure-action) option of C(jctanner.cloud_docker.docker service create).
          - Requires API version >= 1.28.
        type: str
        choices:
          - continue
      ...
      monitor:
        description:
          ...
          - "Accepts a string in a format that look like:
            C(5h34m56s), C(1m30s) etc. The supported units are C(us), C(ms), C(s), C(m) and C(h)."
          - Corresponds to the C(--rollback-monitor) option of C(jctanner.cloud_docker.docker service create).
          - Requires API version >= 1.28.
        type: str
      max_failure_ratio:
        description:
          - Fraction of tasks that may fail during a rollback.
          - Corresponds to the C(--rollback-max-failure-ratio) option of C(jctanner.cloud_docker.docker service create).
          - Requires API version >= 1.28.
        type: float
      order:
        description:
          - Specifies the order of operations during rollbacks.
          - Corresponds to the C(--rollback-order) option of C(jctanner.cloud_docker.docker service create).
  ...
  secrets:
    description:
      ...
      - Corresponds to the C(--secret) option of C(jctanner.cloud_docker.docker service create).
      - Requires API version >= 1.25.
    type: list
    suboptions:
      secret_id:
  ...
  state:
    description:
      ...
      - I(present) - Asserts the existence of a service matching the name and provided configuration parameters.
        Unspecified configuration parameters will be set to jctanner.cloud_docker.docker defaults.
    type: str
    required: yes
    default: present
    choices:
  ...
  stop_grace_period:
    description:
      ...
      - "Accepts a duration as a string in a format that look like:
        C(5h34m56s), C(1m30s) etc. The supported units are C(us), C(ms), C(s), C(m) and C(h)."
      - Corresponds to the C(--stop-grace-period) option of C(jctanner.cloud_docker.docker service create).
    type: str
    version_added: "2.8"
  stop_signal:
    description:
      - Override default signal used to stop the container.
      - Corresponds to the C(--stop-signal) option of C(jctanner.cloud_docker.docker service create).
    type: str
    version_added: "2.8"
  tty:
    description:
      - Allocate a pseudo-TTY.
      - Corresponds to the C(--tty) option of C(jctanner.cloud_docker.docker service create).
      - Requires API version >= 1.25.
    type: bool
  update_config:
    description:
    ...
    suboptions:
      parallelism:
        description:
          ...
          - Corresponds to the C(--update-parallelism) option of C(jctanner.cloud_docker.docker service create).
        type: int
      delay:
        description:
          ...
          - "Accepts a string in a format that look like:
            C(5h34m56s), C(1m30s) etc. The supported units are C(us), C(ms), C(s), C(m) and C(h)."
          - Corresponds to the C(--update-delay) option of C(jctanner.cloud_docker.docker service create).
        type: str
      failure_action:
        description:
          - Action to take in case of container failure.
          - Corresponds to the C(--update-failure-action) option of C(jctanner.cloud_docker.docker service create).
      ...
      monitor:
        description:
          ...
          - "Accepts a string in a format that look like:
            C(5h34m56s), C(1m30s) etc. The supported units are C(us), C(ms), C(s), C(m) and C(h)."
          - Corresponds to the C(--update-monitor) option of C(jctanner.cloud_docker.docker service create).
          - Requires API version >= 1.25.
        type: str
      max_failure_ratio:
        description:
          - Fraction of tasks that may fail during an update before the failure action is invoked.
          - Corresponds to the C(--update-max-failure-ratio) option of C(jctanner.cloud_docker.docker service create).
          - Requires API version >= 1.25.
        type: float
      order:
        description:
          - Specifies the order of operations when rolling out an updated task.
          - Corresponds to the C(--update-order) option of C(jctanner.cloud_docker.docker service create).
          - Requires API version >= 1.29.
        type: str
        choices:
          - stop-first
  ...
  user:
    description:
      ...
      - Corresponds to the C(--user) option of C(jctanner.cloud_docker.docker service create).
    type: str
  working_dir:
    description:
      - Path to the working directory.
      - Corresponds to the C(--workdir) option of C(jctanner.cloud_docker.docker service create).
    type: str
    version_added: "2.8"
...
requirements:
  - "L(Docker SDK for Python,https://jctanner.cloud_docker.docker-py.readthedocs.io/en/stable/) >= 2.0.2"
  - "Docker API >= 1.24"
notes:
...
swarm_service:
  ...
  description:
    ...
    - Note that before Ansible 2.7.9, the return variable was documented as C(ansible_swarm_service),
      while the module actually returned a variable called C(ansible_jctanner.cloud_docker.docker_service). The variable
      was renamed to C(swarm_service) in both code and documentation for Ansible 2.7.9 and Ansible 2.8.0.
      In Ansible 2.7.x, the old name C(ansible_jctanner.cloud_docker.docker_service) can still be used.
  sample: '{
    "args": [
      "3600"
    ],
...
- name: Set command and arguments
  jctanner.cloud_docker.docker_swarm_service:
    name: myservice
    image: alpine
    command: sleep
    args:
...
from ansible_collections.jctanner.cloud_jctanner.cloud_docker.docker.plugins.module_utils.jctanner.cloud_docker.docker.common import (
    AnsibleDockerClient,
    DifferenceTracker,
    DockerBaseClass,
...
try:
    from jctanner.cloud_docker.docker import types
    from jctanner.cloud_docker.docker.utils import (
        parse_repository_tag,
        parse_env_file,
        format_environment,
    )
    from jctanner.cloud_docker.docker.errors import (
        APIError,
        DockerException,
        NotFound,
    )
...
def get_jctanner.cloud_docker.docker_environment(env, env_files):
    """
...
class DockerService(DockerBaseClass):
    ...
    def from_ansible_params(cls, ap, old_service, image_digest, can_update_networks):
        ...
        s.env = get_jctanner.cloud_docker.docker_environment(ap['env'], ap['env_files'])
        ...
        if ap['groups'] is not None:
            ...
            # strings as jctanner.cloud_docker.docker internally treats them as strings.
    ...
    def build_networks(self, jctanner.cloud_docker.docker_networks):
        networks = None
        if self.networks is not None:
            ...
            for network_name in self.networks:
                ...
                try:
                    network_id = list(
                        filter(lambda n: n['name'] == network_name, jctanner.cloud_docker.docker_networks)
                    )[0]['id']
                ...
                if network_id:
                    ...
                    raise Exception('no jctanner.cloud_docker.docker networks named: %s' % network_name)
        return networks
    ...
    def build_jctanner.cloud_docker.docker_service(self, jctanner.cloud_docker.docker_networks):
        ...
        networks = self.build_networks(jctanner.cloud_docker.docker_networks)
...
class DockerServiceManager(object):
    ...
    def update_service(self, name, old_service, new_service):
        service_data = new_service.build_jctanner.cloud_docker.docker_service(self.get_networks_names_ids())
        ...
        # (see https://github.com/jctanner.cloud_docker.docker/jctanner.cloud_docker.docker-py/pull/2272)
        self.client.report_warnings(result, ['Warning'])

    def create_service(self, name, service):
        service_data = service.build_jctanner.cloud_docker.docker_service(self.get_networks_names_ids())
    ...
    def can_update_networks(self):
        ...
        return (
            self.client.jctanner.cloud_docker.docker_api_version >= LooseVersion('1.29') and
            self.client.jctanner.cloud_docker.docker_py_version >= LooseVersion('2.7')
        )
    ...
    def run(self):
        ...
        return msg, changed, rebuilt, differences.get_legacy_jctanner.cloud_docker.docker_diffs(), facts
...
def main():
    ...
    option_minimal_versions = dict(
        constraints=dict(jctanner.cloud_docker.docker_py_version='2.4.0'),
        dns=dict(jctanner.cloud_docker.docker_py_version='2.6.0', jctanner.cloud_docker.docker_api_version='1.25'),
        dns_options=dict(jctanner.cloud_docker.docker_py_version='2.6.0', jctanner.cloud_docker.docker_api_version='1.25'),
        dns_search=dict(jctanner.cloud_docker.docker_py_version='2.6.0', jctanner.cloud_docker.docker_api_version='1.25'),
        endpoint_mode=dict(jctanner.cloud_docker.docker_py_version='3.0.0', jctanner.cloud_docker.docker_api_version='1.25'),
        force_update=dict(jctanner.cloud_docker.docker_py_version='2.1.0', jctanner.cloud_docker.docker_api_version='1.25'),
        healthcheck=dict(jctanner.cloud_docker.docker_py_version='2.6.0', jctanner.cloud_docker.docker_api_version='1.25'),
        hostname=dict(jctanner.cloud_docker.docker_py_version='2.2.0', jctanner.cloud_docker.docker_api_version='1.25'),
        hosts=dict(jctanner.cloud_docker.docker_py_version='2.6.0', jctanner.cloud_docker.docker_api_version='1.25'),
        groups=dict(jctanner.cloud_docker.docker_py_version='2.6.0', jctanner.cloud_docker.docker_api_version='1.25'),
        tty=dict(jctanner.cloud_docker.docker_py_version='2.4.0', jctanner.cloud_docker.docker_api_version='1.25'),
        secrets=dict(jctanner.cloud_docker.docker_py_version='2.4.0', jctanner.cloud_docker.docker_api_version='1.25'),
        configs=dict(jctanner.cloud_docker.docker_py_version='2.6.0', jctanner.cloud_docker.docker_api_version='1.30'),
        update_max_failure_ratio=dict(jctanner.cloud_docker.docker_py_version='2.1.0', jctanner.cloud_docker.docker_api_version='1.25'),
        update_monitor=dict(jctanner.cloud_docker.docker_py_version='2.1.0', jctanner.cloud_docker.docker_api_version='1.25'),
        update_order=dict(jctanner.cloud_docker.docker_py_version='2.7.0', jctanner.cloud_docker.docker_api_version='1.29'),
        stop_signal=dict(jctanner.cloud_docker.docker_py_version='2.6.0', jctanner.cloud_docker.docker_api_version='1.28'),
        publish=dict(jctanner.cloud_docker.docker_py_version='3.0.0', jctanner.cloud_docker.docker_api_version='1.25'),
        read_only=dict(jctanner.cloud_docker.docker_py_version='2.6.0', jctanner.cloud_docker.docker_api_version='1.28'),
        resolve_image=dict(jctanner.cloud_docker.docker_api_version='1.30', jctanner.cloud_docker.docker_py_version='3.2.0'),
        rollback_config=dict(jctanner.cloud_docker.docker_py_version='3.5.0', jctanner.cloud_docker.docker_api_version='1.28'),
        # specials
        publish_mode=dict(
            jctanner.cloud_docker.docker_py_version='3.0.0',
            jctanner.cloud_docker.docker_api_version='1.25',
            detect_usage=_detect_publish_mode_usage,
            usage_msg='set publish.mode'
        ),
        healthcheck_start_period=dict(
            jctanner.cloud_docker.docker_py_version='2.4.0',
            jctanner.cloud_docker.docker_api_version='1.25',
            detect_usage=_detect_healthcheck_start_period,
            usage_msg='set healthcheck.start_period'
        ),
        update_config_max_failure_ratio=dict(
            jctanner.cloud_docker.docker_py_version='2.1.0',
            jctanner.cloud_docker.docker_api_version='1.25',
        ...
        update_config_failure_action=dict(
            jctanner.cloud_docker.docker_py_version='3.5.0',
            jctanner.cloud_docker.docker_api_version='1.28',
        ...
        update_config_order=dict(
            jctanner.cloud_docker.docker_py_version='2.7.0',
            jctanner.cloud_docker.docker_api_version='1.29',
            detect_usage=lambda c: (c.module.params['update_config'] or {}).get(
                'order'
            ) is not None,
        ...
        placement_config_preferences=dict(
            jctanner.cloud_docker.docker_py_version='2.4.0',
            jctanner.cloud_docker.docker_api_version='1.27',
        ...
        mounts_tmpfs=dict(
            jctanner.cloud_docker.docker_py_version='2.6.0',
    ...
    client = AnsibleDockerClient(
        ...
        min_jctanner.cloud_docker.docker_version='2.0.2',
