...
DOCUMENTATION = '''
---
module: jctanner.cloud_docker.docker_node
...
options:
    ...
    labels:
        description:
            ...
            - Label operations in this module apply to the jctanner.cloud_docker.docker swarm node specified by I(hostname).
              Use M(jctanner.cloud_docker.docker_swarm) module to add/modify/remove swarm cluster labels.
...
EXAMPLES = '''
- name: Set node role
  jctanner.cloud_docker.docker_node:
    hostname: mynode
    role: manager
