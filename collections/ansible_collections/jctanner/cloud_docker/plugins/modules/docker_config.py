...
DOCUMENTATION = '''
---
module: jctanner.cloud_docker.docker_config

short_description: Manage jctanner.cloud_docker.docker configs.

version_added: "2.8"

description:
     - Create and remove Docker configs in a Swarm environment. Similar to C(jctanner.cloud_docker.docker config create) and C(jctanner.cloud_docker.docker config rm).
...
requirements:
  - "L(Docker SDK for Python,https://jctanner.cloud_docker.docker-py.readthedocs.io/en/stable/) >= 2.6.0"
  - "Docker API >= 1.30"
...
def main():
    ...
    client = AnsibleDockerClient(
        ...
        min_jctanner.cloud_docker.docker_version='2.6.0',
        min_jctanner.cloud_docker.docker_api_version='1.30',
    )
