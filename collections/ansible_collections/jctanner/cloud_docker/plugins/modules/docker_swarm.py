...
DOCUMENTATION = '''
---
module: jctanner.cloud_docker.docker_swarm
...
options:
  ...
  labels:
    description:
      ...
      - Label operations in this module apply to the jctanner.cloud_docker.docker swarm cluster.
        Use M(jctanner.cloud_docker.docker_node) module to add/modify/remove swarm node labels.
  ...
  autolock_managers:
    description:
      ...
      - M(jctanner.cloud_docker.docker_swarm_info) can be used to retrieve the unlock key.
    type: bool
  rotate_worker_token:
...
- name: Init a new swarm with default parameters
  jctanner.cloud_docker.docker_swarm:
    state: present
    ...
    def __call__(self):
        ...
        if self.state == 'inspect':
            self.client.module.deprecate(
                "The 'inspect' state is deprecated, please use 'jctanner.cloud_docker.docker_swarm_info' to inspect swarm cluster",
                version='2.12')
...
def main():
    ...
    option_minimal_versions = dict(
        labels=dict(jctanner.cloud_docker.docker_py_version='2.6.0', jctanner.cloud_docker.docker_api_version='1.32'),
        signing_ca_cert=dict(jctanner.cloud_docker.docker_py_version='2.6.0', jctanner.cloud_docker.docker_api_version='1.30'),
        signing_ca_key=dict(jctanner.cloud_docker.docker_py_version='2.6.0', jctanner.cloud_docker.docker_api_version='1.30'),
        ca_force_rotate=dict(jctanner.cloud_docker.docker_py_version='2.6.0', jctanner.cloud_docker.docker_api_version='1.30'),
        autolock_managers=dict(jctanner.cloud_docker.docker_py_version='2.6.0'),
        log_driver=dict(jctanner.cloud_docker.docker_py_version='2.6.0'),
        ...
        default_addr_pool=dict(jctanner.cloud_docker.docker_py_version='4.0.0', jctanner.cloud_docker.docker_api_version='1.39'),
        subnet_size=dict(jctanner.cloud_docker.docker_py_version='4.0.0', jctanner.cloud_docker.docker_api_version='1.39'),
    )
