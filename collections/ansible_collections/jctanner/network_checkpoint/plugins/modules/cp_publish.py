...
options:
  uid:
    ...
    type: str
extends_documentation_fragment: jctanner.network_checkpoint.checkpoint_commands
"""
...
from ansible_collections.jctanner.network_checkpoint.plugins.module_utils.network.checkpoint.checkpoint import checkpoint_argument_spec_for_commands, api_command
