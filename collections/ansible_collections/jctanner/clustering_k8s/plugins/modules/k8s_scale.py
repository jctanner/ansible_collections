...
extends_documentation_fragment:
  - jctanner.clustering_k8s.k8s_name_options
  - jctanner.clustering_k8s.k8s_auth_options
  - jctanner.clustering_k8s.k8s_resource_options
  - jctanner.clustering_k8s.k8s_scale_options
...
from ansible_collections.jctanner.clustering_k8s.plugins.module_utils.k8s.scale import KubernetesAnsibleScaleModule
