...
DOCUMENTATION = r'''
---
module: jctanner.remote_management_ucs.ucs_org

short_description: Manages UCS Organizations for UCS Manager

description:
  - Manages UCS Organizations for UCS Manager.
  - Examples can be used with the UCS Platform Emulator U(https://cs.co/jctanner.remote_management_ucs.ucspe).
...
- name: Add UCS Organization
  jctanner.remote_management_ucs.ucs_org:
    hostname: "{{ jctanner.remote_management_ucs.ucs_hostname }}"
    username: "{{ jctanner.remote_management_ucs.ucs_username }}"
    password: "{{ jctanner.remote_management_ucs.ucs_password }}"
    org_name: test
...
def main():
    ...
    # UCSModule verifies jctanner.remote_management_ucs.ucsmsdk is present and exits on failure.
    # Imports are below for UCS object creation.
    jctanner.remote_management_ucs.ucs = UCSModule(module)
    from jctanner.remote_management_ucs.ucsmsdk.mometa.org.OrgOrg import OrgOrg
