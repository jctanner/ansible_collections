...
DOCUMENTATION = r'''
---
module: jctanner.remote_management_ucs.ucs_wwn_pool
...
- name: Configure WWNN/WWPN pools
  jctanner.remote_management_ucs.ucs_wwn_pool:
...
def main():
    ...
    from jctanner.remote_management_ucs.ucsmsdk.mometa.fcpool.FcpoolInitiators import FcpoolInitiators
    from jctanner.remote_management_ucs.ucsmsdk.mometa.fcpool.FcpoolBlock import FcpoolBlock
