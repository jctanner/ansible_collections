...
DOCUMENTATION = r'''
---
module: jctanner.remote_management_ucs.ucs_storage_profile
...
- name: Configure Storage Profile
  jctanner.remote_management_ucs.ucs_storage_profile:
...
def main():
    ...
    # UCSModule creation above verifies jctanner.remote_management_ucs.ucsmsdk is present and exits on failure.  Additional imports are done below.
    from jctanner.remote_management_ucs.ucsmsdk.mometa.lstorage.LstorageProfile import LstorageProfile
    from jctanner.remote_management_ucs.ucsmsdk.mometa.lstorage.LstorageDasScsiLun import LstorageDasScsiLun
