...
DOCUMENTATION = r'''
---
module: jctanner.remote_management_ucs.ucs_vnic_template
...
- name: Configure vNIC template
  jctanner.remote_management_ucs.ucs_vnic_template:
...
def main():
    ...
    from jctanner.remote_management_ucs.ucsmsdk.mometa.vnic.VnicLanConnTempl import VnicLanConnTempl
    from jctanner.remote_management_ucs.ucsmsdk.mometa.vnic.VnicEtherIf import VnicEtherIf
