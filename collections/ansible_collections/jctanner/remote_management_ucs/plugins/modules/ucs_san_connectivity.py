...
DOCUMENTATION = r'''
---
module: jctanner.remote_management_ucs.ucs_san_connectivity
...
- name: Configure SAN Connectivity Policy
  jctanner.remote_management_ucs.ucs_san_connectivity:
...
def main():
    ...
    from jctanner.remote_management_ucs.ucsmsdk.mometa.vnic.VnicSanConnPolicy import VnicSanConnPolicy
    from jctanner.remote_management_ucs.ucsmsdk.mometa.vnic.VnicFcNode import VnicFcNode
    from jctanner.remote_management_ucs.ucsmsdk.mometa.vnic.VnicFc import VnicFc
    from jctanner.remote_management_ucs.ucsmsdk.mometa.vnic.VnicFcIf import VnicFcIf
