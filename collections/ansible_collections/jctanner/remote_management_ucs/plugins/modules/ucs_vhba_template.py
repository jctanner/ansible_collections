...
DOCUMENTATION = r'''
---
module: jctanner.remote_management_ucs.ucs_vhba_template
...
- name: Configure vHBA template
  jctanner.remote_management_ucs.ucs_vhba_template:
...
def main():
    ...
    from jctanner.remote_management_ucs.ucsmsdk.mometa.vnic.VnicSanConnTempl import VnicSanConnTempl
