...
DOCUMENTATION = r'''
---
module: jctanner.remote_management_ucs.ucs_dns_server

short_description: Configure DNS servers on Cisco UCS Manager

extends_documentation_fragment:
- jctanner.remote_management_ucs.ucs
...
- name: Configure DNS server
  jctanner.remote_management_ucs.ucs_dns_server:
...
def run_module():
    ...
    from jctanner.remote_management_ucs.ucsmsdk.mometa.comm.CommDnsProvider import CommDnsProvider
