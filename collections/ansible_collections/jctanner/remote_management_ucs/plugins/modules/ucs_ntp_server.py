...
DOCUMENTATION = r'''
---
module: jctanner.remote_management_ucs.ucs_ntp_server
...
- name: Configure NTP server
  jctanner.remote_management_ucs.ucs_ntp_server:
...
def run_module():
    ...
    from jctanner.remote_management_ucs.ucsmsdk.mometa.comm.CommNtpProvider import CommNtpProvider
