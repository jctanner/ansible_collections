...
DOCUMENTATION = r'''
---
module: jctanner.remote_management_ucs.ucs_ip_pool
...
- name: Configure IPv4 address pools
  jctanner.remote_management_ucs.ucs_ip_pool:
...
def main():
    ...
    from jctanner.remote_management_ucs.ucsmsdk.mometa.ippool.IppoolPool import IppoolPool
    from jctanner.remote_management_ucs.ucsmsdk.mometa.ippool.IppoolBlock import IppoolBlock
    from jctanner.remote_management_ucs.ucsmsdk.mometa.ippool.IppoolIpV6Block import IppoolIpV6Block
