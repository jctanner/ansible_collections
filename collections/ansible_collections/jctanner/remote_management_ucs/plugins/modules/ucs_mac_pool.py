...
DOCUMENTATION = r'''
---
module: jctanner.remote_management_ucs.ucs_mac_pool
...
- name: Configure MAC address pool
  jctanner.remote_management_ucs.ucs_mac_pool:
...
def main():
    ...
    from jctanner.remote_management_ucs.ucsmsdk.mometa.macpool.MacpoolPool import MacpoolPool
    from jctanner.remote_management_ucs.ucsmsdk.mometa.macpool.MacpoolBlock import MacpoolBlock
