...
DOCUMENTATION = r'''
---
module: jctanner.remote_management_ucs.ucs_vlans
...
EXAMPLES = r'''
- name: Configure VLAN
  jctanner.remote_management_ucs.ucs_vlans:
...
def main():
    ...
    # UCSModule creation above verifies jctanner.remote_management_ucs.ucsmsdk is present and exits on failure, so additional imports are done below.
    from jctanner.remote_management_ucs.ucsmsdk.mometa.fabric.FabricVlan import FabricVlan
