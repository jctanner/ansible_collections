...
try:
    ...
    from library.module_utils.network.jctanner.network_f5.f5.compare import compare_complex_list
    from library.module_utils.network.jctanner.network_f5.f5.icontrol import module_provisioned
    ...
    from ansible_collections.jctanner.network_jctanner.network_f5.f5.plugins.module_utils.network.jctanner.network_f5.f5.compare import compare_complex_list
    from ansible_collections.jctanner.network_jctanner.network_f5.f5.plugins.module_utils.network.jctanner.network_f5.f5.icontrol import module_provisioned
