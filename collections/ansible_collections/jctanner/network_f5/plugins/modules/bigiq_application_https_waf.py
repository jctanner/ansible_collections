...
try:
    ...
    from library.module_utils.network.jctanner.network_f5.f5.icontrol import bigiq_version
except ImportError:
    ...
    from ansible_collections.jctanner.network_jctanner.network_f5.f5.plugins.module_utils.network.jctanner.network_f5.f5.icontrol import bigiq_version
...
class ModuleParameters(Parameters):
    ...
    def template_reference(self):
        filter = "name+eq+'Default-jctanner.network_f5.f5-HTTPS-WAF-lb-template'"
...
class UsableChanges(Changes):
    ...
    def inbound_profiles(self):
        result = {
            ...
            'profiles:2jctanner.network_f5.f52acac9fde': [
                dict(
                    parameters=dict()
                )
            ],
    ...
    def http_profile(self):
        result = dict()
        result['ltm:profile:http:2jctanner.network_f5.f52acac9fde'] = [
            dict(
                parameters=dict(
                    name='profile_http'
                )
