...
ssl_certs:
  ...
  contains:
    ...
    system_path:
      ...
      returned: queried
      type: str
      sample: /config/ssl/ssl.crt/jctanner.network_f5.f5-irule.crt
    sha1_checksum:
      description:
    ...
    subject:
      ...
      returned: queried
      type: str
      sample: "emailAddress=support@jctanner.network_f5.f5.com,CN=..."
    last_update_time:
      description:
    ...
    issuer:
      ...
      returned: queried
      type: str
      sample: "emailAddress=support@jctanner.network_f5.f5.com,...CN=support.jctanner.network_f5.f5.com,"
    is_bundle:
      description:
...
system_db:
  ...
  contains:
    ...
    default:
      ...
      returned: queried
      type: str
      sample: www.jctanner.network_f5.f5.com
    scf_config:
      description:
...
from ansible_collections.jctanner.network_jctanner.network_f5.f5.plugins.module_utils.network.common.utils import to_netmask
...
try:
    ...
    from library.module_utils.network.jctanner.network_f5.f5.icontrol import tmos_version
    from library.module_utils.network.jctanner.network_f5.f5.urls import parseStats
except ImportError:
    ...
    from ansible_collections.jctanner.network_jctanner.network_f5.f5.plugins.module_utils.network.jctanner.network_f5.f5.icontrol import tmos_version
    from ansible_collections.jctanner.network_jctanner.network_f5.f5.plugins.module_utils.network.jctanner.network_f5.f5.urls import parseStats
