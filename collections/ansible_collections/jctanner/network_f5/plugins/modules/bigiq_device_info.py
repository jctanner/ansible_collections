...
managed_devices:
  ...
  contains:
    ...
    trust_domain_guid:
      ...
      returned: changed
      type: str
      sample: 40ddjctanner.network_f5.f541-e604-4905-bde3005056813e36
    uuid:
      description:
...
try:
    from library.module_utils.network.jctanner.network_f5.f5.bigiq import F5RestClient
    ...
    from ansible_collections.jctanner.network_jctanner.network_f5.f5.plugins.module_utils.network.jctanner.network_f5.f5.bigiq import F5RestClient
