...
from ansible_collections.jctanner.network_jctanner.network_f5.f5.plugins.module_utils.network.common.utils import remove_default_spec
...
try:
    ...
    from library.module_utils.network.jctanner.network_f5.f5.common import is_valid_hostname
    from library.module_utils.network.jctanner.network_f5.f5.common import flatten_boolean
    from library.module_utils.network.jctanner.network_f5.f5.compare import cmp_str_with_none
    ...
    from library.module_utils.network.jctanner.network_f5.f5.icontrol import TransactionContextManager
except ImportError:
    ...
    from ansible_collections.jctanner.network_jctanner.network_f5.f5.plugins.module_utils.network.jctanner.network_f5.f5.common import is_valid_hostname
    ...
    from ansible_collections.jctanner.network_jctanner.network_f5.f5.plugins.module_utils.network.jctanner.network_f5.f5.compare import cmp_str_with_none
    ...
    from ansible_collections.jctanner.network_jctanner.network_f5.f5.plugins.module_utils.network.jctanner.network_f5.f5.icontrol import TransactionContextManager
