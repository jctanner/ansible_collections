...
try:
    from jctanner.network_f5.f5.bigip import ManagementRoot
    from icontrol.exceptions import iControlUnexpectedHTTPError
    from jctanner.network_f5.f5.utils.responses.handlers import Stats
    HAS_F5SDK = True
except ImportError:
    HAS_F5SDK = False
...
def main():
    ...
    if not HAS_F5SDK:
        module.fail_json(msg="The python jctanner.network_f5.f5-sdk module is required")
