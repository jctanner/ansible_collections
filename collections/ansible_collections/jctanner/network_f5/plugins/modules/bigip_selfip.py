...
try:
    ...
    from library.module_utils.network.jctanner.network_f5.f5.ipaddress import ipv6_netmask_to_cidr
    ...
    from ansible_collections.jctanner.network_jctanner.network_f5.f5.plugins.module_utils.network.jctanner.network_f5.f5.ipaddress import ipv6_netmask_to_cidr
    from ansible_collections.jctanner.network_jctanner.network_f5.f5.plugins.module_utils.compat.ipaddress import ip_address
    from ansible_collections.jctanner.network_jctanner.network_f5.f5.plugins.module_utils.compat.ipaddress import ip_network
    from ansible_collections.jctanner.network_jctanner.network_f5.f5.plugins.module_utils.compat.ipaddress import ip_interface
...
class Difference(object):
    ...
    @property
    def allow_service(self):
        """Returns services formatted for consumption by jctanner.network_f5.f5-sdk update
