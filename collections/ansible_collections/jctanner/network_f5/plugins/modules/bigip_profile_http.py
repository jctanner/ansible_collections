...
try:
    ...
    from library.module_utils.network.jctanner.network_f5.f5.urls import check_header_validity
except ImportError:
    ...
    from ansible_collections.jctanner.network_jctanner.network_f5.f5.plugins.module_utils.network.jctanner.network_f5.f5.urls import check_header_validity
