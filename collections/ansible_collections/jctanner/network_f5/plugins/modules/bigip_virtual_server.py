...
try:
    from library.module_utils.network.jctanner.network_f5.f5.bigip import F5RestClient
    from library.module_utils.network.jctanner.network_f5.f5.common import MANAGED_BY_ANNOTATION_VERSION
    from library.module_utils.network.jctanner.network_f5.f5.common import MANAGED_BY_ANNOTATION_MODIFIED
    from library.module_utils.network.jctanner.network_f5.f5.common import F5ModuleError
    from library.module_utils.network.jctanner.network_f5.f5.common import AnsibleF5Parameters
    from library.module_utils.network.jctanner.network_f5.f5.common import fq_name
    from library.module_utils.network.jctanner.network_f5.f5.common import jctanner.network_f5.f5_argument_spec
    from library.module_utils.network.jctanner.network_f5.f5.common import transform_name
    from library.module_utils.network.jctanner.network_f5.f5.common import mark_managed_by
    from library.module_utils.network.jctanner.network_f5.f5.common import only_has_managed_metadata
    from library.module_utils.network.jctanner.network_f5.f5.common import flatten_boolean
    from library.module_utils.network.jctanner.network_f5.f5.compare import cmp_simple_list
    from library.module_utils.network.jctanner.network_f5.f5.ipaddress import is_valid_ip
    from library.module_utils.network.jctanner.network_f5.f5.ipaddress import ip_interface
    from library.module_utils.network.jctanner.network_f5.f5.ipaddress import validate_ip_v6_address
    from library.module_utils.network.jctanner.network_f5.f5.ipaddress import get_netmask
    from library.module_utils.network.jctanner.network_f5.f5.ipaddress import compress_address
    from library.module_utils.network.jctanner.network_f5.f5.icontrol import modules_provisioned
except ImportError:
    from ansible_collections.jctanner.network_jctanner.network_f5.f5.plugins.module_utils.network.jctanner.network_f5.f5.bigip import F5RestClient
    from ansible_collections.jctanner.network_jctanner.network_f5.f5.plugins.module_utils.network.jctanner.network_f5.f5.common import MANAGED_BY_ANNOTATION_VERSION
    from ansible_collections.jctanner.network_jctanner.network_f5.f5.plugins.module_utils.network.jctanner.network_f5.f5.common import MANAGED_BY_ANNOTATION_MODIFIED
    from ansible_collections.jctanner.network_jctanner.network_f5.f5.plugins.module_utils.network.jctanner.network_f5.f5.common import F5ModuleError
    from ansible_collections.jctanner.network_jctanner.network_f5.f5.plugins.module_utils.network.jctanner.network_f5.f5.common import AnsibleF5Parameters
    from ansible_collections.jctanner.network_jctanner.network_f5.f5.plugins.module_utils.network.jctanner.network_f5.f5.common import fq_name
    ...
    from ansible_collections.jctanner.network_jctanner.network_f5.f5.plugins.module_utils.network.jctanner.network_f5.f5.common import transform_name
    from ansible_collections.jctanner.network_jctanner.network_f5.f5.plugins.module_utils.network.jctanner.network_f5.f5.common import mark_managed_by
    from ansible_collections.jctanner.network_jctanner.network_f5.f5.plugins.module_utils.network.jctanner.network_f5.f5.common import only_has_managed_metadata
    from ansible_collections.jctanner.network_jctanner.network_f5.f5.plugins.module_utils.network.jctanner.network_f5.f5.common import flatten_boolean
    from ansible_collections.jctanner.network_jctanner.network_f5.f5.plugins.module_utils.network.jctanner.network_f5.f5.compare import cmp_simple_list
    from ansible_collections.jctanner.network_jctanner.network_f5.f5.plugins.module_utils.network.jctanner.network_f5.f5.ipaddress import is_valid_ip
    from ansible_collections.jctanner.network_jctanner.network_f5.f5.plugins.module_utils.network.jctanner.network_f5.f5.ipaddress import ip_interface
    from ansible_collections.jctanner.network_jctanner.network_f5.f5.plugins.module_utils.network.jctanner.network_f5.f5.ipaddress import validate_ip_v6_address
    from ansible_collections.jctanner.network_jctanner.network_f5.f5.plugins.module_utils.network.jctanner.network_f5.f5.ipaddress import get_netmask
    from ansible_collections.jctanner.network_jctanner.network_f5.f5.plugins.module_utils.network.jctanner.network_f5.f5.ipaddress import compress_address
    from ansible_collections.jctanner.network_jctanner.network_f5.f5.plugins.module_utils.network.jctanner.network_f5.f5.icontrol import modules_provisioned
