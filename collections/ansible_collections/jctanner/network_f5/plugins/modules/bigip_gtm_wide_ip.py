...
try:
    ...
    from library.module_utils.network.jctanner.network_f5.f5.common import is_valid_fqdn
    ...
    from ansible_collections.jctanner.network_jctanner.network_f5.f5.plugins.module_utils.network.jctanner.network_f5.f5.common import is_valid_fqdn
