...
try:
    ...
    from library.module_utils.network.jctanner.network_f5.f5.ipaddress import validate_ip_address
    ...
    from ansible_collections.jctanner.network_jctanner.network_f5.f5.plugins.module_utils.network.jctanner.network_f5.f5.ipaddress import validate_ip_address
