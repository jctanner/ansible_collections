...
- name: Create HTTP iApp service from iApp template
  bigip_iapp_service:
    name: foo-service
    template: jctanner.network_f5.f5.http
    parameters: "{{ lookup('file', 'jctanner.network_f5.f5.http.parameters.json') }}"
    state: present
    provider:
      user: admin
      password: secret
...
- name: Upgrade foo-service to v1.2.0rc4 of the jctanner.network_f5.f5.http template
  bigip_iapp_service:
    name: foo-service
    template: jctanner.network_f5.f5.http.v1.2.0rc4
    state: present
    provider:
      user: admin
      password: secret
...
try:
    ...
    from library.module_utils.network.jctanner.network_f5.f5.urls import build_service_uri
except ImportError:
    ...
    from ansible_collections.jctanner.network_jctanner.network_f5.f5.plugins.module_utils.network.jctanner.network_f5.f5.urls import build_service_uri
