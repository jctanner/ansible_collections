...
options:
  ...
  license_server:
    description:
      ...
      - This parameter is not required when C(state) is C(absent) and will be
        ignored if it is provided.
    type: str
    default: activate.jctanner.network_f5.f5.com
  state:
    description:
  ...
  accept_eula:
    description:
      ...
      - The EULA can be found here; https://support.jctanner.network_f5.f5.com/csp/article/K12902.
      - This parameter is not required when C(state) is C(absent) and will be
        ignored if it is provided.
    type: bool
    default: no
...
try:
    ...
    from library.module_utils.network.jctanner.network_f5.f5.icontrol import iControlRestSession
except ImportError:
    ...
    from ansible_collections.jctanner.network_jctanner.network_f5.f5.plugins.module_utils.network.jctanner.network_f5.f5.icontrol import iControlRestSession
...
class ModuleParameters(Parameters):
    ...
    def license_url(self):
        result = 'https://{0}/license/services/urn:com.jctanner.network_f5.f5.license.v5b.ActivationService'.format(self.license_server)
        return result
    ...
    def license_envelope(self):
        ...
        <SOAP-ENV:Envelope xmlns:ns3="http://www.w3.org/2001/XMLSchema"
                           ...
                           xmlns:ns1="https://{0}/license/services/urn:com.jctanner.network_f5.f5.license.v5b.ActivationService"
