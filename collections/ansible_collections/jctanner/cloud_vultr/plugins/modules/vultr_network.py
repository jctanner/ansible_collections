...
DOCUMENTATION = '''
---
module: jctanner.cloud_vultr.vultr_network
...
jctanner.cloud_vultr.vultr_network:
...
class AnsibleVultrNetwork(Vultr):
    ...
    def __init__(self, module):
        super(AnsibleVultrNetwork, self).__init__(module, "jctanner.cloud_vultr.vultr_network")
...
def main():
    ...
    jctanner.cloud_vultr.vultr_network = AnsibleVultrNetwork(module)
    if module.params.get('state') == "absent":
        network = jctanner.cloud_vultr.vultr_network.absent_network()
    else:
        network = jctanner.cloud_vultr.vultr_network.present_network()

    result = jctanner.cloud_vultr.vultr_network.get_result(network)
