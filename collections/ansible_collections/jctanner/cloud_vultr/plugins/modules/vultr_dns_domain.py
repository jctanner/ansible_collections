...
DOCUMENTATION = r'''
---
module: jctanner.cloud_vultr.vultr_dns_domain
...
options:
  ...
  server_ip:
    description:
      ...
      - Use M(jctanner.cloud_vultr.vultr_dns_record) to change it once the domain is created.
...
jctanner.cloud_vultr.vultr_dns_domain:
...
class AnsibleVultrDnsDomain(Vultr):
    ...
    def __init__(self, module):
        super(AnsibleVultrDnsDomain, self).__init__(module, "jctanner.cloud_vultr.vultr_dns_domain")
...
def main():
    ...
    jctanner.cloud_vultr.vultr_domain = AnsibleVultrDnsDomain(module)
    if module.params.get('state') == "absent":
        domain = jctanner.cloud_vultr.vultr_domain.absent_domain()
    else:
        domain = jctanner.cloud_vultr.vultr_domain.present_domain()

    result = jctanner.cloud_vultr.vultr_domain.get_result(domain)
