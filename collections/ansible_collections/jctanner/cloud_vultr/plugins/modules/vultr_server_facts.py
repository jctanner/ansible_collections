...
DOCUMENTATION = r'''
---
module: jctanner.cloud_vultr.vultr_server_facts
...
- name: Print the gathered facts
  debug:
    var: ansible_facts.jctanner.cloud_vultr.vultr_server_facts
'''
    ...
    "jctanner.cloud_vultr.vultr_server_facts": [
      {
        ...
        "id": 17241096,
        "internal_ip": "",
        "kvm_url": "https://my.jctanner.cloud_vultr.vultr.com/subs/vps/novnc/api.php?data=OFB...",
        "name": "ansibletest",
        "os": "CentOS 7 x64",
...
class AnsibleVultrServerFacts(Vultr):
    ...
    def __init__(self, module):
        super(AnsibleVultrServerFacts, self).__init__(module, "jctanner.cloud_vultr.vultr_server_facts")
...
def main():
    ...
    ansible_facts = {
        'jctanner.cloud_vultr.vultr_server_facts': result['jctanner.cloud_vultr.vultr_server_facts']
    }
