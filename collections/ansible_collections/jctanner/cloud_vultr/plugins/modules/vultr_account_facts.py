...
DOCUMENTATION = r'''
---
module: jctanner.cloud_vultr.vultr_account_facts
...
- name: Print the gathered facts
  debug:
    var: ansible_facts.jctanner.cloud_vultr.vultr_account_facts
'''
...
jctanner.cloud_vultr.vultr_account_facts:
...
class AnsibleVultrAccountFacts(Vultr):
    ...
    def __init__(self, module):
        super(AnsibleVultrAccountFacts, self).__init__(module, "jctanner.cloud_vultr.vultr_account_facts")
...
def main():
    ...
    ansible_facts = {
        'jctanner.cloud_vultr.vultr_account_facts': result['jctanner.cloud_vultr.vultr_account_facts']
    }
