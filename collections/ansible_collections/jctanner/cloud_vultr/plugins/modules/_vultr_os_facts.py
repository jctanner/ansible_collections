...
DOCUMENTATION = r'''
---
module: jctanner.cloud_vultr.vultr_os_facts
...
deprecated:
  ...
  alternative: Use M(jctanner.cloud_vultr.vultr_os_info) instead.
...
- name: Print the gathered facts
  debug:
    var: ansible_facts.jctanner.cloud_vultr.vultr_os_facts
'''
...
ansible_facts:
  ...
  type: complex
  contains:
    "jctanner.cloud_vultr.vultr_os_facts": [
      {
        "arch": "x64",
        "family": "openbsd",
        "id": 234,
...
class AnsibleVultrOSFacts(Vultr):
    ...
    def __init__(self, module):
        super(AnsibleVultrOSFacts, self).__init__(module, "jctanner.cloud_vultr.vultr_os_facts")
...
def main():
    ...
    ansible_facts = {
        'jctanner.cloud_vultr.vultr_os_facts': result['jctanner.cloud_vultr.vultr_os_facts']
    }
