...
DOCUMENTATION = r'''
---
module: jctanner.cloud_vultr.vultr_startup_script_facts
short_description: Gather facts about the Vultr startup scripts available.
description:
  - Gather facts about jctanner.cloud_vultr.vultr_startup_scripts available.
version_added: "2.7"
...
- name: Print the gathered facts
  debug:
    var: ansible_facts.jctanner.cloud_vultr.vultr_startup_script_facts
'''
...
jctanner.cloud_vultr.vultr_startup_script_facts:
...
class AnsibleVultrStartupScriptFacts(Vultr):
    ...
    def __init__(self, module):
        super(AnsibleVultrStartupScriptFacts, self).__init__(module, "jctanner.cloud_vultr.vultr_startup_script_facts")
...
def main():
    ...
    ansible_facts = {
        'jctanner.cloud_vultr.vultr_startup_script_facts': result['jctanner.cloud_vultr.vultr_startup_script_facts']
    }
