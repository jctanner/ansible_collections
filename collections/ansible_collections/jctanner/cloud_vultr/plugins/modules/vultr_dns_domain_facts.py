...
DOCUMENTATION = r'''
---
module: jctanner.cloud_vultr.vultr_dns_domain_facts
...
- name: Gather Vultr DNS domains facts
  local_action:
    module: jctanner.cloud_vultr.vultr_dns_domains_facts

- name: Print the gathered facts
  debug:
    var: ansible_facts.jctanner.cloud_vultr.vultr_dns_domain_facts
'''
...
jctanner.cloud_vultr.vultr_dns_domain_facts:
...
class AnsibleVultrDnsDomainFacts(Vultr):
    ...
    def __init__(self, module):
        super(AnsibleVultrDnsDomainFacts, self).__init__(module, "jctanner.cloud_vultr.vultr_dns_domain_facts")
...
def main():
    ...
    ansible_facts = {
        'jctanner.cloud_vultr.vultr_dns_domain_facts': result['jctanner.cloud_vultr.vultr_dns_domain_facts']
    }
