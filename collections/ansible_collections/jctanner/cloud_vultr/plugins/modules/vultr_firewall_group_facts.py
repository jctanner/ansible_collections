...
DOCUMENTATION = r'''
---
module: jctanner.cloud_vultr.vultr_firewall_group_facts
...
- name: Print the gathered facts
  debug:
    var: ansible_facts.jctanner.cloud_vultr.vultr_firewall_group_facts
'''
...
jctanner.cloud_vultr.vultr_firewall_group_facts:
...
class AnsibleVultrFirewallGroupFacts(Vultr):
    ...
    def __init__(self, module):
        super(AnsibleVultrFirewallGroupFacts, self).__init__(module, "jctanner.cloud_vultr.vultr_firewall_group_facts")
...
def main():
    ...
    ansible_facts = {
        'jctanner.cloud_vultr.vultr_firewall_group_facts': result['jctanner.cloud_vultr.vultr_firewall_group_facts']
    }
