...
DOCUMENTATION = r'''
---
module: jctanner.cloud_vultr.vultr_plan_facts
...
- name: Print the gathered facts
  debug:
    var: ansible_facts.jctanner.cloud_vultr.vultr_plan_facts
'''
...
jctanner.cloud_vultr.vultr_plan_facts:
...
class AnsibleVultrPlanFacts(Vultr):
    ...
    def __init__(self, module):
        super(AnsibleVultrPlanFacts, self).__init__(module, "jctanner.cloud_vultr.vultr_plan_facts")
...
def main():
    ...
    ansible_facts = {
        'jctanner.cloud_vultr.vultr_plan_facts': result['jctanner.cloud_vultr.vultr_plan_facts']
    }
