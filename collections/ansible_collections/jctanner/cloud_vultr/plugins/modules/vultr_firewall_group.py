...
DOCUMENTATION = '''
---
module: jctanner.cloud_vultr.vultr_firewall_group
...
class AnsibleVultrFirewallGroup(Vultr):
    ...
    def __init__(self, module):
        super(AnsibleVultrFirewallGroup, self).__init__(module, "jctanner.cloud_vultr.vultr_firewall_group")
...
def main():
    ...
    jctanner.cloud_vultr.vultr_firewall_group = AnsibleVultrFirewallGroup(module)
    if module.params.get('state') == "absent":
        firewall_group = jctanner.cloud_vultr.vultr_firewall_group.absent_firewall_group()
    else:
        firewall_group = jctanner.cloud_vultr.vultr_firewall_group.present_firewall_group()

    result = jctanner.cloud_vultr.vultr_firewall_group.get_result(firewall_group)
