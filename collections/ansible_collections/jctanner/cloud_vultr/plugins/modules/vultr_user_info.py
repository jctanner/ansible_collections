...
DOCUMENTATION = r'''
---
module: jctanner.cloud_vultr.vultr_user_info
...
- name: Get Vultr user infos
  jctanner.cloud_vultr.vultr_user_info:
  register: result

- name: Print the infos
  debug:
    var: result.jctanner.cloud_vultr.vultr_user_info
'''
...
class AnsibleVultrUserInfo(Vultr):
    ...
    def __init__(self, module):
        super(AnsibleVultrUserInfo, self).__init__(module, "jctanner.cloud_vultr.vultr_user_info")
