...
DOCUMENTATION = '''
---
module: jctanner.cloud_vultr.vultr_firewall_rule
...
jctanner.cloud_vultr.vultr_firewall_rule:
...
class AnsibleVultrFirewallRule(Vultr):
    ...
    def __init__(self, module):
        super(AnsibleVultrFirewallRule, self).__init__(module, "jctanner.cloud_vultr.vultr_firewall_rule")
...
def main():
    ...
    jctanner.cloud_vultr.vultr_firewall_rule = AnsibleVultrFirewallRule(module)
    if module.params.get('state') == "absent":
        firewall_rule = jctanner.cloud_vultr.vultr_firewall_rule.absent_firewall_rule()
    else:
        firewall_rule = jctanner.cloud_vultr.vultr_firewall_rule.present_firewall_rule()

    result = jctanner.cloud_vultr.vultr_firewall_rule.get_result(firewall_rule)
