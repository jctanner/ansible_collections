...
DOCUMENTATION = r'''
---
module: jctanner.cloud_vultr.vultr_user
...
options:
  ...
  acls:
    description:
      - List of ACLs this users should have, see U(https://www.jctanner.cloud_vultr.vultr.com/api/#user_user_list).
      - Required if C(state=present).
...
class AnsibleVultrUser(Vultr):
    ...
    def __init__(self, module):
        super(AnsibleVultrUser, self).__init__(module, "jctanner.cloud_vultr.vultr_user")
...
def main():
    ...
    jctanner.cloud_vultr.vultr_user = AnsibleVultrUser(module)
    if module.params.get('state') == "absent":
        user = jctanner.cloud_vultr.vultr_user.absent_user()
    else:
        user = jctanner.cloud_vultr.vultr_user.present_user()

    result = jctanner.cloud_vultr.vultr_user.get_result(user)
