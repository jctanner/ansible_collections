...
DOCUMENTATION = '''
---
module: jctanner.cloud_vultr.vultr_block_storage
...
class AnsibleVultrBlockStorage(Vultr):
    ...
    def __init__(self, module):
        super(AnsibleVultrBlockStorage, self).__init__(module, "jctanner.cloud_vultr.vultr_block_storage")
...
def main():
    ...
    jctanner.cloud_vultr.vultr_block_storage = AnsibleVultrBlockStorage(module)
    if module.params.get('state') == "absent":
        volume = jctanner.cloud_vultr.vultr_block_storage.absent_block_storage_volume()
    else:
        volume = jctanner.cloud_vultr.vultr_block_storage.present_block_storage_volume()

    result = jctanner.cloud_vultr.vultr_block_storage.get_result(volume)
