...
DOCUMENTATION = r'''
---
module: jctanner.cloud_vultr.vultr_network_facts
...
- name: Print the gathered facts
  debug:
    var: ansible_facts.jctanner.cloud_vultr.vultr_network_facts
'''
...
class AnsibleVultrNetworkFacts(Vultr):
    ...
    def __init__(self, module):
        super(AnsibleVultrNetworkFacts, self).__init__(module, "jctanner.cloud_vultr.vultr_network_facts")
...
def main():
    ...
    ansible_facts = {
        'jctanner.cloud_vultr.vultr_network_facts': result['jctanner.cloud_vultr.vultr_network_facts']
    }
