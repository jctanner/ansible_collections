...
DOCUMENTATION = r'''
---
module: jctanner.cloud_vultr.vultr_os_info
...
- name: Get Vultr OSes infos
  jctanner.cloud_vultr.vultr_os_info:
  register: results

- name: Print the gathered infos
  debug:
    var: results.jctanner.cloud_vultr.vultr_os_info
'''
...
class AnsibleVultrOSInfo(Vultr):
    ...
    def __init__(self, module):
        super(AnsibleVultrOSInfo, self).__init__(module, "jctanner.cloud_vultr.vultr_os_info")
