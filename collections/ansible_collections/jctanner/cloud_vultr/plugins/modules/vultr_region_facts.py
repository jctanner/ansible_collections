...
DOCUMENTATION = r'''
---
module: jctanner.cloud_vultr.vultr_region_facts
...
- name: Print the gathered facts
  debug:
    var: ansible_facts.jctanner.cloud_vultr.vultr_region_facts
'''
...
class AnsibleVultrRegionFacts(Vultr):
    ...
    def __init__(self, module):
        super(AnsibleVultrRegionFacts, self).__init__(module, "jctanner.cloud_vultr.vultr_region_facts")
...
def main():
    ...
    ansible_facts = {
        'jctanner.cloud_vultr.vultr_region_facts': result['jctanner.cloud_vultr.vultr_region_facts']
    }
