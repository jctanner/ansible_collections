...
DOCUMENTATION = r'''
---
module: jctanner.cloud_vultr.vultr_startup_script
...
- name: ensure a boot script exists
  jctanner.cloud_vultr.vultr_startup_script:
    name: jctanner.cloud_vultr.vultr_startup_script
...
class AnsibleVultrStartupScript(Vultr):
    ...
    def __init__(self, module):
        super(AnsibleVultrStartupScript, self).__init__(module, "jctanner.cloud_vultr.vultr_startup_script")
...
def main():
    ...
    jctanner.cloud_vultr.vultr_script = AnsibleVultrStartupScript(module)
    if module.params.get('state') == "absent":
        script = jctanner.cloud_vultr.vultr_script.absent_script()
    else:
        script = jctanner.cloud_vultr.vultr_script.present_script()

    result = jctanner.cloud_vultr.vultr_script.get_result(script)
