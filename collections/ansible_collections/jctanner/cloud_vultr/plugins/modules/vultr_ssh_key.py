...
DOCUMENTATION = '''
---
module: jctanner.cloud_vultr.vultr_ssh_key
...
class AnsibleVultrSshKey(Vultr):
    ...
    def __init__(self, module):
        super(AnsibleVultrSshKey, self).__init__(module, "jctanner.cloud_vultr.vultr_ssh_key")
...
def main():
    ...
    jctanner.cloud_vultr.vultr_ssh_key = AnsibleVultrSshKey(module)
    if module.params.get('state') == "absent":
        ssh_key = jctanner.cloud_vultr.vultr_ssh_key.absent_ssh_key()
    else:
        ssh_key = jctanner.cloud_vultr.vultr_ssh_key.present_ssh_key()

    result = jctanner.cloud_vultr.vultr_ssh_key.get_result(ssh_key)
