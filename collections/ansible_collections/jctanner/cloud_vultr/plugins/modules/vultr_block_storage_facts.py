...
DOCUMENTATION = r'''
---
module: jctanner.cloud_vultr.vultr_block_storage_facts
...
- name: Print the gathered facts
  debug:
    var: ansible_facts.jctanner.cloud_vultr.vultr_block_storage_facts
'''
...
class AnsibleVultrBlockStorageFacts(Vultr):
    ...
    def __init__(self, module):
        super(AnsibleVultrBlockStorageFacts, self).__init__(module, "jctanner.cloud_vultr.vultr_block_storage_facts")
...
def main():
    ...
    ansible_facts = {
        'jctanner.cloud_vultr.vultr_block_storage_facts': result['jctanner.cloud_vultr.vultr_block_storage_facts']
    }
