...
DOCUMENTATION = '''
---
module: jctanner.cloud_vultr.vultr_dns_record
...
class AnsibleVultrDnsRecord(Vultr):
    ...
    def __init__(self, module):
        super(AnsibleVultrDnsRecord, self).__init__(module, "jctanner.cloud_vultr.vultr_dns_record")
...
def main():
    ...
    jctanner.cloud_vultr.vultr_record = AnsibleVultrDnsRecord(module)
    if module.params.get('state') == "absent":
        record = jctanner.cloud_vultr.vultr_record.absent_record()
    else:
        record = jctanner.cloud_vultr.vultr_record.present_record()

    result = jctanner.cloud_vultr.vultr_record.get_result(record)
