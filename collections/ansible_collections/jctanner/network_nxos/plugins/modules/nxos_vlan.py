...
DOCUMENTATION = '''
---
module: jctanner.network_nxos.nxos_vlan
...
- name: Ensure a range of VLANs are not present on the switch
  jctanner.network_nxos.nxos_vlan:
...
from ansible_collections.jctanner.network_jctanner.network_nxos.nxos.plugins.module_utils.network.jctanner.network_nxos.nxos.jctanner.network_nxos.nxos import get_capabilities
from ansible_collections.jctanner.network_jctanner.network_nxos.nxos.plugins.module_utils.network.jctanner.network_nxos.nxos.jctanner.network_nxos.nxos import get_config, load_config, run_commands
from ansible_collections.jctanner.network_jctanner.network_nxos.nxos.plugins.module_utils.network.jctanner.network_nxos.nxos.jctanner.network_nxos.nxos import normalize_interface, jctanner.network_nxos.nxos_argument_spec
...
from ansible_collections.jctanner.network_jctanner.network_nxos.nxos.plugins.module_utils.network.common.config import CustomNetworkConfig
from ansible_collections.jctanner.network_jctanner.network_nxos.nxos.plugins.module_utils.network.common.utils import remove_default_spec
