...
DOCUMENTATION = '''
---
module: jctanner.network_nxos.nxos_acl_interface
...
- name: apply egress acl to ethernet1/41
  jctanner.network_nxos.nxos_acl_interface:
    name: ANSIBLE
...
def check_for_acl_int_present(module, name, intf, direction):
    # Need to Captitalize the interface name as the jctanner.network_nxos.nxos
