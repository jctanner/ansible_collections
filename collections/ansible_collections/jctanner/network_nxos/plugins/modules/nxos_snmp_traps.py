...
DOCUMENTATION = '''
---
module: jctanner.network_nxos.nxos_snmp_traps
...
notes:
    ...
    - This module works at the group level for traps.  If you need to only
      enable/disable 1 specific trap within a group, use the M(jctanner.network_nxos.nxos_command)
      module.
...
- jctanner.network_nxos.nxos_snmp_traps:
    group: lldp
    state: enabled
