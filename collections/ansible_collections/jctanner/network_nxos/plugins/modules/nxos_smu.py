...
DOCUMENTATION = '''
---
module: jctanner.network_nxos.nxos_smu
...
EXAMPLES = '''
- jctanner.network_nxos.nxos_smu:
    pkg: "jctanner.network_nxos.nxos.CSCuz65185-n9k_EOR-1.0.0-7.0.3.I2.2d.lib32_n9000.rpm"
'''
...
commands:
    ...
    returned: always
    type: list
    sample: ["install add bootflash:jctanner.network_nxos.nxos.CSCuz65185-n9k_EOR-1.0.0-7.0.3.I2.2d.lib32_n9000.rpm",
             "install activate bootflash:jctanner.network_nxos.nxos.CSCuz65185-n9k_EOR-1.0.0-7.0.3.I2.2d.lib32_n9000.rpm force",
             "install commit bootflash:jctanner.network_nxos.nxos.CSCuz65185-n9k_EOR-1.0.0-7.0.3.I2.2d.lib32_n9000.rpm"]
'''
