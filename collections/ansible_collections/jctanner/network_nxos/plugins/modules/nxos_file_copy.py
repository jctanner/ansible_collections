...
DOCUMENTATION = '''
---
module: jctanner.network_nxos.nxos_file_copy
...
EXAMPLES = '''
# File copy from ansible controller to jctanner.network_nxos.nxos device
  - name: "copy from server to device"
    jctanner.network_nxos.nxos_file_copy:
      local_file: "./test_file.txt"
      remote_file: "test_file.txt"

# Initiate file copy from the jctanner.network_nxos.nxos device to transfer file from an SCP server back to the jctanner.network_nxos.nxos device
...
from ansible_collections.jctanner.network_jctanner.network_nxos.nxos.plugins.module_utils.compat.paramiko import paramiko
