...
DOCUMENTATION = """
---
module: jctanner.network_nxos.nxos_l3_interface
version_added: "2.5"
...
- name: Set interface IPv4 address
  jctanner.network_nxos.nxos_l3_interface:
    name: Ethernet2/3
    ipv4: 192.168.0.1/24
...
from ansible_collections.jctanner.network_jctanner.network_nxos.nxos.plugins.module_utils.network.jctanner.network_nxos.nxos.jctanner.network_nxos.nxos import get_config, load_config
