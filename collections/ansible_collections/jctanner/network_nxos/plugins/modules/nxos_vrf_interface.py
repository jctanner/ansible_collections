...
DOCUMENTATION = '''
---
module: jctanner.network_nxos.nxos_vrf_interface
...
notes:
    ...
    - VRF needs to be added globally with M(jctanner.network_nxos.nxos_vrf) before
...
- name: Ensure vrf ntc exists on Eth1/1
  jctanner.network_nxos.nxos_vrf_interface:
    vrf: ntc
...
from ansible_collections.jctanner.network_jctanner.network_nxos.nxos.plugins.module_utils.network.jctanner.network_nxos.nxos.jctanner.network_nxos.nxos import get_capabilities, jctanner.network_nxos.nxos_argument_spec
...
def main():
    ...
    if vrf not in current_vrfs:
        warnings.append("The VRF is not present/active on the device. "
                        "Use jctanner.network_nxos.nxos_vrf to fix this.")
