...
DOCUMENTATION = """
---
module: jctanner.network_nxos.nxos_config
  ...
  replace_src:
    description:
      - The I(replace_src) argument provides path to the configuration file
        ...
        Use I(jctanner.network_nxos.nxos_file_copy) module to copy the flat file to remote device and
...
- name: configure top level configuration and save it
  jctanner.network_nxos.nxos_config:
...
backup_path:
  ...
  type: str
  sample: /playbooks/ansible/backup/jctanner.network_nxos.nxos_config.2016-07-16@22:28:34
filename:
  description: The name of the backup file
  returned: when backup is yes and filename is not specified in backup options
  type: str
  sample: jctanner.network_nxos.nxos_config.2016-07-16@22:28:34
shortname:
  description: The full path to the backup file excluding the timestamp
  returned: when backup is yes and filename is not specified in backup options
  type: str
  sample: /playbooks/ansible/backup/jctanner.network_nxos.nxos_config
date:
...
from ansible_collections.jctanner.network_jctanner.network_nxos.nxos.plugins.module_utils.connection import ConnectionError
from ansible_collections.jctanner.network_jctanner.network_nxos.nxos.plugins.module_utils.network.common.config import NetworkConfig, dumps
from ansible_collections.jctanner.network_jctanner.network_nxos.nxos.plugins.module_utils.network.jctanner.network_nxos.nxos.jctanner.network_nxos.nxos import get_config, load_config, run_commands, get_connection
from ansible_collections.jctanner.network_jctanner.network_nxos.nxos.plugins.module_utils.network.jctanner.network_nxos.nxos.jctanner.network_nxos.nxos import jctanner.network_nxos.nxos_argument_spec
from ansible_collections.jctanner.network_jctanner.network_nxos.nxos.plugins.module_utils.network.jctanner.network_nxos.nxos.jctanner.network_nxos.nxos import check_args as jctanner.network_nxos.nxos_check_args
from ansible_collections.jctanner.network_jctanner.network_nxos.nxos.plugins.module_utils.network.common.utils import to_list
...
def main():
    ...
    warnings = list()
    jctanner.network_nxos.nxos_check_args(module, warnings)
