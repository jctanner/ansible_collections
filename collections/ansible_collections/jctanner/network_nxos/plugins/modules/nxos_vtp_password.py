...
module: jctanner.network_nxos.nxos_vtp_password
...
notes:
    ...
    - Use this in combination with M(jctanner.network_nxos.nxos_vtp_domain) and M(jctanner.network_nxos.nxos_vtp_version)
...
- jctanner.network_nxos.nxos_vtp_password:
    state: present
