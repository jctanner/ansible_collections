...
DOCUMENTATION = '''
---
module: jctanner.network_nxos.nxos_vtp_domain
...
notes:
    ...
    - If it's never been configured before, VTP version is set to 1 by default.
      ...
      Use M(jctanner.network_nxos.nxos_vtp_version) to change it.
    - Use this in combination with M(jctanner.network_nxos.nxos_vtp_password) and M(jctanner.network_nxos.nxos_vtp_version)
...
- jctanner.network_nxos.nxos_vtp_domain:
    domain: ntc
