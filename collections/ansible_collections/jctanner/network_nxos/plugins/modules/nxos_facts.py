...
DOCUMENTATION = """
---
module: jctanner.network_nxos.nxos_facts
...
EXAMPLES = """
- jctanner.network_nxos.nxos_facts:
    gather_subset: all
...
from ansible_collections.jctanner.network_jctanner.network_nxos.nxos.plugins.module_utils.network.jctanner.network_nxos.nxos.jctanner.network_nxos.nxos import run_commands, get_config
from ansible_collections.jctanner.network_jctanner.network_nxos.nxos.plugins.module_utils.network.jctanner.network_nxos.nxos.jctanner.network_nxos.nxos import get_capabilities, get_interface_type
...
from ansible_collections.jctanner.network_jctanner.network_nxos.nxos.plugins.module_utils.network.jctanner.network_nxos.nxos.jctanner.network_nxos.nxos import normalize_interface
...
class Interfaces(FactsBase):
    ...
    def ipv6_structure_op_supported(self):
        ...
        if data:
            jctanner.network_nxos.nxos_os_version = data['device_info']['network_os_version']
            unsupported_versions = ['I2', 'F1', 'A8']
            for ver in unsupported_versions:
                if ver in jctanner.network_nxos.nxos_os_version:
                    return False
            return True
...
class Legacy(FactsBase):
    # facts from jctanner.network_nxos.nxos_facts 2.1
...
def main():
    ...
    spec.update(jctanner.network_nxos.nxos_argument_spec)
    ...
    for key, value in iteritems(facts):
        # this is to maintain capability with jctanner.network_nxos.nxos_facts 2.1
        if key.startswith('_'):
