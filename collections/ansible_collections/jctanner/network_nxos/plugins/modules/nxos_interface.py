...
DOCUMENTATION = """
---
module: jctanner.network_nxos.nxos_interface
...
notes:
  ...
  - The M(jctanner.network_nxos.nxos_overlay_global) C(anycast_gateway_mac) attribute must be
...
- name: Ensure an interface is a Layer 3 port and that it has the proper description
  jctanner.network_nxos.nxos_interface:
    name: Ethernet1/1
...
from ansible_collections.jctanner.network_jctanner.network_nxos.nxos.plugins.module_utils.network.jctanner.network_nxos.nxos.jctanner.network_nxos.nxos import load_config, run_commands
from ansible_collections.jctanner.network_jctanner.network_nxos.nxos.plugins.module_utils.network.jctanner.network_nxos.nxos.jctanner.network_nxos.nxos import jctanner.network_nxos.nxos_argument_spec, normalize_interface
from ansible_collections.jctanner.network_jctanner.network_nxos.nxos.plugins.module_utils.network.jctanner.network_nxos.nxos.jctanner.network_nxos.nxos import get_interface_type
from ansible.module_utils.basic import AnsibleModule
from ansible_collections.jctanner.network_jctanner.network_nxos.nxos.plugins.module_utils.network.common.utils import conditional, remove_default_spec
        ...
        if body:
            ...
            if interface_table:
                if interface_table.get('eth_mode') == 'fex-fabric':
                    module.fail_json(msg='jctanner.network_nxos.nxos_interface does not support interfaces with mode "fex-fabric"')
                ...
                if obj['admin_state'] is None:
                    # Some jctanner.network_nxos.nxos platforms do not have the 'admin_state' key.
