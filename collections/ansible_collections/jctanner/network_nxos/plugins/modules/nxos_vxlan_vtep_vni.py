...
DOCUMENTATION = '''
---
module: jctanner.network_nxos.nxos_vxlan_vtep_vni
...
'''
EXAMPLES = '''
- jctanner.network_nxos.nxos_vxlan_vtep_vni:
    interface: nve1
    vni: 6000
...
def main():
    ...
    if state == 'present':
        if not interface_exist:
            module.fail_json(msg="The proposed NVE interface does not exist. Use jctanner.network_nxos.nxos_interface to create it first.")
