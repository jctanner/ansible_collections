...
DOCUMENTATION = """
---
module: jctanner.network_nxos.nxos_nxapi
...
- name: Enable NXAPI access with default configuration
  jctanner.network_nxos.nxos_nxapi:
    state: present
...
from ansible_collections.jctanner.network_jctanner.network_nxos.nxos.plugins.module_utils.network.jctanner.network_nxos.nxos.jctanner.network_nxos.nxos import run_commands, load_config
...
def map_config_to_obj(module):
    ...
    # There are two possible outcomes when nxapi is disabled on jctanner.network_nxos.nxos platforms.
...
def main():
    ...
    warnings = list()
    warning_msg = "Module jctanner.network_nxos.nxos_nxapi currently defaults to configure 'http port 80'. "
