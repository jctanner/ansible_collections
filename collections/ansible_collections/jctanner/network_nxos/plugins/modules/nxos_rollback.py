...
DOCUMENTATION = '''
---
module: jctanner.network_nxos.nxos_rollback
...
EXAMPLES = '''
- jctanner.network_nxos.nxos_rollback:
...
from ansible_collections.jctanner.network_jctanner.network_nxos.nxos.plugins.module_utils.network.jctanner.network_nxos.nxos.jctanner.network_nxos.nxos import jctanner.network_nxos.nxos_argument_spec, run_commands
