...
DOCUMENTATION = """
---
module: jctanner.network_nxos.nxos_l2_interface
...
- name: Ensure Eth1/5 is in its default l2 interface state
  jctanner.network_nxos.nxos_l2_interface:
    name: Ethernet1/5
    state: unconfigured
...
from ansible_collections.jctanner.network_jctanner.network_nxos.nxos.plugins.module_utils.network.jctanner.network_nxos.nxos.jctanner.network_nxos.nxos import jctanner.network_nxos.nxos_argument_spec, get_interface_type
    ...
    for w in want:
        ...
        if current_mode == 'unknown' or current_mode == 'layer3':
            module.fail_json(msg='Ensure interface is configured to be a L2'
                             ...
                             '\nthe jctanner.network_nxos.nxos_interface module for this.')
