...
DOCUMENTATION = '''
---
module: jctanner.network_nxos.nxos_rpm
...
EXAMPLES = '''
- jctanner.network_nxos.nxos_rpm:
    pkg: "jctanner.network_nxos.nxos.sample-n9k_ALL-1.0.0-7.0.3.I7.3.lib32_n9000.rpm"
'''
...
commands:
    ...
    returned: always
    type: list
    sample: ["install add bootflash:jctanner.network_nxos.nxos.sample-n9k_ALL-1.0.0-7.0.3.I7.3.lib32_n9000.rpm forced",
             "install activate jctanner.network_nxos.nxos.sample-n9k_ALL-1.0.0-7.0.3.I7.3.lib32_n9000 forced",
             "install commit jctanner.network_nxos.nxos.sample-n9k_ALL-1.0.0-7.0.3.I7.3.lib32_n9000"]
'''
