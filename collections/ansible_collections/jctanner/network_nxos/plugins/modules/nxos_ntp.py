...
DOCUMENTATION = '''
---
module: jctanner.network_nxos.nxos_ntp
...
- jctanner.network_nxos.nxos_ntp:
    server: 1.2.3.4
    key_id: 32
    prefer: enabled
...
from ansible_collections.jctanner.network_jctanner.network_nxos.nxos.plugins.module_utils.network.jctanner.network_nxos.nxos.jctanner.network_nxos.nxos import check_args, load_config, jctanner.network_nxos.nxos_argument_spec, run_commands
