...
DOCUMENTATION = '''
---
module: jctanner.network_nxos.nxos_bfd_global
...
'''
EXAMPLES = '''
- jctanner.network_nxos.nxos_bfd_global:
...
import re
from ansible_collections.jctanner.network_jctanner.network_nxos.nxos.plugins.module_utils.network.jctanner.network_nxos.nxos.jctanner.network_nxos.nxos import NxosCmdRef
