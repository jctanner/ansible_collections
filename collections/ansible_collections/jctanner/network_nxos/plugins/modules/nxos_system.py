...
DOCUMENTATION = """
---
module: jctanner.network_nxos.nxos_system
...
- name: configure hostname and domain-name
  jctanner.network_nxos.nxos_system:
    hostname: jctanner.network_nxos.nxos01
...
from ansible_collections.jctanner.network_jctanner.network_nxos.nxos.plugins.module_utils.network.common.config import NetworkConfig
from ansible_collections.jctanner.network_jctanner.network_nxos.nxos.plugins.module_utils.network.common.utils import ComplexList
