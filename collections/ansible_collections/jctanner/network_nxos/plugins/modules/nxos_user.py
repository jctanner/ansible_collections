...
DOCUMENTATION = """
---
module: jctanner.network_nxos.nxos_user
  ...
  purge:
    description:
      - The C(purge) argument instructs the module to consider the
        ...
        `admin` user which cannot be deleted per jctanner.network_nxos.nxos constraints.
    type: bool
    default: 'no'
  state:
    description:
...
- name: create a new user
  jctanner.network_nxos.nxos_user:
    name: ansible
...
from ansible_collections.jctanner.network_jctanner.network_nxos.nxos.plugins.module_utils.network.common.utils import remove_default_spec, to_list
...
def main():
    ...
    # the jctanner.network_nxos.nxos cli prevents this by rule so capture it and display
