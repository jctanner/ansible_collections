...
DOCUMENTATION = '''
---
module: jctanner.cloud_vmware.vca_nat
short_description: add remove nat rules in a gateway  in a jctanner.cloud_vmware.vca
description:
  - Adds or removes nat rules from a gateway in a jctanner.cloud_vmware.vca environment
version_added: "2.0"
