...
from ansible_collections.jctanner.cloud_vmware.plugins.module_utils.vmware import (HAS_PYVMOMI, connect_to_api, find_datacenter_by_name, find_datastore_by_name,
...
try:
    from ansible_collections.jctanner.cloud_vmware.plugins.module_utils.vmware import vim
