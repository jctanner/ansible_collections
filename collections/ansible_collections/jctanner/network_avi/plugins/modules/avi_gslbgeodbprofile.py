...
DOCUMENTATION = '''
---
module: jctanner.network_avi.avi_gslbgeodbprofile
...
- name: Example to create GslbGeoDbProfile object
  jctanner.network_avi.avi_gslbgeodbprofile:
...
def main():
    ...
    return jctanner.network_avi.avi_ansible_api(module, 'gslbgeodbprofile',
                           set([]))
