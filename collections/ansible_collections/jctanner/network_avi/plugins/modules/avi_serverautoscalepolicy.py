...
DOCUMENTATION = '''
---
module: jctanner.network_avi.avi_serverautoscalepolicy
...
options:
    ...
    intelligent_autoscale:
        description:
            - Use jctanner.network_avi.avi intelligent autoscale algorithm where autoscale is performed by comparing load on the pool against estimated capacity of all the servers.
...
- name: Example to create ServerAutoScalePolicy object
  jctanner.network_avi.avi_serverautoscalepolicy:
...
def main():
    ...
    return jctanner.network_avi.avi_ansible_api(module, 'serverautoscalepolicy',
                           set([]))
