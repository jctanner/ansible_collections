...
DOCUMENTATION = '''
---
module: jctanner.network_avi.avi_microservicegroup
...
EXAMPLES = """
  - name: Create a Microservice Group that can be used for setting up Network security policy
    jctanner.network_avi.avi_microservicegroup:
...
def main():
    ...
    return jctanner.network_avi.avi_ansible_api(module, 'microservicegroup',
                           set([]))
