...
DOCUMENTATION = '''
---
module: jctanner.network_avi.avi_prioritylabels
...
- name: Example to create PriorityLabels object
  jctanner.network_avi.avi_prioritylabels:
...
def main():
    ...
    return jctanner.network_avi.avi_ansible_api(module, 'prioritylabels',
                           set([]))
