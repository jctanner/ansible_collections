...
DOCUMENTATION = '''
---
module: jctanner.network_avi.avi_networkprofile
...
options:
    ...
    connection_mirror:
        description:
            - When enabled, jctanner.network_avi.avi mirrors all tcp fastpath connections to standby.
...
EXAMPLES = """
  - name: Create a network profile for an UDP application
    jctanner.network_avi.avi_networkprofile:
...
def main():
    ...
    return jctanner.network_avi.avi_ansible_api(module, 'networkprofile',
                           set([]))
