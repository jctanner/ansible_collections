...
DOCUMENTATION = '''
---
module: jctanner.network_avi.avi_certificatemanagementprofile
...
- name: Example to create CertificateManagementProfile object
  jctanner.network_avi.avi_certificatemanagementprofile:
...
def main():
    ...
    return jctanner.network_avi.avi_ansible_api(module, 'certificatemanagementprofile',
                           set([]))
