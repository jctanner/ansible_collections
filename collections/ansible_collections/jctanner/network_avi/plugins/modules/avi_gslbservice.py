...
DOCUMENTATION = '''
---
module: jctanner.network_avi.avi_gslbservice
...
options:
    ...
    health_monitor_scope:
        description:
            ...
            - In such a case, jctanner.network_avi.avi members can have controller derived status while non-jctanner.network_avi.avi members can be probed by via health monitor probes in dataplane.
...
- name: Example to create GslbService object
  jctanner.network_avi.avi_gslbservice:
...
def main():
    ...
    return jctanner.network_avi.avi_ansible_api(module, 'gslbservice',
                           set([]))
