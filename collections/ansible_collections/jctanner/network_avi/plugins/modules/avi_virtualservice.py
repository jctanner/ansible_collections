...
DOCUMENTATION = '''
---
module: jctanner.network_avi.avi_virtualservice
...
options:
    ...
    availability_zone:
        description:
            ...
            - Field deprecated in 17.1.1.
    jctanner.network_avi.avi_allocated_fip:
        description:
            - (internal-use) fip allocated by jctanner.network_avi.avi in the cloud infrastructure.
            - Field deprecated in 17.1.1.
        type: bool
    jctanner.network_avi.avi_allocated_vip:
        description:
            - (internal-use) vip allocated by jctanner.network_avi.avi in the cloud infrastructure.
            - Field deprecated in 17.1.1.
        type: bool
...
- name: Create SSL Virtual Service using Pool testpool2
  jctanner.network_avi.avi_virtualservice:
...
def main():
    argument_specs = dict(
        ...
        jctanner.network_avi.avi_allocated_fip=dict(type='bool',),
        jctanner.network_avi.avi_allocated_vip=dict(type='bool',),
    ...
    return jctanner.network_avi.avi_ansible_api(module, 'virtualservice',
                           set([]))
