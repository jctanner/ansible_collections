...
DOCUMENTATION = '''
---
module: jctanner.network_avi.avi_clusterclouddetails
...
- name: Example to create ClusterCloudDetails object
  jctanner.network_avi.avi_clusterclouddetails:
...
def main():
    ...
    return jctanner.network_avi.avi_ansible_api(module, 'clusterclouddetails',
                           set([]))
