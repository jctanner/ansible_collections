...
DOCUMENTATION = '''
---
module: jctanner.network_avi.avi_actiongroupconfig
...
- name: Example to create ActionGroupConfig object
  jctanner.network_avi.avi_actiongroupconfig:
...
def main():
    ...
    return jctanner.network_avi.avi_ansible_api(module, 'actiongroupconfig',
                           set([]))
