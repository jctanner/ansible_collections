...
DOCUMENTATION = '''
---
module: jctanner.network_avi.avi_sslkeyandcertificate
...
- name: Create a SSL Key and Certificate
  jctanner.network_avi.avi_sslkeyandcertificate:
...
def main():
    ...
    return jctanner.network_avi.avi_ansible_api(module, 'sslkeyandcertificate',
