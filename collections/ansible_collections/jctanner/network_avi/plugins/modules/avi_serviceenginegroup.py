...
DOCUMENTATION = '''
---
module: jctanner.network_avi.avi_serviceenginegroup
...
options:
    ...
    disable_jctanner.network_avi.avi_securitygroups:
        description:
            - By default, jctanner.network_avi.avi creates and manages security groups along with custom sg provided by user.
            - Set this to true to disallow jctanner.network_avi.avi to create and manage new security groups.
    ...
    mgmt_network_ref:
        description:
            - Management network to use for jctanner.network_avi.avi service engines.
            - It is a reference to an object of type network.
    mgmt_subnet:
        description:
            - Management subnet to use for jctanner.network_avi.avi service engines.
    min_cpu_usage:
        description:
    ...
    vip_asg:
        description:
            - When vip_asg is set, vip configuration will be managed by jctanner.network_avi.avi.user will be able to configure vip_asg or vips individually at the time of create.
            - Field introduced in 17.2.12, 18.1.2.
        version_added: "2.9"
    vs_host_redundancy:
        description:
...
- name: Example to create ServiceEngineGroup object
  jctanner.network_avi.avi_serviceenginegroup:
...
def main():
    argument_specs = dict(
        ...
        disable_jctanner.network_avi.avi_securitygroups=dict(type='bool',),
    ...
    return jctanner.network_avi.avi_ansible_api(module, 'serviceenginegroup',
                           set([]))
