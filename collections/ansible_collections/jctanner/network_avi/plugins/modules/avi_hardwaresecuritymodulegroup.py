...
DOCUMENTATION = '''
---
module: jctanner.network_avi.avi_hardwaresecuritymodulegroup
...
- name: Example to create HardwareSecurityModuleGroup object
  jctanner.network_avi.avi_hardwaresecuritymodulegroup:
...
def main():
    ...
    return jctanner.network_avi.avi_ansible_api(module, 'hardwaresecuritymodulegroup',
                           set([]))
