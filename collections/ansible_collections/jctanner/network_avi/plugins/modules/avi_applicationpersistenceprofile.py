...
DOCUMENTATION = '''
---
module: jctanner.network_avi.avi_applicationpersistenceprofile
...
options:
    ...
    server_hm_down_recovery:
        description:
            - Specifies behjctanner.network_avi.avior when a persistent server has been marked down by a health monitor.
...
EXAMPLES = """
  - name: Create an Application Persistence setting using http cookie.
    jctanner.network_avi.avi_applicationpersistenceprofile:
...
def main():
    ...
    return jctanner.network_avi.avi_ansible_api(module, 'applicationpersistenceprofile',
                           set([]))
