...
DOCUMENTATION = '''
---
module: jctanner.network_avi.avi_applicationprofile
...
EXAMPLES = """
  - name: Create an Application Profile for HTTP application enabled for SSL traffic
    jctanner.network_avi.avi_applicationprofile:
...
def main():
    ...
    return jctanner.network_avi.avi_ansible_api(module, 'applicationprofile',
                           set([]))
