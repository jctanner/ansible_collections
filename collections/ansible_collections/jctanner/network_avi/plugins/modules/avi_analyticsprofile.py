...
DOCUMENTATION = '''
---
module: jctanner.network_avi.avi_analyticsprofile
...
options:
    ...
    apdex_rtt_threshold:
        description:
            - Satisfactory client to jctanner.network_avi.avi round trip time(rtt).
    ...
    apdex_rtt_tolerated_factor:
        description:
            - Tolerated client to jctanner.network_avi.avi round trip time(rtt) factor.
    ...
    client_log_config:
        description:
            - Configure which logs are sent to the jctanner.network_avi.avi controller from ses and how they are processed.
    ...
    conn_lossy_ooo_threshold:
        description:
            - A connection between client and jctanner.network_avi.avi is considered lossy when more than this percentage of out of order packets are received.
            - Allowed values are 1-100.
            - Default value when not specified in API or module is interpreted by Avi Controller as 50.
    conn_lossy_timeo_rexmt_threshold:
        description:
            - A connection between client and jctanner.network_avi.avi is considered lossy when more than this percentage of packets are retransmitted due to timeout.
            - Allowed values are 1-100.
            - Default value when not specified in API or module is interpreted by Avi Controller as 20.
    conn_lossy_total_rexmt_threshold:
        description:
            - A connection between client and jctanner.network_avi.avi is considered lossy when more than this percentage of packets are retransmitted.
            - Allowed values are 1-100.
            - Default value when not specified in API or module is interpreted by Avi Controller as 50.
    ...
    conn_server_lossy_ooo_threshold:
        description:
            - A connection between jctanner.network_avi.avi and server is considered lossy when more than this percentage of out of order packets are received.
            - Allowed values are 1-100.
            - Default value when not specified in API or module is interpreted by Avi Controller as 50.
    conn_server_lossy_timeo_rexmt_threshold:
        description:
            - A connection between jctanner.network_avi.avi and server is considered lossy when more than this percentage of packets are retransmitted due to timeout.
            - Allowed values are 1-100.
            - Default value when not specified in API or module is interpreted by Avi Controller as 20.
    conn_server_lossy_total_rexmt_threshold:
        description:
            - A connection between jctanner.network_avi.avi and server is considered lossy when more than this percentage of packets are retransmitted.
            - Allowed values are 1-100.
            - Default value when not specified in API or module is interpreted by Avi Controller as 50.
...
EXAMPLES = """
  - name: Create a custom Analytics profile object
    jctanner.network_avi.avi_analyticsprofile:
...
def main():
    ...
    return jctanner.network_avi.avi_ansible_api(module, 'analyticsprofile',
                           set([]))
