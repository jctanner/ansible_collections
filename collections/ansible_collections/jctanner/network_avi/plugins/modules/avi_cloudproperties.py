...
DOCUMENTATION = '''
---
module: jctanner.network_avi.avi_cloudproperties
...
- name: Example to create CloudProperties object
  jctanner.network_avi.avi_cloudproperties:
...
def main():
    ...
    return jctanner.network_avi.avi_ansible_api(module, 'cloudproperties',
                           set([]))
