...
DOCUMENTATION = '''
---
module: jctanner.network_avi.avi_snmptrapprofile
...
- name: Example to create SnmpTrapProfile object
  jctanner.network_avi.avi_snmptrapprofile:
...
def main():
    ...
    return jctanner.network_avi.avi_ansible_api(module, 'snmptrapprofile',
                           set([]))
