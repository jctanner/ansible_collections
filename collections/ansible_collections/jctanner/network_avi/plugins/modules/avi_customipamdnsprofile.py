...
DOCUMENTATION = '''
---
module: jctanner.network_avi.avi_customipamdnsprofile
...
- name: Example to create CustomIpamDnsProfile object
  jctanner.network_avi.avi_customipamdnsprofile:
...
def main():
    ...
    return jctanner.network_avi.avi_ansible_api(module, 'customipamdnsprofile',
                           set([]))
