...
DOCUMENTATION = '''
---
module: jctanner.network_avi.avi_alertscriptconfig
...
options:
    ...
    action_script:
        description:
            ...
            - Please refer to kb.jctanner.network_avi.avinetworks.com for more information.
    name:
        description:
...
EXAMPLES = """
  - name: Create Alert Script to perform AWS server autoscaling
    jctanner.network_avi.avi_alertscriptconfig:
      username: '{{ username }}'
...
def main():
    ...
    return jctanner.network_avi.avi_ansible_api(module, 'alertscriptconfig',
                           set([]))
