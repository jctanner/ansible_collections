...
DOCUMENTATION = '''
---
module: jctanner.network_avi.avi_controllerproperties
...
- name: Example to create ControllerProperties object
  jctanner.network_avi.avi_controllerproperties:
...
def main():
    ...
    return jctanner.network_avi.avi_ansible_api(module, 'controllerproperties',
                           set(['portal_token']))
