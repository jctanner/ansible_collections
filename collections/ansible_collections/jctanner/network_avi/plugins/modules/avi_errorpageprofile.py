...
DOCUMENTATION = '''
---
module: jctanner.network_avi.avi_errorpageprofile
...
- name: Example to create ErrorPageProfile object
  jctanner.network_avi.avi_errorpageprofile:
...
def main():
    ...
    return jctanner.network_avi.avi_ansible_api(module, 'errorpageprofile',
                           set([]))
