...
DOCUMENTATION = '''
---
module: jctanner.network_avi.avi_ipamdnsproviderprofile
...
options:
    ...
    allocate_ip_in_vrf:
        description:
            ...
            - Applicable for jctanner.network_avi.avi vantage ipam only.
    ...
    internal_profile:
        description:
            - Provider details if type is jctanner.network_avi.avi.
    name:
        description:
...
EXAMPLES = """
  - name: Create IPAM DNS provider setting
    jctanner.network_avi.avi_ipamdnsproviderprofile:
...
def main():
    ...
    return jctanner.network_avi.avi_ansible_api(module, 'ipamdnsproviderprofile',
                           set([]))
