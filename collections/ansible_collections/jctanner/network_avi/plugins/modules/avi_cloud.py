...
DOCUMENTATION = '''
---
module: jctanner.network_avi.avi_cloud
...
options:
    ...
    custom_tags:
        description:
            - Custom tags for all jctanner.network_avi.avi created resources in the cloud infrastructure.
...
EXAMPLES = """
  - name: Create a VMWare cloud with write access mode
    jctanner.network_avi.avi_cloud:
      username: '{{ username }}'
...
def main():
    ...
    return jctanner.network_avi.avi_ansible_api(module, 'cloud',
                           set([]))
