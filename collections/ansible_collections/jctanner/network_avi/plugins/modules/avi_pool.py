...
DOCUMENTATION = '''
---
module: jctanner.network_avi.avi_pool
...
options:
    ...
    autoscale_launch_config_ref:
        description:
            - If configured then jctanner.network_avi.avi will trigger orchestration of pool server creation and deletion.
    ...
    default_server_port:
        description:
            ...
            - The ssl checkbox enables jctanner.network_avi.avi to server encryption.
    ...
    host_check_enabled:
        description:
            ...
            - If enabled and no explicit domain name is specified, jctanner.network_avi.avi will use the incoming host header to do the match.
            - Default value when not specified in API or module is interpreted by Avi Controller as False.
        type: bool
    inline_health_monitor:
        description:
            ...
            - This may alter the expected behjctanner.network_avi.avior of the lb method, such as round robin.
            - Default value when not specified in API or module is interpreted by Avi Controller as True.
        type: bool
    ipaddrgroup_ref:
        description:
    ...
    networks:
        description:
            ...
            - This field is used internally by jctanner.network_avi.avi, not editable by the user.
    nsx_securitygroup:
        description:
    ...
    server_name:
        description:
            ...
            - If no value is specified, jctanner.network_avi.avi will use the incoming host header instead.
    server_reselect:
        description:
    ...
    server_timeout:
        description:
            ...
            - between jctanner.network_avi.avi and the server.
    ...
    service_metadata:
        description:
            ...
            - Any user input to this field will be overwritten by jctanner.network_avi.avi vantage.
            - Field introduced in 17.2.14,18.1.5,18.2.1.
        version_added: "2.9"
    sni_enabled:
        description:
            - Enable tls sni for server connections.
            - If disabled, jctanner.network_avi.avi will not send the sni extension as part of the handshake.
            - Default value when not specified in API or module is interpreted by Avi Controller as True.
        type: bool
    ...
    ssl_profile_ref:
        description:
            - When enabled, jctanner.network_avi.avi re-encrypts traffic to the backend servers.
...
- name: Create a Pool with two servers and HTTP monitor
  jctanner.network_avi.avi_pool:
    controller: 10.10.1.20
    username: jctanner.network_avi.avi_user
    password: jctanner.network_avi.avi_password
    name: testpool1
...
- name: Patch pool with a single server using patch op and jctanner.network_avi.avi_credentials
  jctanner.network_avi.avi_pool:
    jctanner.network_avi.avi_api_update_method: patch
    jctanner.network_avi.avi_api_patch_op: delete
    jctanner.network_avi.avi_credentials: "{{jctanner.network_avi.avi_credentials}}"
    name: test-pool
    servers:
      - ip:
        addr: 10.90.64.13
...
def main():
    ...
    return jctanner.network_avi.avi_ansible_api(module, 'pool',
                           set([]))
