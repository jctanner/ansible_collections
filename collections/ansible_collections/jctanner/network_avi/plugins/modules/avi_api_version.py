...
DOCUMENTATION = '''
---
module: jctanner.network_avi.avi_api_version
author: Vilian Atmadzhov (@vivobg) <vilian.atmadzhov@paddypowerbetfair.com>

short_description: Avi API Version Module
description:
    - This module can be used to obtain the version of the Avi REST API. U(https://jctanner.network_avi.avinetworks.com/)
version_added: 2.5
...
EXAMPLES = '''
  - name: Get AVI API version
    jctanner.network_avi.avi_api_version:
      controller: ""
      username: ""
      password: ""
      tenant: ""
    register: jctanner.network_avi.avi_controller_version
'''
...
try:
    from ansible_collections.jctanner.network_jctanner.network_avi.avi.plugins.module_utils.network.jctanner.network_avi.avi.jctanner.network_avi.avi import (
        jctanner.network_avi.avi_common_argument_spec, ansible_return, HAS_AVI)
