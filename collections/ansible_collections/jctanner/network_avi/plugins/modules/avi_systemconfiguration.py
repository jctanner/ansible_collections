...
DOCUMENTATION = '''
---
module: jctanner.network_avi.avi_systemconfiguration
...
options:
    ...
    dns_virtualservice_refs:
        description:
            - Dns virtualservices hosting fqdn records for applications across jctanner.network_avi.avi vantage.
            - If no virtualservices are provided, jctanner.network_avi.avi vantage will provide dns services for configured applications.
            - Switching back to jctanner.network_avi.avi vantage from dns virtualservices is not allowed.
...
- name: Example to create SystemConfiguration object
  jctanner.network_avi.avi_systemconfiguration:
...
def main():
    ...
    return jctanner.network_avi.avi_ansible_api(module, 'systemconfiguration',
                           set([]))
