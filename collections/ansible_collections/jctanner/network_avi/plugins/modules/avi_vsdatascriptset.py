...
DOCUMENTATION = '''
---
module: jctanner.network_avi.avi_vsdatascriptset
...
- name: Example to create VSDataScriptSet object
  jctanner.network_avi.avi_vsdatascriptset:
...
def main():
    ...
    return jctanner.network_avi.avi_ansible_api(module, 'vsdatascriptset',
                           set([]))
