...
DOCUMENTATION = '''
---
module: jctanner.network_avi.avi_poolgroupdeploymentpolicy
...
options:
    ...
    webhook_ref:
        description:
            - Webhook configured with url that jctanner.network_avi.avi controller will pass back information about pool group, old and new pool information and current deployment
            - rule results.
...
- name: Example to create PoolGroupDeploymentPolicy object
  jctanner.network_avi.avi_poolgroupdeploymentpolicy:
...
def main():
    ...
    return jctanner.network_avi.avi_ansible_api(module, 'poolgroupdeploymentpolicy',
                           set([]))
