...
#
# @author: Gaurav Rastogi (grastogi@jctanner.network_avi.avinetworks.com) GitHub ID: grastogi23
#
# module_check: supported
#
# Copyright: (c) 2016 Gaurav Rastogi, <grastogi@jctanner.network_avi.avinetworks.com>
...
DOCUMENTATION = '''
---
module: jctanner.network_avi.avi_gslbservice_patch_member
author: Gaurav Rastogi (@grastogi23) <grastogi@jctanner.network_avi.avinetworks.com>

short_description: Avi API Module
description:
    - This module can be used for calling any resources defined in Avi REST API. U(https://jctanner.network_avi.avinetworks.com/)
...
EXAMPLES = '''
  - name: Patch GSLB Service to add a new member and group
    jctanner.network_avi.avi_gslbservice_patch_member:
...
try:
    from ansible_collections.jctanner.network_jctanner.network_avi.avi.plugins.module_utils.network.jctanner.network_avi.avi.jctanner.network_avi.avi import (
        jctanner.network_avi.avi_common_argument_spec, jctanner.network_avi.avi_obj_cmp, cleanup_absent_fields,
        ansible_return, AviCheckModeResponse, HAS_AVI)
    from ansible_collections.jctanner.network_jctanner.network_avi.avi.plugins.module_utils.network.jctanner.network_avi.avi.jctanner.network_avi.avi_api import (
...
def add_member(module, check_mode, api, tenant, tenant_uuid,
    ...
    if not existing_obj:
        ...
        changed = not jctanner.network_avi.avi_obj_cmp(req, existing_obj)
...
def main():
    ...
    if not HAS_AVI:
        return module.fail_json(msg=(
            'Avi python API SDK (jctanner.network_avi.avisdk>=17.1) or ansible>=2.8 is not installed. '
