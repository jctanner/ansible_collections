...
DOCUMENTATION = '''
---
module: jctanner.network_avi.avi_gslb
...
options:
    ...
    async_interval:
        description:
            ...
            - Value of 0 disables async behjctanner.network_avi.avior and rpc are sent inline.
    ...
    leader_cluster_uuid:
        description:
            ...
            - This site is the one among the jctanner.network_avi.avi sites.
        required: true
    maintenance_mode:
        description:
    ...
    sites:
        description:
            - Select jctanner.network_avi.avi site member belonging to this gslb.
    tenant_ref:
        description:
...
- name: Example to create Gslb object
  jctanner.network_avi.avi_gslb:
    name: "test-gslb"
    jctanner.network_avi.avi_credentials:
      username: '{{ username }}'
      password: '{{ password }}'
...
- name: Update Gslb site's configurations (Patch Add Operation)
  jctanner.network_avi.avi_gslb:
    ...
    jctanner.network_avi.avi_api_patch_op: add
    leader_cluster_uuid: "cluster-d4ee5fcc-3e0a-4d4f-9ae6-4182bc605829"
    name: "test-gslb"
    dns_configs:
...
- name: Update Gslb site's configurations (Patch Replace Operation)
  jctanner.network_avi.avi_gslb:
    ...
    name: "test-gslb"
    jctanner.network_avi.avi_api_update_method: patch
    jctanner.network_avi.avi_api_patch_op: replace
    dns_configs:
...
try:
    ...
    from ansible_collections.jctanner.network_jctanner.network_avi.avi.plugins.module_utils.network.jctanner.network_avi.avi.jctanner.network_avi.avi_api import ApiSession, AviCredentials
except ImportError:
    HAS_AVI = False
...
def main():
    ...
    api_method = module.params['jctanner.network_avi.avi_api_update_method']
    if str(api_method).lower() == 'patch':
        patch_op = module.params['jctanner.network_avi.avi_api_patch_op']
        ...
        module.params.update(
            {
                'jctanner.network_avi.avi_api_update_method': 'put',
                'state': 'present'
            }
        )
    return jctanner.network_avi.avi_ansible_api(module, 'gslb',
                           set([]))
