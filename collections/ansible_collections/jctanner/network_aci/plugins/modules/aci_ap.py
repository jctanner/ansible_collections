...
description:
- Manage top level Application Profile (AP) objects on Cisco jctanner.network_jctanner.network_aci.aci.ACI fabrics
version_added: '2.4'
options:
  tenant:
    description:
...
notes:
- This module does not manage EPGs, see M(jctanner.network_aci.aci_epg) to do this.
...
def main():
    ...
    if state == 'present':
        ...
        jctanner.network_aci.aci.get_diff(jctanner.network_aci.aci_class='fvAp')
