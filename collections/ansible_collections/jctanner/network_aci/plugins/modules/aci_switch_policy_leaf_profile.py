...
description:
- Manage switch policy leaf profiles on Cisco jctanner.network_jctanner.network_aci.aci.ACI fabrics.
version_added: '2.5'
options:
  leaf_profile:
    description:
...
- name: creating a Leaf Profile with description
  jctanner.network_aci.aci_switch_policy_leaf_profile:
    host: apic
    username: admin
...
def main():
    ...
    if state == 'present':
        ...
        jctanner.network_aci.aci.get_diff(jctanner.network_aci.aci_class='infraNodeP')
