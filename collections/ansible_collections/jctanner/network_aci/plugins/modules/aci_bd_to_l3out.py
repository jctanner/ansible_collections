...
DOCUMENTATION = r'''
---
module: jctanner.network_aci.aci_bd_to_l3out
short_description: Bind Bridge Domain to L3 Out (fv:RsBDToOut)
description:
- Bind Bridge Domain to L3 Out on Cisco jctanner.network_jctanner.network_aci.aci.ACI fabrics.
version_added: '2.4'
options:
  bd:
    description:
...
- The C(bd) and C(l3out) parameters should exist before using this module.
  The M(jctanner.network_aci.aci_bd) and C(jctanner.network_aci.aci_l3out) can be used for these.
seealso:
- module: jctanner.network_aci.aci_bd
- module: jctanner.network_aci.aci_l3out
...
def main():
    ...
    jctanner.network_aci.aci.construct_url(
        ...
        subclass_2=dict(
            jctanner.network_aci.aci_class='fvRsBDToOut',
            jctanner.network_aci.aci_rn='rsBDToOut-{0}'.format(l3out),
            module_object=l3out,
    ...
    if state == 'present':
        ...
        jctanner.network_aci.aci.get_diff(jctanner.network_aci.aci_class='fvRsBDToOut')
