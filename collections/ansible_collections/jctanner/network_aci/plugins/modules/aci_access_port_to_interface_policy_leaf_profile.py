...
DOCUMENTATION = r'''
---
module: jctanner.network_aci.aci_access_port_to_interface_policy_leaf_profile
...
description:
- Manage Fabric interface policy leaf profile interface selectors on Cisco jctanner.network_jctanner.network_aci.aci.ACI fabrics.
version_added: '2.5'
options:
  ...
  leaf_port_blk:
    description:
    - B(Deprecated)
    - Starting with Ansible 2.8 we recommend using the module L(jctanner.network_aci.aci_access_port_block_to_access_port, jctanner.network_aci.aci_access_port_block_to_access_port.html).
...
def main():
    ...
    if state == 'present':
        ...
        jctanner.network_aci.aci.get_diff(jctanner.network_aci.aci_class='infraHPortS')
