...
DOCUMENTATION = r'''
---
module: jctanner.network_aci.aci_interface_policy_port_channel
short_description: Manage port channel interface policies (lacp:LagPol)
description:
- Manage port channel interface policies on Cisco jctanner.network_jctanner.network_aci.aci.ACI fabrics.
version_added: '2.4'
options:
  port_channel:
    description:
...
EXAMPLES = r'''
- jctanner.network_aci.aci_interface_policy_port_channel:
...
def main():
    ...
    jctanner.network_aci.aci.construct_url(
        root_class=dict(
            jctanner.network_aci.aci_class='lacpLagPol',
            jctanner.network_aci.aci_rn='infra/lacplagp-{0}'.format(port_channel),
    ...
    if state == 'present':
        ...
        jctanner.network_aci.aci.get_diff(jctanner.network_aci.aci_class='lacpLagPol')
