...
description:
- Manage SPAN source groups on Cisco jctanner.network_jctanner.network_aci.aci.ACI fabrics.
version_added: '2.4'
options:
  admin_state:
    description:
...
EXAMPLES = r'''
- jctanner.network_aci.aci_tenant_span_src_group:
    host: apic
    username: admin
...
def main():
    ...
    if state == 'present':
        ...
        jctanner.network_aci.aci.get_diff(jctanner.network_aci.aci_class='spanSrcGrp')
