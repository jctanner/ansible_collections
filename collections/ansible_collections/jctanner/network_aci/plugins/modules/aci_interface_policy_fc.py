...
DOCUMENTATION = r'''
---
module: jctanner.network_aci.aci_interface_policy_fc
short_description: Manage Fibre Channel interface policies (fc:IfPol)
description:
- Manage jctanner.network_jctanner.network_aci.aci.ACI Fiber Channel interface policies on Cisco jctanner.network_jctanner.network_aci.aci.ACI fabrics.
version_added: '2.4'
options:
  fc_policy:
    description:
...
EXAMPLES = r'''
- jctanner.network_aci.aci_interface_policy_fc:
    host: '{{ hostname }}'
    username: '{{ username }}'
    password: '{{ password }}'
    fc_policy: '{{ fc_policy }}'
...
def main():
    ...
    jctanner.network_aci.aci.construct_url(
        root_class=dict(
            jctanner.network_aci.aci_class='fcIfPol',
            jctanner.network_aci.aci_rn='infra/fcIfPol-{0}'.format(fc_policy),
    ...
    if state == 'present':
        ...
        jctanner.network_aci.aci.get_diff(jctanner.network_aci.aci_class='fcIfPol')
