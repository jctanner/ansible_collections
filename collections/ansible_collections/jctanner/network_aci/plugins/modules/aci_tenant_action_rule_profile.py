...
DOCUMENTATION = r'''
---
module: jctanner.network_aci.aci_tenant_action_rule_profile
short_description: Manage action rule profiles (rtctrl:AttrP)
description:
- Manage action rule profiles on Cisco jctanner.network_jctanner.network_aci.aci.ACI fabrics.
version_added: '2.4'
options:
  action_rule:
    description:
...
EXAMPLES = r'''
- jctanner.network_aci.aci_tenant_action_rule_profile:
    host: apic
    username: admin
...
def main():
    ...
    jctanner.network_aci.aci.construct_url(
        ...
        subclass_1=dict(
            jctanner.network_aci.aci_class='rtctrlAttrP',
            jctanner.network_aci.aci_rn='attr-{0}'.format(action_rule),
    ...
    if state == 'present':
        ...
        jctanner.network_aci.aci.get_diff(jctanner.network_aci.aci_class='rtctrlAttrP')
