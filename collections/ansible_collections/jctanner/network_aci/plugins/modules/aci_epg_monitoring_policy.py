...
DOCUMENTATION = r'''
---
module: jctanner.network_aci.aci_epg_monitoring_policy
short_description: Manage monitoring policies (mon:EPGPol)
description:
- Manage monitoring policies on Cisco jctanner.network_jctanner.network_aci.aci.ACI fabrics.
version_added: '2.4'
options:
  monitoring_policy:
    description:
...
EXAMPLES = r'''
- jctanner.network_aci.aci_epg_monitoring_policy:
    host: '{{ hostname }}'
    username: '{{ username }}'
    password: '{{ password }}'
...
def main():
    ...
    jctanner.network_aci.aci.construct_url(
        ...
        subclass_1=dict(
            jctanner.network_aci.aci_class='monEPGPol',
            jctanner.network_aci.aci_rn='monepg-{0}'.format(monitoring_policy),
    ...
    if state == 'present':
        ...
        jctanner.network_aci.aci.get_diff(jctanner.network_aci.aci_class='monEPGPol')
