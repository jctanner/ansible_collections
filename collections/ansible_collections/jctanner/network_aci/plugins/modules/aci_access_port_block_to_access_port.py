...
DOCUMENTATION = r'''
---
module: jctanner.network_aci.aci_access_port_block_to_access_port
...
description:
- Manage port blocks of Fabric interface policy leaf profile interface selectors on Cisco jctanner.network_jctanner.network_aci.aci.ACI fabrics.
version_added: '2.8'
options:
...
def main():
    ...
    jctanner.network_aci.aci.construct_url(
        ...
        subclass_2=dict(
            jctanner.network_aci.aci_class='infraPortBlk',
            jctanner.network_aci.aci_rn='portblk-{0}'.format(leaf_port_blk),
    ...
    if state == 'present':
        ...
        jctanner.network_aci.aci.get_diff(jctanner.network_aci.aci_class='infraPortBlk')
