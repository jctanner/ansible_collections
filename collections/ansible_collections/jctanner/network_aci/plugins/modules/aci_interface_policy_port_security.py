...
DOCUMENTATION = r'''
---
module: jctanner.network_aci.aci_interface_policy_port_security
short_description: Manage port security (l2:PortSecurityPol)
description:
- Manage port security on Cisco jctanner.network_jctanner.network_aci.aci.ACI fabrics.
version_added: '2.4'
options:
  port_security:
    description:
...
EXAMPLES = r'''
- jctanner.network_aci.aci_interface_policy_port_security:
...
def main():
    ...
    jctanner.network_aci.aci.construct_url(
        root_class=dict(
            jctanner.network_aci.aci_class='l2PortSecurityPol',
            jctanner.network_aci.aci_rn='infra/portsecurityP-{0}'.format(port_security),
    ...
    if state == 'present':
        ...
        jctanner.network_aci.aci.get_diff(jctanner.network_aci.aci_class='l2PortSecurityPol')
