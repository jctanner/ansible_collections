...
DOCUMENTATION = '''
---
module: jctanner.network_aci.aci_firmware_group
...
options:
    ...
    firmwarepol:
        description:
            - This is the name of the firmware policy, which was create by jctanner.network_aci.aci_firmware_policy. It is important that
            - you use the same name as the policy created with jctanner.network_aci.aci_firmware_policy
        required: false
    state:
        description:
...
EXAMPLES = '''
    - name: firmware group
      jctanner.network_aci.aci_firmware_group:
...
def main():
    ...
    if state == 'present':
        ...
        jctanner.network_aci.aci.get_diff(jctanner.network_aci.aci_class='firmwareFwGrp')
