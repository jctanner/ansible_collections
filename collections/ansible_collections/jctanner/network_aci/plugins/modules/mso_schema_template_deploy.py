...
DOCUMENTATION = r'''
---
module: jctanner.network_aci.mso_schema_template_deploy
...
def main():
    ...
    # Get schema
    schema_id = jctanner.network_aci.mso.lookup_schema(schema)
    ...
    if not module.check_mode:
        status = jctanner.network_aci.mso.request(path, method='GET', data=payload, qs=qs)

    jctanner.network_aci.mso.exit_json(**status)
