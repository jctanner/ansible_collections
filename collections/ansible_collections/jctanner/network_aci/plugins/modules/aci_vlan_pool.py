...
description:
- Manage VLAN pools on Cisco jctanner.network_jctanner.network_aci.aci.ACI fabrics.
version_added: '2.5'
options:
...
- name: Add a new VLAN pool
  jctanner.network_aci.aci_vlan_pool:
    host: apic
    username: admin
...
def main():
    ...
    if state == 'present':
        ...
        jctanner.network_aci.aci.get_diff(jctanner.network_aci.aci_class='fvnsVlanInstP')
