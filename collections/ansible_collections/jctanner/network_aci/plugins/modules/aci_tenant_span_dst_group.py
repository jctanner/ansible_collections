...
description:
- Manage SPAN destination groups on Cisco jctanner.network_jctanner.network_aci.aci.ACI fabrics.
version_added: '2.4'
options:
  dst_group:
    description:
...
EXAMPLES = r'''
- jctanner.network_aci.aci_tenant_span_dst_group:
    host: apic
    username: admin
...
def main():
    ...
    jctanner.network_aci.aci.construct_url(
        ...
        subclass_1=dict(
            jctanner.network_aci.aci_class='spanDestGrp',
            jctanner.network_aci.aci_rn='destgrp-{0}'.format(dst_group),
    ...
    if state == 'present':
        ...
        jctanner.network_aci.aci.get_diff(jctanner.network_aci.aci_class='spanDestGrp')
