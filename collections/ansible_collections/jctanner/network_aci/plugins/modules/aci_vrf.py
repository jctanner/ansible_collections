...
description:
- Manage contexts or VRFs on Cisco jctanner.network_jctanner.network_aci.aci.ACI fabrics.
...
def main():
    ...
    jctanner.network_aci.aci.construct_url(
        ...
        subclass_1=dict(
            jctanner.network_aci.aci_class='fvCtx',
            jctanner.network_aci.aci_rn='ctx-{0}'.format(vrf),
            module_object=vrf,
    ...
    if state == 'present':
        ...
        jctanner.network_aci.aci.get_diff(jctanner.network_aci.aci_class='fvCtx')
