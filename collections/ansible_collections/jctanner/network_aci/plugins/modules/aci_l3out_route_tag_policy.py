...
DOCUMENTATION = r'''
---
module: jctanner.network_aci.aci_l3out_route_tag_policy
short_description: Manage route tag policies (l3ext:RouteTagPol)
description:
- Manage route tag policies on Cisco jctanner.network_jctanner.network_aci.aci.ACI fabrics.
version_added: '2.4'
options:
  rtp:
    description:
...
EXAMPLES = r'''
- jctanner.network_aci.aci_l3out_route_tag_policy:
    host: apic
    username: admin
...
def main():
    ...
    jctanner.network_aci.aci.construct_url(
        ...
        subclass_1=dict(
            jctanner.network_aci.aci_class='l3extRouteTagPol',
            jctanner.network_aci.aci_rn='rttag-{0}'.format(rtp),
            module_object=rtp,
    ...
    if state == 'present':
        ...
        jctanner.network_aci.aci.get_diff(jctanner.network_aci.aci_class='l3extRouteTagPol')
