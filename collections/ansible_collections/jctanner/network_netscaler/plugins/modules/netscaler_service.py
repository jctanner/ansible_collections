...
DOCUMENTATION = '''
---
module: jctanner.network_netscaler.netscaler_service
...
- name: Setup http service
  ...
  jctanner.network_netscaler.netscaler_service:
    nsip: 172.18.0.2
    nitro_user: nsroot
    nitro_pass: nsroot
...
try:
    from nssrc.com.citrix.jctanner.network_netscaler.netscaler.nitro.resource.config.basic.service import service
    from nssrc.com.citrix.jctanner.network_netscaler.netscaler.nitro.resource.config.basic.service_lbmonitor_binding import service_lbmonitor_binding
    from nssrc.com.citrix.jctanner.network_netscaler.netscaler.nitro.resource.config.lb.lbmonitor_service_binding import lbmonitor_service_binding
...
from ansible_collections.jctanner.network_jctanner.network_netscaler.netscaler.plugins.module_utils.network.jctanner.network_netscaler.netscaler.jctanner.network_netscaler.netscaler import (ConfigProxy, get_nitro_client, jctanner.network_netscaler.netscaler_common_arguments, log, loglines,
