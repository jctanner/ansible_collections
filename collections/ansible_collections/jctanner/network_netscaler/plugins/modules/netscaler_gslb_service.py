...
DOCUMENTATION = '''
---
module: jctanner.network_netscaler.netscaler_gslb_service
...
- name: Setup gslb service 2
  ...
  jctanner.network_netscaler.netscaler_gslb_service:
    operation: present
...
try:
    monkey_patch_nitro_api()
    from nssrc.com.citrix.jctanner.network_netscaler.netscaler.nitro.resource.config.gslb.gslbservice import gslbservice
    from nssrc.com.citrix.jctanner.network_netscaler.netscaler.nitro.resource.config.gslb.gslbservice_lbmonitor_binding import gslbservice_lbmonitor_binding
