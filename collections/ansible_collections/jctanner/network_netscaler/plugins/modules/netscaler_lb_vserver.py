...
DOCUMENTATION = '''
---
module: jctanner.network_netscaler.netscaler_lb_vserver
short_description: Manage load balancing vserver configuration
description:
    - Manage load balancing vserver configuration
    - This module is intended to run either on the ansible  control node or a bastion (jumpserver) with access to the actual jctanner.network_netscaler.netscaler instance
...
options:
    ...
    ssl_certkey:
        description:
            ...
            - Creating the certificate can be done with the M(jctanner.network_netscaler.netscaler_ssl_certkey) module.
...
extends_documentation_fragment: jctanner.network_netscaler.netscaler
requirements:
    - nitro python sdk
'''

EXAMPLES = '''
# Netscaler services service-http-1, service-http-2 must have been already created with the jctanner.network_netscaler.netscaler_service module

- name: Create a load balancing vserver bound to services
  delegate_to: localhost
  jctanner.network_netscaler.netscaler_lb_vserver:
    nsip: 172.18.0.2
    nitro_user: nsroot
    nitro_pass: nsroot
    validate_certs: no
...
# Service group service-group-1 must have been already created with the jctanner.network_netscaler.netscaler_servicegroup module
...
from ansible_collections.jctanner.network_jctanner.network_netscaler.netscaler.plugins.module_utils.network.jctanner.network_netscaler.netscaler.jctanner.network_netscaler.netscaler import (
    ConfigProxy,
    get_nitro_client,
    jctanner.network_netscaler.netscaler_common_arguments,
    log,
    loglines,
...
try:
    from nssrc.com.citrix.jctanner.network_netscaler.netscaler.nitro.resource.config.lb.lbvserver import lbvserver
    from nssrc.com.citrix.jctanner.network_netscaler.netscaler.nitro.resource.config.lb.lbvserver_servicegroup_binding import lbvserver_servicegroup_binding
    from nssrc.com.citrix.jctanner.network_netscaler.netscaler.nitro.resource.config.lb.lbvserver_service_binding import lbvserver_service_binding
    from nssrc.com.citrix.jctanner.network_netscaler.netscaler.nitro.resource.config.ssl.sslvserver_sslcertkey_binding import sslvserver_sslcertkey_binding
    from nssrc.com.citrix.jctanner.network_netscaler.netscaler.nitro.exception.nitro_exception import nitro_exception
...
def main():
    ...
    argument_spec.update(jctanner.network_netscaler.netscaler_common_arguments)
