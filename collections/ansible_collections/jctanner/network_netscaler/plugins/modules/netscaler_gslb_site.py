...
DOCUMENTATION = '''
---
module: jctanner.network_netscaler.netscaler_gslb_site
...
- name: Setup gslb site
  ...
  jctanner.network_netscaler.netscaler_gslb_site:
    nsip: 172.18.0.2
    nitro_user: nsroot
    nitro_pass: nsroot
...
try:
    from nssrc.com.citrix.jctanner.network_netscaler.netscaler.nitro.resource.config.gslb.gslbsite import gslbsite
