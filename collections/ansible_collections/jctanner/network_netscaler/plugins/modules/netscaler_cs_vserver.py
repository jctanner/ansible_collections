...
DOCUMENTATION = '''
---
module: jctanner.network_netscaler.netscaler_cs_vserver
...
EXAMPLES = '''
# policy_1 must have been already created with the jctanner.network_netscaler.netscaler_cs_policy module
# lbvserver_1 must have been already created with the jctanner.network_netscaler.netscaler_lb_vserver module

- name: Setup content switching vserver
  delegate_to: localhost
  jctanner.network_netscaler.netscaler_cs_vserver:
    nsip: 172.18.0.2
    nitro_user: nsroot
    nitro_pass: nsroot
...
try:
    from nssrc.com.citrix.jctanner.network_netscaler.netscaler.nitro.resource.config.cs.csvserver import csvserver
    from nssrc.com.citrix.jctanner.network_netscaler.netscaler.nitro.resource.config.cs.csvserver_lbvserver_binding import csvserver_lbvserver_binding
    from nssrc.com.citrix.jctanner.network_netscaler.netscaler.nitro.resource.config.cs.csvserver_cspolicy_binding import csvserver_cspolicy_binding
