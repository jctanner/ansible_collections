...
DOCUMENTATION = '''
---
module: jctanner.network_netscaler.netscaler_servicegroup
...
options:
    ...
    monitorbindings:
        description:
            ...
            - Note that the monitors must have already been setup possibly using the M(jctanner.network_netscaler.netscaler_lb_monitor) module or some other method
        suboptions:
            monitorname:
                description:
...
- name: Setup http service with ip members
  ...
  jctanner.network_netscaler.netscaler_servicegroup:
    nsip: 172.18.0.2
    nitro_user: nsroot
    nitro_pass: nsroot
...
from ansible_collections.jctanner.network_jctanner.network_netscaler.netscaler.plugins.module_utils.network.jctanner.network_netscaler.netscaler.jctanner.network_netscaler.netscaler import ConfigProxy, get_nitro_client, jctanner.network_netscaler.netscaler_common_arguments, log, \
    loglines, get_immutables_intersection
try:
    from nssrc.com.citrix.jctanner.network_netscaler.netscaler.nitro.resource.config.basic.servicegroup import servicegroup
    from nssrc.com.citrix.jctanner.network_netscaler.netscaler.nitro.resource.config.basic.servicegroup_servicegroupmember_binding import servicegroup_servicegroupmember_binding
    from nssrc.com.citrix.jctanner.network_netscaler.netscaler.nitro.exception.nitro_exception import nitro_exception

    from nssrc.com.citrix.jctanner.network_netscaler.netscaler.nitro.resource.config.basic.servicegroup_lbmonitor_binding import servicegroup_lbmonitor_binding
    from nssrc.com.citrix.jctanner.network_netscaler.netscaler.nitro.resource.config.lb.lbmonitor_servicegroup_binding import lbmonitor_servicegroup_binding
