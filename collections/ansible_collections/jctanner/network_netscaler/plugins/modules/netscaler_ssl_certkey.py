...
DOCUMENTATION = '''
---
module: jctanner.network_netscaler.netscaler_ssl_certkey
...
- name: Setup ssl certkey
  ...
  jctanner.network_netscaler.netscaler_ssl_certkey:
    nitro_user: nsroot
    nitro_pass: nsroot
    nsip: 172.18.0.2
...
try:
    from nssrc.com.citrix.jctanner.network_netscaler.netscaler.nitro.resource.config.ssl.sslcertkey import sslcertkey
