...
DOCUMENTATION = '''
---
module: jctanner.network_netscaler.netscaler_server
...
try:
    from nssrc.com.citrix.jctanner.network_netscaler.netscaler.nitro.resource.config.basic.server import server
