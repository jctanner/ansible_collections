...
DOCUMENTATION = '''
---
module: jctanner.network_netscaler.netscaler_cs_policy
...
- name: Create url cs policy
  ...
  jctanner.network_netscaler.netscaler_cs_policy:
    nsip: 172.18.0.2
    nitro_user: nsroot
    nitro_pass: nsroot
    validate_certs: no
...
from ansible_collections.jctanner.network_jctanner.network_netscaler.netscaler.plugins.module_utils.network.jctanner.network_netscaler.netscaler.jctanner.network_netscaler.netscaler import ConfigProxy, get_nitro_client, jctanner.network_netscaler.netscaler_common_arguments, log, loglines, ensure_feature_is_enabled
try:
    from nssrc.com.citrix.jctanner.network_netscaler.netscaler.nitro.resource.config.cs.cspolicy import cspolicy
