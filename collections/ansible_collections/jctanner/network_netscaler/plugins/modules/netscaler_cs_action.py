...
DOCUMENTATION = '''
---
module: jctanner.network_netscaler.netscaler_cs_action
...
EXAMPLES = '''
# lb_vserver_1 must have been already created with the jctanner.network_netscaler.netscaler_lb_vserver module

- name: Configure jctanner.network_netscaler.netscaler content switching action
  delegate_to: localhost
  jctanner.network_netscaler.netscaler_cs_action:
      nsip: 172.18.0.2
      nitro_user: nsroot
      nitro_pass: nsroot
      validate_certs: no
...
try:
    from nssrc.com.citrix.jctanner.network_netscaler.netscaler.nitro.resource.config.cs.csaction import csaction
