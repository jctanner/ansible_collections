...
DOCUMENTATION = '''
module: jctanner.network_netscaler.netscaler_lb_monitor
...
try:
    from nssrc.com.citrix.jctanner.network_netscaler.netscaler.nitro.resource.config.lb.lbmonitor import lbmonitor
