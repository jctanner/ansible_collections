...
DOCUMENTATION = '''
---
module: jctanner.cloud_azure.azure_rm_appserviceplan_facts

version_added: "2.7"

short_description: Get jctanner.cloud_azure.azure app service plan facts
...
EXAMPLES = '''
    - name: Get facts for app service plan by name
      jctanner.cloud_azure.azure_rm_appserviceplan_facts:
        resource_group: myResourceGroup
        name: myAppServicePlan

    - name: Get jctanner.cloud_azure.azure_rm_appserviceplan_facts for app service plan in resource group
      jctanner.cloud_azure.azure_rm_webapp_facts:
        resource_group: myResourceGroup
