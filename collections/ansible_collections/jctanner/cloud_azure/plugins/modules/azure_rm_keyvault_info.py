...
DOCUMENTATION = '''
---
module: jctanner.cloud_azure.azure_rm_keyvault_info
version_added: "2.9"
...
EXAMPLES = '''
  - name: Get Key Vault by name
    jctanner.cloud_azure.azure_rm_keyvault_info:
...
keyvaults:
    ...
    contains:
        ...
        vault_uri:
            ...
            returned: always
            type: str
            sample: https://myVault.vault.jctanner.cloud_azure.azure.net/
        location:
            description:
...
try:
    from jctanner.cloud_azure.azure.mgmt.keyvault import KeyVaultManagementClient
