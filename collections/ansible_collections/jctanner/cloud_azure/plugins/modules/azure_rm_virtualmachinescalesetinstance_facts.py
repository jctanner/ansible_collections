...
DOCUMENTATION = '''
---
module: jctanner.cloud_azure.azure_rm_virtualmachinescalesetinstance_facts
version_added: "2.8"
...
EXAMPLES = '''
  - name: List VM instances in Virtual Machine ScaleSet
    jctanner.cloud_azure.azure_rm_computevirtualmachinescalesetinstance_facts:
...
try:
    ...
    from jctanner.cloud_azure.azure.mgmt.compute import ComputeManagementClient
