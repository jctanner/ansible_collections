...
DOCUMENTATION = '''
---
module: jctanner.cloud_azure.azure_rm_mariadbconfiguration
version_added: "2.8"
...
EXAMPLES = '''
  - name: Update SQL Server setting
    jctanner.cloud_azure.azure_rm_mariadbconfiguration:
...
try:
    ...
    from jctanner.cloud_azure.azure.mgmt.rdbms.mysql import MariaDBManagementClient
