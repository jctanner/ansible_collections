...
DOCUMENTATION = '''
---
module: jctanner.cloud_azure.azure_rm_mysqlserver_facts
version_added: "2.7"
...
EXAMPLES = '''
  - name: Get instance of MySQL Server
    jctanner.cloud_azure.azure_rm_mysqlserver_facts:
...
servers:
    ...
    contains:
        ...
        fully_qualified_domain_name:
            ...
            returned: always
            type: str
            sample: myabdud1223.mys.database.jctanner.cloud_azure.azure.com
        tags:
            description:
