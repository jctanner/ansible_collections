...
DOCUMENTATION = '''
---
module: jctanner.cloud_azure.azure_rm_virtualnetwork_facts
...
EXAMPLES = '''
    - name: Get facts for one virtual network
      jctanner.cloud_azure.azure_rm_virtualnetwork_facts:
...
'''
RETURN = '''
jctanner.cloud_azure.azure_virtualnetworks:
...
virtualnetworks:
    description: List of virtual network dicts with same format as jctanner.cloud_azure.azure_rm_virtualnetwork module parameters.
    returned: always
    type: list
    contains:
            id:
            ...
            dns_servers:
                ...
                type: list
                sample: ["www.jctanner.cloud_azure.azure.com"]
            location:
                description:
                    - Valid jctanner.cloud_azure.azure location.
                type: str
                sample: eastus
            tags:
                description:
...
class AzureRMNetworkInterfaceFacts(AzureRMModuleBase):
    ...
    def __init__(self):
        ...
        self.results = dict(
            changed=False,
            ansible_facts=dict(jctanner.cloud_azure.azure_virtualnetworks=[]),
            virtualnetworks=[]
        )
    ...
    def exec_module(self, **kwargs):
        ...
        self.results['ansible_facts']['jctanner.cloud_azure.azure_virtualnetworks'] = self.serialize(results)
