...
DOCUMENTATION = '''
---
module: jctanner.cloud_azure.azure_rm_sqlserver_facts
version_added: "2.5"
...
EXAMPLES = '''
  - name: Get instance of SQL Server
    jctanner.cloud_azure.azure_rm_sqlserver_facts:
...
try:
    ...
    from jctanner.cloud_azure.azure.mgmt.sql import SqlManagementClient
