...
DOCUMENTATION = '''
---
module: jctanner.cloud_azure.azure_rm_keyvaultsecret
version_added: 2.5
...
EXAMPLES = '''
    - name: Create a secret
      jctanner.cloud_azure.azure_rm_keyvaultsecret:
...
state:
    ...
    contains:
        secret_id:
          ...
          type: str
          example: https://contoso.vault.jctanner.cloud_azure.azure.net/secrets/hello/e924f053839f4431b35bc54393f98423
'''
...
try:
    from jctanner.cloud_azure.azure.keyvault import KeyVaultClient, KeyVaultAuthentication, KeyVaultId
