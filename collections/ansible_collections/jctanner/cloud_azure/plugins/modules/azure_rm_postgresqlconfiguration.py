...
DOCUMENTATION = '''
---
module: jctanner.cloud_azure.azure_rm_postgresqlconfiguration
version_added: "2.8"
...
EXAMPLES = '''
  - name: Update PostgreSQL Server setting
    jctanner.cloud_azure.azure_rm_postgresqlconfiguration:
...
try:
    ...
    from jctanner.cloud_azure.azure.mgmt.rdbms.postgresql import MySQLManagementClient
