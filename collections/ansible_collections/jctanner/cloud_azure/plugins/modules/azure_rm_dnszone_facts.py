...
DOCUMENTATION = '''
---
module: jctanner.cloud_azure.azure_rm_dnszone_facts
...
- name: Get facts for one zone
  jctanner.cloud_azure.azure_rm_dnszone_facts:
...
RETURN = '''
jctanner.cloud_azure.azure_dnszones:
    description:
        - List of zone dicts.
    returned: always
    type: list
...
dnszones:
    description:
        - List of zone dicts, which share the same layout as jctanner.cloud_azure.azure_rm_dnszone module parameter.
    returned: always
    type: list
    contains:
        id:
            description:
                - id of the DNS Zone.
            sample: "/subscriptions/xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx/resourceGroups/myResourceGroup/providers/Microsoft.Network/dnszones/jctanner.cloud_azure.azure.com"
        name:
            description:
                - name of the DNS zone.
            sample: jctanner.cloud_azure.azure.com
        type:
            description:
        ...
        name_servers:
            ...
            type: list
            sample:  [
                "ns1-03.jctanner.cloud_azure.azure-dns.com.",
                "ns2-03.jctanner.cloud_azure.azure-dns.net.",
                "ns3-03.jctanner.cloud_azure.azure-dns.org.",
                "ns4-03.jctanner.cloud_azure.azure-dns.info."
            ]
'''
...
class AzureRMDNSZoneFacts(AzureRMModuleBase):
    ...
    def __init__(self):
        ...
        self.results = dict(
            changed=False,
            ansible_facts=dict(jctanner.cloud_azure.azure_dnszones=[])
        )
    ...
    def exec_module(self, **kwargs):
        ...
        self.results['ansible_facts']['jctanner.cloud_azure.azure_dnszones'] = self.serialize_items(results)
