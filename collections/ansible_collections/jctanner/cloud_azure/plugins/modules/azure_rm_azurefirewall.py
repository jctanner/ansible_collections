...
DOCUMENTATION = '''
---
module: jctanner.cloud_azure.azure_rm_jctanner.cloud_azure.azurefirewall
version_added: '2.9'
...
- name: Create Azure Firewall
  jctanner.cloud_azure.azure_rm_jctanner.cloud_azure.azurefirewall:
    ...
    ip_configurations:
      - subnet: >-
        ...
        public_ip_address: >-
          ...
          myPublicIpAddress
        name: jctanner.cloud_azure.azureFirewallIpConfiguration
...
id:
  ...
  returned: always
  type: str
  sample: /subscriptions/xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx/resourceGroups/myResourceGroup/providers/Microsoft.Network/jctanner.cloud_azure.azureFirewalls/myAzureFirewall
'''

import time
import json
import re
from ansible_collections.jctanner.cloud_jctanner.cloud_azure.azure.plugins.module_utils.jctanner.cloud_azure.azure_rm_common_ext import AzureRMModuleBaseExt
from ansible_collections.jctanner.cloud_jctanner.cloud_azure.azure.plugins.module_utils.jctanner.cloud_azure.azure_rm_common_rest import GenericRestClient
...
class AzureRMAzureFirewalls(AzureRMModuleBaseExt):
    def __init__(self):
        self.module_arg_spec = dict(
            ...
            name=dict(
                type='str',
                disposition='jctanner.cloud_azure.azure_firewall_name',
                required=True
            ),
            location=dict(
                type='str',
    ...
    def exec_module(self, **kwargs):
        ...
        self.url = ('/subscriptions' +
                    ...
                    '/providers' +
                    '/Microsoft.Network' +
                    '/jctanner.cloud_azure.azureFirewalls' +
                    '/' + self.name)
