...
DOCUMENTATION = '''
---
module: jctanner.cloud_azure.azure_rm_roledefinition
version_added: "2.8"
...
EXAMPLES = '''
    - name: Create a role definition
      jctanner.cloud_azure.azure_rm_roledefinition:
        name: myTestRole
...
try:
    ...
    from jctanner.cloud_azure.azure.mgmt.authorization import AuthorizationManagementClient
    from jctanner.cloud_azure.azure.mgmt.authorization.model import (RoleDefinition, Permission)
