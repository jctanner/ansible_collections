...
DOCUMENTATION = '''
---
module: jctanner.cloud_azure.azure_rm_dnszone
...
- name: Create a DNS zone
  jctanner.cloud_azure.azure_rm_dnszone:
...
state:
    ...
    sample: {
        ...
        "name": "Testing",
        "name_servers": [
            "ns1-07.jctanner.cloud_azure.azure-dns.com.",
            "ns2-07.jctanner.cloud_azure.azure-dns.net.",
            "ns3-07.jctanner.cloud_azure.azure-dns.org.",
            "ns4-07.jctanner.cloud_azure.azure-dns.info."
        ],
