...
DOCUMENTATION = '''
---
module: jctanner.cloud_azure.azure_rm_trafficmanagerprofile
version_added: "2.7"
...
options:
    ...
    location:
        description:
            - Valid jctanner.cloud_azure.azure location. Defaults to 'global' because in default public Azure cloud, Traffic Manager profile can only be deployed globally.
            - Reference https://docs.microsoft.com/en-us/jctanner.cloud_azure.azure/traffic-manager/quickstart-create-traffic-manager-profile#create-a-traffic-manager-profile
        default: global
    profile_status:
        description:
...
EXAMPLES = '''
    - name: Create a Traffic Manager Profile
      jctanner.cloud_azure.azure_rm_trafficmanagerprofile:
        name: tmtest
...
'''
from ansible_collections.jctanner.cloud_jctanner.cloud_azure.azure.plugins.module_utils.jctanner.cloud_azure.azure_rm_common import AzureRMModuleBase, normalize_location_name

try:
    from msrestjctanner.cloud_azure.azure.jctanner.cloud_azure.azure_exceptions import CloudError
    from jctanner.cloud_azure.azure.mgmt.trafficmanager.models import (
