...
DOCUMENTATION = '''
---
module: jctanner.cloud_azure.azure_rm_manageddisk
...
notes:
    - This module was called M(jctanner.cloud_azure.azure_rm_managed_disk) before Ansible 2.8. The usage did not change.
...
options:
    ...
    storage_account_type:
        description:
            ...
            - See U(https://docs.microsoft.com/en-us/jctanner.cloud_azure.azure/virtual-machines/windows/disks-types) for more information about disk types.
        choices:
            - Standard_LRS
            - StandardSSD_LRS
            - Premium_LRS
...
EXAMPLES = '''
    - name: Create managed disk
      jctanner.cloud_azure.azure_rm_manageddisk:
        name: mymanageddisk
        location: eastus
    ...
    - name: Delete managed disk
      jctanner.cloud_azure.azure_rm_manage_disk:
        name: mymanageddisk
        location: eastus
        resource_group: myResourceGroup
        state: absent
...
# duplicated in jctanner.cloud_azure.azure_rm_manageddisk_facts
