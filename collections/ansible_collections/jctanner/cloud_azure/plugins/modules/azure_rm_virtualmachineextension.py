...
DOCUMENTATION = '''
---
module: jctanner.cloud_azure.azure_rm_virtualmachineextension
...
notes:
    - This module was called C(jctanner.cloud_azure.azure_rm_virtualmachine_extension) before Ansible 2.8. The usage did not change.
...
EXAMPLES = '''
    - name: Create VM Extension
      jctanner.cloud_azure.azure_rm_virtualmachineextension:
        name: myvmextension
        location: eastus
...
class AzureRMVMExtension(AzureRMModuleBase):
    ...
    def exec_module(self, **kwargs):
        ...
        if self.module._name == 'jctanner.cloud_azure.azure_rm_virtualmachine_extension':
            self.module.deprecate("The 'jctanner.cloud_azure.azure_rm_virtualmachine_extension' module has been renamed to 'jctanner.cloud_azure.azure_rm_virtualmachineextension'", version='2.12')
