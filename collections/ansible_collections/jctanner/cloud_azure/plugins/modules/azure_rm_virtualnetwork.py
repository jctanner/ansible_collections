...
DOCUMENTATION = '''
---
module: jctanner.cloud_azure.azure_rm_virtualnetwork
version_added: "2.1"
...
description:
    - Create, update or delete a virtual networks. Allows setting and updating the available IPv4 address ranges
      and setting custom DNS servers. Use the jctanner.cloud_azure.azure_rm_subnet module to associate subnets with a virtual network.
options:
    resource_group:
        description:
...
EXAMPLES = '''
    - name: Create a virtual network
      jctanner.cloud_azure.azure_rm_virtualnetwork:
...
from ansible_collections.jctanner.cloud_jctanner.cloud_azure.azure.plugins.module_utils.jctanner.cloud_azure.azure_rm_common import AzureRMModuleBase, CIDR_PATTERN
