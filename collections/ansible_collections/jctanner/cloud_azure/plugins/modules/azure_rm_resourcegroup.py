...
DOCUMENTATION = '''
---
module: jctanner.cloud_azure.azure_rm_resourcegroup
version_added: "2.1"
            ...
            if self.state == 'present':
                ...
                if contains_resources and not self.force_delete_nonempty:
                    self.fail("Error removing resource group {0}. Resources exist within the group. "
                              ...
                              "To list resources under {0}, use `jctanner.cloud_azure.azure_rm_resourcegroup_facts` module with `list_resources` option.".format(self.name))
