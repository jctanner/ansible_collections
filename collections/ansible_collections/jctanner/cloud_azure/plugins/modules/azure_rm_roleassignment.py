...
DOCUMENTATION = '''
---
module: jctanner.cloud_azure.azure_rm_roleassignment
version_added: "2.8"
...
EXAMPLES = '''
    - name: Create a role assignment
      jctanner.cloud_azure.azure_rm_roleassignment:
...
try:
    ...
    from jctanner.cloud_azure.azure.mgmt.authorization.models import RoleAssignmentCreateParameters
