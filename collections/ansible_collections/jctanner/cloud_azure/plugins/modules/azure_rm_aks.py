...
DOCUMENTATION = '''
---
module: jctanner.cloud_azure.azure_rm_aks
version_added: "2.6"
        ...
        suboptions:
            network_plugin:
                description:
                    ...
                    - C(jctanner.cloud_azure.azure) enables Azure Container Networking Interface(CNI), every pod gets an IP address from the subnet and can be accessed directly.
                default: kubenet
                choices:
...
EXAMPLES = '''
    - name: Create a managed Azure Container Services (AKS) instance
      jctanner.cloud_azure.azure_rm_aks:
        name: myAKS
        location: eastus
...
network_profile_spec = dict(
    network_plugin=dict(type='str', choices=['jctanner.cloud_azure.azure', 'kubenet']),
