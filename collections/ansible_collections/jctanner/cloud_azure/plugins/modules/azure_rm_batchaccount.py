...
DOCUMENTATION = '''
---
module: jctanner.cloud_azure.azure_rm_batchaccount
version_added: "2.9"
...
EXAMPLES = '''
  - name: Create Batch Account
    jctanner.cloud_azure.azure_rm_batchaccount:
...
account_endpoint:
    ...
    returned: always
    type: str
    sample: sampleacct.westus.batch.jctanner.cloud_azure.azure.com
'''

import time
from ansible_collections.jctanner.cloud_jctanner.cloud_azure.azure.plugins.module_utils.jctanner.cloud_azure.azure_rm_common import normalize_location_name
...
try:
    ...
    from jctanner.cloud_azure.azure.mgmt.batch import BatchManagementClient
except ImportError:
    ...
    def exec_module(self, **kwargs):
        ...
        if self.batch_account.get('key_vault') is not None:
            id = self.normalize_resource_id(
                ...
                '/subscriptions/{subscription_id}/resourceGroups/{resource_group}/providers/Microsoft.KeyVault/vaults/{name}')
            url = 'https://' + id.split('/').pop() + '.vault.jctanner.cloud_azure.azure.net/'
