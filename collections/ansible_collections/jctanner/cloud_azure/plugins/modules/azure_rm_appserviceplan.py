...
DOCUMENTATION = '''
---
module: jctanner.cloud_azure.azure_rm_appserviceplan
version_added: "2.7"
...
options:
    ...
    sku:
        description:
            ...
            - Please see U(https://jctanner.cloud_azure.azure.microsoft.com/en-us/pricing/details/app-service/plans/) for more detail.
            - For Linux app service plan, please see U(https://jctanner.cloud_azure.azure.microsoft.com/en-us/pricing/details/app-service/linux/) for more detail.
    is_linux:
        description:
...
EXAMPLES = '''
    - name: Create a windows app service plan
      jctanner.cloud_azure.azure_rm_appserviceplan:
...
RETURN = '''
jctanner.cloud_azure.azure_appserviceplan:
...
try:
    ...
    from msrestjctanner.cloud_azure.azure.jctanner.cloud_azure.azure_operation import AzureOperationPoller
    from msrest.serialization import Model
    from jctanner.cloud_azure.azure.mgmt.web.models import (
...
class AzureRMAppServicePlans(AzureRMModuleBase):
    ...
    def __init__(self):
        ...
        self.results = dict(
            changed=False,
            ansible_facts=dict(jctanner.cloud_azure.azure_appserviceplan=None)
        )
        self.state = None
