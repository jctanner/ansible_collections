...
DOCUMENTATION = '''
---
module: jctanner.cloud_azure.azure_rm_containerregistry_facts
version_added: "2.7"
...
EXAMPLES = '''
  - name: Get instance of Registry
    jctanner.cloud_azure.azure_rm_containerregistry_facts:
...
registries:
    ...
    contains:
        ...
        login_server:
            ...
            returned: always
            type: str
            sample: acrd08521b.jctanner.cloud_azure.azurecr.io
        credentials:
            description:
