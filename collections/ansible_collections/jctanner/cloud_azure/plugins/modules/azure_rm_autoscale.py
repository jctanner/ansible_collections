...
DOCUMENTATION = '''
---
module: jctanner.cloud_azure.azure_rm_autoscale
version_added: "2.7"
...
- name: Create an auto scale
  jctanner.cloud_azure.azure_rm_autoscale:
...
from ansible_collections.jctanner.cloud_jctanner.cloud_azure.azure.plugins.module_utils.jctanner.cloud_azure.azure_rm_common import AzureRMModuleBase, format_resource_id
...
try:
    ...
    from jctanner.cloud_azure.azure.mgmt.monitor.models import WebhookNotification, EmailNotification, AutoscaleNotification, RecurrentSchedule, MetricTrigger, \
...
# duplicated in jctanner.cloud_azure.azure_rm_autoscale_facts
