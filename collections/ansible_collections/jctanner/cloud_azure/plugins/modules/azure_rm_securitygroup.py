...
DOCUMENTATION = '''
---
module: jctanner.cloud_azure.azure_rm_securitygroup
version_added: "2.1"
...
- jctanner.cloud_azure.azure_rm_securitygroup:
...
state:
    ...
    sample: {
        "default_rules": [
            ...
            {
                "access": "Allow",
                "description": "Allow inbound traffic from jctanner.cloud_azure.azure load balancer",
                "destination_address_prefix": "*",
                "destination_port_range": "*",
                "direction": "Inbound",
                "etag": 'W/"edf48d56-b315-40ca-a85d-dbcb47f2da7d"',
...
try:
    ...
    from msrestjctanner.cloud_azure.azure.tools import is_valid_resource_id
...
class AzureRMSecurityGroup(AzureRMModuleBase):
    ...
    def __init__(self):
        ...
        self.state = None
        self.tags = None
        self.nsg_models = None  # type: jctanner.cloud_azure.azure.mgmt.network.models
