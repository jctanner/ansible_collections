...
DOCUMENTATION = '''
---
module: jctanner.cloud_azure.azure_rm_storageaccount
version_added: "2.1"
...
EXAMPLES = '''
    - name: remove account, if it exists
      jctanner.cloud_azure.azure_rm_storageaccount:
...
try:
    ...
    from jctanner.cloud_azure.azure.storage.cloudstorageaccount import CloudStorageAccount
    from jctanner.cloud_azure.azure.common import AzureMissingResourceHttpError
except ImportError:
    # This is handled in jctanner.cloud_azure.azure_rm_common
    pass

import copy
from ansible_collections.jctanner.cloud_jctanner.cloud_azure.azure.plugins.module_utils.jctanner.cloud_azure.azure_rm_common import AZURE_SUCCESS_STATE, AzureRMModuleBase
