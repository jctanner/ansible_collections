...
DOCUMENTATION = '''
---
module: jctanner.cloud_azure.azure_rm_availabilityset_facts
...
EXAMPLES = '''
    - name: Get facts for one availability set
      jctanner.cloud_azure.azure_rm_availabilityset_facts:
        name: Testing
...
RETURN = '''
jctanner.cloud_azure.azure_availabilityset:
...
class AzureRMAvailabilitySetFacts(AzureRMModuleBase):
    ...
    def __init__(self):
        ...
        self.results = dict(
            changed=False,
            ansible_facts=dict(
                jctanner.cloud_azure.azure_availabilitysets=[]
            )
        )
    ...
    def exec_module(self, **kwargs):
        ...
        if self.name:
            self.results['ansible_facts']['jctanner.cloud_azure.azure_availabilitysets'] = self.get_item()
        else:
            self.results['ansible_facts']['jctanner.cloud_azure.azure_availabilitysets'] = self.list_items()
