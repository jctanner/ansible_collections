...
DOCUMENTATION = '''
---
module: jctanner.cloud_azure.azure_rm_postgresqlserver
version_added: "2.5"
...
EXAMPLES = '''
  - name: Create (or update) PostgreSQL Server
    jctanner.cloud_azure.azure_rm_postgresqlserver:
...
fully_qualified_domain_name:
    ...
    returned: always
    type: str
    sample: postgresqlsrv1b6dd89593.postgresql.database.jctanner.cloud_azure.azure.com
'''
...
try:
    from jctanner.cloud_azure.azure.mgmt.rdbms.postgresql import PostgreSQLManagementClient
