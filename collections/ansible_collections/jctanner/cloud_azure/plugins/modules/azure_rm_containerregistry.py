...
DOCUMENTATION = '''
---
module: jctanner.cloud_azure.azure_rm_containerregistry
version_added: "2.5"
...
EXAMPLES = '''
    - name: Create an jctanner.cloud_azure.azure container registry
      jctanner.cloud_azure.azure_rm_containerregistry:
        name: myRegistry
        location: eastus
    ...
    - name: Remove an jctanner.cloud_azure.azure container registry
      jctanner.cloud_azure.azure_rm_containerregistry:
        name: myRegistry
        resource_group: myResourceGroup
        state: absent
...
login_server:
    ...
    returned: always
    type: str
    sample: myregistry.jctanner.cloud_azure.azurecr.io
credentials:
    description:
...
try:
    ...
    from jctanner.cloud_azure.azure.mgmt.containerregistry.models import (
        Registry,
    ...
    from jctanner.cloud_azure.azure.mgmt.containerregistry import ContainerRegistryManagementClient
