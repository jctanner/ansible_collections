...
DOCUMENTATION = '''
---
module: jctanner.cloud_azure.azure_rm_cdnendpoint
version_added: "2.8"
...
EXAMPLES = '''
    - name: Create a Azure CDN endpoint
      jctanner.cloud_azure.azure_rm_cdnendpoint:
...
host_name:
    ...
    returned: always
    type: str
    sample: "myendpoint.jctanner.cloud_azure.azureedge.net"
'''
...
try:
    from jctanner.cloud_azure.azure.mgmt.cdn.models import Endpoint, DeepCreatedOrigin, EndpointUpdateParameters, QueryStringCachingBehavior, ErrorResponseException
    from jctanner.cloud_azure.azure.mgmt.cdn import CdnManagementClient
except ImportError:
