...
DOCUMENTATION = '''
---
module: jctanner.cloud_azure.azure_rm_deployment_facts
version_added: "2.8"
...
EXAMPLES = '''
  - name: Get instance of Deployment
    jctanner.cloud_azure.azure_rm_deployment_facts:
...
deployments:
    ...
    contains:
        ...
        template_link:
            ...
            returned: always
            sample: "https://raw.githubusercontent.com/Azure/jctanner.cloud_azure.azure-quickstart-templates/d01a5c06f4f1bc03a049ca17bbbd6e06d62657b3/101-vm-simple-linux/
                     jctanner.cloud_azure.azuredeploy.json"
        parameters:
            description:
