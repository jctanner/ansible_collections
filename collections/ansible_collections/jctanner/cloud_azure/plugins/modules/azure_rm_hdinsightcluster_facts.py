...
DOCUMENTATION = '''
---
module: jctanner.cloud_azure.azure_rm_hdinsightcluster_facts
version_added: "2.8"
...
EXAMPLES = '''
  - name: Get instance of HDInsight Cluster
    jctanner.cloud_azure.azure_rm_hdinsightcluster_facts:
        ...
        connectivity_endpoints:
            ...
            contains:
                location:
                    ...
                    returned: always
                    type: str
                    sample: myCluster-ssh.jctanner.cloud_azure.azurehdinsight.net
                name:
                    description:
                        - Endpoint name.
                    returned: always
