...
DOCUMENTATION = '''
---
module: jctanner.cloud_azure.azure_rm_publicipaddress_facts
...
EXAMPLES = '''
    - name: Get facts for one Public IP
      jctanner.cloud_azure.azure_rm_publicipaddress_facts:
...
RETURN = '''
jctanner.cloud_azure.azure_publicipaddresses:
    description:
...
publicipaddresses:
    description:
        ...
        - Contains the detail which matches jctanner.cloud_azure.azure_rm_publicipaddress parameters.
...
class AzureRMPublicIPFacts(AzureRMModuleBase):
    ...
    def __init__(self):
        ...
        self.results = dict(
            changed=False,
            ansible_facts=dict(jctanner.cloud_azure.azure_publicipaddresses=[])
        )
    ...
    def exec_module(self, **kwargs):
        ...
        self.results['ansible_facts']['jctanner.cloud_azure.azure_publicipaddresses'] = self.serialize(raw)
    ...
    # duplicate with jctanner.cloud_azure.azure_rm_publicipaddress
