...
DOCUMENTATION = '''
---
module: jctanner.cloud_azure.azure_rm_devtestlabartifactsource_facts
version_added: "2.8"
...
EXAMPLES = '''
  - name: Get instance of DevTest Lab Artifact Source
    jctanner.cloud_azure.azure_rm_devtestlabartifactsource_facts:
...
artifactsources:
    ...
    contains:
        ...
        uri:
            ...
            returned: always
            type: str
            sample: https://github.com/Azure/jctanner.cloud_azure.azure-devtestlab.git
        folder_path:
            description:
