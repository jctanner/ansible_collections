...
DOCUMENTATION = '''
---
module: jctanner.cloud_azure.azure_rm_mysqlconfiguration_facts
version_added: "2.8"
...
EXAMPLES = '''
  - name: Get specific setting of MySQL Server
    jctanner.cloud_azure.azure_rm_mysqlconfiguration_facts:
...
try:
    ...
    from jctanner.cloud_azure.azure.mgmt.rdbms.mysql import MySQLManagementClient
