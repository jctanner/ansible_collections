...
DOCUMENTATION = '''
---
module: jctanner.cloud_azure.azure_rm_aksversion_facts
...
EXAMPLES = '''
    - name: Get available versions for AKS in location eastus
      jctanner.cloud_azure.azure_rm_aksversion_facts:
        location: eastus
...
RETURN = '''
jctanner.cloud_azure.azure_aks_versions:
...
class AzureRMAKSVersion(AzureRMModuleBase):
    ...
    def exec_module(self, **kwargs):
        ...
        self.results['jctanner.cloud_azure.azure_aks_versions'] = self.get_all_versions(self.location, self.version)
