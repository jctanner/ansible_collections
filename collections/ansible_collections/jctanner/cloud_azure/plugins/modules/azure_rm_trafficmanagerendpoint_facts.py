...
DOCUMENTATION = '''
---
module: jctanner.cloud_azure.azure_rm_trafficmanagerendpoint_facts
...
EXAMPLES = '''
    - name: Get endpoints facts of a Traffic Manager profile
      jctanner.cloud_azure.azure_rm_trafficmanagerendpoint_facts:
        resource_group: myResourceGroup
        profile_name: Testing

    - name: Get specific endpoint of a Traffic Manager profile
      jctanner.cloud_azure.azure_rm_trafficmanager_facts:
        resource_group: myResourceGroup
        profile_name: Testing
