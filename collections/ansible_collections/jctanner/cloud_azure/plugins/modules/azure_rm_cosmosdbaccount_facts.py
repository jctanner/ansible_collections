...
DOCUMENTATION = '''
---
module: jctanner.cloud_azure.azure_rm_cosmosdbaccount_facts
version_added: "2.8"
...
EXAMPLES = '''
  - name: Get instance of Database Account
    jctanner.cloud_azure.azure_rm_cosmosdbaccount_facts:
      resource_group: myResourceGroup
      name: testaccount

  - name: List instances of Database Account
    jctanner.cloud_azure.azure_rm_cosmosdbaccousnt_facts:
      resource_group: myResourceGroup
'''
...
accounts:
    ...
    contains:
        ...
        read_locations:
            ...
            contains:
                ...
                document_endpoint:
                    ...
                    returned: always
                    type: str
                    sample: https://testaccount-eastus.documents.jctanner.cloud_azure.azure.com:443/
                provisioning_state:
                    description:
                        - Provisioning state.
                    returned: always
        ...
        document_endpoint:
            ...
            returned: always
            type: str
            sample: https://testaccount.documents.jctanner.cloud_azure.azure.com:443/
        provisioning_state:
            description:
        ...
        connection_strings:
            ...
            contains:
                ...
                description:
                    ...
                    type: str
                    returned: always
                    sample: "AccountEndpoint=https://testaccount.documents.jctanner.cloud_azure.azure.com:443/;AccountKey=fSEjathnk6ZeBTrXkud9j5kfhtSEQ
...
try:
    ...
    from jctanner.cloud_azure.azure.mgmt.cosmosdb import CosmosDB
