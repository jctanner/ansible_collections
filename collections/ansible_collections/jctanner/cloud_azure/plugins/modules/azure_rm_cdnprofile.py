...
DOCUMENTATION = '''
---
module: jctanner.cloud_azure.azure_rm_cdnprofile
version_added: "2.8"
...
options:
    ...
    sku:
        description:
            ...
            - Detailed pricing can be find at U(https://jctanner.cloud_azure.azure.microsoft.com/en-us/pricing/details/cdn/).
        choices:
            - standard_verizon
            - premium_verizon
            - custom_verizon
...
EXAMPLES = '''
    - name: Create a CDN profile
      jctanner.cloud_azure.azure_rm_cdnprofile:
...
try:
    from jctanner.cloud_azure.azure.mgmt.cdn.models import Profile, Sku, ErrorResponseException
