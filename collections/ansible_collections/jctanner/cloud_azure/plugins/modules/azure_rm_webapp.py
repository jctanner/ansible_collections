...
DOCUMENTATION = '''
---
module: jctanner.cloud_azure.azure_rm_webapp
version_added: "2.7"
...
options:
    ...
    plan:
        description:
            ...
            - C(sku). SKU of app service plan. For allowed sku, please refer to U(https://jctanner.cloud_azure.azure.microsoft.com/en-us/pricing/details/app-service/linux/).
    ...
    frameworks:
        description:
            ...
            - See U(https://docs.microsoft.com/en-us/jctanner.cloud_azure.azure/app-service/app-service-web-overview) for more info.
        suboptions:
            name:
                description:
    ...
    skip_custom_domain_verification:
        description:
            - If true, custom (non *.jctanner.cloud_azure.azurewebsites.net) domains associated with web app are not verified.
        type: bool
...
EXAMPLES = '''
    - name: Create a windows web app with non-exist app service plan
      jctanner.cloud_azure.azure_rm_webapp:
...
RETURN = '''
jctanner.cloud_azure.azure_webapp:
