...
DOCUMENTATION = r'''
---
module: jctanner.cloud_azure.azure_rm_manageddisk_facts
...
notes:
    - This module was called M(jctanner.cloud_azure.azure_rm_managed_disk_facts) before Ansible 2.8. The usage did not change.
...
- name: Get facts for one managed disk
  jctanner.cloud_azure.azure_rm_manageddisk_facts:
    name: Testing
...
RETURN = r'''
jctanner.cloud_azure.azure_managed_disk:
    description:
    ...
    contains:
        ...
        storage_account_type:
            description:
                ...
                - See U(https://docs.microsoft.com/en-us/jctanner.cloud_azure.azure/virtual-machines/windows/disks-types) for more information about this type.
            type: str
            sample: Standard_LRS
        create_option:
            description:
...
# duplicated in jctanner.cloud_azure.azure_rm_manageddisk
...
class AzureRMManagedDiskFacts(AzureRMModuleBase):
    ...
    def exec_module(self, **kwargs):
        ...
        self.results['ansible_facts']['jctanner.cloud_azure.azure_managed_disk'] = (
