...
DOCUMENTATION = '''
---
module: jctanner.cloud_azure.azure_rm_mysqlserver
version_added: "2.5"
...
EXAMPLES = '''
  - name: Create (or update) MySQL Server
    jctanner.cloud_azure.azure_rm_mysqlserver:
...
fully_qualified_domain_name:
    ...
    returned: always
    type: str
    sample: mysqlsrv1b6dd89593.mysql.database.jctanner.cloud_azure.azure.com
'''
