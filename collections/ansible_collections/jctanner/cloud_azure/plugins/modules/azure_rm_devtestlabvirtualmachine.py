...
DOCUMENTATION = '''
---
module: jctanner.cloud_azure.azure_rm_devtestlabvirtualmachine
version_added: "2.8"
...
options:
    ...
    vm_size:
        description:
            ...
            - Available values can be found on this website, link U(https://docs.microsoft.com/en-us/jctanner.cloud_azure.azure/virtual-machines/windows/sizes-general).
...
EXAMPLES = '''
  - name: Create (or update) Virtual Machine
    jctanner.cloud_azure.azure_rm_devtestlabvirtualmachine:
      resource_group: myrg
      lab_name: mylab
      name: myvm
...
fqdn:
    ...
    returned: always
    type: str
    sample: myvm.eastus.cloudapp.jctanner.cloud_azure.azure.com
'''
...
try:
    ...
    from jctanner.cloud_azure.azure.mgmt.devtestlabs import DevTestLabsClient
