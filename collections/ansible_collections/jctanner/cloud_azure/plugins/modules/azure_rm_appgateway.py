...
DOCUMENTATION = '''
---
module: jctanner.cloud_azure.azure_rm_appgateway
version_added: "2.7"
...
- name: Create instance of Application Gateway
  jctanner.cloud_azure.azure_rm_appgateway:
...
from ansible_collections.jctanner.cloud_jctanner.cloud_azure.azure.plugins.module_utils.network.common.utils import dict_merge
