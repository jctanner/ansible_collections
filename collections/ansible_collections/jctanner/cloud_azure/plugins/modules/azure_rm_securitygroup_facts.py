...
DOCUMENTATION = '''
---
module: jctanner.cloud_azure.azure_rm_securitygroup_facts
...
EXAMPLES = '''
    - name: Get facts for one security group
      jctanner.cloud_azure.azure_rm_securitygroup_facts:
...
RETURN = '''
jctanner.cloud_azure.azure_securitygroups:
...
class AzureRMSecurityGroupFacts(AzureRMModuleBase):
    ...
    def __init__(self):
        ...
        self.results = dict(
            changed=False,
            ansible_facts=dict(jctanner.cloud_azure.azure_securitygroups=[])
        )
    ...
    def exec_module(self, **kwargs):
        ...
        if self.name is not None:
            self.results['ansible_facts']['jctanner.cloud_azure.azure_securitygroups'] = self.get_item()
        else:
            self.results['ansible_facts']['jctanner.cloud_azure.azure_securitygroups'] = self.list_items()
