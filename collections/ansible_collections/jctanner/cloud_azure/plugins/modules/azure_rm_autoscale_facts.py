...
DOCUMENTATION = '''
---
module: jctanner.cloud_azure.azure_rm_autoscale_facts
version_added: "2.7"
...
EXAMPLES = '''
  - name: Get instance of Auto Scale Setting
    jctanner.cloud_azure.azure_rm_autoscale_facts:
...
# duplicated in jctanner.cloud_azure.azure_rm_autoscale
