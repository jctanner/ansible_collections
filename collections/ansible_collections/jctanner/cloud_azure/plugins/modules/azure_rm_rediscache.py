...
DOCUMENTATION = '''
---
module: jctanner.cloud_azure.azure_rm_rediscache
version_added: "2.8"
...
options:
    ...
    maxfragmentationmemory_reserved:
        description:
            ...
            - Please see U(https://docs.microsoft.com/en-us/jctanner.cloud_azure.azure/redis-cache/cache-configure#advanced-settings) for more detail.
    maxmemory_reserved:
        description:
...
EXAMPLES = '''
  - name: Create an Azure Cache for Redis
    jctanner.cloud_azure.azure_rm_rediscache:
...
try:
    ...
    from jctanner.cloud_azure.azure.mgmt.redis import RedisManagementClient
    from jctanner.cloud_azure.azure.mgmt.redis.models import (RedisCreateParameters, RedisUpdateParameters, Sku)
except ImportError:
