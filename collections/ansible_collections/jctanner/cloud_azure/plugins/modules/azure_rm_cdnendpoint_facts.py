...
DOCUMENTATION = '''
---
module: jctanner.cloud_azure.azure_rm_cdnendpoint_facts
...
EXAMPLES = '''
  - name: Get facts for all endpoints in CDN profile
    jctanner.cloud_azure.azure_rm_cdnendpoint_facts:
...
try:
    ...
    from jctanner.cloud_azure.azure.mgmt.cdn.models import ErrorResponseException
    from jctanner.cloud_azure.azure.common import AzureHttpError
except ImportError:
