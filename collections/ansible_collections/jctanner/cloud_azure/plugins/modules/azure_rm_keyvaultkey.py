...
DOCUMENTATION = '''
---
module: jctanner.cloud_azure.azure_rm_keyvaultkey
version_added: 2.5
...
EXAMPLES = '''
    - name: Create a key
      jctanner.cloud_azure.azure_rm_keyvaultkey:
        key_name: MyKey
        keyvault_uri: https://contoso.vault.jctanner.cloud_azure.azure.net/
    ...
    contains:
        key_id:
          description:
              - key resource path.
          type: str
          example: https://contoso.vault.jctanner.cloud_azure.azure.net/keys/hello/e924f053839f4431b35bc54393f98423
'''
...
try:
    import re
    import codecs
    from jctanner.cloud_azure.azure.keyvault import KeyVaultClient, KeyVaultId, KeyVaultAuthentication
    from jctanner.cloud_azure.azure.keyvault.models import KeyAttributes, JsonWebKey
    from jctanner.cloud_azure.azure.common.credentials import ServicePrincipalCredentials
    from jctanner.cloud_azure.azure.keyvault.models.key_vault_error import KeyVaultErrorException
    from msrestjctanner.cloud_azure.azure.jctanner.cloud_azure.azure_active_directory import MSIAuthentication
...
class AzureRMKeyVaultKey(AzureRMModuleBase):
    ...
    def get_keyvault_client(self):
        try:
            ...
            credentials = MSIAuthentication(resource='https://vault.jctanner.cloud_azure.azure.net')
        ...
        def auth_callback(server, resource, scope):
            if self.credentials['client_id'] is None or self.credentials['secret'] is None:
                self.fail('Please specify client_id, secret and tenant to access jctanner.cloud_azure.azure Key Vault.')
            ...
            authcredential = ServicePrincipalCredentials(
                ...
                resource="https://vault.jctanner.cloud_azure.azure.net")
