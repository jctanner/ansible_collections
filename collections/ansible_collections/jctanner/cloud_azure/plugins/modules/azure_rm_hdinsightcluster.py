...
DOCUMENTATION = '''
---
module: jctanner.cloud_azure.azure_rm_hdinsightcluster
version_added: "2.8"
...
- name: Create instance of HDInsight Cluster
  jctanner.cloud_azure.azure_rm_hdinsightcluster:
...
try:
    ...
    from jctanner.cloud_azure.azure.mgmt.hdinsight import HDInsightManagementClient
