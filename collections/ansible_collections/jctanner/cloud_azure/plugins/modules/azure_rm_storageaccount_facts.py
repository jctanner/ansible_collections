...
DOCUMENTATION = '''
---
module: jctanner.cloud_azure.azure_rm_storageaccount_facts
...
EXAMPLES = '''
    - name: Get facts for one account
      jctanner.cloud_azure.azure_rm_storageaccount_facts:
...
RETURN = '''
jctanner.cloud_azure.azure_storageaccounts:
...
class AzureRMStorageAccountFacts(AzureRMModuleBase):
    def __init__(self):
        ...
        self.results = dict(
            changed=False,
            ansible_facts=dict(jctanner.cloud_azure.azure_storageaccounts=[]),
            storageaccounts=[]
        )
    ...
    def exec_module(self, **kwargs):
        ...
        self.results['ansible_facts']['jctanner.cloud_azure.azure_storageaccounts'] = self.serialize(filtered)
