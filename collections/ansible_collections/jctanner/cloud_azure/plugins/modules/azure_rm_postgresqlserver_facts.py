...
DOCUMENTATION = '''
---
module: jctanner.cloud_azure.azure_rm_postgresqlserver_facts
version_added: "2.7"
...
EXAMPLES = '''
  - name: Get instance of PostgreSQL Server
    jctanner.cloud_azure.azure_rm_postgresqlserver_facts:
...
servers:
    ...
    contains:
        ...
        fully_qualified_domain_name:
            ...
            returned: always
            type: str
            sample: postgreabdud1223.postgres.database.jctanner.cloud_azure.azure.com
        tags:
            description:
