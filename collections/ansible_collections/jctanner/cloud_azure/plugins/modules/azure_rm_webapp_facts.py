...
DOCUMENTATION = '''
---
module: jctanner.cloud_azure.azure_rm_webapp_facts

version_added: "2.7"

short_description: Get jctanner.cloud_azure.azure web app facts.
...
webapps:
    ...
    contains:
        ...
        ftp_publish_url:
            ...
            type: str
            sample: ftp://xxxx.ftp.jctanner.cloud_azure.azurewebsites.windows.net
        state:
