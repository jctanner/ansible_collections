...
DOCUMENTATION = '''
---
module: jctanner.cloud_azure.azure_rm_dnsrecordset
...
- name: ensure an "A" record set with multiple records
  jctanner.cloud_azure.azure_rm_dnsrecordset:
...
from ansible_collections.jctanner.cloud_jctanner.cloud_azure.azure.plugins.module_utils.jctanner.cloud_azure.azure_rm_common import AzureRMModuleBase, HAS_AZURE
...
RECORD_ARGSPECS = dict(
    ...
    # FUTURE: ensure all record types are supported (see https://github.com/Azure/jctanner.cloud_azure.azure-sdk-for-python/tree/master/jctanner.cloud_azure.azure-mgmt-dns/jctanner.cloud_azure.azure/mgmt/dns/models)
)
