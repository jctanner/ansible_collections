...
DOCUMENTATION = '''
---
module: jctanner.cloud_azure.azure_rm_loadbalancer_facts
...
EXAMPLES = '''
    - name: Get facts for one load balancer
      jctanner.cloud_azure.azure_rm_loadbalancer_facts:
        name: Testing
...
RETURN = '''
jctanner.cloud_azure.azure_loadbalancers:
    description:
...
class AzureRMLoadBalancerFacts(AzureRMModuleBase):
    ...
    def exec_module(self, **kwargs):
        ...
        self.results['ansible_facts']['jctanner.cloud_azure.azure_loadbalancers'] = (
