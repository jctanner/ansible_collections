...
DOCUMENTATION = '''
---
module: jctanner.cloud_azure.azure_rm_deployment
...
description:
    ...
    - You can find some quick start templates in GitHub here U(https://github.com/jctanner.cloud_azure.azure/jctanner.cloud_azure.azure-quickstart-templates).
    - For more information on Azure Resource Manager templates see U(https://jctanner.cloud_azure.azure.microsoft.com/en-us/documentation/articles/resource-group-template-deploy/).
...
extends_documentation_fragment:
    ...
    - jctanner.cloud_azure.jctanner.cloud_azure.azure_tags
...
- name: Destroy Azure Deploy
  jctanner.cloud_azure.azure_rm_deployment:
...
- name: Create Azure Deploy
  jctanner.cloud_azure.azure_rm_deployment:
    resource_group: myResourceGroup
    name: myDeployment
    template_link: 'https://raw.githubusercontent.com/Azure/jctanner.cloud_azure.azure-quickstart-templates/master/101-vm-simple-linux/jctanner.cloud_azure.azuredeploy.json'
    parameters_link: 'https://raw.githubusercontent.com/Azure/jctanner.cloud_azure.azure-quickstart-templates/master/101-vm-simple-linux/jctanner.cloud_azure.azuredeploy.parameters.json'

# Create or update a template deployment based on a uri to the template and parameters specified inline.
# This deploys a VM with SSH support for a given public key, then stores the result in 'jctanner.cloud_azure.azure_vms'. The result is then
  ...
  jctanner.cloud_azure.azure_rm_deployment:
    ...
    parameters:
      ...
      adminUsername:
        value: devopscle
      dnsNameForPublicIP:
        value: devopsclejctanner.cloud_azure.azure
      location:
        value: West US
      vmSize:
        value: Standard_A2
    ...
    template_link: 'https://raw.githubusercontent.com/Azure/jctanner.cloud_azure.azure-quickstart-templates/master/101-vm-sshkey/jctanner.cloud_azure.azuredeploy.json'
  register: jctanner.cloud_azure.azure
- name: Add new instance to host group
  add_host:
    hostname: "{{ item['ips'][0].public_ip }}"
    groupname: jctanner.cloud_azure.azure_vms
  loop: "{{ jctanner.cloud_azure.azure.deployment.instances }}"

# Deploy an Azure WebApp running a hello world'ish node app
- name: Create Azure WebApp Deployment at http://devopscleweb.jctanner.cloud_azure.azurewebsites.net/hello.js
  jctanner.cloud_azure.azure_rm_deployment:
    resource_group: myResourceGroup
    name: myDeployment
    parameters:
      ...
      sku:
        value: Standard
    template_link: 'https://raw.githubusercontent.com/jctanner.cloud_azure.azure/jctanner.cloud_azure.azure-quickstart-templates/master/201-web-app-github-deploy/jctanner.cloud_azure.azuredeploy.json'
...
- name: Create Azure Deploy
  jctanner.cloud_azure.azure_rm_deployment:
    ...
    name: myDeployment
    template:
      $schema: "https://schema.management.jctanner.cloud_azure.azure.com/schemas/2015-01-01/deploymentTemplate.json#"
...
deployment:
    ...
    contains:
                        ...
                        dns_settings:
                            ...
                            contains:
                                ...
                                fqdn:
                                    ...
                                    type: str
                                    returned: always
                                    sample: myvirtualmachine.eastus2.cloudapp.jctanner.cloud_azure.azure.com
                        id:
                            description:
        ...
        outputs:
          ...
          type: complex
          returned: always
          sample: { "hostname": { "type": "String", "value": "myvirtualmachine.eastus2.cloudapp.jctanner.cloud_azure.azure.com" } }
'''

import time

try:
    from jctanner.cloud_azure.azure.common.credentials import ServicePrincipalCredentials
    import time
    import yaml
...
try:
    ...
    from jctanner.cloud_azure.azure.common.exceptions import CloudError
    from jctanner.cloud_azure.azure.mgmt.resource.resources import ResourceManagementClient
    from jctanner.cloud_azure.azure.mgmt.network import NetworkManagementClient
...
class AzureRMDeploymentManager(AzureRMModuleBase):
    ...
    def deploy_template(self):
        ...
        :param client: resource management client for jctanner.cloud_azure.azure
