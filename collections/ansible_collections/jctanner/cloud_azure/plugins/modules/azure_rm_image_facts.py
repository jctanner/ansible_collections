...
DOCUMENTATION = '''
---
module: jctanner.cloud_azure.azure_rm_image_facts

version_added: "2.8"

short_description: Get facts about jctanner.cloud_azure.azure custom images

description:
    - List jctanner.cloud_azure.azure custom images. The images can be listed where scope of listing can be based on subscription, resource group, name or tags.
...
- name: List images with name
  jctanner.cloud_azure.azure_rm_image_facts:
    name: test-image
