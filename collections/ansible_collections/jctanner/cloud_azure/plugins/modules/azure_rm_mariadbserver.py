...
DOCUMENTATION = '''
---
module: jctanner.cloud_azure.azure_rm_mariadbserver
version_added: "2.8"
...
EXAMPLES = '''
  - name: Create (or update) MariaDB Server
    jctanner.cloud_azure.azure_rm_mariadbserver:
...
fully_qualified_domain_name:
    ...
    returned: always
    type: str
    sample: mariadbsrv1b6dd89593.mariadb.database.jctanner.cloud_azure.azure.com
'''
