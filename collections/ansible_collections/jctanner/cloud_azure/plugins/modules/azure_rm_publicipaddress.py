...
DOCUMENTATION = '''
---
module: jctanner.cloud_azure.azure_rm_publicipaddress
...
description:
    - Create, update and delete a Public IP address. Allows setting and updating the address allocation method and
      domain name label. Use the jctanner.cloud_azure.azure_rm_networkinterface module to associate a Public IP with a network interface.
...
EXAMPLES = '''
    - name: Create a public ip address
      jctanner.cloud_azure.azure_rm_publicipaddress:
