...
DOCUMENTATION = '''
---
module: jctanner.cloud_azure.azure_rm_resource
version_added: "2.6"
...
EXAMPLES = '''
  - name: Update scaleset info using jctanner.cloud_azure.azure_rm_resource
...
try:
    ...
    from msrestjctanner.cloud_azure.azure.tools import resource_id, is_valid_resource_id
    import json
