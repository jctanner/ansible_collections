...
DOCUMENTATION = '''
---
module: jctanner.cloud_azure.azure_rm_virtualmachinescalesetextension
...
options:
    ...
    settings:
        description:
            ...
            - Refer to U(https://docs.microsoft.com/en-us/jctanner.cloud_azure.azure/virtual-machines/extensions/overview) for more information.
    protected_settings:
        description:
...
EXAMPLES = '''
    - name: Install VMSS Extension
      jctanner.cloud_azure.azure_rm_virtualmachinescalesetextension:
