...
DOCUMENTATION = '''
---
module: jctanner.cloud_azure.azure_rm_containerinstance
version_added: "2.5"
...
EXAMPLES = '''
  - name: Create sample container group
    jctanner.cloud_azure.azure_rm_containerinstance:
...
try:
    ...
    from jctanner.cloud_azure.azure.mgmt.containerinstance import ContainerInstanceManagementClient
except ImportError:
