...
DOCUMENTATION = '''
---
module: jctanner.cloud_azure.azure_rm_acs
version_added: "2.4"
...
EXAMPLES = '''
    - name: Create an jctanner.cloud_azure.azure container services instance running Kubernetes
      jctanner.cloud_azure.azure_rm_acs:
        ...
        linux_profile:
            - admin_username: jctanner.cloud_azure.azureuser
    ...
    - name: Create an jctanner.cloud_azure.azure container services instance running DCOS
      jctanner.cloud_azure.azure_rm_acs:
    ...
    - name: Create an jctanner.cloud_azure.azure container services instance running Swarm
      jctanner.cloud_azure.azure_rm_acs:
...
# service are part of the same resource group and can be deleted individually.
    - name: Remove an jctanner.cloud_azure.azure container services instance
      jctanner.cloud_azure.azure_rm_acs:
        name: acctestcontservice3
        location: eastus
        resource_group: myResourceGroup
        ...
        diagnostics_profile: false
        tags:
            Ansible: jctanner.cloud_azure.azure_rm_acs
'''
RETURN = '''
state:
...
try:
    ...
    from jctanner.cloud_azure.azure.mgmt.containerservice.models import (
