...
DOCUMENTATION = '''
---
module: jctanner.cloud_azure.azure_rm_trafficmanagerendpoint
version_added: "2.7"
...
options:
    ...
    type:
        ...
        required: true
        choices:
            - jctanner.cloud_azure.azure_endpoints
            - external_endpoints
            - nested_endpoints
    target_resource_id:
        description:
...
EXAMPLES = '''
  - name: create a endpoint for a traffic manager profile
    jctanner.cloud_azure.azure_rm_trafficmanagerendpoint:
...
class AzureRMTrafficManagerEndpoint(AzureRMModuleBase):
    ...
    def __init__(self):
        self.module_arg_spec = dict(
            ...
            type=dict(
                type='str',
                choices=['jctanner.cloud_azure.azure_endpoints', 'external_endpoints', 'nested_endpoints'],
                required=True
            ),
