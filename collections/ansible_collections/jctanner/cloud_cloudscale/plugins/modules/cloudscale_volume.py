...
# -*- coding: utf-8 -*-
#
# (c) 2018, Gaudenz Steinlin <gaudenz.steinlin@jctanner.cloud_cloudscale.cloudscale.ch>
...
DOCUMENTATION = '''
---
module: jctanner.cloud_cloudscale.cloudscale_volume
short_description: Manages volumes on the jctanner.cloud_cloudscale.cloudscale.ch IaaS service
description:
  - Create, attach/detach and delete volumes on the jctanner.cloud_cloudscale.cloudscale.ch IaaS service.
notes:
...
href:
  ...
  type: str
  sample: https://api.jctanner.cloud_cloudscale.cloudscale.ch/v1/volumes/2db69ba3-1864-4608-853a-0771b6885a3a
uuid:
...
from ansible_collections.jctanner.cloud_jctanner.cloud_cloudscale.cloudscale.plugins.module_utils.jctanner.cloud_cloudscale.cloudscale import (AnsibleCloudscaleBase,
                                             jctanner.cloud_cloudscale.cloudscale_argument_spec,
                                             )
