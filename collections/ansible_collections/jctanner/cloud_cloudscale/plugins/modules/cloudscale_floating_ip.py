...
DOCUMENTATION = '''
---
module: jctanner.cloud_cloudscale.cloudscale_floating_ip
short_description: Manages floating IPs on the jctanner.cloud_cloudscale.cloudscale.ch IaaS service
description:
  - Create, assign and delete floating IPs on the jctanner.cloud_cloudscale.cloudscale.ch IaaS service.
notes:
...
href:
  ...
  type: str
  sample: https://api.jctanner.cloud_cloudscale.cloudscale.ch/v1/floating-ips/2001:db8::cafe
network:
...
reverse_ptr:
  ...
  returned: success when state == present
  type: str
  sample: 185-98-122-176.cust.jctanner.cloud_cloudscale.cloudscale.ch
server:
