...
description:
    - Retrieve facts about available OpenStack instance flavors. By default,
      ...
      *ALL* filters must match on a flavor before that flavor is returned as
      a fact.
notes:
    - This module creates a new top-level C(jctanner.cloud_openstack.openstack_flavors) fact, which
...
RETURN = '''
jctanner.cloud_openstack.openstack_flavors:
...
def main():
    ...
    try:
        ...
        module.exit_json(changed=False,
                         ansible_facts=dict(jctanner.cloud_openstack.openstack_flavors=flavors))
