...
notes:
    - Facts are placed in the C(jctanner.cloud_openstack.openstack_ports) variable.
requirements:
    - "python >= 2.7"
...
RETURN = '''
jctanner.cloud_openstack.openstack_ports:
...
def main():
    ...
    try:
        ...
        module.exit_json(changed=False, ansible_facts=dict(
            jctanner.cloud_openstack.openstack_ports=ports))
