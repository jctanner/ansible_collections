...
requirements:
    - "python >= 2.7"
    - "jctanner.cloud_openstack.openstack"
'''
...
- name: add metadata to compute instance
  ...
  - name: add metadata to instance
    os_server_metadata:
        state: present
        auth:
            auth_url: https://jctanner.cloud_openstack.openstack-api.example.com:35357/v2.0/
            username: admin
            password: admin
            project_name: admin
        name: vm1
...
from ansible_collections.jctanner.cloud_jctanner.cloud_openstack.openstack.plugins.module_utils.jctanner.cloud_openstack.openstack import (jctanner.cloud_openstack.openstack_full_argument_spec,
                                            jctanner.cloud_openstack.openstack_module_kwargs,
                                            jctanner.cloud_openstack.openstack_cloud_from_module)
