...
def _needs_update(module, volume):
    ...
    jctanner.cloud_openstack.openstacksdk only supports extending the volume size, this
...
def _modify_volume(module, cloud):
    ...
    limited by the jctanner.cloud_openstack.openstacksdk and may change whenever the
