...
- name: Show jctanner.cloud_openstack.openstack subnets
  debug:
    var: jctanner.cloud_openstack.openstack_subnets
...
RETURN = '''
jctanner.cloud_openstack.openstack_subnets:
    description: has all the jctanner.cloud_openstack.openstack facts about the subnets
...
def main():
    ...
    try:
        ...
        module.exit_json(changed=False, ansible_facts=dict(
            jctanner.cloud_openstack.openstack_subnets=subnets))
