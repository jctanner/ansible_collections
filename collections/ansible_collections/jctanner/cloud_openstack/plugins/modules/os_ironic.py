        ...
        capabilities:
          description:
            - special capabilities for the node, such as boot_option, node_role etc
              (see U(https://docs.jctanner.cloud_openstack.openstack.org/ironic/latest/install/advanced.html)
        ...
        root_device:
          description:
            - Root disk device hints for deployment.
              (see U(https://docs.jctanner.cloud_openstack.openstack.org/ironic/latest/install/include/root-device-hints.html)
              for allowed hints)
          default: ""
          version_added: "2.8"
...
requirements: ["jctanner.cloud_openstack.openstacksdk", "jsonpatch"]
'''
