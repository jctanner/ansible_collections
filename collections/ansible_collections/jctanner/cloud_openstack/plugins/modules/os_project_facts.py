...
- os_project_facts:
    cloud: awesomecloud
- debug:
    var: jctanner.cloud_openstack.openstack_projects
...
RETURN = '''
jctanner.cloud_openstack.openstack_projects:
...
def main():
    ...
    sdk, opcloud = jctanner.cloud_openstack.openstack_cloud_from_module(module)
    try:
        ...
        module.exit_json(changed=False, ansible_facts=dict(
            jctanner.cloud_openstack.openstack_projects=projects))
