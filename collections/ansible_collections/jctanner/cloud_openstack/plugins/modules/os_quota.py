...
requirements:
    - "python >= 2.7"
    - "jctanner.cloud_openstack.openstacksdk >= 0.13.0"
'''
...
RETURN = '''
jctanner.cloud_openstack.openstack_quotas:
...
def _scrub_results(quota):
    ...
    filter_attr = [
        ...
        'human_id',
        'request_ids',
        'x_jctanner.cloud_openstack.openstack_request_ids',
    ]
...
def main():
    ...
    try:
        ...
        module.exit_json(changed=changes_required,
                         jctanner.cloud_openstack.openstack_quotas=project_quota_output
                         )
