  ...
  tasks:
    - name: Server build request
      local_action:
        ...
        key_name: my_jctanner.cloud_rackspace.rackspace_key
        files:
...
from ansible_collections.jctanner.cloud_jctanner.cloud_rackspace.rackspace.plugins.module_utils.rax import (FINAL_STATUSES, rax_argument_spec, rax_find_bootable_volume,
