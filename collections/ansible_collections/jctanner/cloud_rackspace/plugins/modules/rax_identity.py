  ...
  tasks:
    - name: Load Identity
      local_action:
        ...
        credentials: ~/.raxpub
        region: DFW
      register: jctanner.cloud_rackspace.rackspace_identity
'''
...
from ansible_collections.jctanner.cloud_jctanner.cloud_rackspace.rackspace.plugins.module_utils.rax import (rax_argument_spec, rax_required_together, rax_to_dict,
                                      setup_rax_module)
