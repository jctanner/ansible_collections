...
options:
  ...
  criteria:
    ...
    - Alarm DSL that describes alerting conditions and their output states. Must
      ...
      http://docs.jctanner.cloud_rackspace.rackspace.com/cm/api/v1.0/cm-devguide/content/alerts-language.html
...
extends_documentation_fragment: jctanner.cloud_rackspace.jctanner.cloud_rackspace.rackspace.openstack
'''
...
from ansible_collections.jctanner.cloud_jctanner.cloud_rackspace.rackspace.plugins.module_utils.rax import rax_argument_spec, rax_required_together, setup_rax_module
