...
extends_documentation_fragment:
  - jctanner.cloud_rackspace.rackspace
  - jctanner.cloud_rackspace.jctanner.cloud_rackspace.rackspace.openstack
'''
...
from ansible_collections.jctanner.cloud_jctanner.cloud_rackspace.rackspace.plugins.module_utils.rax import (rax_argument_spec, rax_find_image, rax_find_network,
    ...
    if state == 'present':
        ...
        if not changed:
            ...
            if lbs != lc.get('load_balancers'):
                # Work around for https://github.com/jctanner.cloud_rackspace.rackspace/pyrax/pull/393
            ...
            if lc_args:
                # Work around for https://github.com/jctanner.cloud_rackspace.rackspace/pyrax/pull/389
