...
options:
  ...
  state:
    ...
    default: present
extends_documentation_fragment: jctanner.net_tools_ldap.ldap.documentation
"""
...
from ansible_collections.jctanner.net_tools_ldap.plugins.module_utils.ldap import LdapGeneric, gen_specs
