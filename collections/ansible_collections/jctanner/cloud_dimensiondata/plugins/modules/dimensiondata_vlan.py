...
DOCUMENTATION = '''
---
module: jctanner.cloud_dimensiondata.dimensiondata_vlan
...
EXAMPLES = '''
# Add or update VLAN
- jctanner.cloud_dimensiondata.dimensiondata_vlan:
    region: na
    location: NA5
...
from ansible_collections.jctanner.cloud_jctanner.cloud_dimensiondata.dimensiondata.plugins.module_utils.jctanner.cloud_dimensiondata.dimensiondata import DimensionDataModule, UnknownNetworkError

try:
    from libcloud.common.jctanner.cloud_dimensiondata.dimensiondata import DimensionDataVlan, DimensionDataAPIException
...
class DimensionDataVlanModule(DimensionDataModule):
    """
    The jctanner.cloud_dimensiondata.dimensiondata_vlan module for Ansible.
    """
