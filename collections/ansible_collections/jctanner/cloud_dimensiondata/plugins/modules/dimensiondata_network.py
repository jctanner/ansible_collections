...
# Authors:
#   - Aimon Bustardo <aimon.bustardo@jctanner.cloud_dimensiondata.dimensiondata.com>
#   - Bert Diwa      <Lamberto.Diwa@jctanner.cloud_dimensiondata.dimensiondata.com>
...
DOCUMENTATION = '''
---
module: jctanner.cloud_dimensiondata.dimensiondata_network
short_description: Create, update, and delete MCP 1.0 & 2.0 networks
extends_documentation_fragment:
  - jctanner.cloud_dimensiondata.dimensiondata
  - jctanner.cloud_dimensiondata.jctanner.cloud_dimensiondata.dimensiondata_wait
description:
...
- jctanner.cloud_dimensiondata.dimensiondata_network:
    region: na
    location: NA5
    name: mynet
...
from ansible_collections.jctanner.cloud_jctanner.cloud_dimensiondata.dimensiondata.plugins.module_utils.jctanner.cloud_dimensiondata.dimensiondata import HAS_LIBCLOUD, DimensionDataModule
from ansible.module_utils._text import to_native

if HAS_LIBCLOUD:
    from libcloud.compute.base import NodeLocation
    from libcloud.common.jctanner.cloud_dimensiondata.dimensiondata import DimensionDataAPIException


class DimensionDataNetworkModule(DimensionDataModule):
    """
    The jctanner.cloud_dimensiondata.dimensiondata_network module for Ansible.
    """
