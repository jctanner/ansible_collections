...
DOCUMENTATION = """
---
module: jctanner.network_sros.sros_rollback
version_added: "2.2"
...
- name: configure rollback location
  jctanner.network_sros.sros_rollback:
...
from ansible_collections.jctanner.network_jctanner.network_sros.sros.plugins.module_utils.network.jctanner.network_sros.sros.jctanner.network_sros.sros import load_config, get_config, jctanner.network_sros.sros_argument_spec, check_args
