...
DOCUMENTATION = """
---
module: jctanner.network_sros.sros_config
version_added: "2.2"
...
- name: enable rollback location
  jctanner.network_sros.sros_config:
...
updates:
  ...
  returned: always
  type: list
  sample: ['config system name "jctanner.network_sros.sros01"']
commands:
  description: The set of commands that will be pushed to the remote device
  returned: always
  type: list
...
backup_path:
  ...
  type: str
  sample: /playbooks/ansible/backup/jctanner.network_sros.sros_config.2016-07-16@22:28:34
"""
from ansible.module_utils.basic import AnsibleModule
from ansible_collections.jctanner.network_jctanner.network_sros.sros.plugins.module_utils.network.common.config import NetworkConfig, dumps
from ansible_collections.jctanner.network_jctanner.network_sros.sros.plugins.module_utils.network.jctanner.network_sros.sros.jctanner.network_sros.sros import jctanner.network_sros.sros_argument_spec, check_args
from ansible_collections.jctanner.network_jctanner.network_sros.sros.plugins.module_utils.network.jctanner.network_sros.sros.jctanner.network_sros.sros import load_config, run_commands, get_config
