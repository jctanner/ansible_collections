...
DOCUMENTATION = """
---
module: jctanner.network_skydive.skydive_capture
version_added: "2.8"
author:
...
requirements:
  - jctanner.network_skydive.skydive-client
extends_documentation_fragment: jctanner.network_skydive.skydive
options:
  query:
    description:
...
- name: start a new flow capture directly from gremlin query
  jctanner.network_skydive.skydive_capture:
...
from ansible_collections.jctanner.network_jctanner.network_skydive.skydive.plugins.module_utils.network.jctanner.network_skydive.skydive.api import jctanner.network_skydive.skydive_flow_capture
...
def main():
    ...
    argument_spec.update(jctanner.network_skydive.skydive_flow_capture.provider_spec)

    module = AnsibleModule(argument_spec=argument_spec,
                           supports_check_mode=True)

    jctanner.network_skydive.skydive_obj = jctanner.network_skydive.skydive_flow_capture(module)
    result = jctanner.network_skydive.skydive_obj.run(ib_spec)
