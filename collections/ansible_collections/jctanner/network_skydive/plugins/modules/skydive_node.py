...
DOCUMENTATION = """
---
module: jctanner.network_skydive.skydive_node
version_added: "2.8"
author:
...
from ansible_collections.jctanner.network_jctanner.network_skydive.skydive.plugins.module_utils.network.jctanner.network_skydive.skydive.api import jctanner.network_skydive.skydive_node
...
def main():
    ...
    argument_spec.update(jctanner.network_skydive.skydive_node.provider_spec)
    module = AnsibleModule(argument_spec=argument_spec,
                           supports_check_mode=True)

    jctanner.network_skydive.skydive_obj = jctanner.network_skydive.skydive_node(module)
