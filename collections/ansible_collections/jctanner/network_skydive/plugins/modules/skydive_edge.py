...
DOCUMENTATION = """
---
module: jctanner.network_skydive.skydive_edge
version_added: "2.8"
author:
...
EXAMPLES = """
- name: create tor
  jctanner.network_skydive.skydive_node:
    name: 'TOR'
    node_type: "fabric"
    seed: TOR
    metadata:
...
- name: link node tor and port 1
  jctanner.network_skydive.skydive_edge:
...
from ansible_collections.jctanner.network_jctanner.network_skydive.skydive.plugins.module_utils.network.jctanner.network_skydive.skydive.api import jctanner.network_skydive.skydive_edge
...
def main():
    ...
    argument_spec.update(jctanner.network_skydive.skydive_edge.provider_spec)
    module = AnsibleModule(argument_spec=argument_spec,
                           supports_check_mode=True)

    jctanner.network_skydive.skydive_obj = jctanner.network_skydive.skydive_edge(module)
    result = jctanner.network_skydive.skydive_obj.run()
