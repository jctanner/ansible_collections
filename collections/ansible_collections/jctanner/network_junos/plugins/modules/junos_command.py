...
DOCUMENTATION = """
---
module: jctanner.network_junos.junos_command
version_added: "2.1"
...
options:
  commands:
    description:
      - The commands to send to the remote jctanner.network_junos.junos device over the
...
- name: run show version on remote devices
  jctanner.network_junos.junos_command:
...
from ansible_collections.jctanner.network_jctanner.network_junos.junos.plugins.module_utils.network.jctanner.network_junos.junos.jctanner.network_junos.junos import jctanner.network_junos.junos_argument_spec, get_configuration, get_connection, get_capabilities, tostring
from ansible_collections.jctanner.network_jctanner.network_junos.junos.plugins.module_utils.network.common.parsing import Conditional, FailedConditionalError
from ansible_collections.jctanner.network_jctanner.network_junos.junos.plugins.module_utils.network.common.utils import to_lines
