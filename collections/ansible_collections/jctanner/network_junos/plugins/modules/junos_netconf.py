...
DOCUMENTATION = """
---
module: jctanner.network_junos.junos_netconf
version_added: "2.1"
...
options:
  ...
  state:
    description:
      - Specifies the state of the C(jctanner.network_junos.junos_netconf) resource on
...
notes:
  ...
  - Recommended connection is C(network_cli). See L(the Junos OS Platform Options,../network/user_guide/platform_jctanner.network_junos.junos.html).
...
- name: enable netconf service on port 830
  jctanner.network_junos.junos_netconf:
    listens_on: 830
    state: present
...
from ansible_collections.jctanner.network_jctanner.network_junos.junos.plugins.module_utils.connection import ConnectionError
from ansible.module_utils.basic import AnsibleModule
from ansible_collections.jctanner.network_jctanner.network_junos.junos.plugins.module_utils.network.jctanner.network_junos.junos.jctanner.network_junos.junos import jctanner.network_junos.junos_argument_spec, get_connection
from ansible_collections.jctanner.network_jctanner.network_junos.junos.plugins.module_utils.network.jctanner.network_junos.junos.jctanner.network_junos.junos import commit_configuration, discard_changes
from ansible_collections.jctanner.network_jctanner.network_junos.junos.plugins.module_utils.network.common.utils import to_list
