...
DOCUMENTATION = """
---
module: jctanner.network_junos.junos_linkagg
version_added: "2.4"
...
- name: configure link aggregation
  jctanner.network_junos.junos_linkagg:
    name: ae11
    members:
      - ge-0/0/5
      - ge-0/0/6
...
diff:
  ...
  sample: >
            ...
            [edit interfaces]
            +   ae0 {
            +       description "configured by jctanner.network_junos.junos_linkagg";
...
from ansible_collections.jctanner.network_jctanner.network_junos.junos.plugins.module_utils.network.jctanner.network_junos.junos.jctanner.network_junos.junos import load_config, map_params_to_obj, map_obj_to_ele, to_param_list
from ansible_collections.jctanner.network_jctanner.network_junos.junos.plugins.module_utils.network.jctanner.network_junos.junos.jctanner.network_junos.junos import commit_configuration, discard_changes, locked_config, get_configuration
