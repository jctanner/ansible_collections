...
DOCUMENTATION = """
---
module: jctanner.network_junos.junos_config
version_added: "2.1"
...
options:
  ...
  comment:
    ...
    default: configured by jctanner.network_junos.junos_config
  replace:
    description:
...
- name: load configure file into device
  jctanner.network_junos.junos_config:
    src: srx.cfg
...
filename:
  ...
  type: str
  sample: jctanner.network_junos.junos01_config.2016-07-16@22:28:34
shortname:
  description: The full path to the backup file excluding the timestamp
  returned: when backup is yes and filename is not specified in backup options
  type: str
  sample: /playbooks/ansible/backup/jctanner.network_junos.junos01_config
date:
...
from ansible_collections.jctanner.network_jctanner.network_junos.junos.plugins.module_utils.network.jctanner.network_junos.junos.jctanner.network_junos.junos import get_diff, load_config, get_configuration
from ansible_collections.jctanner.network_jctanner.network_junos.junos.plugins.module_utils.network.jctanner.network_junos.junos.jctanner.network_junos.junos import commit_configuration, discard_changes, locked_config
from ansible_collections.jctanner.network_jctanner.network_junos.junos.plugins.module_utils.network.jctanner.network_junos.junos.jctanner.network_junos.junos import jctanner.network_junos.junos_argument_spec, load_configuration, tostring
...
DEFAULT_COMMENT = 'configured by jctanner.network_junos.junos_config'
