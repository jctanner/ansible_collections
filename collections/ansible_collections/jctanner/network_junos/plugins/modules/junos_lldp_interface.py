...
DOCUMENTATION = """
---
module: jctanner.network_junos.junos_lldp_interface
version_added: "2.4"
...
- name: Configure LLDP on specific interfaces
  jctanner.network_junos.junos_lldp_interface:
    name: ge-0/0/5
    state: present
...
from ansible_collections.jctanner.network_jctanner.network_junos.junos.plugins.module_utils.network.jctanner.network_junos.junos.jctanner.network_junos.junos import jctanner.network_junos.junos_argument_spec
from ansible_collections.jctanner.network_jctanner.network_junos.junos.plugins.module_utils.network.jctanner.network_junos.junos.jctanner.network_junos.junos import load_config, map_params_to_obj, map_obj_to_ele, tostring
