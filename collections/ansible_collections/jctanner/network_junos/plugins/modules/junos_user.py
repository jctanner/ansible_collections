...
DOCUMENTATION = """
---
module: jctanner.network_junos.junos_user
version_added: "2.3"
...
- name: create new user account
  jctanner.network_junos.junos_user:
    name: ansible
    role: super-user
...
from ansible_collections.jctanner.network_jctanner.network_junos.junos.plugins.module_utils.network.jctanner.network_junos.junos.jctanner.network_junos.junos import jctanner.network_junos.junos_argument_spec, get_connection, tostring
...
from ansible_collections.jctanner.network_jctanner.network_junos.junos.plugins.module_utils.network.jctanner.network_junos.junos.jctanner.network_junos.junos import load_config, locked_config
