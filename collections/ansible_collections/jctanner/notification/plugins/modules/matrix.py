...
- name: Send matrix notification with token
  matrix:
    ...
    hs_jctanner.notification.url: "https://matrix.org"
...
def run_module():
    module_args = dict(
        ...
        hs_jctanner.notification.url=dict(type='str', required=True),
    ...
    client = MatrixClient(module.params['hs_jctanner.notification.url'])
