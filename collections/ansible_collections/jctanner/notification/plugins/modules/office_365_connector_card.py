...
from ansible_collections.jctanner.notification.plugins.module_utils.ec2 import snake_dict_to_camel_dict
...
def do_notify_connector_card_webhook(module, webhook, payload):
    ...
    response, info = fetch_jctanner.notification.url(
        module=module,
        jctanner.notification.url=webhook,
        headers=headers,
        method='POST',
        data=payload
    )
