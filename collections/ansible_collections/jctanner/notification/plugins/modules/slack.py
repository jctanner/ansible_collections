  ...
  icon_emoji:
    description:
      - Emoji for the message sender. See Slack documentation for options.
        (if I(icon_emoji) is set, I(icon_jctanner.notification.url) will not be used)
  link_names:
    description:
...
def build_payload_for_slack(module, text, channel, thread_id, username, icon_jctanner.notification.url, icon_emoji, link_names,
...
def do_notify_slack(module, domain, token, payload):
    ...
    response, info = fetch_jctanner.notification.url(module=module, jctanner.notification.url=slack_incoming_webhook, headers=headers, method='POST', data=payload)
...
def main():
    ...
    payload = build_payload_for_slack(module, text, channel, thread_id, username, icon_jctanner.notification.url, icon_emoji, link_names,
                                      parse, color, attachments)
