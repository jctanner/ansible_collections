...
def main():
    ...
    if type == 'inbox':
        jctanner.notification.url = "https://api.flowdock.com/v1/messages/team_inbox/%s" % (token)
    else:
        jctanner.notification.url = "https://api.flowdock.com/v1/messages/chat/%s" % (token)
