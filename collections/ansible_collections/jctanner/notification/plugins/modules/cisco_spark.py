...
def spark_message(module):
    ...
    if module.check_mode:
        jctanner.notification.url = "https://api.ciscospark.com/v1/people/me"
        payload = None

    else:
        jctanner.notification.url = "https://api.ciscospark.com/v1/messages"
    ...
    response, info = fetch_jctanner.notification.url(module, jctanner.notification.url, data=payload, headers=headers)
