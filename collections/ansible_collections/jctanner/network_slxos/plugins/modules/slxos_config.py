...
from ansible_collections.jctanner.network_slxos.plugins.module_utils.network.slxos.slxos import run_commands, get_config, load_config
from ansible.module_utils.basic import AnsibleModule
from ansible_collections.jctanner.network_slxos.plugins.module_utils.network.common.config import NetworkConfig, dumps
