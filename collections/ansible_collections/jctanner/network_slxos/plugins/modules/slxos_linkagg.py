...
from ansible_collections.jctanner.network_slxos.plugins.module_utils.network.common.config import CustomNetworkConfig
from ansible_collections.jctanner.network_slxos.plugins.module_utils.network.common.utils import remove_default_spec
