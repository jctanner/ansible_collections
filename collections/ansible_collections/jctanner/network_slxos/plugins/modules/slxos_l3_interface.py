...
from ansible_collections.jctanner.network_slxos.plugins.module_utils.network.slxos.slxos import get_config, load_config
from ansible_collections.jctanner.network_slxos.plugins.module_utils.network.common.config import NetworkConfig
from ansible_collections.jctanner.network_slxos.plugins.module_utils.network.common.utils import conditional, remove_default_spec
from ansible_collections.jctanner.network_slxos.plugins.module_utils.network.common.utils import is_netmask, is_masklen, to_netmask, to_masklen
