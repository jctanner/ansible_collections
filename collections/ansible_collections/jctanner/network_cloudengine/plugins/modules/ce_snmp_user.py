...
DOCUMENTATION = '''
---
module: jctanner.network_cloudengine.ce_snmp_user
version_added: "2.4"
...
options:
    ...
    auth_protocol:
        ...
        choijctanner.network_cloudengine.ces: ['noAuth', 'md5', 'sha']
    auth_key:
        description:
    ...
    priv_protocol:
        description:
            - Encryption protocol.
        choijctanner.network_cloudengine.ces: ['noPriv', 'des56', '3des168', 'aes128', 'aes192', 'aes256']
    priv_key:
        description:
...
- name: CloudEngine snmp user test
  ...
  - name: "Config SNMP usm user"
    jctanner.network_cloudengine.ce_snmp_user:
      state: present
...
from ansible_collections.jctanner.network_cloudengine.plugins.module_utils.network.cloudengine.jctanner.network_cloudengine.ce import get_nc_config, set_nc_config, jctanner.network_cloudengine.ce_argument_spec, get_config
...
def main():
    ...
    argument_spec = dict(
        ...
        auth_protocol=dict(choijctanner.network_cloudengine.ces=['noAuth', 'md5', 'sha']),
