...
DOCUMENTATION = '''
---
module: jctanner.network_cloudengine.ce_acl_advanjctanner.network_cloudengine.ce
version_added: "2.4"
short_description: Manages advanjctanner.network_cloudengine.ced ACL configuration on HUAWEI CloudEngine switches.
description:
    - Manages advanjctanner.network_cloudengine.ced ACL configurations on HUAWEI CloudEngine switches.
author:
...
options:
    state:
        ...
        required: false
        default: present
        choijctanner.network_cloudengine.ces: ['present','absent','delete_acl']
    acl_name:
        description:
            - ACL number or name.
              For a numbered rule group, the value ranging from 3000 to 3999 indicates a advanjctanner.network_cloudengine.ce ACL.
    ...
    rule_action:
        ...
        choijctanner.network_cloudengine.ces: ['permit','deny']
    protocol:
        description:
            - Protocol type.
        choijctanner.network_cloudengine.ces: ['ip', 'icmp', 'igmp', 'ipinip', 'tcp', 'udp', 'gre', 'ospf']
    sourjctanner.network_cloudengine.ce_ip:
        description:
            - Sourjctanner.network_cloudengine.ce IP address.
              The value is a string of 0 to 255 characters.The default value is 0.0.0.0.
              The value is in dotted decimal notation.
    src_mask:
        description:
            - Sourjctanner.network_cloudengine.ce IP address mask.
              The value is an integer ranging from 1 to 32.
    src_pool_name:
        description:
            - Name of a sourjctanner.network_cloudengine.ce pool.
              The value is a string of 1 to 32 characters.
    dest_ip:
        description:
    ...
    src_port_op:
        description:
            - Range type of the sourjctanner.network_cloudengine.ce port.
        choijctanner.network_cloudengine.ces: ['lt','eq', 'gt', 'range']
    src_port_begin:
        description:
            - Start port number of the sourjctanner.network_cloudengine.ce port.
              The value is an integer ranging from 0 to 65535.
    src_port_end:
        description:
            - End port number of the sourjctanner.network_cloudengine.ce port.
              The value is an integer ranging from 0 to 65535.
    src_port_pool_name:
        description:
            - Name of a sourjctanner.network_cloudengine.ce port pool.
              The value is a string of 1 to 32 characters.
    dest_port_op:
        description:
    ...
    frag_type:
        ...
        choijctanner.network_cloudengine.ces: ['fragment', 'clear_fragment']
    prejctanner.network_cloudengine.cedenjctanner.network_cloudengine.ce:
        description:
    ...
    dscp:
        description:
            - Differentiated Servijctanner.network_cloudengine.ces Code Point.
              The value is an integer ranging from 0 to 63.
    icmp_name:
        description:
            - ICMP name.
        choijctanner.network_cloudengine.ces: ['unconfiged', 'echo', 'echo-reply', 'fragmentneed-DFset', 'host-redirect',
                  ...
                  'port-unreachable', 'protocol-unreachable', 'reassembly-timeout', 'sourjctanner.network_cloudengine.ce-quench',
                  'sourjctanner.network_cloudengine.ce-route-failed', 'timestamp-reply', 'timestamp-request', 'ttl-exjctanner.network_cloudengine.ceeded',
    ...
    vrf_name:
        description:
            - VPN instanjctanner.network_cloudengine.ce name.
    ...
    igmp_type:
        ...
        choijctanner.network_cloudengine.ces: ['host-query', 'mrouter-adver', 'mrouter-solic', 'mrouter-termi', 'mtrajctanner.network_cloudengine.ce-resp', 'mtrajctanner.network_cloudengine.ce-route',
...
- name: CloudEngine advanjctanner.network_cloudengine.ce acl test
  hosts: cloudengine
  connection: local
  gather_facts: no
  vars:
  ...
  - name: "Config ACL"
    jctanner.network_cloudengine.ce_acl_advanjctanner.network_cloudengine.ce:
      state: present
      acl_name: 3200
      provider: "{{ cli }}"
  ...
  - name: "Config ACL advanjctanner.network_cloudengine.ce rule"
    jctanner.network_cloudengine.ce_acl_advanjctanner.network_cloudengine.ce:
      state: present
      acl_name: test
      rule_name: test_rule
      ...
      rule_action: permit
      protocol: tcp
      sourjctanner.network_cloudengine.ce_ip: 10.10.10.10
      src_mask: 24
      frag_type: fragment
      provider: "{{ cli }}"

  - name: "Undo ACL advanjctanner.network_cloudengine.ce rule"
    jctanner.network_cloudengine.ce_acl_advanjctanner.network_cloudengine.ce:
      state: absent
      acl_name: test
      rule_name: test_rule
...
existing:
    ...
    returned: always
    type: dict
    sample: {"aclNumOrName": "test", "aclType": "Advanjctanner.network_cloudengine.ce"}
end_state:
...
# get acl advanjctanner.network_cloudengine.ce rule
...
"""
# merge acl advanjctanner.network_cloudengine.ce rule
...
"""
# delete acl advanjctanner.network_cloudengine.ce rule
...
IGMP_TYPE_NUM = {"host-query": "17",
                 ...
                 "mrouter-solic": "49",
                 "mrouter-termi": "50",
                 "mtrajctanner.network_cloudengine.ce-resp": "30",
                 "mtrajctanner.network_cloudengine.ce-route": "31",
                 "v1host-report": "18",
                 "v2host-report": "22",
                 "v2leave-group": "23",
                 "v3host-report": "34"}
...
class Advanjctanner.network_cloudengine.ceAcl(object):
    """ Manages advanjctanner.network_cloudengine.ce acl configuration """
    ...
    def __init__(self, **kwargs):
        ...
        self.sourjctanner.network_cloudengine.ce_ip = self.module.params['sourjctanner.network_cloudengine.ce_ip'] or None
        ...
        self.prejctanner.network_cloudengine.cedenjctanner.network_cloudengine.ce = self.module.params['prejctanner.network_cloudengine.cedenjctanner.network_cloudengine.ce'] or None
        ...
        self.prejctanner.network_cloudengine.cedenjctanner.network_cloudengine.ce_name = dict()
        self.prejctanner.network_cloudengine.cedenjctanner.network_cloudengine.ce_name["0"] = "routine"
        self.prejctanner.network_cloudengine.cedenjctanner.network_cloudengine.ce_name["1"] = "priority"
        self.prejctanner.network_cloudengine.cedenjctanner.network_cloudengine.ce_name["2"] = "immediate"
        self.prejctanner.network_cloudengine.cedenjctanner.network_cloudengine.ce_name["3"] = "flash"
        self.prejctanner.network_cloudengine.cedenjctanner.network_cloudengine.ce_name["4"] = "flash-override"
        self.prejctanner.network_cloudengine.cedenjctanner.network_cloudengine.ce_name["5"] = "critical"
        self.prejctanner.network_cloudengine.cedenjctanner.network_cloudengine.ce_name["6"] = "internet"
        self.prejctanner.network_cloudengine.cedenjctanner.network_cloudengine.ce_name["7"] = "network"

        # cur config
        self.cur_acl_cfg = dict()
        self.cur_advanjctanner.network_cloudengine.ce_rule_cfg = dict()
            ...
            if self.acl_name.isdigit():
                if int(self.acl_name) < 3000 or int(self.acl_name) > 3999:
                    self.module.fail_json(
                        msg='Error: The value of acl_name is out of [3000-3999] for advanjctanner.network_cloudengine.ce ACL.')
                ...
                self.acl_type = "Advanjctanner.network_cloudengine.ce"
    ...
    def check_advanjctanner.network_cloudengine.ce_rule_args(self):
        """ Check advanjctanner.network_cloudengine.ce rule invalid args """

        need_cfg = False
        find_flag = False
        self.cur_advanjctanner.network_cloudengine.ce_rule_cfg["adv_rule_info"] = []
        ...
        if self.acl_name:
            ...
            if self.rule_name:
                ...
                if self.sourjctanner.network_cloudengine.ce_ip:
                    if not check_ip_addr(self.sourjctanner.network_cloudengine.ce_ip):
                        self.module.fail_json(
                            msg='Error: The sourjctanner.network_cloudengine.ce_ip %s is invalid.' % self.sourjctanner.network_cloudengine.ce_ip)
                ...
                if self.prejctanner.network_cloudengine.cedenjctanner.network_cloudengine.ce:
                    if self.prejctanner.network_cloudengine.cedenjctanner.network_cloudengine.ce.isdigit():
                        if int(self.prejctanner.network_cloudengine.cedenjctanner.network_cloudengine.ce) < 0 or int(self.prejctanner.network_cloudengine.cedenjctanner.network_cloudengine.ce) > 7:
                            self.module.fail_json(
                                msg='Error: The value of prejctanner.network_cloudengine.cedenjctanner.network_cloudengine.ce is out of [0 - 7].')
                    else:
                        self.module.fail_json(
                            msg='Error: The prejctanner.network_cloudengine.cedenjctanner.network_cloudengine.ce is not digit.')
                ...
                if self.sourjctanner.network_cloudengine.ce_ip:
                    conf_str += "<aclSourjctanner.network_cloudengine.ceIp></aclSourjctanner.network_cloudengine.ceIp>"
                if self.src_wild:
                ...
                if self.prejctanner.network_cloudengine.cedenjctanner.network_cloudengine.ce:
                    conf_str += "<aclPrejctanner.network_cloudengine.cedenjctanner.network_cloudengine.ce></aclPrejctanner.network_cloudengine.cedenjctanner.network_cloudengine.ce>"
                if self.tos:
                ...
                if "<data/>" in recv_xml:
                    ...
                    # parse advanjctanner.network_cloudengine.ce rule
                    ...
                    if adv_rule_info:
                        for tmp in adv_rule_info:
                            tmp_dict = dict()
                            for site in tmp:
                                if site.tag in ["aclRuleName", "aclRuleID", "aclAction", "aclProtocol", "aclSourjctanner.network_cloudengine.ceIp",
                                                ...
                                                "aclDPortPoolName", "aclFragType", "aclPrejctanner.network_cloudengine.cedenjctanner.network_cloudengine.ce", "aclTos",
                            ...
                            self.cur_advanjctanner.network_cloudengine.ce_rule_cfg[
                                "adv_rule_info"].append(tmp_dict)

                    if self.cur_advanjctanner.network_cloudengine.ce_rule_cfg["adv_rule_info"]:
                        for tmp in self.cur_advanjctanner.network_cloudengine.ce_rule_cfg["adv_rule_info"]:
                            find_flag = True
                            ...
                            if self.protocol and tmp.get("aclProtocol") != self.protocol_num:
                                find_flag = False
                            if self.sourjctanner.network_cloudengine.ce_ip:
                                tmp_src_ip = self.sourjctanner.network_cloudengine.ce_ip.split(".")
                                ...
                                if tmp_addr != tmp.get("aclSourjctanner.network_cloudengine.ceIp"):
                                    find_flag = False
                            ...
                            if self.frag_type and tmp.get("aclFragType") != self.frag_type:
                                find_flag = False
                            if self.prejctanner.network_cloudengine.cedenjctanner.network_cloudengine.ce and tmp.get("aclPrejctanner.network_cloudengine.cedenjctanner.network_cloudengine.ce") != self.prejctanner.network_cloudengine.cedenjctanner.network_cloudengine.ce:
                                find_flag = False
        ...
        self.cur_advanjctanner.network_cloudengine.ce_rule_cfg["need_cfg"] = need_cfg
    ...
    def get_proposed(self):
        ...
        if self.sourjctanner.network_cloudengine.ce_ip:
            self.proposed["sourjctanner.network_cloudengine.ce_ip"] = self.sourjctanner.network_cloudengine.ce_ip
        if self.src_mask:
        ...
        if self.prejctanner.network_cloudengine.cedenjctanner.network_cloudengine.ce:
            self.proposed["prejctanner.network_cloudengine.cedenjctanner.network_cloudengine.ce"] = self.prejctanner.network_cloudengine.cedenjctanner.network_cloudengine.ce
        if self.tos:
    ...
    def get_existing(self):
        ...
        self.existing["adv_rule_info"] = self.cur_advanjctanner.network_cloudengine.ce_rule_cfg[
            "adv_rule_info"]
    ...
    def get_end_state(self):
        ...
        self.check_advanjctanner.network_cloudengine.ce_rule_args()
        self.end_state["adv_rule_info"] = self.cur_advanjctanner.network_cloudengine.ce_rule_cfg[
            "adv_rule_info"]
    ...
    def merge_adv_rule(self):
        """ Merge advanjctanner.network_cloudengine.ce rule operation """
        ...
        if self.sourjctanner.network_cloudengine.ce_ip:
            conf_str += "<aclSourjctanner.network_cloudengine.ceIp>%s</aclSourjctanner.network_cloudengine.ceIp>" % self.sourjctanner.network_cloudengine.ce_ip
        if self.src_wild:
        ...
        if self.prejctanner.network_cloudengine.cedenjctanner.network_cloudengine.ce:
            conf_str += "<aclPrejctanner.network_cloudengine.cedenjctanner.network_cloudengine.ce>%s</aclPrejctanner.network_cloudengine.cedenjctanner.network_cloudengine.ce>" % self.prejctanner.network_cloudengine.cedenjctanner.network_cloudengine.ce
        if self.tos:
        ...
        if self.rule_action and self.protocol:
            ...
            if self.tos:
                cmd += " tos %s" % self.tos
            if self.sourjctanner.network_cloudengine.ce_ip and self.src_wild:
                cmd += " sourjctanner.network_cloudengine.ce %s %s" % (self.sourjctanner.network_cloudengine.ce_ip, self.src_wild)
            if self.src_pool_name:
                cmd += " sourjctanner.network_cloudengine.ce-pool %s" % self.src_pool_name
            if self.src_port_op:
                cmd += " sourjctanner.network_cloudengine.ce-port"
                if self.src_port_op == "lt":
                    ...
                    cmd += " range %s %s" % (self.src_port_begin,
                                             self.src_port_end)
            if self.src_port_pool_name:
                cmd += " sourjctanner.network_cloudengine.ce-port-pool %s" % self.src_port_pool_name
            ...
            if self.prejctanner.network_cloudengine.cedenjctanner.network_cloudengine.ce:
                cmd += " prejctanner.network_cloudengine.cedenjctanner.network_cloudengine.ce %s" % self.prejctanner.network_cloudengine.cedenjctanner.network_cloudengine.ce_name[self.prejctanner.network_cloudengine.cedenjctanner.network_cloudengine.ce]
            ...
            if self.vrf_name:
                cmd += " vpn-instanjctanner.network_cloudengine.ce %s" % self.vrf_name
            if self.ttl_expired:
                cmd += " ttl-expired"
            if self.log_flag:
                cmd += " logging"
    ...
    def delete_adv_rule(self):
        """ Delete advanjctanner.network_cloudengine.ce rule operation """
        ...
        if self.rule_id:
            ...
            if self.tos:
                cmd += " tos %s" % self.tos
            if self.sourjctanner.network_cloudengine.ce_ip and self.src_mask:
                cmd += " sourjctanner.network_cloudengine.ce %s %s" % (self.sourjctanner.network_cloudengine.ce_ip, self.src_mask)
            if self.src_pool_name:
                cmd += " sourjctanner.network_cloudengine.ce-pool %s" % self.src_pool_name
            if self.src_port_op:
                cmd += " sourjctanner.network_cloudengine.ce-port"
    ...
    def work(self):
        ...
        if self.state == "present":
            if self.cur_acl_cfg["need_cfg"]:
                self.merge_acl()
            if self.cur_advanjctanner.network_cloudengine.ce_rule_cfg["need_cfg"]:
                self.merge_adv_rule()
...
def main():
    ...
    argument_spec = dict(
        state=dict(choijctanner.network_cloudengine.ces=['present', 'absent',
        ...
        rule_action=dict(choijctanner.network_cloudengine.ces=['permit', 'deny']),
        protocol=dict(choijctanner.network_cloudengine.ces=['ip', 'icmp', 'igmp',
                               'ipinip', 'tcp', 'udp', 'gre', 'ospf']),
        sourjctanner.network_cloudengine.ce_ip=dict(type='str'),
        ...
        src_port_op=dict(choijctanner.network_cloudengine.ces=['lt', 'eq', 'gt', 'range']),
        src_port_begin=dict(type='str'),
        src_port_end=dict(type='str'),
        src_port_pool_name=dict(type='str'),
        dest_port_op=dict(choijctanner.network_cloudengine.ces=['lt', 'eq', 'gt', 'range']),
        dest_port_begin=dict(type='str'),
        dest_port_end=dict(type='str'),
        dest_port_pool_name=dict(type='str'),
        frag_type=dict(choijctanner.network_cloudengine.ces=['fragment', 'clear_fragment']),
        prejctanner.network_cloudengine.cedenjctanner.network_cloudengine.ce=dict(type='str'),
        tos=dict(type='str'),
        dscp=dict(type='str'),
        icmp_name=dict(choijctanner.network_cloudengine.ces=['unconfiged', 'echo', 'echo-reply', 'fragmentneed-DFset', 'host-redirect',
                                'host-tos-redirect', 'host-unreachable', 'information-reply', 'information-request',
                                'net-redirect', 'net-tos-redirect', 'net-unreachable', 'parameter-problem',
                                'port-unreachable', 'protocol-unreachable', 'reassembly-timeout', 'sourjctanner.network_cloudengine.ce-quench',
                                'sourjctanner.network_cloudengine.ce-route-failed', 'timestamp-reply', 'timestamp-request', 'ttl-exjctanner.network_cloudengine.ceeded',
        ...
        igmp_type=dict(choijctanner.network_cloudengine.ces=['host-query', 'mrouter-adver', 'mrouter-solic', 'mrouter-termi', 'mtrajctanner.network_cloudengine.ce-resp',
                                'mtrajctanner.network_cloudengine.ce-route', 'v1host-report', 'v2host-report', 'v2leave-group', 'v3host-report']),
        log_flag=dict(required=False, default=False, type='bool')
    )

    argument_spec.update(jctanner.network_cloudengine.ce_argument_spec)
    module = Advanjctanner.network_cloudengine.ceAcl(argument_spec=argument_spec)
    module.work()
