...
module: jctanner.network_cloudengine.ce_dldp_interfajctanner.network_cloudengine.ce
version_added: "2.4"
short_description: Manages interfajctanner.network_cloudengine.ce DLDP configuration on HUAWEI CloudEngine switches.
description:
    - Manages interfajctanner.network_cloudengine.ce DLDP configuration on HUAWEI CloudEngine switches.
author:
    - Zhou Zhijin (@QijunPan)
notes:
    - If C(state=present, enable=disable), interfajctanner.network_cloudengine.ce DLDP enable will be turned off and
      related interfajctanner.network_cloudengine.ce DLDP confuration will be cleared.
    - If C(state=absent), only local_mac is supported to configure.
options:
    interfajctanner.network_cloudengine.ce:
        description:
            - Must be fully qualified interfajctanner.network_cloudengine.ce name, i.e. GE1/0/1, 10GE1/0/1, 40GE1/0/22, 100GE1/0/1.
        required: true
    enable:
        description:
            - Set interfajctanner.network_cloudengine.ce DLDP enable state.
    ...
    local_mac:
        description:
            - Set the sourjctanner.network_cloudengine.ce MAC address for DLDP packets sent in the DLDP-compatible mode.
              The value of MAC address is in H-H-H format. H contains 1 to 4 hexadecimal digits.
    reset:
        description:
            - Specify whether reseting interfajctanner.network_cloudengine.ce DLDP state.
        choijctanner.network_cloudengine.ces: ['enable', 'disable']
    state:
        description:
...
EXAMPLES = '''
- name: DLDP interfajctanner.network_cloudengine.ce test
  hosts: cloudengine
  connection: local
  gather_facts: no
  vars:
  ...
  - name: "Configure interfajctanner.network_cloudengine.ce DLDP enable state and ensure global dldp enable is turned on"
    jctanner.network_cloudengine.ce_dldp_interfajctanner.network_cloudengine.ce:
      interfajctanner.network_cloudengine.ce: 40GE2/0/1
      enable: enable
      provider: "{{ cli }}"

  - name: "Configuire interfajctanner.network_cloudengine.ce DLDP compatible-mode enable state  and ensure interfajctanner.network_cloudengine.ce DLDP state is already enabled"
    jctanner.network_cloudengine.ce_dldp_interfajctanner.network_cloudengine.ce:
      interfajctanner.network_cloudengine.ce: 40GE2/0/1
      enable: enable
      mode_enable: enable
  ...
  - name: "Configuire the sourjctanner.network_cloudengine.ce MAC address for DLDP packets sent in the DLDP-compatible mode  and
           ensure interfajctanner.network_cloudengine.ce DLDP state and compatible-mode enable state  is already enabled"
    jctanner.network_cloudengine.ce_dldp_interfajctanner.network_cloudengine.ce:
      interfajctanner.network_cloudengine.ce: 40GE2/0/1
      enable: enable
      mode_enable: enable
  ...
  - name: "Reset DLDP state of specified interfajctanner.network_cloudengine.ce and ensure interfajctanner.network_cloudengine.ce DLDP state is already enabled"
    jctanner.network_cloudengine.ce_dldp_interfajctanner.network_cloudengine.ce:
      interfajctanner.network_cloudengine.ce: 40GE2/0/1
      enable: enable
      reset: enable
  ...
  - name: "Unconfigure interfajctanner.network_cloudengine.ce DLDP local mac addreess when C(state=absent)"
    jctanner.network_cloudengine.ce_dldp_interfajctanner.network_cloudengine.ce:
      interfajctanner.network_cloudengine.ce: 40GE2/0/1
      state: absent
      local_mac: aa-aa-aa
...
proposed:
    ...
    sample: {
                "enable": "enalbe",
                "interfajctanner.network_cloudengine.ce": "40GE2/0/22",
                "local_mac": "aa-aa-aa",
                "mode_enable": "enable",
                "reset": "enable"
            }
existing:
    description: k/v pairs of existing interfajctanner.network_cloudengine.ce DLDP configration
    returned: always
    type: dict
    sample: {
                "enable": "disable",
...
end_state:
    description: k/v pairs of interfajctanner.network_cloudengine.ce DLDP configration after module execution
    returned: always
    type: dict
    sample: {
                "enable": "enable",
...
<filter type="subtree">
  <dldp xmlns="http://www.huawei.com/netconf/vrp" content-version="1.0" format-version="1.0">
    <dldpInterfajctanner.network_cloudengine.ces>
      <dldpInterfajctanner.network_cloudengine.ce>
        <ifName>%s</ifName>
...
<config>
  <dldp xmlns="http://www.huawei.com/netconf/vrp" content-version="1.0" format-version="1.0">
    <dldpInterfajctanner.network_cloudengine.ces>
      <dldpInterfajctanner.network_cloudengine.ce operation="merge">
        <ifName>%s</ifName>
...
<config>
  <dldp xmlns="http://www.huawei.com/netconf/vrp" content-version="1.0" format-version="1.0">
    <dldpInterfajctanner.network_cloudengine.ces>
      <dldpInterfajctanner.network_cloudengine.ce operation="create">
        <ifName>%s</ifName>
        <dldpEnable>%s</dldpEnable>
        <dldpCompatibleEnable>%s</dldpCompatibleEnable>
        <dldpLocalMac>%s</dldpLocalMac>
...
<config>
  <dldp xmlns="http://www.huawei.com/netconf/vrp" content-version="1.0" format-version="1.0">
    <dldpInterfajctanner.network_cloudengine.ces>
      <dldpInterfajctanner.network_cloudengine.ce operation="delete">
        <ifName>%s</ifName>
      </dldpInterfajctanner.network_cloudengine.ce>
    </dldpInterfajctanner.network_cloudengine.ces>
  </dldp>
...
class DldpInterfajctanner.network_cloudengine.ce(object):
    """Manage interfajctanner.network_cloudengine.ce dldp configration"""
    ...
    def __init__(self, argument_spec):
        ...
        # DLDP interfajctanner.network_cloudengine.ce configration info
    ...
    def get_dldp_intf_exist_config(self):
        ...
        dldp_conf = dict()
        xml_str = CE_NC_GET_INTF_DLDP_CONFIG % self.interfajctanner.network_cloudengine.ce
        ...
        topo = root.find("data/dldp/dldpInterfajctanner.network_cloudengine.ces/dldpInterfajctanner.network_cloudengine.ce")
        if topo is None:
            self.module.fail_json(
    ...
    def config_intf_dldp(self):
        ...
        if self.state == "present":
            ...
            if self.enable == 'disable' and self.enable != self.dldp_intf_conf['dldpEnable']:
                xml_str = CE_NC_DELETE_DLDP_INTF_CONFIG % self.interfajctanner.network_cloudengine.ce
                ...
                xml_str = CE_NC_CREATE_DLDP_INTF_CONFIG % (
                    self.interfajctanner.network_cloudengine.ce, 'true', mode_enable, local_mac)
                ret_xml = set_nc_config(self.module, xml_str)
                ...
                xml_str = CE_NC_MERGE_DLDP_INTF_CONFIG % (
                    self.interfajctanner.network_cloudengine.ce, enable, mode_enable, local_mac)
                ret_xml = set_nc_config(self.module, xml_str)
                self.check_response(ret_xml, "MERGE_DLDP_INTF_CONFIG")

            if self.reset == 'enable':
                xml_str = CE_NC_ACTION_RESET_INTF_DLDP % self.interfajctanner.network_cloudengine.ce
            ...
            if self.local_mac and judge_is_mac_same(self.local_mac, self.dldp_intf_conf['dldpLocalMac']):
                ...
                xml_str = CE_NC_MERGE_DLDP_INTF_CONFIG % (self.interfajctanner.network_cloudengine.ce, dldp_enable, dldp_compat_enable, '')
                ret_xml = set_nc_config(self.module, xml_str)
    ...
    def get_existing(self):
        ...
        dldp_conf['interfajctanner.network_cloudengine.ce'] = self.interfajctanner.network_cloudengine.ce
    ...
    def get_proposed(self):
        ...
        self.proposed = dict(interfajctanner.network_cloudengine.ce=self.interfajctanner.network_cloudengine.ce, enable=self.enable,
...
def main():
    ...
    argument_spec = dict(
        ...
        mode_enable=dict(choijctanner.network_cloudengine.ces=['enable', 'disable'], type='str'),
    ...
    dldp_intf_obj = DldpInterfajctanner.network_cloudengine.ce(argument_spec)
    dldp_intf_obj.work()
