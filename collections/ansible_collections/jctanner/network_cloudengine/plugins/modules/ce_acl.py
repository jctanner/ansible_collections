...
DOCUMENTATION = '''
---
module: jctanner.network_cloudengine.ce_acl
version_added: "2.4"
...
options:
    ...
    rule_name:
        description:
            - Name of a basic ACL rule.
              ...
              The value is case-insensitive, and cannot contain spajctanner.network_cloudengine.ces or begin with an underscore (_).
    rule_id:
        description:
    ...
    src_mask:
        description:
            - Mask of a sourjctanner.network_cloudengine.ce IP address.
    ...
    time_range:
        description:
            - Name of a time range in which an ACL rule takes effect.
              The value is a string of 1 to 32 characters.
              The value is case-insensitive, and cannot contain spajctanner.network_cloudengine.ces. The name must start with an uppercase
...
- name: CloudEngine acl test
  ...
  - name: "Config ACL"
    jctanner.network_cloudengine.ce_acl:
      state: present
      acl_name: 2200
      provider: "{{ cli }}"
                ...
                if "<data/>" in recv_xml:
                    ...
                    if base_rule_info:
                        for tmp in base_rule_info:
                            tmp_dict = dict()
                            for site in tmp:
                                if site.tag in ["aclRuleName", "aclRuleID", "aclAction", "aclSourjctanner.network_cloudengine.ceIp", "aclSrcWild",
