...
DOCUMENTATION = '''
---
module: jctanner.network_cloudengine.ce_reboot
version_added: 2.4
...
- name: reboot module test
  ...
  tasks:
  - name: Reboot the devijctanner.network_cloudengine.ce
    jctanner.network_cloudengine.ce_reboot:
      confirm: true
      save_config: true
      provider: "{{ cli }}"
'''
...
RETURN = '''
rebooted:
    description: Whether the devijctanner.network_cloudengine.ce was instructed to reboot.
    returned: sucjctanner.network_cloudengine.cess
    type: bool
    sample: true
'''
...
from ansible_collections.jctanner.network_cloudengine.plugins.module_utils.network.cloudengine.jctanner.network_cloudengine.ce import execute_nc_action, jctanner.network_cloudengine.ce_argument_spec
...
class Reboot(object):
    """ Reboot a network devijctanner.network_cloudengine.ce """
