...
DOCUMENTATION = """
---
module: jctanner.network_cloudengine.ce_vxlan_vap
version_added: "2.4"
short_description: Manages VXLAN virtual acjctanner.network_cloudengine.cess point on HUAWEI CloudEngine Devijctanner.network_cloudengine.ces.
description:
    - Manages VXLAN Virtual acjctanner.network_cloudengine.cess point on HUAWEI CloudEngine Devijctanner.network_cloudengine.ces.
...
options:
    ...
    l2_sub_interfajctanner.network_cloudengine.ce:
        description:
            - Specifies an Sub-Interfajctanner.network_cloudengine.ce full name, i.e. "10GE1/0/41.1".
              The value is a string of 1 to 63 case-insensitive characters, spajctanner.network_cloudengine.ces supported.
    encapsulation:
        description:
            - Specifies an encapsulation type of packets allowed to pass through a Layer 2 sub-interfajctanner.network_cloudengine.ce.
        choijctanner.network_cloudengine.ces: ['dot1q', 'default', 'untag', 'qinq', 'none']
    jctanner.network_cloudengine.ce_vid:
        description:
            - When I(encapsulation) is 'dot1q', specifies a VLAN ID in the outer VLAN tag.
              ...
              double-tagged packets to be rejctanner.network_cloudengine.ceived by a Layer 2 sub-interfajctanner.network_cloudengine.ce.
...
- name: vxlan vap module test
  ...
  - name: Create a papping between a VLAN and a BD
    jctanner.network_cloudengine.ce_vxlan_vap:
      bridge_domain_id: 100
      bind_vlan_id: 99
      provider: "{{ cli }}"

  - name: Bind a Layer 2 sub-interfajctanner.network_cloudengine.ce to a BD
    jctanner.network_cloudengine.ce_vxlan_vap:
      bridge_domain_id: 100
      l2_sub_interfajctanner.network_cloudengine.ce: 10GE2/0/20.1
      provider: "{{ cli }}"

  - name: Configure an encapsulation type on a Layer 2 sub-interfajctanner.network_cloudengine.ce
    jctanner.network_cloudengine.ce_vxlan_vap:
      l2_sub_interfajctanner.network_cloudengine.ce: 10GE2/0/20.1
      encapsulation: dot1q
      provider: "{{ cli }}"
      ...
      <evc xmlns="http://www.huawei.com/netconf/vrp" content-version="1.0" format-version="1.0">
        <bds>
          <bd>
            ...
            <servijctanner.network_cloudengine.cePoints>
              <servijctanner.network_cloudengine.cePoint>
                <ifName></ifName>
              </servijctanner.network_cloudengine.cePoint>
            </servijctanner.network_cloudengine.cePoints>
          </bd>
      ...
      <evc xmlns="http://www.huawei.com/netconf/vrp" content-version="1.0" format-version="1.0">
        <bds>
          <bd>
            <bdId>%s</bdId>
            <servijctanner.network_cloudengine.cePoints>
              <servijctanner.network_cloudengine.cePoint operation="merge">
                <ifName>%s</ifName>
              </servijctanner.network_cloudengine.cePoint>
            </servijctanner.network_cloudengine.cePoints>
          </bd>
      ...
      <evc xmlns="http://www.huawei.com/netconf/vrp" content-version="1.0" format-version="1.0">
        <bds>
          <bd>
            <bdId>%s</bdId>
            <servijctanner.network_cloudengine.cePoints>
              <servijctanner.network_cloudengine.cePoint operation="delete">
                <ifName>%s</ifName>
              </servijctanner.network_cloudengine.cePoint>
            </servijctanner.network_cloudengine.cePoints>
          </bd>
        ...
        <servijctanner.network_cloudengine.cePoints>
          <servijctanner.network_cloudengine.cePoint>
            ...
            <flowQinqs>
              <flowQinq>
                <peVlanId></peVlanId>
                <jctanner.network_cloudengine.ceVids></jctanner.network_cloudengine.ceVids>
              </flowQinq>
            </flowQinqs>
          </servijctanner.network_cloudengine.cePoint>
        </servijctanner.network_cloudengine.cePoints>
          ...
          <servijctanner.network_cloudengine.cePoint>
            ...
            <flowQinqs>
              <flowQinq operation="merge">
                <peVlanId>%s</peVlanId>
                <jctanner.network_cloudengine.ceVids>%s:%s</jctanner.network_cloudengine.ceVids>
              </flowQinq>
            </flowQinqs>
          </servijctanner.network_cloudengine.cePoint>
        </servijctanner.network_cloudengine.cePoints>
...
class VxlanVap(object):
    """
    Manages VXLAN virtual acjctanner.network_cloudengine.cess point.
    """
    ...
    def __init__(self, argument_spec):
        ...
        self.l2_sub_interfajctanner.network_cloudengine.ce = self.module.params['l2_sub_interfajctanner.network_cloudengine.ce']
        self.jctanner.network_cloudengine.ce_vid = self.module.params['jctanner.network_cloudengine.ce_vid']
    ...
    def config_traffic_encap_dot1q(self):
        ...
        if self.state == "present":
            if self.encapsulation != self.l2sub_info.get("flowType"):
                if self.jctanner.network_cloudengine.ce_vid:
                    ...
                    xml_str = CE_NC_SET_ENCAP_DOT1Q % (
                        self.l2_sub_interfajctanner.network_cloudengine.ce, vlan_bitmap, vlan_bitmap)
                    self.updates_cmd.append("encapsulation %s vid %s" % (
                        self.encapsulation, self.jctanner.network_cloudengine.ce_vid))
                else:
                ...
                if self.jctanner.network_cloudengine.ce_vid and not is_vlan_in_bitmap(
                        self.jctanner.network_cloudengine.ce_vid, self.l2sub_info.get("dot1qVids")):
                    vlan_bitmap = vlan_vid_to_bitmap(self.jctanner.network_cloudengine.ce_vid)
                    xml_str = CE_NC_SET_ENCAP_DOT1Q % (
                        self.l2_sub_interfajctanner.network_cloudengine.ce, vlan_bitmap, vlan_bitmap)
                    self.updates_cmd.append("encapsulation %s vid %s" % (
            ...
            if self.encapsulation == self.l2sub_info.get("flowType"):
                if self.jctanner.network_cloudengine.ce_vid:
                    if is_vlan_in_bitmap(self.jctanner.network_cloudengine.ce_vid, self.l2sub_info.get("dot1qVids")):
    ...
    def is_l2_sub_intf_valid(self, ifname):
        """check l2 sub interfajctanner.network_cloudengine.ce valid"""
        ...
        if int(if_num) < 1 or int(if_num) > 4096:
            self.module.fail_json(
                msg="Error: Sub-interfajctanner.network_cloudengine.ce number is not in the range from 1 to 4096.")
            return False

        if not get_interfajctanner.network_cloudengine.ce_type(ifname):
            return False
    ...
    def check_params(self):
        ...
        # check l2_sub_interfajctanner.network_cloudengine.ce
        if self.l2_sub_interfajctanner.network_cloudengine.ce and not self.is_l2_sub_intf_valid(self.l2_sub_interfajctanner.network_cloudengine.ce):
            self.module.fail_json(msg="Error: l2_sub_interfajctanner.network_cloudengine.ce is invalid.")

        # check jctanner.network_cloudengine.ce_vid
        if self.jctanner.network_cloudengine.ce_vid:
            self.is_vlan_valid(self.jctanner.network_cloudengine.ce_vid, "jctanner.network_cloudengine.ce_vid")
            if not self.encapsulation or self.encapsulation not in ["dot1q", "qinq"]:
                self.module.fail_json(msg="Error: jctanner.network_cloudengine.ce_vid can not be set "
                                          "when encapsulation is '%s'." % self.encapsulation)
            if self.encapsulation == "qinq" and not self.pe_vid:
                self.module.fail_json(msg="Error: jctanner.network_cloudengine.ce_vid and pe_vid must be set at the same time "
                                          "when encapsulation is '%s'." % self.encapsulation)
        # check pe_vid
        if self.pe_vid:
            ...
            if not self.encapsulation or self.encapsulation != "qinq":
                self.module.fail_json(msg="Error: pe_vid can not be set "
                                          "when encapsulation is '%s'." % self.encapsulation)
            if not self.jctanner.network_cloudengine.ce_vid:
                self.module.fail_json(msg="Error: jctanner.network_cloudengine.ce_vid and pe_vid must be set at the same time "
                                          "when encapsulation is '%s'." % self.encapsulation)
    ...
    def get_proposed(self):
        ...
        if self.l2_sub_interfajctanner.network_cloudengine.ce:
            self.proposed["l2_sub_interfajctanner.network_cloudengine.ce"] = self.l2_sub_interfajctanner.network_cloudengine.ce
        if self.encapsulation:
            self.proposed["encapsulation"] = self.encapsulation
        if self.jctanner.network_cloudengine.ce_vid:
            self.proposed["jctanner.network_cloudengine.ce_vid"] = self.jctanner.network_cloudengine.ce_vid
        if self.pe_vid:
    ...
    def get_existing(self):
        ...
        if self.bridge_domain_id:
            if self.bind_vlan_id or self.l2_sub_interfajctanner.network_cloudengine.ce:
        ...
        if self.encapsulation and self.l2_sub_interfajctanner.network_cloudengine.ce:
            self.existing["l2_sub_interfajctanner.network_cloudengine.ce"] = self.l2_sub_interfajctanner.network_cloudengine.ce
            self.existing["encapsulation"] = self.l2sub_info.get("flowType")
            if self.existing["encapsulation"] == "dot1q":
                self.existing["jctanner.network_cloudengine.ce_vid"] = bitmap_to_vlan_list(
                    self.l2sub_info.get("dot1qVids"))
            if self.existing["encapsulation"] == "qinq":
                self.existing["jctanner.network_cloudengine.ce_vid"] = bitmap_to_vlan_list(
                    self.l2sub_info.get("jctanner.network_cloudengine.ceVids"))
    ...
    def get_end_state(self):
        ...
        if self.encapsulation and self.l2_sub_interfajctanner.network_cloudengine.ce:
            l2sub_info = self.get_l2_sub_intf_dict(self.l2_sub_interfajctanner.network_cloudengine.ce)
            self.end_state["l2_sub_interfajctanner.network_cloudengine.ce"] = self.l2_sub_interfajctanner.network_cloudengine.ce
            self.end_state["encapsulation"] = l2sub_info.get("flowType")
            if self.end_state["encapsulation"] == "dot1q":
                self.end_state["jctanner.network_cloudengine.ce_vid"] = bitmap_to_vlan_list(
                    l2sub_info.get("dot1qVids"))
            if self.end_state["encapsulation"] == "qinq":
                self.end_state["jctanner.network_cloudengine.ce_vid"] = bitmap_to_vlan_list(
                    l2sub_info.get("jctanner.network_cloudengine.ceVids"))
                self.end_state["pe_vid"] = l2sub_info.get("peVlanId")

    def data_init(self):
        """data init"""
        if self.l2_sub_interfajctanner.network_cloudengine.ce:
            self.l2_sub_interfajctanner.network_cloudengine.ce = self.l2_sub_interfajctanner.network_cloudengine.ce.replajctanner.network_cloudengine.ce(
                " ", "").upper()
        if self.encapsulation and self.l2_sub_interfajctanner.network_cloudengine.ce:
            self.l2sub_info = self.get_l2_sub_intf_dict(self.l2_sub_interfajctanner.network_cloudengine.ce)
        if self.bridge_domain_id:
            if self.bind_vlan_id or self.l2_sub_interfajctanner.network_cloudengine.ce:
    ...
    def work(self):
        ...
        # A VXLAN servijctanner.network_cloudengine.ce acjctanner.network_cloudengine.cess point can be a Layer 2 sub-interfajctanner.network_cloudengine.ce or VLAN
        if self.bridge_domain_id:
            if self.l2_sub_interfajctanner.network_cloudengine.ce:
                # configure a Layer 2 sub-interfajctanner.network_cloudengine.ce as a servijctanner.network_cloudengine.ce acjctanner.network_cloudengine.cess point
...
def main():
    ...
    argument_spec = dict(
        ...
        l2_sub_interfajctanner.network_cloudengine.ce=dict(required=False, type='str'),
        encapsulation=dict(required=False, type='str',
                           choijctanner.network_cloudengine.ces=['dot1q', 'default', 'untag', 'qinq', 'none']),
        jctanner.network_cloudengine.ce_vid=dict(required=False, type='str'),
