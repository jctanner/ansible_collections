...
DOCUMENTATION = '''
---
module: jctanner.network_cloudengine.ce_info_jctanner.network_cloudengine.center_global
version_added: "2.4"
...
author:
    - Li Yanfeng (@QijunPan)
options:
    info_jctanner.network_cloudengine.center_enable:
        description:
            - Whether the info-jctanner.network_cloudengine.center function is enabled. The value is of the Boolean type.
        choijctanner.network_cloudengine.ces: ['true','false']
    packet_priority:
        description:
            - Set the priority of the syslog packet.The value is an integer ranging from 0 to 7. The default value is 0.
    suppress_enable:
        description:
            - Whether a devijctanner.network_cloudengine.ce is enabled to suppress duplicate statistics. The value is of the Boolean type.
        choijctanner.network_cloudengine.ces: [ 'false', 'true' ]
    logfile_max_num:
        description:
    ...
    logfile_max_size:
        ...
        default: 32
        choijctanner.network_cloudengine.ces: ['4', '8', '16', '32']
    channel_id:
        description:
    ...
    channel_out_direct:
        ...
        choijctanner.network_cloudengine.ces: ['console','monitor','trapbuffer','logbuffer','snmp','logfile']
    filter_feature_name:
        description:
    ...
    ip_type:
        ...
        choijctanner.network_cloudengine.ces: ['ipv4','ipv6']
    server_ip:
        description:
    ...
    level:
        ...
        choijctanner.network_cloudengine.ces: ['emergencies','alert','critical','error','warning','notification','informational','debugging']
    server_port:
        description:
    ...
    facility:
        description:
            - Log record tool.
        choijctanner.network_cloudengine.ces: ['local0','local1','local2','local3','local4','local5','local6','local7']
    channel_name:
        description:
    ...
    timestamp:
        ...
        choijctanner.network_cloudengine.ces: ['UTC', 'localtime']
    transport_mode:
        description:
            - Transport mode. The value is of the enumerated type and case-sensitive.
        choijctanner.network_cloudengine.ces: ['tcp','udp']
    ssl_policy_name:
        description:
            - SSL policy name. The value is a string of 1 to 23 case-sensitive characters.
    sourjctanner.network_cloudengine.ce_ip:
        description:
            - Log sourjctanner.network_cloudengine.ce ip address, IPv4 or IPv6 type. The value is a string of 0 to 255.
              The value can be an valid IPv4 or IPv6 address.
    state:
        description:
...
'''
EXAMPLES = '''
- name: info jctanner.network_cloudengine.center global module test
  hosts: cloudengine
  connection: local
  gather_facts: no
  vars:
  ...
  - name: Config info-jctanner.network_cloudengine.center enable
    jctanner.network_cloudengine.ce_info_jctanner.network_cloudengine.center_global:
      info_jctanner.network_cloudengine.center_enable: true
      state: present
      provider: "{{ cli }}"
  ...
  - name: Config info-jctanner.network_cloudengine.center syslog packet-priority 1
    jctanner.network_cloudengine.ce_info_jctanner.network_cloudengine.center_global:
      packet_priority: 2
      state: present
      provider: "{{ cli }}"

  - name: Config info-jctanner.network_cloudengine.center channel 1 name aaa
    jctanner.network_cloudengine.ce_info_jctanner.network_cloudengine.center_global:
      channel_id: 1
  ...
  - name: Config info-jctanner.network_cloudengine.center logfile size 10
    jctanner.network_cloudengine.ce_info_jctanner.network_cloudengine.center_global:
      logfile_max_num: 10
      state: present
      provider: "{{ cli }}"

  - name: Config info-jctanner.network_cloudengine.center console channel 1
    jctanner.network_cloudengine.ce_info_jctanner.network_cloudengine.center_global:
  ...
  - name: Config info-jctanner.network_cloudengine.center filter-id bymodule-alias snmp snmp_ipunlock
    jctanner.network_cloudengine.ce_info_jctanner.network_cloudengine.center_global:
  ...
  - name: Config info-jctanner.network_cloudengine.center max-logfile-number 16
    jctanner.network_cloudengine.ce_info_jctanner.network_cloudengine.center_global:
      logfile_max_size: 16
      state: present
      provider: "{{ cli }}"
        ...
        "server_domain_info": [
            {
                ...
                "serverDomain": "aaa",
                "serverPort": "100",
                "sourjctanner.network_cloudengine.ceIP": "0.0.0.0",
                "sslPolicyName": "gmc",
                "timestamp": "UTC",
                "transportMode": "tcp",
                "vrfName": "aaa"
...
updates:
    ...
    returned: always
    type: list
    sample: ["info-jctanner.network_cloudengine.center loghost domain aaa level alert port 100 facility local4 channel 1 localtime transport tcp"]
changed:
...
from ansible_collections.jctanner.network_cloudengine.plugins.module_utils.network.cloudengine.jctanner.network_cloudengine.ce import jctanner.network_cloudengine.ce_argument_spec, get_nc_config, set_nc_config, check_ip_addr
...
class InfoCenterGlobal(object):
    """
    Manages info jctanner.network_cloudengine.center global configuration.
    """
    ...
    def __init__(self, argument_spec):
        ...
        # module input info
        self.info_jctanner.network_cloudengine.center_enable = self.module.params['info_jctanner.network_cloudengine.center_enable'] or None
    ...
    def config_merge_syslog_channel(self, channel_id, channel_name):
        ...
        if not self.is_exist_channel_id_name(channel_id, channel_name):
            ...
            self.updates_cmd.append(
                "info-jctanner.network_cloudengine.center channel %s name %s" % (channel_id, channel_name))
            self.changed = True
    ...
    def delete_merge_syslog_channel(self, channel_id, channel_name):
        ...
        if change_flag:
            ...
            self.updates_cmd.append("undo info-jctanner.network_cloudengine.center channel %s" % channel_id)
            self.changed = True
    ...
    def config_merge_out_direct(self, out_direct, channel_id):
        ...
        if not self.is_exist_out_direct(out_direct, channel_id):
            ...
            self.updates_cmd.append(
                "info-jctanner.network_cloudengine.center %s channel %s" % (out_direct, channel_id))
            self.changed = True
    ...
    def delete_merge_out_direct(self, out_direct, channel_id):
        ...
        if change_flag:
            ...
            self.updates_cmd.append("undo info-jctanner.network_cloudengine.center logfile channel")
            self.changed = True
    ...
    def config_merge_filter(self, filter_feature_name, filter_log_name):
        ...
        if not self.is_exist_filter(filter_feature_name, filter_log_name):
            ...
            self.updates_cmd.append("info-jctanner.network_cloudengine.center filter-id bymodule-alias %s %s"
    ...
    def delete_merge_filter(self, filter_feature_name, filter_log_name):
        ...
        if change_flag:
            ...
            if "<ok/>" not in recv_xml:
                self.module.fail_json(
                    msg='Error: Merge syslog channel out direct failed.')
            self.updates_cmd.append("undo info-jctanner.network_cloudengine.center filter-id bymodule-alias %s %s"
                                    % (filter_feature_name, filter_log_name))
            self.changed = True
            ...
            for syslog_server in syslog_servers:
                ...
                for ele in syslog_server:
                    if ele.tag in ["ipType", "serverIp", "vrfName", "level", "serverPort", "facility", "chnlId",
                                   ...
                                   "sourjctanner.network_cloudengine.ceIP", "isBriefFmt"]:
    ...
    def config_merge_loghost(self):
        ...
        if self.sourjctanner.network_cloudengine.ce_ip:
            conf_str += "<sourjctanner.network_cloudengine.ceIP>%s</sourjctanner.network_cloudengine.ceIP>" % self.sourjctanner.network_cloudengine.ce_ip
        if self.ip_type:
        ...
        cmd = "info-jctanner.network_cloudengine.center loghost"
        ...
        if self.sourjctanner.network_cloudengine.ce_ip:
            cmd += " sourjctanner.network_cloudengine.ce-ip %s" % self.sourjctanner.network_cloudengine.ce_ip
        if self.ssl_policy_name:
    ...
    def delete_merge_loghost(self):
        ...
        cmd = "undo info-jctanner.network_cloudengine.center loghost"
        if self.ip_type == "ipv4" and self.server_ip:
            cmd += " %s" % self.server_ip
        if self.ip_type == "ipv6" and self.server_ip:
            cmd += " ipv6 %s" % self.server_ip
            ...
            if self.server_ip_info:
                for tmp in self.server_ip_info["serverIpInfos"]:
                    ...
                    if self.ssl_policy_name and tmp.get("sslPolicyName") != self.ssl_policy_name:
                        find_flag = False
                    if self.sourjctanner.network_cloudengine.ce_ip and tmp.get("sourjctanner.network_cloudengine.ceIP") != self.sourjctanner.network_cloudengine.ce_ip:
                        find_flag = False
                    if find_flag:
                        break
        elif self.server_domain:
    ...
    def get_syslog_global(self):
        ...
        if self.info_jctanner.network_cloudengine.center_enable:
    ...
    def merge_syslog_global(self):
        ...
        if self.info_jctanner.network_cloudengine.center_enable:
            conf_str += "<icEnable>%s</icEnable>" % self.info_jctanner.network_cloudengine.center_enable
        if self.packet_priority:
            if self.state == "present":
        ...
        if self.info_jctanner.network_cloudengine.center_enable == "true" and self.cur_global_info["icEnable"] != self.info_jctanner.network_cloudengine.center_enable:
            cmd = "info-jctanner.network_cloudengine.center enable"
            self.updates_cmd.append(cmd)
            self.changed = True
        if self.suppress_enable == "true" and self.cur_global_info["suppressEnable"] != self.suppress_enable:
            cmd = "info-jctanner.network_cloudengine.center statistic-suppress enable"
            self.updates_cmd.append(cmd)
            self.changed = True
        if self.info_jctanner.network_cloudengine.center_enable == "false" and self.cur_global_info["icEnable"] != self.info_jctanner.network_cloudengine.center_enable:
            cmd = "undo info-jctanner.network_cloudengine.center enable"
            self.updates_cmd.append(cmd)
            self.changed = True
        if self.suppress_enable == "false" and self.cur_global_info["suppressEnable"] != self.suppress_enable:
            cmd = "undo info-jctanner.network_cloudengine.center statistic-suppress enable"
            self.updates_cmd.append(cmd)
            self.changed = True
        ...
        if self.state == "present":
            if self.packet_priority:
                if self.packet_priority != "0" and self.cur_global_info["packetPriority"] != self.packet_priority:
                    cmd = "info-jctanner.network_cloudengine.center syslog packet-priority %s" % self.packet_priority
                    self.updates_cmd.append(cmd)
                    self.changed = True
        if self.state == "absent":
            if self.packet_priority:
                if self.packet_priority != "0" and self.cur_global_info["packetPriority"] == self.packet_priority:
                    cmd = "undo info-jctanner.network_cloudengine.center syslog packet-priority %s" % self.packet_priority
                    self.updates_cmd.append(cmd)
                    self.changed = True
        if self.changed:
            recv_xml = set_nc_config(self.module, conf_str)
    ...
    def merge_syslog_logfile(self):
        ...
        if self.state == "present":
            if self.logfile_max_num:
                if self.cur_logfile_info["maxFileNum"] != self.logfile_max_num:
                    cmd = "info-jctanner.network_cloudengine.center max-logfile-number %s" % self.logfile_max_num
                    self.updates_cmd.append(cmd)
                    self.changed = True
            if self.logfile_max_size:
                if self.cur_logfile_info["maxFileSize"] != self.logfile_max_size:
                    cmd = "info-jctanner.network_cloudengine.center logfile size %s" % self.logfile_max_size
                    self.updates_cmd.append(cmd)
                    self.changed = True
        if self.state == "absent":
            if self.logfile_max_num and self.logfile_max_num != "200":
                if self.cur_logfile_info["maxFileNum"] == self.logfile_max_num:
                    cmd = "undo info-jctanner.network_cloudengine.center max-logfile-number"
                    self.updates_cmd.append(cmd)
                    self.changed = True
            if self.logfile_max_size and self.logfile_max_size != "32":
                if self.cur_logfile_info["maxFileSize"] == self.logfile_max_size:
                    cmd = "undo info-jctanner.network_cloudengine.center logfile size"
                    self.updates_cmd.append(cmd)
                    self.changed = True
    ...
    def check_params(self):
        ...
        if self.channel_cfg_name:
            if len(self.channel_cfg_name) > 30 \
                    or len(self.channel_cfg_name.replajctanner.network_cloudengine.ce(' ', '')) < 1:
                self.module.fail_json(
        ...
        if self.filter_feature_name:
            if len(self.filter_feature_name) > 31 \
                    or len(self.filter_feature_name.replajctanner.network_cloudengine.ce(' ', '')) < 1:
                self.module.fail_json(
        ...
        if self.filter_log_name:
            if len(self.filter_log_name) > 63 \
                    or len(self.filter_log_name.replajctanner.network_cloudengine.ce(' ', '')) < 1:
                self.module.fail_json(
        ...
        # sourjctanner.network_cloudengine.ce_ip check
        if self.sourjctanner.network_cloudengine.ce_ip:
            if not check_ip_addr(self.sourjctanner.network_cloudengine.ce_ip):
                self.module.fail_json(
                    msg='Error: The %s is not a valid ip address' % self.sourjctanner.network_cloudengine.ce_ip)

        # server_domain check
        if self.server_domain:
            if len(self.server_domain) > 255 \
                    or len(self.server_domain.replajctanner.network_cloudengine.ce(' ', '')) < 1:
                self.module.fail_json(
        ...
        if self.vrf_name:
            if len(self.vrf_name) > 31 \
                    or len(self.vrf_name.replajctanner.network_cloudengine.ce(' ', '')) < 1:
                self.module.fail_json(
        ...
        if self.channel_name:
            if len(self.channel_name) > 31 \
                    or len(self.channel_name.replajctanner.network_cloudengine.ce(' ', '')) < 1:
                self.module.fail_json(
        ...
        if self.ssl_policy_name:
            if len(self.ssl_policy_name) > 23 \
                    or len(self.ssl_policy_name.replajctanner.network_cloudengine.ce(' ', '')) < 1:
                self.module.fail_json(
    ...
    def get_proposed(self):
        ...
        if self.info_jctanner.network_cloudengine.center_enable:
            self.proposed["info_jctanner.network_cloudengine.center_enable"] = self.info_jctanner.network_cloudengine.center_enable
        if self.packet_priority:
    ...
    def get_existing(self):
        ...
        if self.info_jctanner.network_cloudengine.center_enable:
            self.existing["info_jctanner.network_cloudengine.center_enable"] = self.cur_global_info[
                "icEnable"]
        if self.packet_priority:
    ...
    def get_end_state(self):
        ...
        if self.info_jctanner.network_cloudengine.center_enable or self.packet_priority or self.suppress_enable:
        ...
        if self.info_jctanner.network_cloudengine.center_enable:
            self.end_state[
                "info_jctanner.network_cloudengine.center_enable"] = self.cur_global_info["icEnable"]
        if self.packet_priority:
    ...
    def work(self):
        ...
        if self.ip_type or self.server_domain or self.channel_id or self.filter_feature_name:
            ...
            if self.state == "present":
                # info-jctanner.network_cloudengine.center channel channel-number name channel-name
                if self.channel_id and self.channel_cfg_name:
                    self.config_merge_syslog_channel(
                        self.channel_id, self.channel_cfg_name)
                # info-jctanner.network_cloudengine.center { console | logfile | monitor | snmp | logbuffer
                # | trapbuffer } channel channel-number
                if self.channel_out_direct and self.channel_id:
                    self.config_merge_out_direct(
                        self.channel_out_direct, self.channel_id)
                # info-jctanner.network_cloudengine.center filter-id bymodule-alias modname alias
                if self.filter_feature_name and self.filter_log_name:
...
def main():
    ...
    argument_spec = dict(
        info_jctanner.network_cloudengine.center_enable=dict(choijctanner.network_cloudengine.ces=['true', 'false']),
        packet_priority=dict(type='str'),
        suppress_enable=dict(choijctanner.network_cloudengine.ces=['true', 'false']),
        logfile_max_num=dict(type='str'),
        logfile_max_size=dict(choijctanner.network_cloudengine.ces=['4', '8', '16', '32']),
        channel_id=dict(type='str'),
        channel_cfg_name=dict(type='str'),
        channel_out_direct=dict(choijctanner.network_cloudengine.ces=['console', 'monitor',
                                         'trapbuffer', 'logbuffer', 'snmp', 'logfile']),
        filter_feature_name=dict(type='str'),
        filter_log_name=dict(type='str'),
        ip_type=dict(choijctanner.network_cloudengine.ces=['ipv4', 'ipv6']),
        server_ip=dict(type='str'),
        server_domain=dict(type='str'),
        is_default_vpn=dict(default=False, type='bool'),
        vrf_name=dict(type='str'),
        level=dict(choijctanner.network_cloudengine.ces=['emergencies', 'alert', 'critical', 'error', 'warning', 'notification',
                            'informational', 'debugging']),
        server_port=dict(type='str'),
        facility=dict(choijctanner.network_cloudengine.ces=['local0', 'local1', 'local2',
                               'local3', 'local4', 'local5', 'local6', 'local7']),
        channel_name=dict(type='str'),
        timestamp=dict(choijctanner.network_cloudengine.ces=['UTC', 'localtime']),
        transport_mode=dict(choijctanner.network_cloudengine.ces=['tcp', 'udp']),
