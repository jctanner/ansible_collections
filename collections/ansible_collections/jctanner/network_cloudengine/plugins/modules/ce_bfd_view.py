...
DOCUMENTATION = """
---
module: jctanner.network_cloudengine.ce_bfd_view
version_added: "2.4"
short_description: Manages BFD session view configuration on HUAWEI CloudEngine devijctanner.network_cloudengine.ces.
description:
    - Manages BFD session view configuration on HUAWEI CloudEngine devijctanner.network_cloudengine.ces.
...
options:
    ...
    min_tx_interval:
        description:
            - Specifies the minimum interval for rejctanner.network_cloudengine.ceiving BFD packets.
    ...
    description:
        description:
            - Specifies the description of a BFD session.
              The value is a string of 1 to 51 case-sensitive characters with spajctanner.network_cloudengine.ces.
    state:
        description:
...
extends_documentation_fragment: jctanner.network_cloudengine.ce
"""
...
- name: bfd view module test
  ...
  - name: Set the local discriminator of a BFD session to 80 and the remote discriminator to 800
    jctanner.network_cloudengine.ce_bfd_view:
      session_name: atob
      local_discr: 80
      remote_discr: 800
      state: present
  ...
  - name: Set the minimum interval for rejctanner.network_cloudengine.ceiving BFD packets to 500 ms
    jctanner.network_cloudengine.ce_bfd_view:
      session_name: atob
      min_rx_interval: 500
      state: present
