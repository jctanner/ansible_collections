...
DOCUMENTATION = """
---
module: jctanner.network_cloudengine.ce_bfd_global
version_added: "2.4"
short_description: Manages BFD global configuration on HUAWEI CloudEngine devijctanner.network_cloudengine.ces.
description:
    - Manages BFD global configuration on HUAWEI CloudEngine devijctanner.network_cloudengine.ces.
...
- name: bfd global module test
  ...
  - name: Enable the global BFD function
    jctanner.network_cloudengine.ce_bfd_global:
      bfd_enable: enable
      provider: '{{ cli }}'
...
def main():
    ...
    argument_spec = dict(
        bfd_enable=dict(required=False, type='str', choijctanner.network_cloudengine.ces=['enable', 'disable']),
