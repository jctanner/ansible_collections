...
DOCUMENTATION = '''
---
module: jctanner.network_cloudengine.ce_evpn_global
version_added: "2.4"
...
- name: evpn global module test
  ...
  - name: Configure EVPN as the VXLAN control plan
    jctanner.network_cloudengine.ce_evpn_global:
...
def main():
    ...
    argument_spec = dict(
        evpn_overlay_enable=dict(
            required=True, type='str', choijctanner.network_cloudengine.ces=['enable', 'disable']),
    )
