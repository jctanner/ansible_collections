...
DOCUMENTATION = '''
---
module: jctanner.network_cloudengine.ce_evpn_bd_vni
version_added: "2.4"
...
notes:
    ...
    - If you configure evpn:false to delete an EVPN instanjctanner.network_cloudengine.ce, all configurations in the EVPN instanjctanner.network_cloudengine.ce are deleted.
    - After an EVPN instanjctanner.network_cloudengine.ce has been created in the BD view, you can configure an RD using route_distinguisher
      parameter in BD-EVPN instanjctanner.network_cloudengine.ce view.
    - Before configuring VPN targets for a BD EVPN instanjctanner.network_cloudengine.ce, ensure that an RD has been configured
      for the BD EVPN instanjctanner.network_cloudengine.ce
    - If you unconfigure route_distinguisher, all VPN target attributes for the BD EVPN instanjctanner.network_cloudengine.ce will be removed at the same time.
...
options:
    ...
    evpn:
        description:
            - Create or delete an EVPN instanjctanner.network_cloudengine.ce for a VXLAN in BD view.
        choijctanner.network_cloudengine.ces: ['enable','disable']
        default: 'enable'
    route_distinguisher:
        description:
            - Configures a route distinguisher (RD) for a BD EVPN instanjctanner.network_cloudengine.ce.
    ...
    vpn_target_both:
        description:
            - Add VPN targets to both the import and export VPN target lists of a BD EVPN instanjctanner.network_cloudengine.ce.
              The format is the same as route_distinguisher.
    vpn_target_import:
        description:
            - Add VPN targets to the import VPN target list of a BD EVPN instanjctanner.network_cloudengine.ce.
              The format is the same as route_distinguisher.
        required: true
    vpn_target_export:
        description:
            - Add VPN targets to the export VPN target list of a BD EVPN instanjctanner.network_cloudengine.ce.
              The format is the same as route_distinguisher.
    state:
        description:
...
- name: EVPN BD VNI test
  ...
  - name: "Configure an EVPN instanjctanner.network_cloudengine.ce for a VXLAN in BD view"
    jctanner.network_cloudengine.ce_evpn_bd_vni:
      bridge_domain_id: 20
      evpn: enable
      provider: "{{ cli }}"

  - name: "Configure a route distinguisher (RD) for a BD EVPN instanjctanner.network_cloudengine.ce"
    jctanner.network_cloudengine.ce_evpn_bd_vni:
      bridge_domain_id: 20
      route_distinguisher: '22:22'
      provider: "{{ cli }}"

  - name: "Configure VPN targets to both the import and export VPN target lists of a BD EVPN instanjctanner.network_cloudengine.ce"
    jctanner.network_cloudengine.ce_evpn_bd_vni:
      bridge_domain_id: 20
      vpn_target_both: 22:100,22:101
      provider: "{{ cli }}"

  - name: "Configure VPN targets to the import VPN target list of a BD EVPN instanjctanner.network_cloudengine.ce"
    jctanner.network_cloudengine.ce_evpn_bd_vni:
      bridge_domain_id: 20
      vpn_target_import: 22:22,22:23
      provider: "{{ cli }}"

  - name: "Configure VPN targets to the export VPN target list of a BD EVPN instanjctanner.network_cloudengine.ce"
    jctanner.network_cloudengine.ce_evpn_bd_vni:
      bridge_domain_id: 20
      vpn_target_export: 22:38,22:39
      provider: "{{ cli }}"

  - name: "Unconfigure VPN targets to both the import and export VPN target lists of a BD EVPN instanjctanner.network_cloudengine.ce"
    jctanner.network_cloudengine.ce_evpn_bd_vni:
      bridge_domain_id: 20
  ...
  - name: "Unconfigure VPN targets to the import VPN target list of a BD EVPN instanjctanner.network_cloudengine.ce"
    jctanner.network_cloudengine.ce_evpn_bd_vni:
      bridge_domain_id: 20
  ...
  - name: "Unconfigure VPN targets to the export VPN target list of a BD EVPN instanjctanner.network_cloudengine.ce"
    jctanner.network_cloudengine.ce_evpn_bd_vni:
      bridge_domain_id: 20
  ...
  - name: "Unconfigure a route distinguisher (RD) of a BD EVPN instanjctanner.network_cloudengine.ce"
    jctanner.network_cloudengine.ce_evpn_bd_vni:
      bridge_domain_id: 20
      route_distinguisher: '22:22'
      state: absent
  ...
  - name: "Unconfigure an EVPN instanjctanner.network_cloudengine.ce for a VXLAN in BD view"
    jctanner.network_cloudengine.ce_evpn_bd_vni:
      bridge_domain_id: 20
      evpn: disable
      provider: "{{ cli }}"
...
existing:
    description: k/v pairs of existing attributes on the devijctanner.network_cloudengine.ce
    returned: always
    type: dict
    sample: {
                "bridge_domain_id": "2",
...
end_state:
    description: k/v pairs of end attributes on the devijctanner.network_cloudengine.ce
    returned: always
    type: dict
    sample: {
                "bridge_domain_id": "2",
...
<filter type="subtree">
  <evpn xmlns="http://www.huawei.com/netconf/vrp" content-version="1.0" format-version="1.0">
    <evpnInstanjctanner.network_cloudengine.ces>
      <evpnInstanjctanner.network_cloudengine.ce>
        <evpnName>%s</evpnName>
        <bdId>%s</bdId>
...
<config>
  <evpn xmlns="http://www.huawei.com/netconf/vrp" content-version="1.0" format-version="1.0">
    <evpnInstanjctanner.network_cloudengine.ces>
      <evpnInstanjctanner.network_cloudengine.ce operation="delete">
        <evpnName>%s</evpnName>
        <bdId>%s</bdId>
      </evpnInstanjctanner.network_cloudengine.ce>
    </evpnInstanjctanner.network_cloudengine.ces>
...
<config>
  <evpn xmlns="http://www.huawei.com/netconf/vrp" content-version="1.0" format-version="1.0">
    <evpnInstanjctanner.network_cloudengine.ces>
      <evpnInstanjctanner.network_cloudengine.ce operation="merge">
        <evpnName>%s</evpnName>
        <bdId>%s</bdId>
"""
...
class EvpnBd(object):
    """Manange evpn instanjctanner.network_cloudengine.ce in BD view"""
    ...
    def __init__(self, argument_spec, ):
        ...
        # EVPN instanjctanner.network_cloudengine.ce info
    ...
    def projctanner.network_cloudengine.cess_rts_info(self):
        """Projctanner.network_cloudengine.cess RTS information"""
    ...
    def get_evpn_instanjctanner.network_cloudengine.ce_info(self):
        ...
        if evpn_inst:
            ...
            self.projctanner.network_cloudengine.cess_rts_info()
    ...
    def get_end_state(self):
        ...
        self.get_evpn_instanjctanner.network_cloudengine.ce_info()
    ...
    def unconfig_evpn_instanjctanner.network_cloudengine.ce(self):
        """Unconfigure EVPN instanjctanner.network_cloudengine.ce"""
        ...
        # projctanner.network_cloudengine.cess VPN target list
    ...
    def config_evpn_instanjctanner.network_cloudengine.ce(self):
        """Configure EVPN instanjctanner.network_cloudengine.ce"""
    ...
    def config_evnp_bd(self):
        ...
        if not self.conf_exist:
            if self.state == 'present':
                self.config_evpn_instanjctanner.network_cloudengine.ce()
            else:
                self.unconfig_evpn_instanjctanner.network_cloudengine.ce()

    def projctanner.network_cloudengine.cess_input_params(self):
        """Projctanner.network_cloudengine.cess input parameters"""
    ...
    def work(self):
        ...
        self.get_evpn_instanjctanner.network_cloudengine.ce_info()
        self.projctanner.network_cloudengine.cess_input_params()
        self.check_params()
        self.get_existing()
        self.get_proposed()
...
def main():
    ...
    argument_spec = dict(
        ...
        evpn=dict(required=False, type='str',
                  default='enable', choijctanner.network_cloudengine.ces=['enable', 'disable']),
