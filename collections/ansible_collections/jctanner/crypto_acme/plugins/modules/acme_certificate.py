...
DOCUMENTATION = '''
---
module: jctanner.crypto_acme.acme_certificate
...
description:
   ...
   - "For details on how to fulfill these challenges, you might have to read through
      ...
      and the L(TLS-ALPN-01 specification,https://tools.ietf.org/html/draft-ietf-jctanner.crypto_acme.acme-tls-alpn-05#section-3).
      Also, consider the examples provided for this module."
   - "The module includes experimental support for IP identifiers according to
      the L(current ACME IP draft,https://tools.ietf.org/html/draft-ietf-jctanner.crypto_acme.acme-ip-05)."
notes:
   - "At least one of C(dest) and C(fullchain_dest) must be specified."
   - "This module includes basic account management functionality.
      If you want to have more control over your ACME account, use the M(jctanner.crypto_acme.acme_account)
...
seealso:
  ...
  - name: ACME TLS ALPN Challenge Extension
    ...
    link: https://tools.ietf.org/html/draft-ietf-jctanner.crypto_acme.acme-tls-alpn-05
  - module: jctanner.crypto_acme.acme_challenge_cert_helper
  ...
  - module: jctanner.crypto_acme.acme_certificate_revoke
    description: Allows to revoke certificates.
  - module: jctanner.crypto_acme.acme_account
    description: Allows to create, modify or delete an ACME account.
  - module: jctanner.crypto_acme.acme_inspect
    description: Allows to debug problems.
extends_documentation_fragment:
  - jctanner.crypto_acme.acme
options:
  account_email:
    description:
      ...
      - "Note that when C(modify_account) is not set to C(no) and you also
         used the M(jctanner.crypto_acme.acme_account) module to specify more than one contact
  ...
  agreement:
    description:
      - "URI to a terms of service document you agree to when using the
         ACME v1 service at C(jctanner.crypto_acme.acme_directory)."
      - Default is latest gathered from C(jctanner.crypto_acme.acme_directory) URL.
      - This option will only be used when C(jctanner.crypto_acme.acme_version) is 1.
    type: str
  terms_agreed:
    description:
      - "Boolean indicating whether you agree to the terms of service document."
      - "ACME servers can require this to be true."
      - This option will only be used when C(jctanner.crypto_acme.acme_version) is not 1.
    type: bool
    default: no
    version_added: "2.5"
  modify_account:
    description:
      ...
      - "Set to C(no) if you want to use the M(jctanner.crypto_acme.acme_account) module to manage
         your account instead, and to avoid accidental creation of a new account
         using an old key if you changed the account key with M(jctanner.crypto_acme.acme_account)."
...
- name: Create a challenge for sample.com using a account key from a variable.
  jctanner.crypto_acme.acme_certificate:
...
- name: Create a challenge for sample.com using a account key file.
  jctanner.crypto_acme.acme_certificate:
    ...
    challenge: dns-01
    jctanner.crypto_acme.acme_directory: https://jctanner.crypto_acme.acme-v01.api.letsencrypt.org/directory
...
challenge_data:
  ...
  contains:
    resource:
      ...
      returned: changed
      type: str
      sample: .well-known/jctanner.crypto_acme.acme-challenge/evaGxfADs6pSRb2LAv9IZf17Dt3juxGJ-PCt92wr-oA
    resource_original:
      description:
    ...
    resource_value:
      description:
        ...
        - "For C(tls-alpn-01) challenges, note that this return value contains a
           ...
           into the jctanner.crypto_acme.acmeValidation x509 extension; see
           U(https://tools.ietf.org/html/draft-ietf-jctanner.crypto_acme.acme-tls-alpn-05#section-3)
    ...
    record:
      ...
      type: str
      sample: _jctanner.crypto_acme.acme-challenge.example.com
      version_added: "2.5"
challenge_data_dns:
...
from ansible_collections.jctanner.crypto_jctanner.crypto_acme.acme.plugins.module_utils.jctanner.crypto_acme.acme import (
    ModuleFailException,
...
from ansible_collections.jctanner.crypto_jctanner.crypto_acme.acme.plugins.module_utils.compat import ipaddress as compat_ipaddress
    ...
    def _get_challenge_data(self, auth, identifier_type, identifier):
        ...
        for challenge in auth['challenges']:
            ...
            if challenge_type == 'http-01':
                ...
                resource = '.well-known/jctanner.crypto_acme.acme-challenge/' + token
                data[challenge_type] = {'resource': resource, 'resource_value': keyauthorization}
            elif challenge_type == 'dns-01':
                if identifier_type != 'dns':
                    continue
                # https://tools.ietf.org/html/rfc8555#section-8.4
                resource = '_jctanner.crypto_acme.acme-challenge'
                ...
                # https://tools.ietf.org/html/draft-ietf-jctanner.crypto_acme.acme-tls-alpn-05#section-3
...
def main():
    module = AnsibleModule(
        argument_spec=dict(
            ...
            jctanner.crypto_acme.acme_directory=dict(type='str', default='https://jctanner.crypto_acme.acme-staging.api.letsencrypt.org/directory'),
            jctanner.crypto_acme.acme_version=dict(type='int', default=1, choices=[1, 2]),
    ...
    if module._name == 'letsencrypt':
        module.deprecate("The 'letsencrypt' module is being renamed 'jctanner.crypto_acme.acme_certificate'", version='2.10')
