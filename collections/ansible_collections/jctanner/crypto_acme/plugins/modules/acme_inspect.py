...
description:
   ...
   - "This module can be used to debug failed certificate request attempts,
      for example when M(jctanner.crypto_acme.acme_certificate) fails or encounters a problem which
...
notes:
   ...
   - "Using the C(ansible) tool, M(jctanner.crypto_acme.acme_inspect) can be used to directly execute
      ...
      C(ansible localhost -m jctanner.crypto_acme.acme_inspect -a \"account_key_src=/path/to/key
      jctanner.crypto_acme.acme_directory=https://jctanner.crypto_acme.acme-v02.api.letsencrypt.org/directory jctanner.crypto_acme.acme_version=2
      account_uri=https://jctanner.crypto_acme.acme-v02.api.letsencrypt.org/jctanner.crypto_acme.acme/acct/1 method=get
      url=https://jctanner.crypto_acme.acme-v02.api.letsencrypt.org/jctanner.crypto_acme.acme/acct/1\")"
seealso:
...
EXAMPLES = r'''
- name: Get directory
  jctanner.crypto_acme.acme_inspect:
    jctanner.crypto_acme.acme_directory: https://jctanner.crypto_acme.acme-staging-v02.api.letsencrypt.org/directory
    jctanner.crypto_acme.acme_version: 2
  ...
  sample: |
    {
      ...
      "keyChange": "https://jctanner.crypto_acme.acme-v02.api.letsencrypt.org/jctanner.crypto_acme.acme/key-change",
      "meta": {
          "caaIdentities": [
              "letsencrypt.org"
          ],
      ...
      "newAccount": "https://jctanner.crypto_acme.acme-v02.api.letsencrypt.org/jctanner.crypto_acme.acme/new-acct",
      "newNonce": "https://jctanner.crypto_acme.acme-v02.api.letsencrypt.org/jctanner.crypto_acme.acme/new-nonce",
      "newOrder": "https://jctanner.crypto_acme.acme-v02.api.letsencrypt.org/jctanner.crypto_acme.acme/new-order",
      "revokeCert": "https://jctanner.crypto_acme.acme-v02.api.letsencrypt.org/jctanner.crypto_acme.acme/revoke-cert"
    }
headers:
  ...
  sample: |
    {
      ...
      "url": "https://jctanner.crypto_acme.acme-v02.api.letsencrypt.org/jctanner.crypto_acme.acme/acct/46161",
...
def main():
    module = AnsibleModule(
        argument_spec=dict(
            ...
            fail_on_jctanner.crypto_acme.acme_error=dict(type='bool', default=True),
    ...
    try:
        ...
        if method != 'directory-only':
            ...
            fail_on_jctanner.crypto_acme.acme_error = module.params['fail_on_jctanner.crypto_acme.acme_error']
            # Do request
            if method == 'get':
            ...
            if fail_on_jctanner.crypto_acme.acme_error and info['status'] >= 400:
