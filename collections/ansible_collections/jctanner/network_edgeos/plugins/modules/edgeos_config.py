...
from ansible_collections.jctanner.network_edgeos.plugins.module_utils.network.common.config import NetworkConfig
from ansible_collections.jctanner.network_edgeos.plugins.module_utils.network.edgeos.edgeos import load_config, get_config, run_commands
