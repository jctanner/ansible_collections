...
DOCUMENTATION = '''
---
module: jctanner.network_cnos.cnos_conditional_template
...
description:
    - This module allows you to work with the running configuration of a
     ...
     jctanner.network_cnos.cnos_template module. The only exception is that the following inventory
...
Tasks : The following are examples of using the module
 jctanner.network_cnos.cnos_conditional_template. These are written in the main.yml file of the
 tasks directory.
---
- name: Applying CLI template on VLAG Tier1 Leaf Switch1
  jctanner.network_cnos.cnos_conditional_template:
...
def main():
    ...
    for line in f:
        ...
        if not line.startswith("#"):
            # jctanner.network_cnos.cnos.debugOutput(line)
            command = line.strip()
    ...
    cmd.extend(save_cmd)
    output = output + str(jctanner.network_cnos.cnos.run_jctanner.network_cnos.cnos_commands(module, cmd))
