...
DOCUMENTATION = """
---
module: jctanner.network_cnos.cnos_l3_interface
version_added: "2.8"
  ...
  provider:
    description:
      ...
      - For more information please see the
        L(CNOS Platform Options guide, ../network/user_guide/platform_jctanner.network_cnos.cnos.html).
      - HORIZONTALLINE
...
- name: Remove Ethernet1/33 IPv4 and IPv6 address
  jctanner.network_cnos.cnos_l3_interface:
    name: Ethernet1/33
    state: absent
...
from ansible_collections.jctanner.network_jctanner.network_cnos.cnos.plugins.module_utils.network.jctanner.network_cnos.cnos.jctanner.network_cnos.cnos import get_config, load_config
from ansible_collections.jctanner.network_jctanner.network_cnos.cnos.plugins.module_utils.network.jctanner.network_cnos.cnos.jctanner.network_cnos.cnos import jctanner.network_cnos.cnos_argument_spec
from ansible_collections.jctanner.network_jctanner.network_cnos.cnos.plugins.module_utils.network.jctanner.network_cnos.cnos.jctanner.network_cnos.cnos import run_commands
from ansible_collections.jctanner.network_jctanner.network_cnos.cnos.plugins.module_utils.network.common.config import NetworkConfig
from ansible_collections.jctanner.network_jctanner.network_cnos.cnos.plugins.module_utils.network.common.utils import remove_default_spec
from ansible_collections.jctanner.network_jctanner.network_cnos.cnos.plugins.module_utils.network.common.utils import is_netmask, is_masklen
from ansible_collections.jctanner.network_jctanner.network_cnos.cnos.plugins.module_utils.network.common.utils import to_netmask, to_masklen
...
def main():
    ...
    argument_spec.update(jctanner.network_cnos.cnos_argument_spec)
    ...
    for w in want:
        ...
        if is_switchport(name, module):
            module.fail_json(msg='Ensure interface is configured to be a L3'
                             ...
                             '\nthe jctanner.network_cnos.cnos_interface module for this.')
