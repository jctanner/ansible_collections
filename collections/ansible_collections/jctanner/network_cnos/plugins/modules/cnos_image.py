...
DOCUMENTATION = '''
---
module: jctanner.network_cnos.cnos_image
...
'''
EXAMPLES = '''
Tasks : The following are examples of using the module jctanner.network_cnos.cnos_image. These are
  written in the main.yml file of the tasks directory.
---
- name: Test Image transfer
  jctanner.network_cnos.cnos_image:
      deviceType: "{{ hostvars[inventory_hostname]['deviceType'] }}"
      outputfile: "./results/test_image_{{ inventory_hostname }}_output.txt"
      protocol: "sftp"
      serverip: "10.241.106.118"
      imgpath: "/root/jctanner.network_cnos.cnos_images/G8272-10.1.0.112.img"
      imgtype: "os"
      serverusername: "root"
