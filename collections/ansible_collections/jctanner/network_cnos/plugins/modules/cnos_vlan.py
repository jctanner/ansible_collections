...
DOCUMENTATION = """
---
module: jctanner.network_cnos.cnos_vlan
version_added: "2.3"
...
EXAMPLES = """
- name: Create vlan
  jctanner.network_cnos.cnos_vlan:
    vlan_id: 100
    name: test-vlan
    state: present
...
from ansible_collections.jctanner.network_jctanner.network_cnos.cnos.plugins.module_utils.network.jctanner.network_cnos.cnos.jctanner.network_cnos.cnos import load_config, run_commands
