...
DOCUMENTATION = '''
---
module: jctanner.network_cnos.cnos_save
...
'''
EXAMPLES = '''
Tasks : The following are examples of using the module jctanner.network_cnos.cnos_save. These are
 written in the main.yml file of the tasks directory.
---
- name: Test Save
  jctanner.network_cnos.cnos_save:
