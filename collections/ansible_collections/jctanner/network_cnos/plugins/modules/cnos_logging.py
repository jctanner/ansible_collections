...
DOCUMENTATION = """
---
module: jctanner.network_cnos.cnos_logging
version_added: "2.8"
...
- name: configure server logging
  jctanner.network_cnos.cnos_logging:
    dest: server
    name: 10.241.107.224
    facility: local7
    state: present
...
from ansible_collections.jctanner.network_jctanner.network_cnos.cnos.plugins.module_utils.network.common.utils import validate_ip_address
...
from ansible_collections.jctanner.network_jctanner.network_cnos.cnos.plugins.module_utils.network.jctanner.network_cnos.cnos.jctanner.network_cnos.cnos import get_capabilities
from ansible_collections.jctanner.network_jctanner.network_cnos.cnos.plugins.module_utils.network.jctanner.network_cnos.cnos.jctanner.network_cnos.cnos import check_args
