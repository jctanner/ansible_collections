...
DOCUMENTATION = '''
---
module: jctanner.network_cnos.cnos_showrun
...
'''
EXAMPLES = '''
Tasks : The following are examples of using the module jctanner.network_cnos.cnos_showrun. These are
 written in the main.yml file of the tasks directory.
---
- name: Run show running-config
  jctanner.network_cnos.cnos_showrun:
