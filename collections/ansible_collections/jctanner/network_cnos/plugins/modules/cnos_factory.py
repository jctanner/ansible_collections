...
DOCUMENTATION = '''
---
module: jctanner.network_cnos.cnos_factory
...
'''
EXAMPLES = '''
Tasks : The following are examples of using the module jctanner.network_cnos.cnos_reload. These are
 written in the main.yml file of the tasks directory.
---
- name: Test Reset to factory
  jctanner.network_cnos.cnos_factory:
