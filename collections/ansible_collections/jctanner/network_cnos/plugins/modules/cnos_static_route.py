...
DOCUMENTATION = """
---
module: jctanner.network_cnos.cnos_static_route
version_added: "2.8"
...
- name: configure static route
  jctanner.network_cnos.cnos_static_route:
    prefix: 10.241.107.0
    mask: 255.255.255.0
...
from ansible_collections.jctanner.network_jctanner.network_cnos.cnos.plugins.module_utils.compat import ipaddress
