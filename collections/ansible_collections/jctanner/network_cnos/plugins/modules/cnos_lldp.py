...
DOCUMENTATION = """
---
module: jctanner.network_cnos.cnos_lldp
version_added: "2.8"
...
- name: Enable LLDP service
  jctanner.network_cnos.cnos_lldp:
    state: present
...
from ansible_collections.jctanner.network_jctanner.network_cnos.cnos.plugins.module_utils.network.jctanner.network_cnos.cnos.jctanner.network_cnos.cnos import debugOutput, run_commands
