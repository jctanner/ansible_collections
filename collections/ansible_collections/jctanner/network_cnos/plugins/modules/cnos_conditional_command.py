...
DOCUMENTATION = '''
---
module: jctanner.network_cnos.cnos_conditional_command
...
description:
   - This module allows you to modify the running configuration of a switch. It
    ...
    This module functions the same as the jctanner.network_cnos.cnos_command module.
...
Tasks : The following are examples of using the module
 jctanner.network_cnos.cnos_conditional_command. These are written in the main.yml file of the tasks
 directory.
---
- name: Applying CLI template on VLAG Tier1 Leaf Switch1
  jctanner.network_cnos.cnos_conditional_command:
