...
DOCUMENTATION = '''
---
module: jctanner.network_cnos.cnos_facts
version_added: "2.3"
...
'''
EXAMPLES = '''
Tasks: The following are examples of using the module jctanner.network_cnos.cnos_facts.
---
- name: Test jctanner.network_cnos.cnos Facts
  jctanner.network_cnos.cnos_facts:
