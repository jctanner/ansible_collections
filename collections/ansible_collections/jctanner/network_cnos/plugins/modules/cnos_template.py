...
DOCUMENTATION = '''
---
module: jctanner.network_cnos.cnos_template
...
'''
EXAMPLES = '''
Tasks : The following are examples of using the module jctanner.network_cnos.cnos_template. These are written in the main.yml file of the tasks directory.
---
...
- name: Applying CLI commands on Switches
  jctanner.network_cnos.cnos_template:
