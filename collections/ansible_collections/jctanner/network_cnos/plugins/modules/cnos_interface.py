...
DOCUMENTATION = """
---
module: jctanner.network_cnos.cnos_interface
version_added: "2.3"
...
options:
  ...
  provider:
    description:
      ...
      - For more information please see the L(CNOS Platform Options guide, ../network/user_guide/platform_jctanner.network_cnos.cnos.html).
      - HORIZONTALLINE
...
- name: configure interface
  jctanner.network_cnos.cnos_interface:
      name: Ethernet1/33
...
from ansible_collections.jctanner.network_jctanner.network_cnos.cnos.plugins.module_utils.connection import exec_command
...
from ansible_collections.jctanner.network_jctanner.network_cnos.cnos.plugins.module_utils.network.jctanner.network_cnos.cnos.jctanner.network_cnos.cnos import debugOutput, check_args
...
from ansible_collections.jctanner.network_jctanner.network_cnos.cnos.plugins.module_utils.network.common.utils import conditional
