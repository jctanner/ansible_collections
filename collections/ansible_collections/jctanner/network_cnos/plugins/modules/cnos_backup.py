...
DOCUMENTATION = '''
---
module: jctanner.network_cnos.cnos_backup
...
'''
EXAMPLES = '''
Tasks : The following are examples of using the module jctanner.network_cnos.cnos_backup.
 These are written in the main.yml file of the tasks directory.
---
- name: Test Running Config Backup
  jctanner.network_cnos.cnos_backup:
