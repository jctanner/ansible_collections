...
DOCUMENTATION = """
---
module: jctanner.network_cnos.cnos_vrf
version_added: "2.8"
...
EXAMPLES = """
- name: Create vrf
  jctanner.network_cnos.cnos_vrf:
    name: test
    rd: 1:200
    interfaces:
      - Ethernet1/33
...
from ansible_collections.jctanner.network_jctanner.network_cnos.cnos.plugins.module_utils.network.jctanner.network_cnos.cnos.jctanner.network_cnos.cnos import jctanner.network_cnos.cnos_argument_spec, check_args
