...
DOCUMENTATION = """
---
module: jctanner.network_cnos.cnos_linkagg
version_added: "2.8"
...
- name: create link aggregation group
  jctanner.network_cnos.cnos_linkagg:
    group: 10
    state: present
...
from ansible_collections.jctanner.network_jctanner.network_cnos.cnos.plugins.module_utils.network.common.config import CustomNetworkConfig
