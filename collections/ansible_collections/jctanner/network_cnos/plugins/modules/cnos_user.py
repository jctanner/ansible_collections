...
DOCUMENTATION = """
---
module: jctanner.network_cnos.cnos_user
version_added: "2.8"
  ...
  purge:
    description:
      - The C(purge) argument instructs the module to consider the
        ...
        `admin` user which cannot be deleted per jctanner.network_cnos.cnos constraints.
    type: bool
    default: 'no'
  state:
    description:
...
- name: create a new user
  jctanner.network_cnos.cnos_user:
    name: ansible
...
from ansible_collections.jctanner.network_jctanner.network_cnos.cnos.plugins.module_utils.network.jctanner.network_cnos.cnos.jctanner.network_cnos.cnos import run_commands, load_config
from ansible_collections.jctanner.network_jctanner.network_cnos.cnos.plugins.module_utils.network.jctanner.network_cnos.cnos.jctanner.network_cnos.cnos import get_config
...
from ansible_collections.jctanner.network_jctanner.network_cnos.cnos.plugins.module_utils.network.common.utils import to_list
...
from ansible_collections.jctanner.network_jctanner.network_cnos.cnos.plugins.module_utils.network.jctanner.network_cnos.cnos.jctanner.network_cnos.cnos import get_user_roles
...
def main():
    ...
    # the jctanner.network_cnos.cnos cli prevents this by rule but still
