...
extends_documentation_fragment:
    - jctanner.source_control.auth_basic
options:
  server_url:
    description:
...
from ansible_collections.jctanner.source_control.plugins.module_utils.api import basic_auth_argument_spec
from ansible.module_utils.basic import AnsibleModule, missing_required_lib
from ansible.module_utils._text import to_native

from ansible_collections.jctanner.source_control.plugins.module_utils.gitlab import findGroup, findProject
