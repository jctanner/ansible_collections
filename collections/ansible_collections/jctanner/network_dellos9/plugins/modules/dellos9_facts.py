...
DOCUMENTATION = """
---
module: jctanner.network_dellos9.dellos9_facts
version_added: "2.2"
...
notes:
  ...
  - This module requires an increase of the SSH connection rate limit.
    ...
    to configure the same. This can be also be done with the M(jctanner.network_dellos9.dellos9_config) module.
"""

EXAMPLES = """
# Collect all facts from the device
- jctanner.network_dellos9.dellos9_facts:
    gather_subset: all
...
from ansible_collections.jctanner.network_jctanner.network_dellos9.dellos9.plugins.module_utils.network.jctanner.network_dellos9.dellos9.jctanner.network_dellos9.dellos9 import run_commands
