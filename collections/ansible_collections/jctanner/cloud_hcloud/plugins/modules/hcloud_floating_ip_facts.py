...
DOCUMENTATION = """
---
module: jctanner.cloud_hcloud.hcloud_floating_ip_facts
...
EXAMPLES = """
- name: Gather jctanner.cloud_hcloud.hcloud Floating ip facts
  local_action:
    module: jctanner.cloud_hcloud.hcloud_floating_ip_facts
- name: Print the gathered facts
  debug:
    var: ansible_facts.jctanner.cloud_hcloud.hcloud_floating_ip_facts
"""
...
class AnsibleHcloudFloatingIPFacts(Hcloud):
    ...
    def _prepare_result(self):
        ...
        for floating_ip in self.jctanner.cloud_hcloud.hcloud_floating_ip_facts:
    ...
    def get_floating_ips(self):
        try:
            if self.module.params.get("id") is not None:
                self.jctanner.cloud_hcloud.hcloud_floating_ip_facts = [self.client.floating_ips.get_by_id(
                    self.module.params.get("id")
                )]
            elif self.module.params.get("label_selector") is not None:
                self.jctanner.cloud_hcloud.hcloud_floating_ip_facts = self.client.floating_ips.get_all(
...
def main():
    ...
    jctanner.cloud_hcloud.hcloud = AnsibleHcloudFloatingIPFacts(module)

    jctanner.cloud_hcloud.hcloud.get_floating_ips()
    result = jctanner.cloud_hcloud.hcloud.get_result()
    ansible_facts = {
        'jctanner.cloud_hcloud.hcloud_floating_ip_facts': result['jctanner.cloud_hcloud.hcloud_floating_ip_facts']
    }
