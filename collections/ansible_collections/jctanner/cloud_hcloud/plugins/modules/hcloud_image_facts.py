...
DOCUMENTATION = """
---
module: jctanner.cloud_hcloud.hcloud_image_facts
...
EXAMPLES = """
- name: Gather jctanner.cloud_hcloud.hcloud image facts
  local_action:
    module: jctanner.cloud_hcloud.hcloud_image_facts

- name: Print the gathered facts
  debug:
    var: ansible_facts.jctanner.cloud_hcloud.hcloud_image_facts
"""
...
class AnsibleHcloudImageFacts(Hcloud):
    def __init__(self, module):
        Hcloud.__init__(self, module, "jctanner.cloud_hcloud.hcloud_image_facts")
        self.jctanner.cloud_hcloud.hcloud_image_facts = None

    def _prepare_result(self):
        tmp = []

        for image in self.jctanner.cloud_hcloud.hcloud_image_facts:
    ...
    def get_servers(self):
        try:
            if self.module.params.get("id") is not None:
                self.jctanner.cloud_hcloud.hcloud_image_facts = [self.client.images.get_by_id(
                    self.module.params.get("id")
                )]
            elif self.module.params.get("name") is not None:
                self.jctanner.cloud_hcloud.hcloud_image_facts = [self.client.images.get_by_name(
                ...
                self.jctanner.cloud_hcloud.hcloud_image_facts = self.client.images.get_all(**params)
...
def main():
    ...
    jctanner.cloud_hcloud.hcloud = AnsibleHcloudImageFacts(module)
    jctanner.cloud_hcloud.hcloud.get_servers()
    result = jctanner.cloud_hcloud.hcloud.get_result()
    ansible_facts = {
        'jctanner.cloud_hcloud.hcloud_image_facts': result['jctanner.cloud_hcloud.hcloud_image_facts']
    }
