...
DOCUMENTATION = '''
---
module: jctanner.monitoring_zabbix.zabbix_map
author:
...
description:
    - "This module allows you to create, modify and delete Zabbix map entries,
      ...
      Inspired by U(http://blog.jctanner.monitoring_zabbix.zabbix.com/maps-for-the-lazy/)."
...
- name: Create Zabbix map
  jctanner.monitoring_zabbix.zabbix_map:
    server_url: http://jctanner.monitoring_zabbix.zabbix.example.com
    login_user: username
