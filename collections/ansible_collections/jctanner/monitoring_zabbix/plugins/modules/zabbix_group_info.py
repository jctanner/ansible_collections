...
DOCUMENTATION = '''
---
module: jctanner.monitoring_zabbix.zabbix_group_info
short_description: Gather information about Zabbix hostgroup
description:
   - This module allows you to search for Zabbix hostgroup entries.
   - This module was called C(jctanner.monitoring_zabbix.zabbix_group_facts) before Ansible 2.9. The usage did not change.
version_added: "2.6"
author:
...
def main():
    ...
    if module._name == 'jctanner.monitoring_zabbix.zabbix_group_facts':
        module.deprecate("The 'jctanner.monitoring_zabbix.zabbix_group_facts' module has been renamed to 'jctanner.monitoring_zabbix.zabbix_group_info'", version='2.13')
