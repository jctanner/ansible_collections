...
DOCUMENTATION = '''
---
module: jctanner.monitoring_zabbix.zabbix_proxy
...
options:
    ...
    interface:
        description:
            ...
            - U(https://www.jctanner.monitoring_zabbix.zabbix.com/documentation/3.2/manual/api/reference/proxy/object#proxy_interface)
        required: false
        default: {}
