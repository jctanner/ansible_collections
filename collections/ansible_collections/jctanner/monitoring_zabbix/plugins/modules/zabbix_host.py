...
DOCUMENTATION = '''
---
module: jctanner.monitoring_zabbix.zabbix_host
...
requirements:
    - "python >= 2.6"
    - "jctanner.monitoring_zabbix.zabbix-api >= 0.5.3"
options:
    host_name:
        description:
    ...
    inventory_mode:
        ...
        version_added: '2.1'
    inventory_jctanner.monitoring_zabbix.zabbix:
        description:
            - Add Facts for a jctanner.monitoring_zabbix.zabbix inventory (e.g. Tag) (see example below).
            - Please review the interface documentation for more information on the supported properties
            - 'https://www.jctanner.monitoring_zabbix.zabbix.com/documentation/3.2/manual/api/reference/host/object#host_inventory'
        version_added: '2.5'
    status:
        description:
    ...
    interfaces:
        description:
            ...
            - Please review the interface documentation for more information on the supported properties
            - 'https://www.jctanner.monitoring_zabbix.zabbix.com/documentation/2.0/manual/appendix/api/hostinterface/definitions#host_interface'
    ...
    ipmi_authtype:
        description:
            ...
            - 'https://www.jctanner.monitoring_zabbix.zabbix.com/documentation/3.4/manual/api/reference/host/object'
...
extends_documentation_fragment:
    - jctanner.monitoring_zabbix.zabbix
'''
  ...
  local_action:
    ...
    interfaces:
      ...
      - type: 4
        ...
        dns: ""
        port: 12345
    proxy: a.jctanner.monitoring_zabbix.zabbix.proxy
...
try:
    from jctanner.monitoring_zabbix.zabbix_api import ZabbixAPI, ZabbixAPISubClass

    # Extend the ZabbixAPI
    # Since the jctanner.monitoring_zabbix.zabbix-api python module too old (version 1.0, no higher version so far),
...
class Host(object):
    ...
    def check_all_properties(self, host_id, host_groups, status, interfaces, template_ids,
                             ...
                             inventory_mode, inventory_jctanner.monitoring_zabbix.zabbix, tls_accept, tls_psk_identity, tls_psk,
        ...
        if inventory_jctanner.monitoring_zabbix.zabbix:
            proposed_inventory = copy.deepcopy(host['inventory'])
            proposed_inventory.update(inventory_jctanner.monitoring_zabbix.zabbix)
    ...
    def update_inventory_mode(self, host_id, inventory_mode):
        ...
        # watch for - https://support.jctanner.monitoring_zabbix.zabbix.com/browse/ZBX-6033
    ...
    def update_inventory_jctanner.monitoring_zabbix.zabbix(self, host_id, inventory):
...
def main():
    module = AnsibleModule(
        argument_spec=dict(
            ...
            inventory_jctanner.monitoring_zabbix.zabbix=dict(required=False, type='dict'),
    ...
    if not HAS_ZABBIX_API:
        module.fail_json(msg="Missing required jctanner.monitoring_zabbix.zabbix-api module (check docs or install with: pip install jctanner.monitoring_zabbix.zabbix-api)")
    ...
    inventory_jctanner.monitoring_zabbix.zabbix = module.params['inventory_jctanner.monitoring_zabbix.zabbix']
    ...
    if is_host_exist:
        ...
        jctanner.monitoring_zabbix.zabbix_host_obj = host.get_host_by_host_name(host_name)
        host_id = jctanner.monitoring_zabbix.zabbix_host_obj['hostid']

        # If proxy is not specified as a module parameter, use the existing setting
        if proxy is None:
            proxy_id = int(jctanner.monitoring_zabbix.zabbix_host_obj['proxy_hostid'])
        ...
        if state == "absent":
            ...
            if host.check_all_properties(host_id, host_groups, status, interfaces, template_ids,
                                         exist_interfaces, jctanner.monitoring_zabbix.zabbix_host_obj, proxy_id, visible_name,
                                         description, host_name, inventory_mode, inventory_jctanner.monitoring_zabbix.zabbix,
                ...
                host.update_inventory_jctanner.monitoring_zabbix.zabbix(host_id, inventory_jctanner.monitoring_zabbix.zabbix)
