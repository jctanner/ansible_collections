...
module: jctanner.monitoring_zabbix.zabbix_maintenance
...
notes:
    ...
    - Install required module with 'pip install jctanner.monitoring_zabbix.zabbix-api' command.
'''

EXAMPLES = '''
- name: Create a named maintenance window for host www1 for 90 minutes
  jctanner.monitoring_zabbix.zabbix_maintenance:
    name: Update of www1
