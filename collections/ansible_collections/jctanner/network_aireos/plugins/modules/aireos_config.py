...
DOCUMENTATION = """
---
module: jctanner.network_aireos.aireos_config
version_added: "2.4"
...
- name: configure configuration
  jctanner.network_aireos.aireos_config:
...
backup_path:
  ...
  type: str
  sample: /playbooks/ansible/backup/jctanner.network_aireos.aireos_config.2016-07-16@22:28:34
"""
from ansible_collections.jctanner.network_jctanner.network_aireos.aireos.plugins.module_utils.network.jctanner.network_aireos.aireos.jctanner.network_aireos.aireos import run_commands, get_config, load_config
from ansible_collections.jctanner.network_jctanner.network_aireos.aireos.plugins.module_utils.network.jctanner.network_aireos.aireos.jctanner.network_aireos.aireos import jctanner.network_aireos.aireos_argument_spec
from ansible_collections.jctanner.network_jctanner.network_aireos.aireos.plugins.module_utils.network.jctanner.network_aireos.aireos.jctanner.network_aireos.aireos import check_args as jctanner.network_aireos.aireos_check_args
from ansible.module_utils.basic import AnsibleModule
from ansible_collections.jctanner.network_jctanner.network_aireos.aireos.plugins.module_utils.network.common.config import NetworkConfig, dumps
...
def main():
    ...
    warnings = list()
    jctanner.network_aireos.aireos_check_args(module, warnings)
