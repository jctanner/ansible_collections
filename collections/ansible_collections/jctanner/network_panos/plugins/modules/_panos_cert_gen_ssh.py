...
DOCUMENTATION = '''
---
module: jctanner.network_panos.panos_cert_gen_ssh
...
- name: generate self signed certificate
  jctanner.network_panos.panos_cert_gen_ssh:
...
from ansible_collections.jctanner.network_jctanner.network_panos.panos.plugins.module_utils.compat.paramiko import paramiko
import time
