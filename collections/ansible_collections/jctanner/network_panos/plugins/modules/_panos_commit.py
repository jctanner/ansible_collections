...
DOCUMENTATION = '''
---
module: jctanner.network_panos.panos_commit
...
- jctanner.network_panos.panos_commit:
...
def main():
    ...
    jctanner.network_panos.panos_commit_details = dict(
    ...
    if "Commit failed" in xapi.status_detail:
        module.fail_json(msg=xapi.status_detail, jctanner.network_panos.panos_commit=jctanner.network_panos.panos_commit_details)

    if job_id:
        module.exit_json(changed=True, msg="Commit successful.", jctanner.network_panos.panos_commit=jctanner.network_panos.panos_commit_details)
    else:
        module.exit_json(changed=False, msg="No changes to commit.", jctanner.network_panos.panos_commit=jctanner.network_panos.panos_commit_details)
