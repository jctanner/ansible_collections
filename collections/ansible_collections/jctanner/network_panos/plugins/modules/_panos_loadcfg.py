...
DOCUMENTATION = '''
---
module: jctanner.network_panos.panos_loadcfg
...
options:
    ...
    commit:
        ...
        type: bool
        default: 'yes'
extends_documentation_fragment: jctanner.network_panos.panos
'''

EXAMPLES = '''
# Import and load config file from URL
  - name: import configuration
    jctanner.network_panos.panos_import:
  ...
  - name: load configuration
    jctanner.network_panos.panos_loadcfg:
      ip_address: "192.168.1.1"
      password: "admin"
