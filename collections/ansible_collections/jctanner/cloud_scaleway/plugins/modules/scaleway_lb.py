...
DOCUMENTATION = '''
---
module: jctanner.cloud_scaleway.scaleway_lb
...
- name: Create a load-balancer
  jctanner.cloud_scaleway.scaleway_lb:
    name: foobar
    state: present
...
from ansible_collections.jctanner.cloud_jctanner.cloud_scaleway.scaleway.plugins.module_utils.jctanner.cloud_scaleway.scaleway import SCALEWAY_REGIONS, SCALEWAY_ENDPOINT, jctanner.cloud_scaleway.scaleway_argument_spec, Scaleway
...
def core(module):
    ...
    module.exit_json(changed=changed, jctanner.cloud_scaleway.scaleway_lb=summary)
