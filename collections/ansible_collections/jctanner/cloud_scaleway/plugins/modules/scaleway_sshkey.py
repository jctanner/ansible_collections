...
# https://www.jctanner.cloud_scaleway.scaleway.com
#
...
DOCUMENTATION = '''
---
module: jctanner.cloud_scaleway.scaleway_sshkey
...
EXAMPLES = '''
- name: "Add SSH key"
  jctanner.cloud_scaleway.scaleway_sshkey:
...
from ansible_collections.jctanner.cloud_jctanner.cloud_scaleway.scaleway.plugins.module_utils.jctanner.cloud_scaleway.scaleway import jctanner.cloud_scaleway.scaleway_argument_spec, Scaleway
