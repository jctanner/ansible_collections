...
DOCUMENTATION = r'''
---
module: jctanner.cloud_scaleway.scaleway_snapshot_facts
...
- name: Gather Scaleway snapshots facts
  jctanner.cloud_scaleway.scaleway_snapshot_facts:
    region: par1
'''
...
def main():
    ...
    try:
        module.exit_json(
            ansible_facts={'jctanner.cloud_scaleway.scaleway_snapshot_facts': ScalewaySnapshotFacts(module).get_resources()}
        )
