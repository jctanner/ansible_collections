...
DOCUMENTATION = '''
---
module: jctanner.cloud_scaleway.scaleway_security_group
...
EXAMPLES = '''
  - name: Create a Security Group
    jctanner.cloud_scaleway.scaleway_security_group:
      state: present
      region: par1
      name: security_group
...
from ansible_collections.jctanner.cloud_jctanner.cloud_scaleway.scaleway.plugins.module_utils.jctanner.cloud_scaleway.scaleway import SCALEWAY_LOCATION, jctanner.cloud_scaleway.scaleway_argument_spec, Scaleway
...
def present_strategy(api, security_group):
    ...
    if security_group['name'] not in security_group_lookup.keys():
        ...
        if api.module.check_mode:
            ...
            ret['jctanner.cloud_scaleway.scaleway_security_group'] = {'id': str(uuid4())}
            return ret
        ...
        ret['jctanner.cloud_scaleway.scaleway_security_group'] = response.json['security_group']

    else:
        ret['jctanner.cloud_scaleway.scaleway_security_group'] = security_group_lookup[security_group['name']]
