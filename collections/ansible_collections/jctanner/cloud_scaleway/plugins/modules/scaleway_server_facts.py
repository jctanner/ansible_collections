...
DOCUMENTATION = r'''
---
module: jctanner.cloud_scaleway.scaleway_server_facts
...
from ansible_collections.jctanner.cloud_jctanner.cloud_scaleway.scaleway.plugins.module_utils.jctanner.cloud_scaleway.scaleway import (
    Scaleway,
    ScalewayException,
    jctanner.cloud_scaleway.scaleway_argument_spec,
    SCALEWAY_LOCATION,
)
...
def main():
    ...
    try:
        module.exit_json(
            ansible_facts={'jctanner.cloud_scaleway.scaleway_server_facts': ScalewayServerFacts(module).get_resources()}
        )
