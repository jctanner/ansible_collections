...
DOCUMENTATION = r'''
---
module: jctanner.cloud_scaleway.scaleway_image_facts
...
- name: Gather Scaleway images facts
  jctanner.cloud_scaleway.scaleway_image_facts:
    region: par1
'''
    ...
    "jctanner.cloud_scaleway.scaleway_image_facts": [
        {
           ...
           "default_bootscript": {
               "architecture": "x86_64",
               "bootcmdargs": "LINUX_COMMON jctanner.cloud_scaleway.scaleway boot=local nbd.max_part=16",
               "default": false,
               "dtb": "",
...
from ansible_collections.jctanner.cloud_jctanner.cloud_scaleway.scaleway.plugins.module_utils.jctanner.cloud_scaleway.scaleway import (
    Scaleway, ScalewayException, jctanner.cloud_scaleway.scaleway_argument_spec, SCALEWAY_LOCATION)
...
def main():
    ...
    try:
        module.exit_json(
            ansible_facts={'jctanner.cloud_scaleway.scaleway_image_facts': ScalewayImageFacts(module).get_resources()}
        )
