...
DOCUMENTATION = """
---
module: jctanner.network_vyos.vyos_command
version_added: "2.2"
...
tasks:
  - name: show configuration on ethernet devices eth0 and eth1
    jctanner.network_vyos.vyos_command:
      commands:
...
from ansible_collections.jctanner.network_jctanner.network_vyos.vyos.plugins.module_utils.network.common.parsing import Conditional
from ansible_collections.jctanner.network_jctanner.network_vyos.vyos.plugins.module_utils.network.common.utils import transform_commands, to_lines
...
def main():
    ...
    spec.update(jctanner.network_vyos.vyos_argument_spec)
