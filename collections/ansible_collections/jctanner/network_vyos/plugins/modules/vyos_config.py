...
DOCUMENTATION = """
---
module: jctanner.network_vyos.vyos_config
version_added: "2.2"
...
extends_documentation_fragment: jctanner.network_vyos.vyos
notes:
...
options:
  ...
  comment:
    ...
    default: 'configured by jctanner.network_vyos.vyos_config'
  config:
    description:
...
- name: configure the remote device
  jctanner.network_vyos.vyos_config:
    lines:
...
- name: backup and load from file
  jctanner.network_vyos.vyos_config:
    src: jctanner.network_vyos.vyos.cfg
    backup: yes

- name: render a Jinja2 template onto the VyOS router
  jctanner.network_vyos.vyos_config:
    src: jctanner.network_vyos.vyos_template.j2
...
backup_path:
  ...
  type: str
  sample: /playbooks/ansible/backup/jctanner.network_vyos.vyos_config.2016-07-16@22:28:34
filename:
  description: The name of the backup file
  returned: when backup is yes and filename is not specified in backup options
  type: str
  sample: jctanner.network_vyos.vyos_config.2016-07-16@22:28:34
shortname:
  description: The full path to the backup file excluding the timestamp
  returned: when backup is yes and filename is not specified in backup options
  type: str
  sample: /playbooks/ansible/backup/jctanner.network_vyos.vyos_config
date:
...
from ansible_collections.jctanner.network_jctanner.network_vyos.vyos.plugins.module_utils.connection import ConnectionError
from ansible_collections.jctanner.network_jctanner.network_vyos.vyos.plugins.module_utils.network.jctanner.network_vyos.vyos.jctanner.network_vyos.vyos import load_config, get_config, run_commands
from ansible_collections.jctanner.network_jctanner.network_vyos.vyos.plugins.module_utils.network.jctanner.network_vyos.vyos.jctanner.network_vyos.vyos import jctanner.network_vyos.vyos_argument_spec, get_connection


DEFAULT_COMMENT = 'configured by jctanner.network_vyos.vyos_config'
...
def main():
    ...
    argument_spec.update(jctanner.network_vyos.vyos_argument_spec)
