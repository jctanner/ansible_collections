...
DOCUMENTATION = """
---
module: jctanner.network_vyos.vyos_facts
version_added: "2.2"
...
- name: collect all facts from the device
  jctanner.network_vyos.vyos_facts:
    gather_subset: all
...
from ansible_collections.jctanner.network_jctanner.network_vyos.vyos.plugins.module_utils.network.jctanner.network_vyos.vyos.jctanner.network_vyos.vyos import run_commands, get_capabilities
