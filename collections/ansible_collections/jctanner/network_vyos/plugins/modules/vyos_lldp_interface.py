...
DOCUMENTATION = """
---
module: jctanner.network_vyos.vyos_lldp_interface
version_added: "2.4"
...
- name: Create aggregate of LLDP interface configurations
  jctanner.network_vyos.vyos_lldp_interface:
    aggregate:
    - name: eth1
    - name: eth2
    state: present
...
from ansible_collections.jctanner.network_jctanner.network_vyos.vyos.plugins.module_utils.network.jctanner.network_vyos.vyos.jctanner.network_vyos.vyos import get_config, load_config
