...
DOCUMENTATION = """
---
module: jctanner.network_vyos.vyos_ping
...
- name: Test reachability to 10.10.10.10
  jctanner.network_vyos.vyos_ping:
    dest: 10.10.10.10
...
from ansible_collections.jctanner.network_jctanner.network_vyos.vyos.plugins.module_utils.network.jctanner.network_vyos.vyos.jctanner.network_vyos.vyos import run_commands
