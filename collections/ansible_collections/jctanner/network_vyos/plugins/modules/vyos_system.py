...
DOCUMENTATION = """
---
module: "jctanner.network_vyos.vyos_system"
version_added: "2.3"
...
commands:
  ...
  type: list
  sample:
    - set system hostname jctanner.network_vyos.vyos01
    - set system domain-name foo.example.com
"""

EXAMPLES = """
- name: configure hostname and domain-name
  jctanner.network_vyos.vyos_system:
    host_name: jctanner.network_vyos.vyos01
