...
DOCUMENTATION = """
---
module: jctanner.network_vyos.vyos_interface
version_added: "2.4"
...
- name: configure interface
  jctanner.network_vyos.vyos_interface:
    name: eth0
...
from ansible_collections.jctanner.network_jctanner.network_vyos.vyos.plugins.module_utils.connection import exec_command
from ansible_collections.jctanner.network_jctanner.network_vyos.vyos.plugins.module_utils.network.common.utils import conditional, remove_default_spec
from ansible_collections.jctanner.network_jctanner.network_vyos.vyos.plugins.module_utils.network.jctanner.network_vyos.vyos.jctanner.network_vyos.vyos import load_config, get_config
